...
export const exampleAdminFunction = functions.https.onRequest(async (req, res) => {
  try {
...
export const exampleFirestoreFunction = functions.https.onRequest(async (req, res) => {
  try {
...
export const exampleAuthFunction = functions.https.onRequest(async (req, res) => {
