(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  '[project]/node_modules/.pnpm/gsap@3.14.2/node_modules/gsap/gsap-core.js [app-client] (ecmascript)',
  (__turbopack_context__) => {
     ...
     */ /* eslint-disable */ var _config = {
      ...
      _isTypedArray =
        ...
        function () {}, // note: IE10 has ArrayBuffer, but NOT ArrayBuffer.isView().
...
*/ _postAddChecks = function _postAddChecks(timeline, child) {
        ...
        return s.replace(_randomExp, function (match) {
          ...
          var arIndex = match.indexOf('[') + 1,
            values = match
              .substring(
                arIndex || 7,
                arIndex ? match.indexOf(']') : match.length - 1
              )
              .split(_commaDelimExp);
          return random(
            arIndex ? values : +values[0],
            arIndex ? 0 : +values[1],
            +values[2] || 1e-5
          );
        });
      ...
      quickSetter: function quickSetter(target, property, unit) {
        ...
        var Plugin = _plugins[property],
          ...
          p =
            ...
            property, // in case it's an alias, like "rotate" for "rotation".
          setter = Plugin
            ? function (value) {
                var p = new Plugin();
                _quickTween._pt = 0;
  ...
  '[project]/node_modules/.pnpm/gsap@3.14.2/node_modules/gsap/CSSPlugin.js [app-client] (ecmascript)',
  (__turbopack_context__) => {
    'use strict';
     ...
     * Subject to the terms at https://gsap.com/standard-license
     * @author: Jack Doyle, jack@greensock.com
     */ /* eslint-disable */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$gsap$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ =
    ...
    var _win,
      ...
      _renderCSSPropWithBeginningAndEnd =
        function _renderCSSPropWithBeginningAndEnd(ratio, data) {
          return data.set(
            data.t,
            data.p,
            ratio === 1
      ...
      _getStyleSaver = function _getStyleSaver(target, properties) {
        ...
        target._gsap ||
          __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$gsap$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            'gsap'
          ].core.getCache(target); // just make sure there's a _gsap cache defined because we read from it in _saveStyle() and it's more efficient to just check it here once.
        properties &&
          target.style &&
          target.nodeType &&
      ...
      _getReparentedCloneBBox = function _getReparentedCloneBBox(target) {
        ...
        var owner = target.ownerSVGElement,
          svg = _createElement(
            'svg',
            (owner && owner.getAttribute('xmlns')) ||
      ...
      _addNonTweeningPT = function _addNonTweeningPT(
        ...
        var pt =
          new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$gsap$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            'PropTween'
          ](
            plugin._pt,
            target,
      ...
      _tweenComplexCSSString = function _tweenComplexCSSString(
        ...
        if (end.substring(0, 6) === 'var(--') {
          end = _getComputedProperty(
            target,
            end.substring(4, end.indexOf(')'))
          );
        }
        if (end === 'auto') {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$gsap$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
          '_relExp'
        ].test(end) && (pt.e = 0); //if the end string contains relative values or dynamic random(...) values, delete the end it so that on the final render we don't actually set it to the string with += or -= characters (forces it to use the calculated value).
        ...
        clearProps: function clearProps(
          ...
          if (tween.data !== 'isFromStart') {
            var pt = (plugin._pt =
              new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$gsap$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
                'PropTween'
              ](plugin._pt, target, property, 0, 0, _renderClearProps));
            pt.u = endValue;
            pt.pr = -10;
            pt.tween = tween;
            plugin._props.push(property);
      ...
      _addRotationalPropTween = function _addRotationalPropTween(
        ...
        plugin._pt = pt =
          new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$gsap$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            'PropTween'
          ](plugin._pt, target, property, startNum, change, _renderPropWithEnd);
        pt.e = finalValue;
        pt.u = 'deg';
        plugin._props.push(property);
        return pt;
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$gsap$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
      '_forEachName'
    ])('padding,margin,Width,Radius', function (name, index) {
      var t = 'Top',
        r = 'Right',
        b = 'Bottom',
        l = 'Left',
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$gsap$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
      'gsap'
    ].utils.checkPrefix = _checkPropPrefix;
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$gsap$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
      'gsap'
    ].core.getStyleSaver = _getStyleSaver;
  ...
  (__turbopack_context__) => {
    ...
    var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$gsap$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        '[project]/node_modules/.pnpm/gsap@3.14.2/node_modules/gsap/gsap-core.js [app-client] (ecmascript)'
      );
    var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$CSSPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ =
      __turbopack_context__.i(
        '[project]/node_modules/.pnpm/gsap@3.14.2/node_modules/gsap/CSSPlugin.js [app-client] (ecmascript)'
      );
    var gsapWithCSS =
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$gsap$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
          ...
          __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$CSSPlugin$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            'CSSPlugin'
          ]
        ) ||
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$gsap$2d$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
