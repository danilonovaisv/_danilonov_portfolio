  ...
  (__turbopack_context__) => {
    ...
    const PortfolioShowcaseSection = () => {
      ...
      __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
        ...
        {
          'PortfolioShowcaseSection.useMemo[filteredItems]': () => {
            if (activeCategory === '*') return mockPortfolioItems; // Mostra todos
            return mockPortfolioItems.filter(
              {
                'PortfolioShowcaseSection.useMemo[filteredItems]': (item) =>
    ...
    _s(PortfolioShowcaseSection, 'Q0tR4Sngh5IK01Jad4IgASbADaE=');
...
//# sourceMappingURL=src_a16620a5._.js.map
