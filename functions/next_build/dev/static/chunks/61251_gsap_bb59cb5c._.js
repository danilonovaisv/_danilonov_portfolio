(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  '[project]/node_modules/.pnpm/gsap@3.14.2/node_modules/gsap/Observer.js [app-client] (ecmascript)',
      ...
      _proto.init = function init(vars) {
        ...
        var id,
          ...
          limitToTouch =
            ...
            _eventTypes[0] === 'pointerdown', // for devices that accommodate mouse events and touch events, we need to distinguish.
            ...
            var isTrackingDrag = !isNaN(self.y - self.startY),
              ...
              isDragNotClick =
                ...
                (Math.abs(self.x - self.startX) > 3 ||
                  Math.abs(self.y - self.startY) > 3), // some touch devices need some wiggle room in terms of sensing clicks - the finger may move a few pixels.
  ...
  (__turbopack_context__) => {
     ...
     * Subject to the terms at https://gsap.com/standard-license
     * @author: Jack Doyle, jack@greensock.com
     */ /* eslint-disable */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ =
    ...
    var gsap,
      ...
      _getBoundsFunc = function _getBoundsFunc(element) {
        return (
          (0,
          __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            '_getProxyProp'
      ...
      _recordScrollPositions = function _recordScrollPositions() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
          '_scrollers'
    ...
    var ScrollTrigger = /*#__PURE__*/ (function () {
        ...
        self.refresh = function (soft, force, position, pinOffset) {
          ...
          if (invalidateOnRefresh && animation) {
            ...
            animation.getChildren
              ...
              : animation.vars.immediateRender &&
                animation.render(0, true, true); // any from() or fromTo() tweens should render immediately (well, unless they have immediateRender: false)
          }
      ...
      ScrollTrigger.enable = function enable() {
        ...
        if (gsap) {
          ...
          if (_body) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
              'Observer'
            ].register(gsap); // isTouch is 0 if no touch, 1 if ONLY touch, and 2 if it can accommodate touch but also other types like mouse/pointer.
            ScrollTrigger.isTouch =
              __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
                'Observer'
              ].isTouch;
            _fixIOSBug =
              __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
                'Observer'
              ].isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent); // since 2017, iOS has had a bug that causes event.clientX/Y to be inaccurate when a scroll occurs, thus we must alternate ignoring every other touchmove event to work around it. See https://bugs.webkit.org/show_bug.cgi?id=181954 and https://codepen.io/GreenSock/pen/ExbrPNa/087cef197dc35445a0951e8935c41503
            _ignoreMobileResize =
              __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
                'Observer'
              ].isTouch === 1;
      ...
      ScrollTrigger.scrollerProxy = function scrollerProxy(target, vars) {
        ...
        if (~i) {
          __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            '_scrollers'
          ].splice(i, isViewport ? 6 : 2);
        }
        if (vars) {
          isViewport
            ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
                '_proxies'
              ].unshift(_win, vars, _body, vars, _docEl, vars)
            : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
                '_proxies'
              ].unshift(t, vars);
        }
    ...
    ScrollTrigger.update = function (force) {
      return (
        ++__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
          '_scrollers'
        ].cache && _updateAll(force === true ? 2 : 0)
      );
    };
      ...
      _getScrollNormalizer = function _getScrollNormalizer(vars) {
        ...
        vars.onRelease = vars.onGestureStart = function (self, wasDragging) {
          ...
          if (!wasDragging) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
              '_scrollers'
            ].cache++; // make sure we're pulling the non-cached value
        ...
        self =
          new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            'Observer'
          ](vars);
    ...
    ScrollTrigger.observe = function (vars) {
      return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gsap$40$3$2e$14$2e$2$2f$node_modules$2f$gsap$2f$Observer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
        'Observer'
      ](vars);
    };
