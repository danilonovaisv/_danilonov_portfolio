(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    let tt = () => {},
      te = () => {};
    (Q.default, t.s(['invariant', () => te, 'warning', () => tt], 65566));
    ...
    t.s(['initPrefersReducedMotion', () => t1], 38544);
    let t5 = new WeakMap();
    function t2(t) {
    ...
    let t4 = [
      ...
      t9 = ['initial', ...t4];
    function t6(t) {
      return t2(t.animate) || t9.some((e) => t3(t[e]));
    }
    function t8(t) {
    ...
    t.s(['MotionConfigContext', () => ez], 37806);
    ...
    (t.s(['PresenceContext', () => e0], 21476),
      t.s(['useConstant', () => e1], 47414));
    let e5 = (t) => (e, i) => {
    ...
    function e8() {
      return (
        !(function () {
          ...
          let t = {};
          for (let e in e9)
            t[e] = { isEnabled: (t) => e9[e].some((e) => !!t[e]) };
          ((ei = t), (e6 = !0));
        })(),
        ei
      );
    ...
    let is = e4 ? eO.useLayoutEffect : eO.useEffect;
    ...
    t.s(['useIsomorphicLayoutEffect', () => is], 74008);
    class io {
      constructor(t) {
    ...
    function i7({
      ...
      var s;
      let r = Array.isArray(n) && 'number' != typeof n[0] ? n.map(i4) : i4(n),
        o = { done: !1, value: e[0] },
        a = i6(
    ...
    (t.s(['progress', () => i9], 83920),
      t.s(['interpolate', () => i6], 44230),
      t.s(['defaultOffset', () => i8], 15923));
    let nt = (t) => null !== t;
    ...
    t.s(['JSAnimation', () => no], 83352);
    let nl = na(() => void 0 !== window.ScrollTimeline);
    t.s(['supportsScrollTimeline', () => nl], 30551);
    let nh = {},
      nu =
        ((i = na(() => {
          try {
    ...
    class st {
        ...
        (t && ii(t)
          ...
          : t && i
            ? (this.constraints = (function (
                ...
                return { x: n4(t.x, i, s), y: n4(t.y, e, n) };
              })(i.layoutBox, t))
            : (this.constraints = !1),
      ...
      resolveRefConstraints() {
        ...
        let r = (function (t, e, i) {
          ...
          o = ((t = s.layout.layoutBox), { x: n9(t.x, r.x), y: n9(t.y, r.y) });
        if (i) {
          let t = i(
            (function ({ x: t, y: e }) {
        ...
        nI((t) => {
          ...
          if (e && !1 !== this.constraints) {
            ...
            n[t] =
              ...
              (a = nW(i)),
              (l = nW(s)) > a
                ? (o = i9(s.min, s.max - a, i.min))
                : a > l && (o = i9(i.min, i.max - l, s.min)),
              r(0, 1, o));
          }
        });
    ...
    let s2 = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
      ...
      s4 = s3('applewebkit/') && !s3('chrome/') ? Math.round : tS;
    function s9(t) {
      ((t.min = s4(t.min)), (t.max = s4(t.max)));
    }
    function s6(t, e, i) {
      return (
        'position' === t ||
    ...
    (t.s(['resolveElements', () => ri], 49652),
      t.s(['isHTMLElement', () => ro], 72846));
