(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var r = e.i(77579),
      ...
      o = e.i(95535),
      s = e.i(82342);
    let i = (0, a.createContext)({ lenis: null });
    e.i(1921);
    var n = e.i(34476);
    let l = (e) => {
        let t = (0, n.createStore)(e),
          r = (e) =>
            (function (e, t = (e) => e) {
    ...
    function d({ children: e }) {
      let { flags: t } = c(),
        n = (0, o.usePathname)(),
        l = (0, a.useMemo)(() => n?.startsWith('/admin') ?? !1, [n]),
        [d, u] = (0, a.useState)(null);
      return (
        (0, a.useEffect)(() => {
          if (t.reducedMotion || l) return void u(null);
          let e = new s.default({
            lerp: 0.08,
            wheelMultiplier: 1,
            touchMultiplier: 1.2,
        ...
        (0, r.jsx)(i.Provider, { value: { lenis: l ? null : d }, children: e })
      );
    }
    (e.s(['useAntigravityStore', 0, c], 94134),
      e.s(['default', () => d], 19017));
  },
  14072,
  (e) => {
  ...
  (e) => {
              ...
              children: (0, t.jsx)('span', {
                ...
                children: r.map((e, a) =>
                  (0, t.jsx)(
                    'span',
                    {
                      className: `block h-[1em] leading-none text-sm tracking-wide ${a === r.length - 1 ? 'visible' : 'invisible'}`,
                      children: e,
                    },
                    `${e}-${a}`
                  )
    ...
    function P({ logoUrl: e, onLogoClick: r, children: a, isLight: o = !1 }) {
      ...
      return (0, t.jsx)(x.motion.header, {
        variants: {
        ...
        children: (0, t.jsx)('div', {
          ...
          children: (0, t.jsxs)('div', {
            ...
            children: [
              ...
              (0, t.jsx)(x.motion.div, { variants: s, children: a }),
            ],
          }),
        }),
      });
