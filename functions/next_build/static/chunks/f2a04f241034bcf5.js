    ...
    let y = ({
      ...
      if (w !== E) {
        ...
        for (let t = 0; t < M.length; t++) {
          let i = M[t],
            s = f(i);
          j.includes(s) || (e.splice(t, 0, i), R.push(i));
        }
        return ('wait' === d && R.length && (e = R), P(g(e)), z(w), null);
      }
      let { forceRender: B } = (0, i.useContext)(s.LayoutGroupContext);
      return (0, t.jsx)(t.Fragment, {
        children: M.map((e) => {
          let i = f(e),
            s = (!u || !!b) && (w === M || j.includes(i));
          return (0, t.jsx)(
            m,
            {
              isPresent: s,
