(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    e.s(['useReducedMotion', () => o]);
  },
  55064,
  (e) => {
    'use strict';
    var a = e.i(12559);
    let i = (e) => (0, a.buildSupabaseStorageUrl)('site-assets', e),
      t = (e) => (0, a.buildSupabaseStorageUrl)('portfolio-media', e),
      ...
      r = {
        ...
        featuredProjects: [
          {
            ...
            img: t('projects/creative-direction/hero.webp'),
            layout: {
          ...
          },
          {
            ...
            img: t('projects/campaign/hero.webp'),
            layout: {
              h: 'min-h-[400px] md:h-[500px] aspect-[4/5] md:aspect-auto',
              cols: 'md:col-span-7',
          ...
          },
          {
            ...
            year: 2021,
            tags: ['Art Direction'],
            img: t('projects/key-vision/gallery/converted-5-webp.webp'),
            layout: {
          ...
          },
          {
            ...
            img: t('projects/key_vision/hero.webp'),
            layout: {
        ...
        clients: {
          ...
          logos: Array.from({ length: 12 }, (e, a) => ({
            id: a + 1,
            src: i(`clients/clients.strip.${a + 1}.svg`),
      ...
      l = {
        hero: {
          video: {
            desktop: o('VIDEO-APRESENTACAO-PORTFOLIO.mp4'),
            mobile: o('VIDEO-APRESENTACAO-PORTFOLIO.mp4'),
          },
        },
      };
    e.s([
  ...
  (e) => {
    ...
    var a = e.i(43476),
      i = e.i(75157);
    function t({ children: e, className: t, as: o = 'div', ...r }) {
      return (0, a.jsx)(o, {
        className: (0, i.cn)(
  ...
  (e) => {
        ...
        children: (0, a.jsxs)('div', {
          ...
          children: [
            ...
            (0, a.jsx)(i.motion.ul, {
              ...
              children: s.map((e) => {
                let t = e.src?.toLowerCase().endsWith('.svg');
                return (0, a.jsx)(
                  i.motion.li,
                  {
                    role: 'listitem',
    ...
    var u = e.i(40022),
      x = e.i(38341),
      b = e.i(71645);
    let f = ({ label: e, error: i, id: t, className: o = '', ...r }) =>
        (0, a.jsxs)('div', {
          children: [
            (0, a.jsx)('label', {
              htmlFor: t,
            ...
            (0, a.jsx)('input', {
              id: t,
              'aria-invalid': !!i,
              'aria-describedby': i ? `${t}-error` : void 0,
              className: `w-full min-h-[48px] rounded-lg border border-[#111111]/10 bg-[#f8fafc] px-4 py-4 text-[#111111] placeholder:text-[#111111]/30 transition-all outline-none focus:border-[#0057FF] focus:ring-2 focus:ring-[#0057FF]/20 ${i ? 'border-red-500' : ''} ${o}`,
              ...r,
            }),
            i &&
              (0, a.jsx)('p', {
      ...
      v = ({ label: e, error: i, id: t, className: o = '', ...r }) =>
        (0, a.jsxs)('div', {
          children: [
            (0, a.jsx)('label', {
              htmlFor: t,
            ...
            (0, a.jsx)('textarea', {
              ...
              'aria-invalid': !!i,
              'aria-describedby': i ? `${t}-error` : void 0,
              className: `w-full resize-none rounded-lg border border-[#111111]/10 bg-[#f8fafc] px-4 py-4 text-[#111111] placeholder:text-[#111111]/30 transition-all outline-none focus:border-[#0057FF] focus:ring-2 focus:ring-[#0057FF]/20 min-h-[120px] ${i ? 'border-red-500' : ''} ${o}`,
              ...r,
            }),
            i &&
              (0, a.jsx)('p', {
      ...
      let e = [
        {
          label: 'Instagram',
          href: x.SOCIALS.instagram,
          icon: (0, a.jsx)(c.Instagram, { className: 'w-5 h-5 lg:w-4 lg:h-4' }),
        },
        {
          label: 'LinkedIn',
          href: x.SOCIALS.linkedin,
          icon: (0, a.jsx)(m.Linkedin, { className: 'w-5 h-5 lg:w-4 lg:h-4' }),
        },
        {
          label: 'Twitter',
          href: x.SOCIALS.twitter,
          icon: (0, a.jsx)(p, { className: 'w-5 h-5 lg:w-4 lg:h-4' }),
        },
      ];
          ...
          children: [
            (0, a.jsx)('div', {
              ...
              children: (0, a.jsx)('p', {
                ...
                children: x.NAVIGATION.footer.copyright,
              }),
            }),
            (0, a.jsx)('nav', {
              className:
              ...
              children: x.NAVIGATION.footer.links.map((e) =>
                (0, a.jsxs)(
                  N.default,
                  {
                    href: e.href,
    ...
    function O() {
      return (0, a.jsxs)(a.Fragment, {
        children: [(0, a.jsx)(s, {}), (0, a.jsx)(j, {}), (0, a.jsx)(C, {})],
      });
    }
    e.s(['SiteClosure', () => O], 74177);
  },
]);
