(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
        ...
        [
          ...
          ({
            ...
            let [l, c] = (0, i.useState)(!1),
              d = (0, i.useRef)(null),
              u = { type: 'spring', stiffness: 300, damping: 25 };
    ...
    function C() {
      let e = [
        ...
        },
        {
          label: 'LinkedIn',
          href: f.SOCIALS.linkedin,
          icon: (0, t.jsx)(u.Linkedin, { className: 'w-5 h-5 lg:w-4 lg:h-4' }),
        },
        {
          label: 'Twitter',
          href: f.SOCIALS.twitter,
          icon: (0, t.jsx)(m, { className: 'w-5 h-5 lg:w-4 lg:h-4' }),
        },
      ];
  ...
  (e) => {
    ...
    function N(e, t, i, a) {
      ...
      let c = a - l;
      r.velocity = c > 50 ? 0 : (0, y.velocityPerSecond)(r.current - s, c);
    }
    e.i(47167);
    var C = e.i(44230),
      S = e.i(15923),
    ...
    function z(
            ...
            R.set(
              ...
              'function' == typeof a
                ...
                : (!t &&
                  ...
                  (e = (0, u.resolveElements)(a)).forEach((e) => {
                    let i = m.get(e);
                    (i || ((i = new Set()), m.set(e, i)),
                      i.add(n),
                      t?.observe(e));
                  }),
                  () => {
      ...
      return (
        ...
        () => {
          ...
          (L.delete(a),
            t &&
              (V(a).removeEventListener('scroll', t),
              R.get(a)?.(),
    ...
    let W = new Map();
    function P({ source: e, container: t, ...i }) {
      var a;
      let r,
        o,
        { axis: n } = i;
      e && (t = e);
      let s = W.get(t) ?? new Map();
      W.set(t, s);
      let l = i.target ?? 'self',
        d = s.get(l) ?? {},
        u = n + (i.offset ?? []).join(',');
          ...
          function e(a, r, o, c) {
            ...
            if (void 0 !== o && !Array.isArray(o) && 'function' != typeof r) {
              var d = a,
                ...
                m = o,
                g = c;
              let t = (0, i.useConstant)(() => Object.keys(m)),
                n = (0, i.useConstant)(() => ({}));
              for (let i of t) n[i] = e(d, u, m[i], g);
              return n;
            }
            ...
            () =>
              (function (e, o, n = {}) {
                let s,
                  ...
                  c = null,
                  d = l,
                  u = 'string' == typeof l ? l.replace(/[\d.-]/g, '') : void 0,
                  m = () => {
                    c && (c.stop(), (c = null));
                  };
                if (
