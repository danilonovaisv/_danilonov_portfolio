(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let r = (e = new Map(), r = null, o) => ({
      ...
      I = (e) => e.endsWith('%') && O(e.slice(0, -1)),
      T = (e) => y.test(e),
      $ = () => !0,
      M = (e) => v.test(e) && !z.test(e),
      W = () => !1,
      A = (e) => j.test(e),
      P = (e) => G.test(e),
      S = (e) => !B(e) && !D(e),
      ...
      en = ((e, ...r) => {
        ...
        let e = h('color'),
          ...
          G = () => [D, B, i],
          M = () => [C, 'full', 'auto', ...G()],
          W = () => [N, 'none', 'subgrid', D, B],
          A = () => ['auto', { span: ['full', N, D, B] }, N, D, B],
          P = () => [N, 'auto', D, B],
          X = () => ['auto', 'min', 'max', 'fr', D, B],
          Y = () => [
            'start',
            'end',
            'center',
          ...
          eo = () => [e, D, B],
          et = () => [...y(), J, U, { position: [D, B] }],
          el = () => [
            'no-repeat',
            { repeat: ['', 'x', 'y', 'space', 'round'] },
          ],
          ea = () => ['auto', 'cover', 'contain', L, q, { size: [D, B] }],
          en = () => [I, F, K],
          es = () => ['', 'none', 'full', d, D, B],
          ei = () => ['', O, F, K],
        ...
        return {
          ...
          classGroups: {
            aspect: [{ aspect: ['auto', 'square', C, B, D, g] }],
            container: ['container'],
            columns: [{ columns: [O, B, D, s] }],
            ...
            flex: [{ flex: [O, C, 'auto', 'initial', 'none', B] }],
            grow: [{ grow: ['', O, D, B] }],
            shrink: [{ shrink: ['', O, D, B] }],
            order: [{ order: [N, 'first', 'last', 'none', D, B] }],
            ...
            'font-size': [{ text: ['base', o, F, K] }],
            'font-smoothing': ['antialiased', 'subpixel-antialiased'],
            'font-style': ['italic', 'not-italic'],
            'font-weight': [{ font: [t, D, R] }],
            'font-stretch': [
              {
                'font-stretch': [
                  'ultra-condensed',
            ...
            tracking: [{ tracking: [l, D, B] }],
            'line-clamp': [{ 'line-clamp': [O, 'none', D, R] }],
            leading: [{ leading: [a, ...G()] }],
            'list-image': [{ 'list-image': ['none', D, B] }],
            'list-style-position': [{ list: ['inside', 'outside'] }],
            'list-style-type': [{ list: ['disc', 'decimal', 'none', D, B] }],
            'text-alignment': [
            ...
            'text-decoration-thickness': [
              { decoration: [O, 'from-font', 'auto', D, K] },
            ],
            'text-decoration-color': [{ decoration: eo() }],
            'underline-offset': [{ 'underline-offset': [O, 'auto', D, B] }],
            'text-transform': [
              'uppercase',
              'lowercase',
              'capitalize',
            ...
            'mask-image-radial': [{ 'mask-radial': [D, B] }],
            ...
            'mask-image': [{ mask: ['none', D, B] }],
            filter: [{ filter: ['', 'none', D, B] }],
            blur: [{ blur: ep() }],
            brightness: [{ brightness: [O, D, B] }],
            contrast: [{ contrast: [O, D, B] }],
            'drop-shadow': [{ 'drop-shadow': ['', 'none', u, V, E] }],
            'drop-shadow-color': [{ 'drop-shadow': eo() }],
            grayscale: [{ grayscale: ['', O, D, B] }],
            'hue-rotate': [{ 'hue-rotate': [O, D, B] }],
            invert: [{ invert: ['', O, D, B] }],
            saturate: [{ saturate: [O, D, B] }],
            sepia: [{ sepia: ['', O, D, B] }],
            'backdrop-filter': [{ 'backdrop-filter': ['', 'none', D, B] }],
            'backdrop-blur': [{ 'backdrop-blur': ep() }],
            'backdrop-brightness': [{ 'backdrop-brightness': [O, D, B] }],
            'backdrop-contrast': [{ 'backdrop-contrast': [O, D, B] }],
            'backdrop-grayscale': [{ 'backdrop-grayscale': ['', O, D, B] }],
            'backdrop-hue-rotate': [{ 'backdrop-hue-rotate': [O, D, B] }],
            'backdrop-invert': [{ 'backdrop-invert': ['', O, D, B] }],
            'backdrop-opacity': [{ 'backdrop-opacity': [O, D, B] }],
            'backdrop-saturate': [{ 'backdrop-saturate': [O, D, B] }],
            'backdrop-sepia': [{ 'backdrop-sepia': ['', O, D, B] }],
            ...
            duration: [{ duration: [O, 'initial', D, B] }],
            ease: [{ ease: ['linear', 'initial', k, D, B] }],
            delay: [{ delay: [O, D, B] }],
            animate: [{ animate: ['none', x, D, B] }],
            backface: [{ backface: ['hidden', 'visible'] }],
            perspective: [{ perspective: [f, D, B] }],
            ...
            'skew-x': [{ 'skew-x': ef() }],
            'skew-y': [{ 'skew-y': ef() }],
            transform: [{ transform: [D, B, '', 'none', 'gpu', 'cpu'] }],
