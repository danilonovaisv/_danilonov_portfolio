module.exports = [
  ...
  (a) => {
    ...
    var c = a.i(33845),
      d = a.i(10385),
      e = a.i(68335);
    let f = (0, d.createContext)({ lenis: null });
    var g = a.i(91238);
    let h = (a) => {
        let b = (0, g.createStore)(a),
          c = (a) =>
            (function (a, b = (a) => a) {
    ...
    function j({ children: a }) {
      ...
      return (
        ...
        (0, c.jsx)(f.Provider, { value: { lenis: g }, children: a })
      );
    }
    (a.s(['useAntigravityStore', 0, i], 8980),
      a.s(['default', () => j], 83585));
  },
  10943,
  (a) => {
                ...
                children: c.map((a, d) =>
                  (0, b.jsx)(
                    'span',
                    {
                      ...
                      style: {
                        visibility: d === c.length - 1 ? 'visible' : 'hidden',
                      },
                      children: a,
                    },
                    `${a}-${d}`
                ...
                return (0, b.jsx)(
                  'li',
                  {
                    ...
                    children: (0, b.jsx)('button', {
                      onClick: () => f(a.href),
                      className: `sm-panel-item w-full py-3 text-4xl font-light tracking-wide transition-colors text-left leading-none uppercase will-change-transform origin-bottom min-h-[48px] ${(i ? 'text-blueAccent font-semibold' : '') || (h === c ? 'text-blueAccent font-medium underline underline-offset-4' : 'text-white/80 hover:text-white')}`,
                      children: a.label,
                    }),
                  },
                  a.href
