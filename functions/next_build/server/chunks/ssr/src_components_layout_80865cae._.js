module.exports = [
  ...
  (a) => {
    ...
    var c = a.i(59465),
      ...
      e = a.i(421),
      f = a.i(68335);
    let g = (0, d.createContext)({ lenis: null });
    var h = a.i(52339);
    let i = (a) => {
        let b = (0, h.createStore)(a),
          c = (a) =>
            (function (a, b = (a) => a) {
    ...
    function k({ children: a }) {
      let { flags: b } = j(),
        h = (0, e.usePathname)(),
        i = (0, d.useMemo)(() => h?.startsWith('/admin') ?? !1, [h]),
        [k, l] = (0, d.useState)(null);
      return (
        (0, d.useEffect)(() => {
          if (b.reducedMotion || i) return void l(null);
          let a = new f.default({
            lerp: 0.08,
            wheelMultiplier: 1,
            touchMultiplier: 1.2,
        ...
        (0, c.jsx)(g.Provider, { value: { lenis: i ? null : k }, children: a })
      );
    }
    (a.s(['useAntigravityStore', 0, j], 8980),
      a.s(['default', () => k], 83585));
  },
  10943,
  (a) => {
  ...
  (a) => {
    ...
    async function g() {
      ...
      return (function (a, b = {}) {
          ...
          let a = (function (a) {
              let b = (a.bucket || 'site-assets')
                ...
                c = a.key
                  ...
                  .replace(/,+$/g, '')
                  .trim(),
                d = (0, f.normalizeStoragePath)(a.file_path, b),
                e = d
                ...
                j =
                  (0, f.buildSupabaseStorageUrl)(g, e) ||
              ...
              if (a.href) {
                let b = (0, f.validateExternalUrl)(a.href);
                b && (k = { ...k, href: b });
              }
              return k;
            })({
        ...
        for (let a of g.values()) k.set(a.id, a);
      ...
      return (0, b.jsx)('header', {
        ...
        children: (0, b.jsx)('div', {
          ...
          children: (0, b.jsx)('div', {
            ...
            children: (0, b.jsx)('div', {
              className: `${o.default.headerContainer} ${g ? o.default.headerLight : o.default.headerDark} h-16 w-[calc(100%+5rem)] -ml-10 rounded-4xl backdrop-blur-md border border-white/10 bg-black/20 transition-all duration-300`,
    ...
    let q = (0, c.forwardRef)(
      (
        ...
        (0, b.jsxs)('button', {
          ...
          className: `relative inline-flex items-center justify-center gap-2 bg-transparent border-0 cursor-pointer font-medium leading-none overflow-visible z-110 min-h-12 min-w-12 px-3 transition-colors duration-300 ${a ? 'text-white' : 'text-white hover:text-primary'}`,
          children: [
            (0, b.jsx)('span', {
              className:
              ...
              children: (0, b.jsx)('span', {
                ...
                children: c.map((a, d) =>
                  (0, b.jsx)(
                    'span',
                    {
                      className: `block h-[1em] leading-none text-sm tracking-wide ${d === c.length - 1 ? 'visible' : 'invisible'}`,
                      children: a,
                    },
                    `${a}-${d}`
                  )
    ...
    q.displayName = 'MobileMenuButton';
    var r = a.i(29474),
      s = a.i(16721),
      t = a.i(75069),
      u = a.i(47979),
      v = a.i(10913);
    let w = (0, c.forwardRef)(
      (
        {
          navItems: a,
          accentColor: c,
        ...
        (0, b.jsxs)('nav', {
          ...
          children: [
            (0, b.jsx)('ul', {
              ...
              role: 'list',
              children: a.map((a) => {
                let c = a.href.startsWith('/#') ? a.href.substring(1) : a.href;
                return (0, b.jsx)(
                  'li',
                  {
              ...
              children: [
                ...
                (0, b.jsx)('div', {
                  ...
                  children: [
                    {
                      label: 'LinkedIn',
                      href: v.SOCIALS.linkedin,
                      icon: (0, b.jsx)(t.Linkedin, { className: 'w-5 h-5' }),
                    },
                    {
                      label: 'Instagram',
                      href: v.SOCIALS.instagram,
                      icon: (0, b.jsx)(s.Instagram, { className: 'w-5 h-5' }),
                    },
                    {
                      label: 'Email',
                      href: v.SOCIALS.emailPrimary,
                      icon: (0, b.jsx)(u.Mail, { className: 'w-5 h-5' }),
                    },
                  ].map((a) =>
                    (0, b.jsx)(
                      'a',
    ...
    w.displayName = 'MobileMenuPanel';
    let x = (0, c.forwardRef)((a, c) =>
      (0, b.jsx)('div', {
        ref: c,
        className:
          'fixed top-0 right-0 bottom-0 w-full pointer-events-none z-49',
        'aria-hidden': 'true',
        children: ['#4fe6ff', '#8705f2', '#f501d3'].map((a, c) =>
          (0, b.jsx)(
            r.motion.div,
            {
    ...
    function y({ logoUrl: a, onLogoClick: c, children: d, isLight: e = !1 }) {
      let f = {
      ...
      return (0, b.jsx)(r.motion.header, {
        variants: {
        ...
        children: (0, b.jsx)('div', {
          ...
          children: (0, b.jsxs)('div', {
            ...
            children: [
              ...
              (0, b.jsx)(r.motion.div, { variants: f, children: d }),
            ],
          }),
        }),
      });
    }
    x.displayName = 'MobilePreLayers';
    var z = a.i(8909);
    function A({
      navItems: a,
      logoUrl: d,
      ...
      let {
        ...
        state: { open: v, textLines: A },
        actions: { toggleMenu: B, syncState: C },
      } = (function (a, b, d) {
        ...
        (0, c.useLayoutEffect)(() => {
          let a = z.gsap.context(() => {
            ...
            (b && (n = Array.from(b.querySelectorAll('.sm-prelayer'))),
              ...
              z.gsap.set(c, { transformOrigin: '50% 50%', rotate: 0 }),
              z.gsap.set(d, { transformOrigin: '50% 50%', rotate: 90 }),
              z.gsap.set(h, { rotate: 0, transformOrigin: '50% 50%' }),
              z.gsap.set(i, { yPercent: 0 }));
          });
          return () => a.revert();
        }, []);
        let w = (0, c.useCallback)((a) => {
            let b = l.current,
              c = j.current,
              d = k.current;
            b &&
              ...
              (r.current?.kill(),
              a
                ? (z.gsap.set(b, { rotate: 0, transformOrigin: '50% 50%' }),
                  (r.current = z.gsap
          ...
          x = (0, c.useCallback)((a) => {
            ...
            (d.push(a ? 'Close' : 'Menu'),
              o(d),
              z.gsap.set(b, { yPercent: 0 }));
            let f = d.length;
            s.current = z.gsap.to(b, {
              yPercent: -(((f - 1) / f) * 100),
              duration: 0.6,
              ease: 'expo.out',
            });
          ...
          y = (0, c.useCallback)(() => {
            ...
            (c.length &&
              z.gsap.set(c, { x: 40, opacity: 0, filter: 'blur(8px)' }),
              i && z.gsap.set(i, { opacity: 0, filter: 'blur(4px)' }),
              f.length && z.gsap.set(f, { x: 20, opacity: 0 }));
            let j = z.gsap.timeline({ paused: !0 });
            if (
              (b.length &&
                j.to(b, {
                  opacity: 0.9,
            ...
            (q.current?.kill(),
              (q.current = z.gsap.to(c, {
                ...
                onComplete: () => {
                  ...
                  b.length &&
                    z.gsap.set(b, { x: 40, opacity: 0, filter: 'blur(8px)' });
                  let c = h.current;
                  if (c) {
                    let a = c.querySelector('.sm-social-title'),
                      b = Array.from(c.querySelectorAll('.sm-social-link'));
                    (a && z.gsap.set(a, { opacity: 0 }),
                      b.length && z.gsap.set(b, { x: 20, opacity: 0 }));
                  }
                },
              })));
          }, []),
          C = (0, c.useCallback)(() => {
            a !== v.current &&
              (a
                ? ((v.current = !0), u(!0), A(), w(!0), x(!0))
                : ((v.current = !1), u(!1), B(), w(!1), x(!1)));
          }, [a, A, B, w, x]);
        return {
          refs: {
            panelRef: e,
    ...
    function C({ navItems: a, gradient: e, accentColor: f }) {
      let g = (0, h.useRouter)(),
        [i, m] = (0, c.useState)(!1),
        [n, o] = (0, c.useState)(!1),
        [q, r] = (0, c.useState)(!1),
        s = (0, k.useMediaQuery)('(min-width: 1024px)');
      (0, c.useEffect)(() => {
        r(!0);
      }, []);
      let t = (function (a, b = '-45% 0px -45% 0px') {
          let [d, e] = (0, c.useState)('#hero');
          return (
            (0, c.useEffect)(() => {
          ...
          (0, c.useMemo)(
            () =>
              a
                ...
                .map((a) => B(a.href).replace('#', '')),
            [a]
          )
        ),
        u = (0, h.usePathname)(),
        v = (0, c.useMemo)(() => ('/' === u ? t : (u ?? void 0)), [u, t]),
        w = u?.startsWith('/sobre'),
        x = (0, c.useCallback)(
          (a) => {
            let b = B(a);
            if (b) {
            ...
            if (
              ...
              (window.open(a, '_blank', 'noopener,noreferrer'), m(!1));
              return;
            }
            (g.push(a), m(!1));
          },
      ...
      let z =
        (0, d.useSiteAssetUrl)(
          l.SITE_ASSET_KEYS.logos.headerLight,
          j.BRAND.assets.logos.logoLight
        ) ?? j.BRAND.assets.logos.logoLight;
      return q
        ? (0, b.jsx)(b.Fragment, {
            children: s
    ...
    function D() {
      return (0, b.jsx)(C, {
        navItems: v.NAVIGATION.header || [],
        gradient: ['rgba(0,87,255,0.55)', 'rgba(82,39,255,0.45)'],
        accentColor: j.BRAND.colors.bluePrimary,
      });
    }
    var E = a.i(8980);
    let F = [
    ...
    function G({ children: a }) {
      let d = (0, h.usePathname)(),
        e = (0, c.useMemo)(() => d?.startsWith('/admin') ?? !1, [d]);
      return (!(function (a = !0) {
        let b = (0, E.useAntigravityStore)((a) => a.setFlags),
          d = (0, E.useAntigravityStore)((a) => a.setViewport);
        (0, c.useEffect)(() => {
          if (!a) return;
          let c = () => {
    ...
    (F.filter((a) =>
      ...
      F.filter((a) => ['PROMPT_03', 'PROMPT_04', 'PROMPT_07'].includes(a.id)),
      F.filter((a) => ['PROMPT_08', 'PROMPT_09', 'PROMPT_10'].includes(a.id)));
    var H = c;
    class I extends H.Component {
      ...
      componentDidCatch(a, b) {
        (console.error('=== ERROR BOUNDARY CAUGHT ==='),
          ...
          console.error('Error Message:', a.message),
          console.error('Error Stack:', a.stack),
          console.error('Component Stack:', b.componentStack),
          console.error('=== END ERROR BOUNDARY ==='),
          this.setState({ errorInfo: b }));
      }
      render() {
    ...
    function J({ children: a }) {
      ...
      h)
        ? (0, b.jsx)(I, {
            children: (0, b.jsx)(d.SiteAssetsProvider, {
              assets: e,
              children: (0, b.jsx)(G, { children: a }),
            }),
          })
        : (0, b.jsx)(G, { children: a });
    }
    a.s(['default', () => J], 26276);
  },
];

//# sourceMappingURL=src_components_layout_80865cae._.js.map
