module.exports = [
  ...
  (a) => {
    ...
    var b = a.i(87924),
      ...
      d = a.i(50944),
      e = a.i(70106);
    let f = (0, e.default)('layout-dashboard', [
        [
          'rect',
    ...
    var k = a.i(5050);
    let l = (0, k.createServerReference)(
    ...
    var m = a.i(2672);
    let n = [
      { href: m.ADMIN_NAVIGATION.dashboard, label: 'Dashboard', icon: f },
      { href: m.ADMIN_NAVIGATION.trabalhos.index, label: 'Trabalhos', icon: g },
      { href: m.ADMIN_NAVIGATION.tags, label: 'Tags', icon: h.Tag },
      { href: m.ADMIN_NAVIGATION.midia, label: 'Mídia & Layout', icon: i },
      {
        href: m.ADMIN_NAVIGATION['landing-pages'],
        label: 'Landing Pages',
        icon: f,
      },
      { href: m.ADMIN_NAVIGATION.config, label: 'Configurações', icon: j },
    ];
    function o({ children: a, userEmail: e }) {
      let f = (0, d.usePathname)();
      return (0, b.jsx)('div', {
            ...
            (0, b.jsxs)('aside', {
              ...
              children: [
                (0, b.jsxs)('div', {
                  ...
                  children: [
                    (0, b.jsx)(c.default, {
                      href: m.ADMIN_NAVIGATION.dashboard,
                ...
                (0, b.jsx)('nav', {
                  ...
                  children: n.map((a) => {
                    let d = f === a.href || f?.startsWith(a.href + '/'),
                      e = a.icon;
                    return (0, b.jsxs)(
                      c.default,
                      {
                        href: a.href,
                        className: `flex items-center gap-3 rounded-lg px-3 py-2 text-sm transition hover:bg-white/5 ${d ? 'bg-white/10 text-white' : 'text-slate-300'}`,
                        children: [(0, b.jsx)(e, { size: 18 }), a.label],
                      },
                      a.href
                    );
                  }),
                ...
                (0, b.jsx)('div', {
                  ...
                  children: (0, b.jsxs)('div', {
                    ...
                    children: [
                      (0, b.jsx)('span', {
                        children: e ? `Logado como ${e}` : 'Usuário',
                      }),
                      (0, b.jsx)('form', {
                        action: l,
                ...
                (0, b.jsxs)('header', {
                  ...
                  children: [
                    ...
                    (0, b.jsxs)('div', {
                      ...
                      children: [
                        (0, b.jsx)('span', { children: e || 'Usuário' }),
                        (0, b.jsx)('form', {
                          action: l,
                          children: (0, b.jsx)('button', {
                            className:
  ...
  (a) => {
    ...
    var b = a.i(87924),
      c = a.i(38246);
    function d({ message: a, isMissingEnv: d }) {
      return (0, b.jsx)('div', {
        className:
    ...
    a.s(['AdminErrorDisplay', () => d]);
  },
];

//# sourceMappingURL=_f69ad2cb._.js.map
