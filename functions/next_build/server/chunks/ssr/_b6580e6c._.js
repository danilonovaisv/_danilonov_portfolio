module.exports = [
  ...
  (a) => {
    ...
    let h = (a, b = 1) => {
      ...
      i = h(g.BRAND.colors.bluePrimary, 0.45),
      j = h(g.BRAND.colors.blueAccent, 0.6);
    function k({
      ready: a,
      onComplete: d,
      durationMs: h = 2e3,
      label: k = 'Summoning spirits',
      className: m,
    }) {
              ...
              children: (0, b.jsxs)('div', {
                ...
                children: [
                  (0, b.jsx)(f.motion.div, {
                    ...
                    animate: p
                      ...
                      : {
                          ...
                          opacity: [0.95, 1, 0.95],
                          filter: [
                            `drop-shadow(0 0 15px ${i})`,
                            `drop-shadow(0 0 25px ${j})`,
                            `drop-shadow(0 0 15px ${i})`,
                          ],
                        },
                    transition: {
                  ...
                  (0, b.jsx)('div', {
                    ...
                    children: (0, b.jsx)(f.motion.div, {
                      className: 'h-full',
                      style: {
                        background: `linear-gradient(90deg, ${g.BRAND.colors.bluePrimary} 0%, ${g.BRAND.colors.blueAccent} 100%)`,
                        boxShadow: `0 0 12px ${i}`,
                      },
                      initial: { width: '0%' },
                      animate: { width: '100%' },
                      transition: { duration: h / 1e3, ease: 'easeInOut' },
                    }),
                  }),
                ],
              }),
    ...
    var m = a.i(29172),
      ...
      o = a.i(81184);
    let p = {
      initial: { opacity: 0, y: o.MOTION_TOKENS.offset.standard },
      animate: {
        opacity: 1,
        y: 0,
        transition: {
          duration: o.MOTION_TOKENS.duration.normal,
          ease: o.GHOST_EASE,
          delay: 1.2,
        },
      },
    ...
    let u = {
        initial: {
          opacity: 0,
          scale: 0.92,
          y: o.MOTION_TOKENS.offset.dramatic,
          filter: 'blur(10px)',
        },
        animate: {
          opacity: 1,
          ...
          filter: 'blur(0px)',
          transition: {
            duration: o.MOTION_TOKENS.duration.slow,
            ease: o.GHOST_EASE,
            staggerChildren: o.MOTION_TOKENS.stagger.relaxed,
          },
        },
      },
      v = {
    ...
    function w({ ghostRef: a, isLoaded: d = !0 }) {
      var e;
      let g = (0, c.useRef)(null),
        h = (0, r.useReducedMotion)();
      ((e = d && !h),
        (0, c.useEffect)(() => {
          let b;
          if (!e || !a?.current || !g.current) return;
          let c = () => {
      ...
      let i = (a) =>
        (0, b.jsx)(s.Container, {
          className: a ? t.default.maskText : t.default.baseText,
          children: (0, b.jsxs)('div', {
            className: 'flex flex-col items-center',
            children: [
              (0, b.jsx)('span', {
                className: `block mb-3 lg:mb-4 tracking-[0.25em] uppercase font-bold text-accent text-micro ${a ? '' : t.default.tag}`,
                children: n.HOME_CONTENT.hero.tag,
              }),
              (0, b.jsxs)('h1', {
                className: `hidden lg:block mb-20 font-display ${t.default.heroTitle}`,
                children: [
                  n.HOME_CONTENT.hero.title[0].split(' ').slice(0, 2).join(' '),
                  ' ',
                  (0, b.jsx)('br', {}),
                  n.HOME_CONTENT.hero.title[0].split(' ').slice(2).join(' '),
                ],
              }),
              (0, b.jsxs)('h1', {
                className: `lg:hidden mb-12 font-display ${t.default.heroTitle}`,
                children: [
                  n.HOME_CONTENT.hero.title[0].split(' ').slice(0, 2).join(' '),
                  ' ',
                  (0, b.jsx)('br', {}),
                  n.HOME_CONTENT.hero.title[0].split(' ').slice(2, 4).join(' '),
                  ' ',
                  (0, b.jsx)('br', {}),
                  n.HOME_CONTENT.hero.title[0].split(' ').slice(4).join(' '),
                ],
              }),
              (0, b.jsx)('h2', {
                className: `font-h2 type-h2 mt-6 lg:mt-9 text-textSecondary ${a ? '' : 'opacity-80'} ${t.default.heroSubtitle}`,
                children: n.HOME_CONTENT.hero.subtitle,
              }),
            ],
          }),
        });
      return (0, b.jsxs)(f.motion.div, {
        ...(h ? {} : { initial: 'initial', animate: 'animate', variants: u }),
        className: `relative flex flex-col items-center justify-center text-center w-full pointer-events-auto ${t.default.root}`,
        children: [
          (0, b.jsxs)(f.motion.div, {
            ...
            children: [
              i(!1),
              (0, b.jsx)('div', { className: t.default.ctaSpacer }),
            ],
          }),
          !h &&
            (0, b.jsx)('div', {
              className: t.default.maskLayer,
              'aria-hidden': 'true',
              children: (0, b.jsx)('div', {
                className: 'w-full flex flex-col items-center text-center',
                children: (0, b.jsxs)(f.motion.div, {
                  variants: v,
                  children: [
                    i(!0),
                    (0, b.jsx)('div', { className: t.default.ctaSpacer }),
          ...
          (0, b.jsx)('div', {
            ref: g,
            className: `${t.default.ghostAura} ${d ? t.default.isLoaded : ''}`,
          }),
        ],
      });
    }
    let x = (0, d.default)(async () => {}, {
    ...
    function y() {
      let a = (0, c.useRef)(null),
        ...
        [g, h] = (0, c.useState)(!1);
      (0, c.useEffect)(() => {
        let a = setTimeout(() => f(!0), 1800);
        return () => clearTimeout(a);
      }, []);
      let i = (0, c.useCallback)(() => f(!0), []),
        j = (0, c.useCallback)(() => {
          (h(!0), f(!0));
        }, []);
            ...
            (0, b.jsx)('div', {
              ...
              children: (0, b.jsx)('div', {
                ...
                children: (0, b.jsx)('div', {
                  ...
                  children: (0, b.jsx)(w, { isLoaded: d && g }),
                }),
              }),
            }),
            (0, b.jsx)('div', {
              ...
              children: (0, b.jsx)('div', {
                ...
                children: (0, b.jsx)(x, { onCreated: j }),
              }),
            }),
            (0, b.jsx)('div', {
  ...
  (a) => {
    ...
    function r({
      ...
      return (0, b.jsx)(d.motion.div, {
        ...
        transition: { duration: 0.8, ease: o, delay: 0.12 * e },
            ...
            (0, b.jsxs)('div', {
              ...
              children: [
                ...
                (0, b.jsx)(d.motion.div, {
                  ...
                  transition: { duration: 0.7, ease: o },
                  children: (0, b.jsx)('div', {
        ...
        children: (0, b.jsxs)(g.Container, {
          children: [
            ...
            (0, b.jsx)(d.motion.div, {
              ...
              whileInView: { opacity: 1, y: 0 },
              viewport: { once: !0 },
              transition: { duration: 0.6, ease: o, delay: 0.4 },
  ...
  (a) => {
    ...
    function f({ src: a }) {
      ...
      ((0, c.useEffect)(() => {
        ...
        let a = new IntersectionObserver(
          ([b]) => {
            b.isIntersecting && (i(!0), a.disconnect());
          },
          { rootMargin: '200px' }
        );
        return (a.observe(m.current), () => a.disconnect());
      }, []),
        (0, c.useEffect)(() => {
          if (!l.current) return;
          let a = new IntersectionObserver(
            ([a]) => {
              a.isIntersecting ? g(!1) : g(!0);
            },
            { threshold: 0.5 }
          );
        ...
        (0, c.useEffect)(() => {
          n.current && (n.current.muted = f);
        }, [f]));
      let o = 'hd' === j ? a : a.replace('.mp4', '-720p.mp4'),
        p = a.replace('.mp4', '-poster.jpg');
      return (0, b.jsx)(d.motion.section, {
        ...
        initial: {
          opacity: 0,
          scale: 1.05,
          y: e.MOTION_TOKENS.offset.dramatic,
        },
        whileInView: { opacity: 1, scale: 1, y: 0 },
        transition: {
          duration: e.MOTION_TOKENS.duration.slow,
          ease: e.GHOST_EASE,
        },
        viewport: { once: !0, amount: 0.2 },
        children: (0, b.jsx)('div', {
    ...
    a.s(['VideoManifesto', () => f]);
  },
];

//# sourceMappingURL=_b6580e6c._.js.map
