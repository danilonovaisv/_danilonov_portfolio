module.exports = [
  ...
  (a) => {
    ...
    a.s(['velocityPerSecond', () => aT], 92016);
    ...
    a.s(['collectMotionValues', () => aU, 'motionValue', () => aW], 36829);
    let aX = [...Y, z, I],
      aY = { current: null },
      aZ = { current: !1 };
    function a$() {
    ...
    (a.s(
      ...
      a.s(['initPrefersReducedMotion', () => a$], 67126));
    let a_ = new WeakMap();
    function a0(a) {
    ...
    (a.s(['LayoutGroupContext', () => bO], 86723),
    ...
    a.s(['MotionConfigContext', () => bP], 65802);
    ...
    (a.s(['PresenceContext', () => bZ], 14800),
      a.s(['useConstant', () => b$], 74290));
    let b_ = (a) => (b, c) => {
    ...
    a.s(['useIsomorphicLayoutEffect', () => b8], 1703);
    class ca {
      constructor(a) {
    ...
    (a.s(['progress', () => c_], 84913),
      a.s(['interpolate', () => c0], 68203),
      a.s(['defaultOffset', () => c1], 78025));
    let c3 = (a) => null !== a;
    ...
    a.s(['JSAnimation', () => c9], 78621);
    let db = da(() => void 0 !== window.ScrollTimeline);
    a.s(['supportsScrollTimeline', () => db], 66985);
    let dc = {},
      dd =
        ((c = da(() => {
          try {
        ...
        (ce(a, b),
          d.start(
            du(
              ...
              d,
              e,
              a.shouldReduceMotion && W.has(b) ? { type: !1 } : g,
              a,
              l
            )
          ));
    ...
    function ee(a, b, [c, d, e], f, g) {
      !(function (a, b = 0, c = 1, d = 0.5, e, f = a, g = a) {
        ...
        (a === f && (h -= b),
          (a.min = ed(a.min, b, c, h, e)),
          (a.max = ed(a.max, b, c, h, e)));
      })(a, b[c], b[d], b[e], b.scale, f, g);
    }
    let ef = ['x', 'scaleX', 'originX'],
      eg = ['y', 'scaleY', 'originY'];
    function eh(a, b, c, d) {
      (ee(a.x, b, ef, c ? c.x : void 0, d ? d.x : void 0),
        ee(a.y, b, eg, c ? c.y : void 0, d ? d.y : void 0));
    }
    function ei(a, b) {
    ...
    let es = ['TopLeft', 'TopRight', 'BottomLeft', 'BottomRight'],
      et = es.length,
      eu = (a) => ('string' == typeof a ? parseFloat(a) : a),
      ev = (a) => 'number' == typeof a || u.test(a);
    function ew(a, b) {
    ...
    function eB(a) {
      return eA(a) && 'ownerSVGElement' in a;
    }
    a.s(['isSVGElement', () => eB], 45854);
    let eC = (a, b) => a.depth - b.depth;
    class eD {
      constructor() {
    ...
    function eI({
      ...
      return class {
        ...
        mount(b) {
          ...
          ((this.isSVG = eB(b) && !(eB(b) && 'svg' === b.tagName)),
            (this.instance = b));
              ...
              this.addEventListener(
                ...
                ({
                  ...
                  let f =
                    ...
                    i = !this.targetLayout || !ep(this.targetLayout, d),
                    j = !b && c;
                  if (
        ...
        resetTransform() {
          ...
          let a =
            ...
            b = this.projectionDelta && !em(this.projectionDelta),
        ...
        removeElementScroll(a) {
          ...
          for (let c = 0; c < this.path.length; c++) {
            ...
            d !== this.root &&
              e &&
              f.layoutScroll &&
              (e.wasRoot && ej(b, a), bE(b.x, e.offset.x), bE(b.y, e.offset.y));
          }
          return b;
        }
        ...
        removeTransform(a) {
          ...
          return (bz(this.latestValues) && eh(b, this.latestValues), b);
        }
        setTargetDelta(a) {
          ((this.targetDelta = a),
        ...
        calcProjection() {
          ...
          (this.projectionDelta && this.prevProjectionDelta
            ...
            (this.treeScale.x === f &&
              this.treeScale.y === g &&
              er(this.projectionDelta.x, this.prevProjectionDelta.x) &&
              er(this.projectionDelta.y, this.prevProjectionDelta.y)) ||
              ((this.hasProjected = !0),
              this.scheduleRender(),
            ...
            (this.mixTargetDelta = (b) => {
              ...
              (i &&
                ...
                (function (a, b, c, d, e, f) {
                  e
                    ? ((a.opacity = bq(0, c.opacity ?? 1, ex(d))),
                      (a.opacityExit = bq(b.opacity ?? 1, 0, ey(d))))
                    : f && (a.opacity = bq(b.opacity ?? 1, c.opacity ?? 1, d));
                  for (let e = 0; e < et; e++) {
                    let f = `border${es[e]}Radius`,
                      g = ew(b, f),
                      h = ew(c, f);
                    (void 0 !== g || void 0 !== h) &&
                      (g || (g = 0),
        ...
        registerSharedNode(a, b) {
          (this.sharedNodes.has(a) || this.sharedNodes.set(a, new eE()),
    ...
    function e1(a, b, c) {
      return (
        'position' === a ||
        ('preserve-aspect' === a && !(0.2 >= Math.abs(eq(b) - eq(c))))
      );
    }
    function e2(a) {
    ...
    function fa(a) {
      return eA(a) && 'offsetHeight' in a;
    }
    (a.s(['resolveElements', () => e6], 54760),
      a.s(['isHTMLElement', () => fa], 91128));
