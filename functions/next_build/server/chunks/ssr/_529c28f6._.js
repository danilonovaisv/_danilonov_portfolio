...
Read more at https://nextjs.org/docs/messages/missing-root-layout-tags"
  ...
  (a, b, c) => {
    ...
    let g = a.r(41733),
      h = (d = a.r(25393)) && d.__esModule ? d : { default: d },
      i = a.r(29756),
      j = a.r(99870);
    async function k(a) {
      var b, c;
  ...
  (a, b, c) => {
    ...
    class i {
      ...
      async get(a, b, c) {
        ...
        if (
          this.minimal_mode &&
          (null == (d = this.previousCacheItem) ? void 0 : d.key) === a &&
          this.previousCacheItem.expiresAt > Date.now()
        )
          return (0, h.toResponseCacheEntry)(this.previousCacheItem.entry);
        let {
            incrementalCache: e,
            isOnDemandRevalidate: f = !1,
            isFallback: g = !1,
          ...
          m = await this.getBatcher.batch(
            { key: a, isOnDemandRevalidate: f },
            ({ resolve: c }) => {
      ...
      async handleGet(a, b, c, d) {
        ...
        try {
          ...
          if (!g)
            return (
              this.minimal_mode && (this.previousCacheItem = void 0),
              null
            );
      ...
      async handleRevalidate(a, b, c, d, e, f, g) {
        try {
          ...
          if (!i) return null;
          let j = await (0, h.fromResponseCacheEntry)({ ...i, isMiss: !f });
          return (
            j.cacheControl &&
              (this.minimal_mode
  ...
  (a, b, c) => {
    let d = {
        unstable_cache: a.r(71632).unstable_cache,
        updateTag: a.r(65819).updateTag,
        revalidateTag: a.r(65819).revalidateTag,
        revalidatePath: a.r(65819).revalidatePath,
        refresh: a.r(65819).refresh,
        unstable_noStore: a.r(1247).unstable_noStore,
        cacheLife: a.r(32621).cacheLife,
        cacheTag: a.r(72835).cacheTag,
      },
      e = !1,
      f = !1;
  ...
  (a) => {
    ...
    async function i(a) {
      let b = await (0, f.createClient)(),
        { data: c, error: g } = await b
          .from('site_assets')
          .select('bucket,file_path')
          .eq('id', a.assetId)
          .single();
      if (g || !c) throw g ?? Error('Asset não encontrado.');
      let h = (0, e.normalizeStoragePath)(c.file_path, c.bucket),
        i =
          (function (a) {
            if (!a) return '';
            let b = a.split('.');
            return b.length <= 1 ? '' : (b.pop() ?? '');
          })(h) || 'bin',
        j = (function ({ page: a, key: b, subPath: c, extension: e }) {
          let f = [a && a.trim().length > 0 ? a.trim() : 'global'];
          c && f.push(c.trim().replace(/^\/+|\/+$/g, ''));
          let g = b.trim().toLowerCase().replace(/\s+/g, '_').replace(d, ''),
          ...
          page: a.role.page,
          key: a.role.key,
          subPath: a.role.subPath,
          extension: i,
        }),
        l = h;
      if (l && l !== j) {
        let { error: a } = await b.storage.from(c.bucket).move(l, j);
        if (a) throw a;
        l = j;
      }
      let { error: m } = await b
        ...
        .update({
          key: a.role.key,
          page: a.role.page,
          asset_type: a.role.asset_type,
          description: a.role.description,
          sort_order: a.role.sort_order ?? null,
          file_path: l,
        })
        .eq('id', a.assetId);
      if (m) throw m;
    ...
    async function j(a) {
      let b = await (0, f.createClient)();
      if (a.file_path) {
        let c = (0, e.normalizeStoragePath)(a.file_path, a.bucket);
        if (c) {
          let { error: d } = await b.storage.from(a.bucket).remove([c]);
          if (d) throw d;
        }
      }
      let { error: c } = await b.from('site_assets').delete().eq('id', a.id);
      if (c) throw c;
      k();
    }
    function k() {
      ((0, g.revalidatePath)('/'),
        (0, g.revalidatePath)('/about'),
        (0, g.revalidatePath)('/portfolio'));
    }
    ((0, a.i(13095).ensureServerEntryExports)([h, i, j]),
      (0, c.registerServerReference)(
        h,
      ...
      a.s(
        [
          '0094827b48eed67f43ec1dce01bea1de2ab3b21723',
          () => b.signOut,
          '403e4d5d86c41802a75b2087023a8822e1f09f037f',
          () => h,
          '40b7064e12a7a62033ecf7925386e82c76d1c01ef3',
...
//# sourceMappingURL=_529c28f6._.js.map
