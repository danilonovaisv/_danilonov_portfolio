module.exports = [
  ...
  (a) => {
    ...
    (c('about/hero/about.hero.desktop_video.mp4'),
      ...
      e('VIDEO-APRESENTACAO-PORTFOLIO.mp4'),
      e('VIDEO-APRESENTACAO-PORTFOLIO.mp4'),
  ...
  (a) => {
    ...
    async function i() {
      ...
      try {
        {
          let b = (0, f.createStaticClient)();
          a = (await (0, d.listProjects)({}, b)).map((a, b) =>
        ...
        (console.error(
          ...
          (a = (g.HOME_CONTENT.featuredProjects ?? []).map((a, b) => {
            var c;
            let d = a.layout ?? {},
              e = (c = a.category)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__25c9c683._.js.map
