module.exports = [
  ...
  (a) => {
    ...
    function g(a) {
      return (0, b.jsx)('svg', {
        ...
        strokeWidth: 1.5,
        ...a,
        children: (0, b.jsx)('path', { d: 'M3 13L13 3M6 3H13V10' }),
      });
    }
    var h = a.i(88326),
      i = a.i(45112);
    function j({ project: a, onOpen: c }) {
      let e = (0, d.useReducedMotion)(),
        j = () =>
          (0, b.jsxs)(b.Fragment, {
            children: [
              (0, b.jsxs)('div', {
                className: `card-shell relative overflow-hidden rounded-md w-full bg-white/5 transition-all duration-500 ${e ? '' : 'md:group-hover:shadow-[0_22px_54px_-12px_rgba(0,72,255,0.15)] md:group-hover:-translate-y-1 active:scale-[0.98]'}`,
                children: [
                  (0, b.jsx)('div', {
                    className:
                  ...
                  (0, i.isVideo)(a.image)
                    ...
                    : (0, b.jsx)(f.default, {
                        src: a.image,
                        alt: `Logo da marca ${a.client} para ${a.category} - ${a.title}`,
                        fill: !0,
                        sizes: a.layout.sizes ?? '100vw',
                        className: `object-cover transition-transform duration-700 opacity-90 md:group-hover:opacity-100 ${e ? '' : 'md:group-hover:scale-103'}`,
                        loading: 'lazy',
                        onError: i.applyImageFallback,
                      }),
                ],
              }),
              (0, b.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, b.jsx)('div', {
                    className: `w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center text-white shrink-0 border border-white/10 transition-all duration-700 bg-[#0048ff] ${e ? '' : 'md:group-hover:translate-x-5 md:group-hover:bg-[#8705f2] md:group-hover:shadow-[0_0_20px_rgba(135,5,242,0.4)]'}`,
                    children: (0, b.jsx)(g, {
                      className:
      ...
      return a.landingPageSlug
        ? (0, b.jsx)(h.default, {
            href: `/projects/${a.landingPageSlug}?from=home`,
            'aria-label': `Ver Landing Page: ${a.title}`,
            className: k,
            children: (0, b.jsx)(j, {}),
          })
        : 'function' == typeof c
          ? (0, b.jsx)('button', {
              ...
              'aria-label': `Ver detalhes do projeto ${a.title}`,
              className: k,
              children: (0, b.jsx)(j, {}),
            })
          : (0, b.jsx)(h.default, {
    ...
    var m = a.i(55362);
    let { duration: n, offset: o } = e.MOTION_TOKENS,
      p = [
    ...
    function q({ projects: a, onProjectOpen: f }) {
      let g = (0, d.useReducedMotion)(),
        h = a.filter((a) => a.isFeatured),
        i = {
          hidden: g ? {} : { opacity: 0, y: o.dramatic, filter: 'blur(4px)' },
          visible: g
            ? { opacity: 1 }
            : {
                opacity: 1,
                y: 0,
                filter: 'blur(0px)',
                transition: (0, e.ghostTransition)(0, n.normal),
              },
        };
      return (0, b.jsx)('section', {
        ...
        children: (0, b.jsx)(m.Container, {
          children: (0, b.jsxs)(c.motion.div, {
            initial: g ? 'visible' : 'hidden',
            whileInView: 'visible',
            viewport: { once: !0, amount: 0.2 },
            variants: (0, e.staggerContainer)(0.12),
            className:
              'grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-4 md:gap-6',
            children: [
              h.slice(0, 4).map((a, d) => {
                if (!a) return null;
                let e = p[d] || 'md:col-span-4 lg:col-span-4';
                return (0, b.jsx)(
                  c.motion.div,
                  {
                    variants: i,
                    className: `w-full col-span-4 ${e} h-full flex flex-col`,
                    children: (0, b.jsx)(j, { project: a, onOpen: f }),
                  },
                  a.id
                );
              }),
  ...
  (a, b, c) => {
    ...
    function i({ moduleIds: a }) {
      ...
      let i = (0, h.getDeploymentIdQueryOrEmptyString)();
      return (0, d.jsx)(d.Fragment, {
        children: c.map((a) => {
          let c = `${b.assetPrefix}/_next/${(0, g.encodeURIPath)(a)}${i}`;
  ...
  (a) => {
    ...
    let g = (a, b = 1) => {
        let c = a.replace('#', ''),
          d = parseInt(3 === c.length ? c.replace(/./g, (a) => a + a) : c, 16);
        return `rgba(${(d >> 16) & 255}, ${(d >> 8) & 255}, ${255 & d}, ${b})`;
      },
      h = g(f.BRAND.colors.bluePrimary, 0.45),
      i = g(f.BRAND.colors.blueAccent, 0.6);
    function j({
      ready: a,
      onComplete: g,
      durationMs: j = 2e3,
      label: l = 'Summoning spirits',
      className: m,
    }) {
      let [n, o] = (0, c.useState)(!0),
        [p, q] = (0, c.useState)(!1);
      return (
        (0, c.useEffect)(() => {
        ...
        (0, c.useEffect)(() => {
          if ('boolean' == typeof a) {
            if (!a) return;
            let b = setTimeout(() => o(!1), p ? 200 : 800);
                ...
                children: [
                  (0, b.jsx)(e.motion.div, {
                    ...
                    animate: p
                      ...
                      : {
                          ...
                          opacity: [0.95, 1, 0.95],
                          filter: [
                            `drop-shadow(0 0 15px ${h})`,
                            `drop-shadow(0 0 25px ${i})`,
                            `drop-shadow(0 0 15px ${h})`,
                          ],
                        },
                    transition: {
                  ...
                  (0, b.jsx)('div', {
                    ...
                    children: (0, b.jsx)(e.motion.div, {
                      className: 'h-full',
                      style: {
                        background: `linear-gradient(90deg, ${f.BRAND.colors.bluePrimary} 0%, ${f.BRAND.colors.blueAccent} 100%)`,
                        boxShadow: `0 0 12px ${h}`,
                      },
                      initial: { width: '0%' },
                      animate: { width: '100%' },
                      transition: { duration: j / 1e3, ease: 'easeInOut' },
                    }),
                  }),
                ],
              }),
    ...
    let l = (0, a.i(27882).default)(async () => {}, {
      loadableGenerated: { modules: [47908] },
      ssr: !1,
      loading: () =>
        (0, b.jsx)('div', { className: 'absolute inset-0 bg-background' }),
    });
    function m() {
      return (0, b.jsx)(l, {});
    }
    ...
    let v = {
      ...
      w = {
        ...
        animate: {
          opacity: 1,
          y: 0,
          transition: { duration: 0.8, ease: r.GHOST_EASE },
        },
      };
    function x({ ghostRef: a, isLoaded: d = !0 }) {
      var f;
      let g = (0, c.useRef)(null),
        h = (0, s.useReducedMotion)();
      ((f = d && !h),
        (0, c.useEffect)(() => {
          let b;
          if (!f || !a?.current || !g.current) return;
          let c = () => {
            if (!a.current || !g.current) return;
            let d = a.current.position,
              e = g.current,
              f = ((d.x + 10) / 20) * 100,
              h = 100 - ((d.y + 7) / 14) * 100;
            ((e.style.transform = `translate(calc(${f}vw - 50%), calc(${h}vh - 50%))`),
              document.documentElement.style.setProperty('--ghost-x', `${f}vw`),
              document.documentElement.style.setProperty('--ghost-y', `${h}vh`),
      ...
      let i = (a) =>
        (0, b.jsx)(t.Container, {
          className: a ? u.default.maskText : u.default.baseText,
          children: (0, b.jsxs)('div', {
            className: 'flex flex-col items-center',
            children: [
              (0, b.jsx)('span', {
                className: `block mb-3 lg:mb-4 tracking-[0.25em] uppercase font-bold text-accent text-micro ${a ? '' : u.default.tag}`,
                children: o.HOME_CONTENT.hero.tag,
              }),
              (0, b.jsxs)('h1', {
                className: `hidden lg:block mb-20 font-display ${u.default.heroTitle}`,
                children: [
                  o.HOME_CONTENT.hero.title[0].split(' ').slice(0, 2).join(' '),
                  ' ',
                  (0, b.jsx)('br', {}),
                  o.HOME_CONTENT.hero.title[0].split(' ').slice(2).join(' '),
                ],
              }),
              (0, b.jsxs)('h1', {
                className: `lg:hidden mb-12 font-display ${u.default.heroTitle}`,
                children: [
                  o.HOME_CONTENT.hero.title[0].split(' ').slice(0, 2).join(' '),
                  ' ',
                  (0, b.jsx)('br', {}),
                  o.HOME_CONTENT.hero.title[0].split(' ').slice(2, 4).join(' '),
                  ' ',
                  (0, b.jsx)('br', {}),
                  o.HOME_CONTENT.hero.title[0].split(' ').slice(4).join(' '),
                ],
              }),
              (0, b.jsx)('h2', {
                className: `font-h2 type-h2 mt-6 lg:mt-9 text-textSecondary ${a ? '' : 'opacity-80'} ${u.default.heroSubtitle}`,
                children: o.HOME_CONTENT.hero.subtitle,
              }),
            ],
          }),
        });
      return (0, b.jsxs)(e.motion.div, {
        ...(h ? {} : { initial: 'initial', animate: 'animate', variants: v }),
        className: `relative flex flex-col items-center justify-center text-center w-full pointer-events-auto ${u.default.root}`,
        children: [
          (0, b.jsxs)(e.motion.div, {
            ...
            children: [
              i(!1),
              (0, b.jsx)('div', { className: u.default.ctaSpacer }),
            ],
          }),
          !h &&
            (0, b.jsx)('div', {
              className: u.default.maskLayer,
              'aria-hidden': 'true',
          ...
          (0, b.jsx)('div', {
            ref: g,
            className: `${u.default.ghostAura} ${d ? u.default.isLoaded : ''}`,
          }),
        ],
      });
    }
    ...
    function z() {
      let a = (0, c.useRef)(null),
        [e, f] = (0, c.useState)(!1),
        g = (0, y.useMediaQuery)('(min-width: 1024px)');
      (0, c.useEffect)(() => {
        let a = setTimeout(() => f(!0), 2e3);
        return () => clearTimeout(a);
      }, []);
      let h = (0, c.useCallback)(() => f(!0), []);
  ...
  (a) => {
    ...
    var b = a.i(59465),
      ...
      o = a.i(32143),
      p = a.i(45112);
    let q = { damping: 30, stiffness: 200, mass: 1 };
    function r({
      category: a,
      index: e,
      isHovered: f,
      ...
      let s = Array.isArray(a.title) ? a.title : [a.title],
        t = (0, c.useRef)(null),
        { scrollYProgress: u } = (0, j.useScroll)({
          target: t,
          offset: ['start end', 'end start'],
        }),
        v = (0, k.useSpring)(u, q),
        w = (0, l.useTransform)(v, [0, 1], [-20, 20]),
        x = a.thumbnail.endsWith('.mp4');
      return (0, b.jsx)(d.motion.div, {
        ref: t,
        initial: r ? { opacity: 1 } : { opacity: 0, y: 24 },
        whileInView: { opacity: 1, y: 0 },
        viewport: { once: !0, amount: 0.3 },
        transition: { duration: 0.8, ease: o.GHOST_EASE, delay: 0.12 * e },
        children: (0, b.jsxs)(i.default, {
          href: `/portfolio?category=${a.slug}`,
          ...
          children: [
            (0, b.jsxs)('div', {
              className: (0, n.cn)(
                ...
                'right' === a.alignment && 'justify-end',
                'center' === a.alignment && 'justify-center',
                'left' === a.alignment && 'justify-start',
                f ? 'gap-10' : 'gap-6'
              ),
              children: [
                a.showLabel &&
                ...
                (0, b.jsx)(d.motion.div, {
                  ...
                  initial: !1,
                  animate: { width: 288 * !!f, opacity: +!!f },
                  transition: { duration: 0.7, ease: o.GHOST_EASE },
                  children: (0, b.jsx)('div', {
                ...
                (0, b.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, b.jsx)(d.motion.div, {
                      ...
                      animate: {
                        rotate: f ? 0 : -45,
                        backgroundColor: f ? '#8705f2' : '#0048ff',
                      },
                      transition: { duration: 0.5, ease: o.GHOST_EASE },
                      children: (0, b.jsx)(m.ArrowUpRight, {
    ...
    function t() {
      let a = (0, c.useRef)(null),
        ...
        j = !!(0, e.useReducedMotion)();
      return (0, b.jsx)('section', {
        id: 'portfolio-showcase',
        ref: a,
        className: 'relative w-full bg-background py-20 lg:py-32',
        'aria-labelledby': 'portfolio-showcase-heading',
        children: (0, b.jsxs)(g.Container, {
          children: [
            (0, b.jsx)(d.motion.header, {
              initial: j ? { opacity: 1 } : { opacity: 0, y: 30 },
              whileInView: { opacity: 1, y: 0 },
              viewport: { once: !0 },
              transition: { duration: 0.7, ease: o.GHOST_EASE },
            ...
            (0, b.jsx)(d.motion.div, {
              initial: j ? { opacity: 1 } : { opacity: 0, y: 20 },
              whileInView: { opacity: 1, y: 0 },
              viewport: { once: !0 },
              transition: { duration: 0.6, ease: o.GHOST_EASE, delay: 0.4 },
  ...
  (a) => {
    ...
    function e({ src: a }) {
      ...
      ((0, c.useEffect)(() => {
        ...
        let a = new IntersectionObserver(
          ([b]) => {
            b.isIntersecting && (h(!0), a.disconnect());
          },
          { rootMargin: '200px' }
        );
        ...
        (0, c.useEffect)(() => {
          let a = navigator;
          a.connection &&
            ('4g' === a.connection.effectiveType ||
            '5g' === a.connection.effectiveType
              ? j('hd')
              : j('sd'));
        }, []),
        (0, c.useEffect)(() => {
          m.current && (m.current.muted = e);
        }, [e]));
      let n = 'hd' === i ? a : a.replace('.mp4', '-720p.mp4'),
        o = a.replace('.mp4', '-poster.jpg');
      return (0, b.jsx)(d.motion.section, {
        ref: k,
    ...
    a.s(['VideoManifesto', () => e]);
  },
];

//# sourceMappingURL=_f5003364._.js.map
