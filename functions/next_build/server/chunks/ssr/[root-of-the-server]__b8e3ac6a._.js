module.exports = [
  ...
  (a) => {
    ...
    var c = a.i(78255),
      ...
      e = a.i(79216);
    async function f(a) {
      let { id: f } = await a.params,
        g = await (0, d.createClient)(),
        [{ data: h, error: i }, { data: j }, { data: k }] = await Promise.all([
          g
      ...
      (i || !h) && (0, c.notFound)();
      let l = h.project_tags?.map((a) => a.tag_id).filter(Boolean) ?? [];
      return (0, b.jsxs)('div', {
        className: 'space-y-6',
        children: [
          (0, b.jsxs)('div', {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8e3ac6a._.js.map
