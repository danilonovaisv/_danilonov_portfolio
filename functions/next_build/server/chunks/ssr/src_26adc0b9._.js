module.exports = [
  ...
  (a) => {
    ...
    let c = [
        {
          key: b.SITE_ASSET_KEYS.logos.headerLight,
        ...
        {
          key: b.SITE_ASSET_KEYS.logos.headerDark,
        ...
        {
          key: b.SITE_ASSET_KEYS.logos.faviconLight,
          label: 'Favicon claro',
        ...
        {
          key: b.SITE_ASSET_KEYS.logos.faviconDark,
      ...
      d = [
        {
          key: b.SITE_ASSET_KEYS.fonts.display,
          label: '--font-display',
        ...
        {
          key: b.SITE_ASSET_KEYS.fonts.h1,
          label: '--font-h1',
        ...
        {
          key: b.SITE_ASSET_KEYS.fonts.h2,
          label: '--font-h2',
        ...
        {
          key: b.SITE_ASSET_KEYS.fonts.h3,
          label: '--font-h3',
        ...
        {
          key: b.SITE_ASSET_KEYS.fonts.body,
          label: '--font-body',
        ...
        {
          key: b.SITE_ASSET_KEYS.fonts.light,
          label: '--font-light',
      ...
      e = b.SITE_ASSET_KEYS.clients.strips.map((a, b) => ({
        key: a,
      ...
      f = [
        {
          key: b.SITE_ASSET_KEYS.heroVideos.aboutDesktop,
        ...
        {
          key: b.SITE_ASSET_KEYS.heroVideos.aboutMobile,
      ...
      g = b.SITE_ASSET_KEYS.about.originImages.map((a, b) => ({
        key: a,
      ...
      h = {
        key: b.SITE_ASSET_KEYS.heroVideos.method,
        label: 'Vídeo método',
      ...
      i = [
        {
          key: b.SITE_ASSET_KEYS.heroVideos.portfolioDesktop,
        ...
        {
          key: b.SITE_ASSET_KEYS.heroVideos.portfolioMobile,
      ...
      j = [
        { label: 'Global • Logos', roles: c },
        { label: 'Global • Fonts', roles: d },
        {
          label: 'Home • Hero',
          roles: [
            {
              key: b.SITE_ASSET_KEYS.heroVideos.homeManifesto,
        ...
        { label: 'Clients • Logos', roles: e },
        { label: 'Sobre • Hero vídeos', roles: f },
        { label: 'Sobre • Origem', roles: g },
        {
        ...
        { label: 'Portfólio • Hero vídeos', roles: i },
      ],
      k = new Map(j.flatMap((a) => a.roles).map((a) => [a.key, a]));
    function l(a) {
      return k.get(a);
    }
    a.s([
  ...
  (a) => {
    ...
    let f = (0, e.createServerReference)(
      '40ff2118cc4137aadb09e1036482ecc4c0d5939225',
      e.callServer,
      void 0,
      e.findSourceMapURL,
      'upsertAsset'
    ...
    function i({ preset: a }) {
      let e = (0, d.useRouter)(),
        [i, j] = (0, c.useState)(a?.key ?? ''),
        [k, l] = (0, c.useState)(a?.page ?? 'global'),
        [m, n] = (0, c.useState)(a?.asset_type ?? 'image'),
        [o, p] = (0, c.useState)(a?.description ?? ''),
        [q, r] = (0, c.useState)(a?.subPath ?? ''),
        [s, t] = (0, c.useState)(),
        [u, v] = (0, c.useState)(null),
        [w, x] = (0, c.useState)(null),
        [y, z] = (0, c.useTransition)();
      return (0, b.jsxs)('form', {
        ...
        onSubmit: (a) => {
          (a.preventDefault(),
            ...
            z(async () => {
              try {
                let a = (0, g.getSiteAssetRoleByKey)(i),
                  b = null;
                (u &&
                  (b = await (0, h.uploadSiteAsset)({
                    file: u,
                    key: i,
                    page: k,
                    subPath: a?.subPath ?? q,
                  ...
                  await f({
                    ...
                    page: k,
                    asset_type: m,
                    description: o || a?.description || null,
                    sort_order: s ?? null,
                    file_path: b,
                    bucket: 'site-assets',
                  }),
                ...
                x(a instanceof Error ? a.message : 'Falha ao salvar');
              }
            }));
        },
        children: [
              ...
              (0, b.jsxs)('label', {
                ...
                children: [
                  ...
                  (0, b.jsx)('input', {
                    ...
                    value: s ?? '',
                    onChange: (a) =>
                      t(a.target.value ? Number(a.target.value) : void 0),
                    className:
                      'rounded-md bg-slate-900/60 border border-white/10 px-3 py-2 text-sm',
                    placeholder: '10',
                  }),
          ...
          (0, b.jsxs)('label', {
            ...
            children: [
              ...
              (0, b.jsx)('input', {
                ...
                onChange: (a) => v(a.target.files?.[0] ?? null),
              }),
            ],
          }),
          w &&
          ...
          (0, b.jsx)('button', {
            ...
            disabled: y,
            children: y ? 'Salvando...' : 'Salvar asset',
          }),
        ],
      });
    }
    a.s(['AssetForm', () => i], 66896);
  },
  88965,
  (a) => {
    'use strict';
    ...
    let d = [
      {
        key: c.SITE_ASSET_KEYS.logos.headerLight,
  ...
  (a) => {
    ...
    function d() {
      return (0, b.jsxs)('div', {
        ...
        children: [
          ...
          (0, b.jsx)('div', {
            className: 'space-y-4',
            children: c.siteAssetRoleGroups.map((a) =>
              (0, b.jsxs)(
                'div',
                {
                  className: 'space-y-2',
                  children: [
                    ...
                    (0, b.jsx)('div', {
                      ...
                      children: a.roles.map((a) =>
                        (0, b.jsx)(e, { preset: a }, a.key)
                      ),
                    }),
                  ],
                },
    ...
    function e({ preset: a }) {
      return (0, b.jsxs)('button', {
        ...
        children: [
          (0, b.jsx)('div', { className: 'font-semibold', children: a.label }),
          (0, b.jsx)('div', {
            className: 'text-[11px] text-slate-400',
            children: a.key,
          }),
  ...
  (a) => {
    ...
    let g = (0, f.createServerReference)(
        '40a7611c0e3cd1c59854bf38802b4992fd4b8a1c3e',
        f.callServer,
        void 0,
        f.findSourceMapURL,
        'assignAssetRole'
      ...
      h = (0, f.createServerReference)(
        '40dfe0ecffaf9cb8a04e04d45a3e2043ec03dccbbc',
        f.callServer,
        void 0,
        f.findSourceMapURL,
        'removeAsset'
    ...
    var i = a.i(9520);
    function j({ currentKey: a, onSelectRole: d }) {
      ...
      return (0, b.jsxs)('div', {
        ...
        children: [
          (0, b.jsxs)('button', {
            ...
            children: [
              (0, b.jsx)('span', { children: 'Papel do asset' }),
              (0, b.jsx)('span', {
                className: 'text-xs text-slate-400',
                children: e ? 'Fechar' : 'Abrir',
              }),
            ],
          }),
          e &&
            (0, b.jsx)('div', {
              ...
              children: (0, b.jsx)('div', {
                className: 'space-y-4',
                children: i.siteAssetRoleGroups.map((c) =>
                  (0, b.jsxs)(
                    'div',
                    {
                      children: [
                          ...
                          children: c.roles.map((c) => {
                            ...
                            return (0, b.jsxs)(
                              'button',
                              {
                                ...
                                className: `flex flex-col items-start gap-1 rounded-lg border px-3 py-2 text-left text-sm transition ${e ? 'border-blue-400 bg-blue-500/40 text-white' : 'border-white/5 bg-slate-900/70 hover:border-blue-400 hover:bg-blue-500/10'}`,
                                children: [
                                  (0, b.jsx)('span', {
    ...
    function n({ asset: a }) {
      let f = (0, e.useRouter)(),
        [n, o] = (0, c.useTransition)(),
        [p, q] = (0, c.useState)(null),
        r = i.siteAssetRoleMap.get(a.key),
        s = r?.label ?? 'Sem papel definido',
        t = () => {
          confirm('Excluir este asset e o arquivo associado?') &&
            ...
            o(async () => {
              try {
                ...
                q(a instanceof Error ? a.message : 'Falha na exclusão');
              }
            }));
        },
        u =
          a.publicUrl || (0, m.buildSupabaseStorageUrl)(a.bucket, a.file_path),
        v = a.page ?? a.resolvedPage ?? 'global';
      return a.key.startsWith('updated_at:') || a.key.startsWith('key:')
        ? (0, b.jsxs)('div', {
            className:
              ...
              (0, b.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, b.jsxs)('label', {
                    ...
                    children: [
                      (0, b.jsx)('input', {
                        ...
                        onChange: (b) => {
                          var c;
                          (c = b.target.files?.[0] ?? null) &&
                            (q(null),
                            o(async () => {
                              try {
                                let b = await (0, l.uploadSiteAsset)({
                                    file: c,
                                    key: a.key,
                                    page: a.page,
                                    subPath: r?.subPath,
                                  ...
                                  d = (0, k.createClientComponentClient)(),
                                  { error: e } = await d
                                    .from('site_assets')
                                    .update({ file_path: b })
                                    .eq('id', a.id);
                  ...
                  (0, b.jsx)(j, {
                    ...
                    onSelectRole: (b) => {
                      (q(null),
                        o(async () => {
                          try {
                            (await g({ assetId: a.id, role: b }), f.refresh());
                          } catch (a) {
                            q(
                              a instanceof Error
                                ? a.message
                  ...
                  (0, b.jsxs)('div', {
                    ...
                    children: ['Status: ', a.is_active ? 'Ativo' : 'Inativo'],
                  }),
                  (0, b.jsx)('button', {
                    type: 'button',
                    onClick: () => {
                      o(async () => {
                        let b = (0, k.createClientComponentClient)(),
                          { error: c } = await b
                            .from('site_assets')
                            .update({ is_active: !a.is_active })
                            .eq('id', a.id);
                        c ? q(c.message) : f.refresh();
                      });
                    },
                    className:
                      'mt-1 inline-flex items-center rounded-md border border-white/10 px-2 py-1 text-[11px] text-white hover:bg-white/10',
                    children: a.is_active ? 'Desativar' : 'Ativar',
                  }),
                  (0, b.jsx)('button', {
                    type: 'button',
                    onClick: t,
    ...
    function o({ assets: a }) {
      let [d, e] = (0, c.useState)(''),
        [f, g] = (0, c.useState)('all'),
        [h, i] = (0, c.useState)('all'),
        [j, k] = (0, c.useState)(!1),
        [l, m] = (0, c.useState)(1),
        o = (0, c.useDeferredValue)(d),
        p = (0, c.useMemo)(
          () =>
            a.filter(
              (a) =>
                !(
                  !a.key ||
                  a.key.startsWith('updated_at:') ||
                  a.key.startsWith('key:')
                )
            ),
          [a]
        ),
        q = (0, c.useMemo)(() => {
          let a = new Set();
          return (
            p.forEach((b) => a.add(b.page ?? b.resolvedPage ?? '')),
            Array.from(a).filter(Boolean).sort()
          );
        }, [p]),
        r = (0, c.useMemo)(() => {
          let a = new Set();
          return (
            p.forEach((b) => b.asset_type && a.add(b.asset_type)),
            Array.from(a).filter(Boolean).sort()
          );
        }, [p]);
      (0, c.useEffect)(() => {
      ...
      let s = (0, c.useMemo)(() => {
          ...
          return p.filter((b) => {
            if (!j && !b.is_active) return !1;
            let c = b.page ?? b.resolvedPage ?? '';
            return (
              ('all' === f || c === f) &&
              ('all' === h || b.asset_type === h) &&
              (!a ||
                !!`${b.key} ${b.description ?? ''} ${b.file_path} ${c}`
                  .toLowerCase()
                  .includes(a)) &&
              !0
            );
        ...
        t = Math.max(1, Math.ceil(s.length / 24)),
        u = Math.min(l, t),
        v = (u - 1) * 24,
        w = s.slice(v, v + 24);
      return (0, b.jsxs)('div', {
            ...
            children: [
              ...
              (0, b.jsxs)('select', {
                ...
                children: [
                  ...
                  q.map((a) =>
                    (0, b.jsx)('option', { value: a, children: a }, a)
                  ),
                ],
              }),
              (0, b.jsxs)('select', {
              ...
              (0, b.jsxs)('div', {
                ...
                children: [s.length, ' de ', p.length, ' assets válidos'],
              }),
            ],
          }),
          (0, b.jsx)('div', {
            className: 'grid gap-4 md:grid-cols-2 lg:grid-cols-3',
            children: w.map((a) => (0, b.jsx)(n, { asset: a }, a.id)),
          }),
          !w.length &&
            (0, b.jsx)('div', {
              className:
