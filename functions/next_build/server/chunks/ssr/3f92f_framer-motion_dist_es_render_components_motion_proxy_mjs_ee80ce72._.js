module.exports = [
  ...
  (a) => {
    ...
    let g = {
      ...
      h = { ...g, transform: (a) => f(0, 1, a) },
      i = { ...g, default: 1 },
      j = (a) => Math.round(1e5 * a) / 1e5,
      k = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu,
      l =
        /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu,
      m = (a, b) => (c) =>
        !!(
          ('string' == typeof c && l.test(c) && c.startsWith(a)) ||
          (b && null != c && Object.prototype.hasOwnProperty.call(c, b))
        ),
      n = (a, b, c) => (d) => {
        if ('string' != typeof d) return d;
        let [e, f, g, h] = d.match(k);
        return {
          [a]: parseFloat(e),
          [b]: parseFloat(f),
          [c]: parseFloat(g),
      ...
      o = { ...g, transform: (a) => Math.round(f(0, 255, a)) },
      p = {
        test: m('rgb', 'red'),
      ...
      x = {
        ...t,
        parse: (a) => t.parse(a) / 100,
        transform: (a) => t.transform(100 * a),
      },
      y = {
        test: m('hsl', 'hue'),
      ...
      z = {
        test: (a) => p.test(a) || q.test(a) || y.test(a),
        parse: (a) =>
          p.test(a) ? p.parse(a) : y.test(a) ? y.parse(a) : q.parse(a),
        transform: (a) =>
          'string' == typeof a
            ? a
        ...
        getAnimatableNone: (a) => {
          let b = z.parse(a);
          return ((b.alpha = 0), z.transform(b));
        },
      },
      A =
      ...
      let b = a.toString(),
        ...
        g = b
          .replace(
            ...
            (a) => (
              z.test(a)
                ? (d.color.push(f), e.push(C), c.push(z.parse(a)))
                : a.startsWith('var(')
                  ? (d.var.push(f), e.push('var'), c.push(a))
                  : (d.number.push(f), e.push(B), c.push(parseFloat(a))),
              ++f,
              '${}'
            )
          )
    ...
    let H = (a) =>
        'number' == typeof a ? 0 : z.test(a) ? z.getAnimatableNone(a) : a,
      I = {
        test: function (a) {
          return (
            isNaN(a) &&
            'string' == typeof a &&
            (a.match(k)?.length || 0) + (a.match(A)?.length || 0) > 0
          );
        },
        parse: F,
        createTransformer: G,
    ...
    let L = /\b([a-z-]*)\(.*?\)/gu,
      M = {
        ...
        getAnimatableNone: (a) => {
          let b = a.match(L);
          return b ? b.map(K).join(' ') : a;
        },
      },
      N = { ...g, transform: Math.round },
      O = {
        borderWidth: u,
        borderTopWidth: u,
        borderRightWidth: u,
      ...
      Q = (a) => P[a],
      R = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
      S = () => ({ x: R(), y: R() }),
      T = () => ({ min: 0, max: 0 }),
      U = () => ({ x: T(), y: T() }),
      V = (a) => !!(a && a.getVelocity);
    a.s(['isMotionValue', () => V], 31405);
    let W = new Set([
        'width',
        'height',
        'top',
      ...
      X = (a) => (b) => b.test(a),
      Y = [g, u, t, s, w, v, { test: (a) => 'auto' === a, parse: (a) => a }],
      Z = (a) => Y.find(X(a)),
      $ = () => {},
      _ = () => {};
    a.s(['invariant', () => _, 'warning', () => $], 14910);
    let aa = (a) => (b) => 'string' == typeof b && b.startsWith(a),
      ab = aa('--'),
      ac = aa('var(--'),
      ad = (a) => !!ac(a) && ae.test(a.split('/*')[0].trim()),
      ae =
        /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
    function af(a) {
      return 'string' == typeof a && a.split('/*')[0].includes('var(--');
    }
    let ag = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u,
      ah = (a) => (180 * a) / Math.PI,
      ai = (a) => ak(ah(Math.atan2(a[1], a[0]))),
      aj = {
        x: 4,
        y: 5,
        translateX: 4,
        ...
        rotate: ai,
        rotateZ: ai,
        skewX: (a) => ah(Math.atan(a[1])),
        skewY: (a) => ah(Math.atan(a[2])),
        skew: (a) => (Math.abs(a[1]) + Math.abs(a[2])) / 2,
      },
      ak = (a) => ((a %= 360) < 0 && (a += 360), a),
      al = (a) => Math.sqrt(a[0] * a[0] + a[1] * a[1]),
      am = (a) => Math.sqrt(a[4] * a[4] + a[5] * a[5]),
      an = {
        x: 12,
        y: 13,
        z: 14,
        ...
        scaleY: am,
        scale: (a) => (al(a) + am(a)) / 2,
        rotateX: (a) => ak(ah(Math.atan2(a[6], a[5]))),
        rotateY: (a) => ak(ah(Math.atan2(-a[2], a[0]))),
        rotateZ: ai,
        rotate: ai,
        skewX: (a) => ah(Math.atan(a[4])),
        skewY: (a) => ah(Math.atan(a[1])),
    ...
    let ar = (a) => a === g || a === u,
      ...
      au = {
        ...
        x: (a, { transform: b }) => ap(b, 'x'),
        y: (a, { transform: b }) => ap(b, 'y'),
      };
    ...
    function ay(a, b) {
      let c = !1,
        ...
        p = () => {
          let f = aw.useManualTiming ? e.timestamp : performance.now();
          ((c = !1),
            aw.useManualTiming ||
              (e.delta = d
                ? 1e3 / 60
      ...
      return {
        ...
        cancel: (a) => {
          for (let b = 0; b < ax.length; b++) g[ax[b]].cancel(a);
        },
        state: e,
        steps: g,
      };
    ...
    let {
      ...
      state: aB,
      steps: aC,
    } = ay('u' > typeof requestAnimationFrame ? requestAnimationFrame : av, !0);
    a.s(
      [
        'cancelFrame',
        () => aA,
    ...
    function aH() {
      if (aF) {
        let a = Array.from(aD).filter((a) => a.needsMeasurement),
      ...
      ((aF = !1), (aE = !1), aD.forEach((a) => a.complete(aG)), aD.clear());
    }
    function aI() {
      aD.forEach((a) => {
        (a.readKeyframes(), a.needsMeasurement && (aF = !0));
      });
    }
    class aJ {
      ...
      scheduleResolve() {
        ((this.state = 'scheduled'),
          this.isAsync
            ? (aD.add(this),
              aE || ((aE = !0), az.read(aI), az.resolveKeyframes(aH)))
      ...
      cancel() {
        'scheduled' === this.state &&
          (aD.delete(this), (this.state = 'pending'));
      }
      resume() {
    ...
    class aM extends aJ {
      ...
      readKeyframes() {
        ...
        for (let c = 0; c < a.length; c++) {
          let d = a[c];
          if ('string' == typeof d && ad((d = d.trim()))) {
            let e = (function a(b, c, d = 1) {
              ...
              return ad(f) ? a(f, c, d + 1) : f;
            })(d, b.current);
            (void 0 !== e && (a[c] = e),
              c === a.length - 1 && (this.finalKeyframe = d));
          }
        }
        if ((this.resolveNoneKeyframes(), !W.has(c) || 2 !== a.length)) return;
        let [d, e] = a,
          f = Z(d),
          g = Z(e);
        if (af(d) !== af(e) && au[c]) {
        ...
        if (f !== g)
          ...
          else au[c] && (this.needsMeasurement = !0);
      }
      resolveNoneKeyframes() {
        ...
        c.length &&
          (function (a, b, c) {
            ...
            if (d && c) for (let e of b) a[e] = aK(c, d);
          })(a, c, b);
      }
      measureInitialState() {
    ...
    class aP {
      ...
      add(a) {
        return (aN(this.subscriptions, a), () => aO(this.subscriptions, a));
      }
      notify(a, b, c) {
    ...
    let { schedule: aQ } = ay(queueMicrotask, !1);
    function aR() {
      b = void 0;
    }
    let aS = {
      now: () => (
        void 0 === b &&
          aS.set(
            aB.isProcessing || aw.useManualTiming
              ? aB.timestamp
              : performance.now()
          ),
        b
      ...
      set: (a) => {
        ((b = a), queueMicrotask(aR));
      },
    };
    function aT(a, b) {
      return b ? (1e3 / b) * a : 0;
    }
    a.s(['velocityPerSecond', () => aT], 75675);
    let aU = { current: void 0 };
    class aV {
      constructor(a, b = {}) {
      ...
      on(a, b) {
        this.events[a] || (this.events[a] = new aP());
      ...
      get() {
        return (aU.current && aU.current.push(this), this.current);
      }
      getPrevious() {
        return this.prev;
      }
    ...
    a.s(['collectMotionValues', () => aU, 'motionValue', () => aW], 62150);
    let aX = [...Y, z, I],
      aY = { current: null },
      aZ = { current: !1 };
    function a$() {
    ...
    (a.s(
      ['hasReducedMotionListener', () => aZ, 'prefersReducedMotion', () => aY],
      24552
    ),
      a.s(['initPrefersReducedMotion', () => a$], 37843));
    let a_ = new WeakMap();
    function a0(a) {
    ...
    let a2 = [
      ...
      a3 = ['initial', ...a2];
    function a4(a) {
      return a0(a.animate) || a3.some((b) => a1(a[b]));
    }
    function a5(a) {
      return !!(a4(a) || a.variants);
    }
    function a6(a) {
      let b = [{}, {}];
      return (
    ...
    class ba {
      ...
      constructor(
        ...
        ((this.current = null),
          ...
          (this.scheduleRender = () => {
            ...
            this.renderScheduledAt < a &&
              ((this.renderScheduledAt = a), az.render(this.render, !1, !0));
          }));
        ...
        ((this.latestValues = h),
          ...
          (this.isControllingVariants = a4(b)),
          (this.isVariantNode = a5(b)),
        ...
        ((this.current = a),
          ...
          'never' === this.reducedMotionConfig
            ...
            : 'always' === this.reducedMotionConfig
              ...
              : (aZ.current || a$(), (this.shouldReduceMotion = aY.current)),
          this.parent?.addChild(this),
          this.update(this.props, this.presenceContext));
      }
      unmount() {
        for (let a in (this.projection && this.projection.unmount(),
        aA(this.notifyUpdate),
        aA(this.render),
      ...
      bindToMotionValue(a, b) {
        ...
        let f = b.on('change', (b) => {
          ((this.latestValues[a] = b),
            this.props.onUpdate && az.preRender(this.notifyUpdate),
            d && this.projection && (this.projection.isTransformDirty = !0),
            this.scheduleRender());
        });
        this.valueSubscriptions.set(a, () => {
          (f(), c && c(), b.owner && b.stop());
        });
      }
      sortNodePosition(a) {
        return this.current &&
      ...
      update(a, b) {
        ...
        ((this.prevMotionValues = (function (a, b, c) {
          for (let d in b) {
            let e = b[d],
              f = c[d];
            if (V(e)) a.addValue(d, e);
            else if (V(f)) a.addValue(d, aW(e, { owner: a }));
            else if (f !== e)
              if (a.hasValue(d)) {
                let b = a.getValue(d);
                ...
                a.addValue(d, aW(void 0 !== b ? b : e, { owner: a }));
              }
          }
      ...
      getValue(a, b) {
        ...
        return (
          void 0 === c &&
            void 0 !== b &&
            ((c = aW(null === b ? void 0 : b, { owner: this })),
            this.addValue(a, c)),
          c
        );
      }
      readValue(a, b) {
        ...
        if (null != c) {
          ...
          if (
            ...
            let d;
            ((d = c), !aX.find(X(d)) && I.test(b) && (c = aK(a, b)));
          }
          this.setBaseTarget(a, V(c) ? c.get() : c);
        }
        return V(c) ? c.get() : c;
      }
      setBaseTarget(a, b) {
      ...
      getBaseTarget(a) {
        ...
        if ('string' == typeof c || 'object' == typeof c) {
          let d = a7(this.props, c, this.presenceContext?.custom);
          d && (b = d[a]);
        }
    ...
    let bd = (a, b) => (b && 'number' == typeof a ? b.transform(a) : a),
      be = {
        x: 'translateX',
        y: 'translateY',
        z: 'translateZ',
      ...
      bf = d.length;
    function bg(a, b, c) {
      let { style: f, vars: g, transformOrigin: h } = a,
        i = !1,
        j = !1;
      for (let a in b) {
        let c = b[a];
        ...
        {
          let b = bd(c, O[a]);
          a.startsWith('origin') ? ((j = !0), (h[a] = b)) : (f[a] = b);
        }
      }
      if (
        (!b.transform &&
        ...
        f.transformOrigin = `${a} ${b} ${c}`;
      }
    }
    let bh = { offset: 'stroke-dashoffset', array: 'stroke-dasharray' },
      bi = { offset: 'strokeDashoffset', array: 'strokeDasharray' },
      bj = ['offsetDistance', 'offsetPath', 'offsetRotate', 'offsetAnchor'];
    function bk(
      a,
      {
        attrX: b,
    ...
    let bl = new Set([
      ...
      bm = (a) => 'string' == typeof a && 'svg' === a.toLowerCase();
    function bn(a, { style: b, vars: c }, d, e) {
      let f,
        g = a.style;
      for (f in b) g[f] = b[f];
    ...
    let bp = {
      ...
      br = {
        ...
        borderTopLeftRadius: bp,
        borderTopRightRadius: bp,
        borderBottomLeftRadius: bp,
        borderBottomRightRadius: bp,
        boxShadow: {
          correct: (a, { treeScale: b, projectionDelta: c }) => {
            let d = I.parse(a);
            if (d.length > 5) return a;
            let e = I.createTransformer(a),
              f = +('number' != typeof d[0]),
              g = c.x.scale * b.x,
              h = c.y.scale * b.y;
            ((d[0 + f] /= g), (d[1 + f] /= h));
    ...
    function bs(a, { layout: b, layoutId: c }) {
      return (
        e.has(a) ||
        a.startsWith('origin') ||
        ((b || void 0 !== c) && (!!br[a] || 'opacity' === a))
      );
    }
    function bt(a, b, c) {
      let d = a.style,
    ...
    class bv extends bb {
      ...
      readValueFromInstance(a, b) {
        ...
        return ((b = bl.has(b) ? b : bc(b)), a.getAttribute(b));
      }
      scrapeMotionValuesFromProps(a, b, c) {
        return bu(a, b, c);
      }
      build(a, b, c) {
        bk(a, b, this.isSVGTag, c.transformTemplate, c.style);
      }
      renderInstance(a, b, c, d) {
        for (let c in (bn(a, b, void 0, d), b.attrs))
          a.setAttribute(bl.has(c) ? c : bc(c), b.attrs[c]);
      }
      mount(a) {
        ((this.isSVGTag = bm(a.tagName)), super.mount(a));
      }
    }
    function bw({ top: a, left: b, right: c, bottom: d }) {
      return { x: { min: b, max: c }, y: { min: a, max: d } };
    }
    function bx(a) {
      return void 0 === a || 1 === a;
    }
    function by({ scale: a, scaleX: b, scaleY: c }) {
    ...
    function bC(a, b = 0, c = 1, d, e) {
      ((a.min = bB(a.min, b, c, d, e)), (a.max = bB(a.max, b, c, d, e)));
    }
    function bD(a, { x: b, y: c }) {
      (bC(a.x, b.translate, b.scale, b.originPoint),
        bC(a.y, c.translate, c.scale, c.originPoint));
    }
    function bE(a, b) {
      ((a.min = a.min + b), (a.max = a.max + b));
    }
    function bF(a, b, c, d, e = 0.5) {
      let f = bq(a.min, a.max, e);
      bC(a, b, c, f, d);
    }
    function bG(a, b) {
      (bF(a.x, b.x, b.scaleX, b.scale, b.originX),
        bF(a.y, b.y, b.scaleY, b.scale, b.originY));
    }
    function bH(a, b) {
      return bw(
        (function (a, b) {
      ...
      readValueFromInstance(a, b) {
              ...
              })(a, b);
        {
          let c = window.getComputedStyle(a),
            d = (ab(b) ? c.getPropertyValue(b) : c[b]) || 0;
    ...
    function bM(a) {
      ...
      else if (bL.indexOf(a) > -1 || /[A-Z]/u.test(a)) return !0;
      return !1;
    }
    var bN = a.i(33845);
    let bO = (0, bK.createContext)({});
    (a.s(['LayoutGroupContext', () => bO], 90544),
      (0, bK.createContext)({ strict: !1 }));
    let bP = (0, bK.createContext)({
      transformPagePoint: (a) => a,
      isStatic: !1,
      reducedMotion: 'never',
    });
    a.s(['MotionConfigContext', () => bP], 74989);
    let bQ = (0, bK.createContext)({});
    function bR(a) {
    ...
    function bT(a, b, c) {
      for (let d in b) V(b[d]) || bs(d, c) || (a[d] = b[d]);
    }
    let bU = () => ({ ...bS(), attrs: {} }),
      bV = new Set([
        'animate',
    ...
    try {
      ((bJ = (() => {
        ...
        'function' == typeof bJ &&
          (bX = (a) => (a.startsWith('on') ? !bW(a) : bJ(a))));
    } catch {}
    function bY(a) {
      return V(a) ? a.get() : a;
    }
    let bZ = (0, bK.createContext)(null);
    function b$(a) {
      let b = (0, bK.useRef)(null);
      return (null === b.current && (b.current = a()), b.current);
    }
    (a.s(['PresenceContext', () => bZ], 51553),
      a.s(['useConstant', () => b$], 63846));
    let b_ = (a) => (b, c) => {
        let d = (0, bK.useContext)(bQ),
          e = (0, bK.useContext)(bZ),
          f = () =>
            (function (
      ...
      b0 = b_({ scrapeMotionValuesFromProps: bt, createRenderState: bS }),
      b1 = b_({ scrapeMotionValuesFromProps: bu, createRenderState: bU }),
      b2 = {
        animation: [
          'animate',
          'variants',
      ...
      b5 = 'data-' + bc('framerAppearId'),
      b6 = (0, bK.createContext)({});
    function b7(a) {
      return (
        a &&
        'object' == typeof a &&
    ...
    let b8 = bK.useEffect;
    function b9(a, { forwardMotionProps: b = !1, type: c } = {}, d, e) {
      d &&
        (function (a) {
          let b =
            (!(function () {
              ...
              let a = {};
              for (let b in b2)
                a[b] = { isEnabled: (a) => b2[b].some((b) => !!a[b]) };
              ((a9 = a), (b3 = !0));
            })(),
            a9);
      ...
      function h(c, d) {
        ...
        let h,
          ...
          m = (function (a) {
            let { initial: b, animate: c } = (function (a, b) {
              if (a4(a)) {
                ...
                return {
                  initial: !1 === b || a1(b) ? b : void 0,
                  animate: a1(c) ? c : void 0,
                };
              }
              return !1 !== a.inherit ? b : {};
            })(a, (0, bK.useContext)(bQ));
            return (0, bK.useMemo)(
              () => ({ initial: b, animate: c }),
              [bR(b), bR(c)]
            );
          ...
          n = g(c, l);
        return (0, bN.jsxs)(bQ.Provider, {
          value: m,
          children: [
            h && m.visualElement
              ? (0, bN.jsx)(h, { visualElement: m.visualElement, ...k })
              : null,
            (function (a, b, c, { latestValues: d }, e, f = !1, g) {
              let h = (
                  (g ?? bM(a))
                    ? function (a, b, c, d) {
                        let e = (0, bK.useMemo)(() => {
                          let c = bU();
                          return (
                            bk(c, b, bm(d), a.transformTemplate, a.style),
                            { ...c.attrs, style: { ...c.style } }
                          );
                        }, [b]);
                        if (a.style) {
                          let b = {};
                          (bT(b, a.style, a), (e.style = { ...b, ...e.style }));
                        }
                        return e;
                      }
                    : function (a, b) {
                ...
                j = a !== bK.Fragment ? { ...i, ...h, ref: c } : {},
                { children: k } = b,
                l = (0, bK.useMemo)(() => (V(k) ? k.get() : k), [k]);
              return (0, bK.createElement)(a, { ...j, children: l });
            })(
              a,
              c,
              ((e = m.visualElement),
              (i = (0, bK.useRef)(d)),
              (0, bK.useInsertionEffect)(() => {
                i.current = d;
              }),
              (j = (0, bK.useRef)(null)),
              (0, bK.useCallback)(
      ...
      let i = (0, bK.forwardRef)(h);
      return ((i[b4] = a), i);
    }
    a.s(['useIsomorphicLayoutEffect', () => b8], 13021);
    class ca {
      constructor(a) {
    ...
    function cb(a, b, c) {
      let d = a.getProps();
      return a7(d, b, void 0 !== c ? c : d.custom, a);
    }
    function cc(a, b) {
      return a?.[b] ?? a?.default ?? a;
    }
    let cd = (a) => Array.isArray(a);
    function ce(a, b) {
      let c = a.getValue('willChange');
      if (V(c) && c.add) return c.add(b);
      if (!c && aw.WillChange) {
        let c = new aw.WillChange('auto');
    ...
    let cf = (a) => 1e3 * a,
      cg = (a, b) => (c) => b(a(c)),
      ch = (...a) => a.reduce(cg),
      ci = { layout: 0, mainThread: 0, waapi: 0 };
    function cj(a, b, c) {
    ...
    let co = (a, b) => {
        let c = cn(a),
          d = cn(b);
        if (!c || !d) return ck(a, b);
        let e = { ...c };
        return (a) => (
          (e.red = cl(c.red, d.red, a)),
          (e.green = cl(c.green, d.green, a)),
          (e.blue = cl(c.blue, d.blue, a)),
          (e.alpha = bq(c.alpha, d.alpha, a)),
          p.transform(e)
        );
      },
      cp = new Set(['none', 'hidden']);
    function cq(a, b) {
      return (c) => bq(a, b, c);
    }
    function cr(a) {
    ...
    function ct(a, b) {
      let c = { ...a, ...b },
        d = {};
      for (let e in c)
        void 0 !== a[e] && void 0 !== b[e] && (d[e] = cr(a[e])(a[e], b[e]));
      return (a) => {
    ...
    let cu = (a, b) => {
      ...
      if ((cp.has(a) && !e.values.length) || (cp.has(b) && !d.values.length))
        return cp.has(a) ? (c) => (c <= 0 ? a : b) : (c) => (c >= 1 ? b : a);
      return ch(
        cs(
          (function (a, b) {
            let c = [],
    ...
    let cw = (a) => {
        ...
        return {
          start: (a = !0) => az.update(b, a),
          stop: () => aA(b),
          now: () => (aB.isProcessing ? aB.timestamp : aS.now()),
        };
      },
      cx = (a, b, c = 10) => {
        let d = '',
    ...
    function cI(a = 0.3, b = 0.3) {
      let c,
          ...
          if (!cH(a, cG) && cH(a, cF))
            if (a.visualDuration) {
              let c = (2 * Math.PI) / (1.2 * a.visualDuration),
                d = c * c,
                e = 2 * f(0.05, 1, 1 - (a.bounce || 0)) * Math.sqrt(d);
                ...
                ((h = f(0.05, 1, h)),
                  ...
                  h < 1
                    ? ((e = (b) => {
                        let d = b * h,
                          e = d * a;
                        return 0.001 - ((d - c) / cE(b, h)) * Math.exp(-e);
                      }),
                      (g = (b) => {
                        let d = b * h * a,
                          ...
                          i = cE(Math.pow(b, 2), h);
                        return (
                          ((d * c + c - f) * g * (-e(b) + 0.001 > 0 ? -1 : 1)) /
                          i
                        );
                      }))
                    : ((e = (b) =>
                        -0.001 + Math.exp(-b * a) * ((b - c) * a + 1)),
                      (g = (b) => a * a * (c - b) * Math.exp(-b * a))));
        ...
        t = Math.sqrt(k / m) / 1e3,
        u = 5 > Math.abs(s);
      if ((e || (e = u ? cA : cB), g || (g = u ? cC : cD), r < 1)) {
        let a = cE(t, r);
        c = (b) =>
          i -
          Math.exp(-r * t * b) *
            (((q + r * t * s) / a) * Math.sin(a * b) + s * Math.cos(a * b));
      } else if (1 === r)
        c = (a) => i - Math.exp(-t * a) * (s + (q + t * s) * a);
      else {
        ...
        c = (b) => {
          ...
          return (
            i -
            (c * ((q + r * t * s) * Math.sinh(d) + a * s * Math.cosh(d))) / a
          );
        };
      }
      let v = {
        ...
        next: (a) => {
          ...
          if (p) j.done = a >= n;
            ...
            let d = 0 === a ? q : 0;
            r < 1 && (d = 0 === a ? cf(q) : cz(c, a, b));
            let f = Math.abs(i - b) <= g;
            j.done = Math.abs(d) <= e && f;
          }
          return ((j.value = j.done ? i : b), j);
        },
        toString: () => {
          let a = Math.min(cy(v), 2e4),
            b = cx((b) => v.next(a * b).value, a, 30);
          return a + 'ms ' + b;
        },
        toTransition: () => {},
      };
    ...
    a.s(['cubicBezier', () => cL], 15812);
    let cM = cL(0.42, 0, 1, 1),
      cN = cL(0, 0, 0.58, 1),
      cO = cL(0.42, 0, 0.58, 1),
      cP = (a) => (b) => (b <= 0.5 ? a(2 * b) / 2 : (2 - a(2 * (1 - b))) / 2),
      cQ = (a) => (b) => 1 - a(1 - b),
      cR = cL(0.33, 1.53, 0.69, 0.99),
      cS = cQ(cR),
      cT = cP(cS),
      cU = (a) =>
        (a *= 2) < 1 ? 0.5 * cS(a) : 0.5 * (2 - Math.pow(2, -10 * (a - 1))),
      cV = (a) => 1 - Math.sin(Math.acos(a)),
      cW = cQ(cV),
      cX = cP(cV),
      cY = (a) => Array.isArray(a) && 'number' == typeof a[0],
      cZ = {
        linear: av,
        easeIn: cM,
        easeInOut: cO,
    ...
    function c0(a, b, { clamp: c = !0, ease: d, mixer: e } = {}) {
      let g = a.length;
      if (
        (_(
          g === b.length,
        ...
        return () => b[0];
      if (2 === g && b[0] === b[1]) return () => b[1];
      let h = a[0] === a[1];
      a[0] > a[g - 1] && ((a = [...a].reverse()), (b = [...b].reverse()));
      let i = (function (a, b, c) {
          let d = [],
            e = c || aw.mix || cv,
            f = a.length - 1;
          for (let c = 0; c < f; c++) {
            let f = e(a[c], a[c + 1]);
            (b && (f = ch(Array.isArray(b) ? b[c] || av : b, f)), d.push(f));
          }
          return d;
        })(b, d, e),
        j = i.length,
        k = (c) => {
          ...
          let e = c_(a[d], a[d + 1], c);
          return i[d](e);
        };
      return c ? (b) => k(f(a[0], a[g - 1], b)) : k;
    }
    function c1(a) {
      let b = [0];
      return (
    ...
    function c2({
      ...
      var e;
      let f = Array.isArray(d) && 'number' != typeof d[0] ? d.map(c$) : c$(d),
        g = { done: !1, value: b[0] },
        h = c0(
          ((e = c && c.length === b.length ? c : c1(b)), e.map((b) => b * a)),
          b,
          {
            ease: Array.isArray(f)
              ? f
              : b.map(() => f || cO).splice(0, b.length - 1),
          }
        );
      return {
    ...
    (a.s(['progress', () => c_], 71942),
      a.s(['interpolate', () => c0], 28662),
      a.s(['defaultOffset', () => c1], 94228));
    let c3 = (a) => null !== a;
    function c4(a, { repeat: b, repeatType: c = 'loop' }, d, e = 1) {
      let f = a.filter(c3),
        g = e < 0 || (b && 'loop' !== c && b % 2 == 1) ? 0 : f.length - 1;
      return g && void 0 !== d ? d : f[g];
    }
    let c5 = { decay: cJ, inertia: cJ, tween: c2, keyframes: c2, spring: cI };
    function c6(a) {
      'string' == typeof a.type && (a.type = c5[a.type]);
    }
    class c7 {
      constructor() {
        this.updateFinished();
    ...
    class c9 extends c7 {
      constructor(a) {
        (super(),
          ...
          (this.stop = () => {
            ...
            (a && a.updatedAt !== aS.now() && this.tick(aS.now()),
              (this.isStopped = !0),
              'idle' !== this.state &&
      ...
      initAnimation() {
        ...
        h !== c2 &&
          'number' != typeof g[0] &&
          ((this.mixKeyframes = ch(c8, cv(g[0], g[1]))), (g = [0, 100]));
        ...
        ('mirror' === e &&
          ...
          null === i.calculatedDuration && (i.calculatedDuration = cy(i)));
      ...
      tick(a, b = !1) {
        ...
        return (
          x && o !== cJ && (v.value = c4(k, this.options, q, this.speed)),
          p && p(v.value),
          x && this.finish(),
          v
        );
      ...
      play() {
        ...
        let { driver: a = cw, startTime: b } = this.options;
    ...
    a.s(['JSAnimation', () => c9], 7059);
    let db = da(() => void 0 !== window.ScrollTimeline);
    a.s(['supportsScrollTimeline', () => db], 5440);
    let dc = {},
      dd =
        ((c = da(() => {
          try {
        ...
        () => dc.linearEasing ?? c()),
      de = ([a, b, c, d]) => `cubic-bezier(${a}, ${b}, ${c}, ${d})`,
      df = {
        linear: 'linear',
        ease: 'ease',
        easeIn: 'ease-in',
        ...
        circIn: de([0, 0.65, 0.55, 1]),
        circOut: de([0.55, 0, 1, 0.45]),
        backIn: de([0.31, 0.01, 0.66, -0.59]),
        backOut: de([0.33, 1.53, 0.69, 0.99]),
      };
    function dg(a) {
    ...
    class dh extends c7 {
        ...
        ((this.animation = (function (
          ...
          (this.animation.onfinish = () => {
            if (((this.finishedTime = this.time), !e)) {
              let a = c4(d, this.options, g, this.speed);
      ...
      set time(a) {
        ((this.manualStartTime = null),
          (this.finishedTime = null),
          (this.animation.currentTime = cf(a)));
      }
      get speed() {
      ...
      attachTimeline({ timeline: a, observe: b }) {
        ...
        a && db())
          ? ((this.animation.timeline = a), av)
          : b(this);
      }
    }
    let di = { anticipate: cU, backInOut: cT, circInOut: cX };
    class dj extends dh {
      constructor(a) {
        (!(function (a) {
          'string' == typeof a.ease && a.ease in di && (a.ease = di[a.ease]);
        })(a),
          c6(a),
          super(a),
      ...
      updateMotionValue(a) {
        ...
        let h = new c9({ ...g, autoplay: !1 }),
          i = Math.max(10, aS.now() - this.startTime),
          j = f(0, 10, i - 10);
        (b.setWithVelocity(
          h.sample(Math.max(0, i - j)).value,
          h.sample(i).value,
          j
        ),
          h.stop());
    ...
    let dm = new Set(['opacity', 'clipPath', 'filter', 'transform']),
      dn = da(() => Object.hasOwnProperty.call(Element.prototype, 'animate'));
    class dp extends c7 {
      constructor({
        autoplay: a = !0,
        delay: b = 0,
      ...
      onKeyframesResolved(a, b, c, d) {
        ...
        ((this.resolvedAt = aS.now()),
          !(function (a, b, c, d) {
            ...
            ((aw.instantAnimations || !h) && j?.(c4(a, c, b)),
            (a[0] = a[a.length - 1]),
            dl(c),
            (c.repeat = 0)));
        let k = {
          ...
          n = l ? new dj({ ...k, element: m }) : new c9(k);
        (n.finished
          .then(() => {
            this.notifyFinished();
          })
      ...
      get animation() {
        return (
          this._animation ||
            (this.keyframeResolver?.resume(), (aG = !0), aI(), aH(), (aG = !1)),
          this._animation
        );
      }
      get duration() {
    ...
    let dq = { type: 'spring', stiffness: 500, damping: 25, restSpeed: 10 },
      dr = { type: 'keyframes', duration: 0.8 },
      ds = { type: 'keyframes', ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
      dt = (a) => null !== a,
      du =
        (a, b, c, d = {}, f, g) =>
        (h) => {
          ...
          (!(function ({
            ...
            l.duration && (l.duration = cf(l.duration)),
            l.repeatDelay && (l.repeatDelay = cf(l.repeatDelay)),
            void 0 !== l.from && (l.keyframes[0] = l.from));
          let m = !1;
          if (
            ((!1 !== l.type && (0 !== l.duration || l.repeatDelay)) ||
              (dl(l), 0 === l.delay && (m = !0)),
            (aw.instantAnimations || aw.skipAnimations) &&
              ((m = !0), dl(l), (l.delay = 0)),
            ...
            if (void 0 !== a)
              return void az.update(() => {
                (l.onUpdate(a), l.onComplete());
              });
          }
          return i.isSync ? new c9(l) : new dp(l);
        };
    function dv(a, b, { delay: c = 0, transitionOverride: d, type: e } = {}) {
      let {
      ...
      for (let b in h) {
        ...
        if (window.MotionHandoffAnimation) {
          let c = a.props[b5];
          if (c) {
            let a = window.MotionHandoffAnimation(c, b, az);
            null !== a && ((g.startTime = a), (m = !0));
          }
        }
        ce(a, b);
        let n = i ?? a.shouldReduceMotion;
        d.start(du(b, d, e, n && W.has(b) ? { type: !1 } : g, a, m));
        let o = d.animation;
        o && j.push(o);
      }
      return (
            ...
            az.update(() => {
              g &&
                (function (a, b) {
                  ...
                  for (let b in (e = { ...e, ...c })) {
                    var f;
                    let c = cd((f = e[b])) ? f[f.length - 1] || 0 : f;
                    a.hasValue(b) ? a.getValue(b).set(c) : a.addValue(b, aW(c));
                  }
                })(a, g);
            });
          }),
    ...
    function dx(a, b, c = {}) {
      let d = cb(a, b, 'exit' === c.type ? a.presenceContext?.custom : void 0),
        { transition: e = a.getDefaultTransition() || {} } = d || {};
      c.transitionOverride && (e = c.transitionOverride);
      let f = d ? () => Promise.all(dv(a, d, c)) : () => Promise.resolve(),
        g =
    ...
    let dG = new Set(['BUTTON', 'INPUT', 'SELECT', 'TEXTAREA', 'A']);
    function dH(a) {
      return dG.has(a.tagName) || !0 === a.isContentEditable;
    }
    function dI(a, b, c, d = { passive: !0 }) {
    ...
    function dL(a, b, c, d = 0.5) {
      ((a.origin = d),
        (a.originPoint = bq(b.min, b.max, a.origin)),
        (a.scale = dK(c) / dK(b)),
        (a.translate = bq(c.min, c.max, a.origin) - a.originPoint),
    ...
    function dM(a, b, c, d) {
      (dL(a.x, b.x, c.x, d ? d.originX : void 0),
        dL(a.y, b.y, c.y, d ? d.originY : void 0));
    }
    function dN(a, b, c) {
      ((a.min = c.min + b.min), (a.max = a.min + dK(b)));
    }
    function dO(a, b, c) {
      ((a.min = b.min - c.min), (a.max = a.min + dK(b)));
    }
    function dP(a, b, c) {
      (dO(a.x, b.x, c.x), dO(a.y, b.y, c.y));
    }
    let dQ = (a) =>
      'mouse' === a.pointerType
    ...
    function dS(a, b, c, d) {
      return dI(a, b, (a) => dQ(a) && c(a, dR(a)), d);
    }
    let dT = ({ current: a }) => (a ? a.ownerDocument.defaultView : null),
      dU = (a, b) => Math.abs(a - b),
      dV = new Set(['auto', 'scroll']);
    class dW {
      constructor(
        a,
        b,
        ...
        if (
          ...
          (this.updatePoint = () => {
            ...
            let c = dZ(this.lastMoveEventInfo, this.history),
              d = null !== this.startEvent,
              e =
                ((a = c.offset),
                (b = { x: 0, y: 0 }),
                Math.sqrt(dU(a.x, b.x) ** 2 + dU(a.y, b.y) ** 2) >=
          ...
          (this.handlePointerMove = (a, b) => {
            ((this.lastMoveEvent = a),
              (this.lastMoveEventInfo = dX(b, this.transformPagePoint)),
              az.update(this.updatePoint, !0));
          }),
        ...
        const h = dX(dR(a), this.transformPagePoint),
          { point: i } = h,
          { timestamp: j } = aB;
        this.history = [{ ...i, timestamp: j }];
        const { onSessionStart: k } = b;
        (k && k(a, dZ(h, this.history)),
      ...
      startScrollTracking(a) {
        ...
        for (; b; ) {
          ...
          ((dV.has(a.overflowX) || dV.has(a.overflowY)) &&
    ...
    function dZ({ point: a }, b) {
      return {
        ...
        velocity: (function (a, b) {
          ...
          for (
            ;
            c >= 0 && ((d = a[c]), !(e.timestamp - d.timestamp > cf(0.1)));
          )
            c--;
          if (!d) return { x: 0, y: 0 };
    ...
    class d4 {
      ...
      start(a, { snapToCursor: b = !1, distanceThreshold: c } = {}) {
        ...
        let e = (a) => {
            b
              ? (this.stopAnimation(), this.snapToCursor(dR(a).point))
              : this.pauseAnimation();
          },
          f = (a, b) => {
            this.stopAnimation();
              ...
              dF((a) => {
                ...
                if (t.test(b)) {
                  ...
                  if (c && c.layout) {
                    ...
                    d && (b = dK(d) * (parseFloat(b) / 100));
                  }
                }
                this.originPoint[a] = b;
              }),
              e && az.postRender(() => e(a, b)),
        ...
        this.panSession = new dW(
          ...
          },
          {
            ...
            dragSnapToOrigin: j,
            distanceThreshold: c,
            contextWindow: dT(this.visualElement),
      ...
      updateAxis(a, b, c) {
        ...
        if (!c || !d5(a, d, this.currentDirection)) return;
        ...
        (this.constraints &&
          ...
          (f = (function (a, { min: b, max: c }, d) {
            return (
              void 0 !== b && a < b
                ? (a = d ? bq(b, a, d.min) : Math.max(a, b))
                : void 0 !== c &&
                  a > c &&
                  (a = d ? bq(c, a, d.max) : Math.min(a, c)),
              a
            );
        ...
        (a && b7(a)
          ...
          : a && c
            ? (this.constraints = (function (
                ...
                return { x: d_(a.x, c, e), y: d_(a.y, b, d) };
              })(c.layoutBox, a))
            : (this.constraints = !1),
          (this.elastic = (function (a = 0.35) {
            return (
              !1 === a ? (a = 0) : !0 === a && (a = 0.35),
              { x: d1(a, 'left', 'right'), y: d1(a, 'top', 'bottom') }
            );
          })(b)),
          d !== this.constraints &&
            c &&
      ...
      resolveRefConstraints() {
        ...
        let f = (function (a, b, c) {
            let d = bH(a, c),
              { scroll: e } = b;
            return (e && (bE(d.x, e.offset.x), bE(d.y, e.offset.y)), d);
          })(d, e.root, this.visualElement.getTransformPagePoint()),
          g = ((a = e.layout.layoutBox), { x: d0(a.x, f.x), y: d0(a.y, f.y) });
        if (c) {
          let a = c(
            (function ({ x: a, y: b }) {
          ...
          ((this.hasMutatedConstraints = !!a), a && (g = bw(a)));
        }
        return g;
      }
      startAnimation(a) {
        ...
        return Promise.all(
          dF((g) => {
            if (!d5(g, b, this.currentDirection)) return;
            let i = (h && h[g]) || {};
            f && (i = { min: 0, max: 0 });
            let j = {
              type: 'inertia',
      ...
      startAxisValueAnimation(a, b) {
        ...
        return (
          ce(this.visualElement, a),
          c.start(du(a, c, 0, b, this.visualElement, !1))
        );
      }
      stopAnimation() {
        dF((a) => this.getAxisMotionValue(a).stop());
      }
      pauseAnimation() {
        dF((a) => this.getAxisMotionValue(a).animation?.pause());
      }
      getAnimationState(a) {
      ...
      scalePositionWithinConstraints() {
        ...
        if (!b7(b) || !c || !this.constraints) return;
        this.stopAnimation();
        let d = { x: 0, y: 0 };
        dF((a) => {
          ...
          if (b && !1 !== this.constraints) {
            ...
            d[a] =
              ...
              (h = dK(c)),
              (i = dK(e)) > h
                ? (g = c_(e.min, e.max - h, c.min))
                : h > i && (g = c_(c.min, c.max - i, e.min)),
              f(0, 1, g));
          }
        });
      ...
      addListeners() {
        if (!this.visualElement.current) return;
        d3.set(this.visualElement, this);
        let a = this.visualElement.current,
          b = dS(a, 'pointerdown', (b) => {
    ...
    let d6 = (a) => (b, c) => {
        a && az.postRender(() => a(b, c));
      },
      d7 = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 };
    var d8 = bK;
    function d9(a = !0) {
      let b = (0, bK.useContext)(bZ);
      ...
      let g = (0, bK.useCallback)(() => a && d && d(f), [f, d, a]);
      return !c && d ? [!1, g] : [!0];
    }
    a.s(['usePresence', () => d9], 15868);
    let ea = !1;
    class eb extends d8.Component {
      componentDidMount() {
        let {
            visualElement: a,
            layoutGroup: b,
    ...
    function ec(a) {
      let [b, c] = d9(),
        d = (0, d8.useContext)(bO);
      return (0, bN.jsx)(eb, {
        ...a,
        layoutGroup: d,
        switchLayoutGroup: (0, d8.useContext)(b6),
        isPresent: b,
        safeToRemove: c,
      });
    }
    ...
    function ee(a) {
      return ed(a) && 'ownerSVGElement' in a;
    }
    a.s(['isSVGElement', () => ee], 60955);
    let ef = ['TopLeft', 'TopRight', 'BottomLeft', 'BottomRight'],
      eg = ef.length,
      eh = (a) => ('string' == typeof a ? parseFloat(a) : a),
      ei = (a) => 'number' == typeof a || u.test(a);
    function ej(a, b) {
    ...
    let ek = em(0, 0.5, cW),
      el = em(0.5, 0.95, av);
    function em(a, b, c) {
      return (d) => (d < a ? 0 : d > b ? 1 : c(c_(a, b, d)));
    }
    function en(a, b) {
      ((a.min = b.min), (a.max = b.max));
    }
    function eo(a, b) {
      (en(a.x, b.x), en(a.y, b.y));
    }
    function ep(a, b) {
    ...
    function er(a, b, [c, d, e], f, g) {
      !(function (a, b = 0, c = 1, d = 0.5, e, f = a, g = a) {
        if (
          (t.test(b) &&
            ((b = parseFloat(b)), (b = bq(g.min, g.max, b / 100) - g.min)),
          'number' != typeof b)
        )
          return;
        let h = bq(f.min, f.max, d);
        (a === f && (h -= b),
          (a.min = eq(a.min, b, c, h, e)),
          (a.max = eq(a.max, b, c, h, e)));
      })(a, b[c], b[d], b[e], b.scale, f, g);
    }
    let es = ['x', 'scaleX', 'originX'],
      et = ['y', 'scaleY', 'originY'];
    function eu(a, b, c, d) {
      (er(a.x, b, es, c ? c.x : void 0, d ? d.x : void 0),
        er(a.y, b, et, c ? c.y : void 0, d ? d.y : void 0));
    }
    function ev(a) {
      return 0 === a.translate && 1 === a.scale;
    }
    function ew(a) {
      return ev(a.x) && ev(a.y);
    }
    function ex(a, b) {
    ...
    function ez(a, b) {
      return ey(a.x, b.x) && ey(a.y, b.y);
    }
    function eA(a) {
      return dK(a.x) / dK(a.y);
    }
    function eB(a, b) {
      return (
        a.translate === b.translate &&
    ...
    class eC {
      ...
      add(a) {
        (aN(this.members, a), a.scheduleRender());
      }
      remove(a) {
        if (
          (aO(this.members, a),
    ...
    let eD = (a, b) => a.depth - b.depth;
    class eE {
      constructor() {
        ((this.children = []), (this.isDirty = !1));
      }
      add(a) {
        (aN(this.children, a), (this.isDirty = !0));
      }
      remove(a) {
    ...
    function eI({
      ...
      return class {
        ...
        addEventListener(a, b) {
          return (
            this.eventHandlers.has(a) || this.eventHandlers.set(a, new aP()),
        ...
        mount(b) {
          ...
          ((this.isSVG = ee(b) && !(ee(b) && 'svg' === b.tagName)),
            (this.instance = b));
              ...
              a(b, () => {
                ...
                if (a !== d) {
                  ...
                  ((d = a),
                    ...
                    az.setup(f, !0),
                    (c = () => aA(f)),
                    d7.hasAnimatedSinceResize &&
                      ((d7.hasAnimatedSinceResize = !1),
            ...
            !1 !== this.options.animate &&
              ...
              this.addEventListener(
                ...
                ({
                  ...
                  let f =
                      this.options.transition || e.getDefaultTransition() || eZ,
                    {
                      onLayoutAnimationStart: g,
                      onLayoutAnimationComplete: h,
                    } = e.getProps(),
                    i = !this.targetLayout || !ez(this.targetLayout, d),
                    j = !b && c;
                  if (
                    ...
                    let b = { ...cc(f, 'layout'), onPlay: g, onComplete: h };
        ...
        update() {
          ...
          if (this.animationId <= this.animationCommitId)
            return void this.nodes.forEach(eP);
          ((this.animationCommitId = this.animationId),
            ...
            this.clearAllSnapshots());
          let a = aS.now();
          ((aB.delta = f(0, 1e3 / 60, a - aB.timestamp)),
            (aB.timestamp = a),
            (aB.isProcessing = !0),
            aC.update.process(aB),
            aC.preRender.process(aB),
            aC.render.process(aB),
            (aB.isProcessing = !1));
        }
        didUpdate() {
          this.updateScheduled ||
            ((this.updateScheduled = !0), aQ.read(this.scheduleUpdate));
        }
        clearAllSnapshots() {
          (this.nodes.forEach(eN), this.sharedNodes.forEach(eV));
        }
        scheduleUpdateProjection() {
          this.projectionUpdateScheduled ||
            ((this.projectionUpdateScheduled = !0),
            az.preRender(this.updateProjection, !1, !0));
        }
        ...
        updateSnapshot() {
          !this.snapshot &&
            ...
            !this.snapshot ||
              dK(this.snapshot.measuredBox.x) ||
              dK(this.snapshot.measuredBox.y) ||
        ...
        resetTransform() {
          ...
          let a =
            ...
            b = this.projectionDelta && !ew(this.projectionDelta),
            c = this.getTransformTemplate(),
            d = c ? c(this.latestValues, '') : void 0,
            f = d !== this.prevTransformTemplateValue;
          a &&
            this.instance &&
            (b || bz(this.latestValues) || f) &&
            (e(this.instance, d),
            (this.shouldResetTransform = !1),
            this.scheduleRender());
        }
        ...
        measurePageBox() {
          ...
          if (!(this.scroll?.wasRoot || this.path.some(e2))) {
            let { scroll: a } = this.root;
            a && (bE(b.x, a.offset.x), bE(b.y, a.offset.y));
          }
          return b;
        }
        removeElementScroll(a) {
          let b = U();
          if ((eo(b, a), this.scroll?.wasRoot)) return b;
          for (let c = 0; c < this.path.length; c++) {
            ...
            d !== this.root &&
              e &&
              f.layoutScroll &&
              (e.wasRoot && eo(b, a), bE(b.x, e.offset.x), bE(b.y, e.offset.y));
          }
          return b;
        }
        applyTransform(a, b = !1) {
          ...
          for (let a = 0; a < this.path.length; a++) {
            ...
            (!b &&
              ...
              d.scroll &&
              d !== d.root &&
              bG(c, { x: -d.scroll.offset.x, y: -d.scroll.offset.y }),
              bz(d.latestValues) && bG(c, d.latestValues));
          }
          return (bz(this.latestValues) && bG(c, this.latestValues), c);
        }
        removeTransform(a) {
          let b = U();
          eo(b, a);
          for (let a = 0; a < this.path.length; a++) {
            let c = this.path[a];
            if (!c.instance || !bz(c.latestValues)) continue;
            by(c.latestValues) && c.updateSnapshot();
            let d = U();
            (eo(d, c.measurePageBox()),
              eu(
                b,
                c.latestValues,
          ...
          return (bz(this.latestValues) && eu(b, this.latestValues), b);
        }
        setTargetDelta(a) {
          ((this.targetDelta = a),
        ...
        forceRelativeParentToResolveTarget() {
          this.relativeParent &&
            this.relativeParent.resolvedRelativeTargetAt !== aB.timestamp &&
        ...
        resolveTargetDelta(a = !1) {
          ...
          this.resolvedRelativeTargetAt = aB.timestamp;
            ...
            if (
              ...
              this.targetDelta
                ? (this.resumingFrom
                  ...
                  bD(this.target, this.targetDelta))
                : eo(this.target, this.layout.layoutBox);
            this.attemptToResolveRelativeTarget &&
        ...
        getClosestProjectingParent() {
          if (
            !(
              !this.parent ||
              by(this.parent.latestValues) ||
              bA(this.parent.latestValues)
            )
          )
        ...
        createRelativeTarget(a, b, c) {
          ((this.relativeParent = a),
            ...
            dP(this.relativeTargetOrigin, b, c),
        ...
        calcProjection() {
          ...
          if (
            ...
            b &&
              ...
              (c = !1),
            this.resolvedRelativeTargetAt === aB.timestamp && (c = !1),
            c)
          )
            return;
          let { layout: d, layoutId: e } = this.options;
              ...
              for (let h = 0; h < g; h++) {
                ...
                (!g ||
                  ...
                  (d &&
                    ...
                    e.scroll &&
                    e !== e.root &&
                    bG(a, { x: -e.scroll.offset.x, y: -e.scroll.offset.y }),
                  f && ((b.x *= f.x.scale), (b.y *= f.y.scale), bD(a, f)),
                  d && bz(e.latestValues) && bG(a, e.latestValues));
              }
          ...
          (this.projectionDelta && this.prevProjectionDelta
            ? (ep(this.prevProjectionDelta.x, this.projectionDelta.x),
              ep(this.prevProjectionDelta.y, this.projectionDelta.y))
            ...
            (this.treeScale.x === f &&
              this.treeScale.y === g &&
              eB(this.projectionDelta.x, this.prevProjectionDelta.x) &&
              eB(this.projectionDelta.y, this.prevProjectionDelta.y)) ||
              ((this.hasProjected = !0),
              this.scheduleRender(),
        ...
        createProjectionDeltas() {
          ((this.prevProjectionDelta = S()),
            (this.projectionDelta = S()),
            (this.projectionDeltaWithTransform = S()));
        }
              ...
              if (
                ...
                (dP(
                  ...
                  c &&
                    ...
                    (m = c),
                    ex(j.x, m.x) && ex(j.y, m.y)) &&
                    (this.isProjectionDirty = !1),
                  c || (c = U()),
                  eo(c, this.relativeTarget));
              }
              (i &&
                ((this.animationValues = f),
                (function (a, b, c, d, e, f) {
                  e
                    ? ((a.opacity = bq(0, c.opacity ?? 1, ek(d))),
                      (a.opacityExit = bq(b.opacity ?? 1, 0, el(d))))
                    : f && (a.opacity = bq(b.opacity ?? 1, c.opacity ?? 1, d));
                  for (let e = 0; e < eg; e++) {
                    let f = `border${ef[e]}Radius`,
                      g = ej(b, f),
                      h = ej(c, f);
                    (void 0 !== g || void 0 !== h) &&
                      (g || (g = 0),
                      h || (h = 0),
                      0 === g || 0 === h || ei(g) === ei(h)
                        ? ((a[f] = Math.max(bq(eh(g), eh(h), d), 0)),
                          (t.test(h) || t.test(g)) && (a[f] += '%'))
                        : (a[f] = h));
                  }
                  (b.rotate || c.rotate) &&
                    (a.rotate = bq(b.rotate || 0, c.rotate || 0, d));
        ...
        startAnimation(a) {
          (this.notifyListeners('animationStart'),
            ...
            this.pendingAnimation &&
              (aA(this.pendingAnimation), (this.pendingAnimation = void 0)),
            (this.pendingAnimation = az.update(() => {
              var b, c, d;
              let e;
              ((d7.hasAnimatedSinceResize = !0),
                ci.layout++,
                this.motionValue || (this.motionValue = aW(0)),
                (this.currentAnimation =
                  ((b = this.motionValue),
                  (c = [0, 1e3]),
                  (d = {
        ...
        applyTransformsToTarget() {
          ...
          if (b && c && d) {
            if (
              ...
              this.layout &&
              d &&
              e1(this.options.animationType, this.layout.layoutBox, d.layoutBox)
            ) {
              c = this.target || U();
              let b = dK(this.layout.layoutBox.x);
              ((c.x.min = a.target.x.min), (c.x.max = c.x.min + b));
              let d = dK(this.layout.layoutBox.y);
        ...
        registerSharedNode(a, b) {
          (this.sharedNodes.has(a) || this.sharedNodes.set(a, new eC()),
        ...
        resetSkewAndRotation() {
          ...
          if (
            ...
            return;
          let d = {};
          c.z && eH('z', a, d, this.animationValues);
          for (let b = 0; b < eF.length; b++)
            (eH(`rotate${eF[b]}`, a, d, this.animationValues),
              eH(`skew${eF[b]}`, a, d, this.animationValues));
        ...
        applyProjectionStyles(a, b) {
          ...
          if (this.needsReset) {
            ((this.needsReset = !1),
              (a.visibility = ''),
              (a.opacity = ''),
              (a.pointerEvents = bY(b?.pointerEvents) || ''),
          ...
          br)) {
            ...
            let { correct: c, applyTo: g, isCSSVariable: h } = br[b],
          ...
          this.options.layoutId &&
            (a.pointerEvents =
              d === this ? bY(b?.pointerEvents) || '' : 'none');
        }
        clearSnapshot() {
    ...
    function eK(a) {
      ...
      if (a.isLead() && a.layout && b && a.hasListeners('didUpdate')) {
        ...
        let h = S();
        f
          ? dM(h, a.applyTransform(d, !0), b.measuredBox)
          : dM(h, c, b.layoutBox);
        let i = !ew(g),
          j = !1;
        if (!a.resumeFrom) {
    ...
    function eW(a, b, c) {
      ((a.translate = bq(b.translate, 0, c)),
        (a.scale = bq(b.scale, 1, c)),
        (a.origin = b.origin),
        (a.originPoint = b.originPoint));
    }
    function eX(a, b, c, d) {
      ((a.min = bq(b.min, c.min, d)), (a.max = bq(b.max, c.max, d)));
    }
    function eY(a) {
    ...
    let eZ = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
      ...
      e_ = e$('applewebkit/') && !e$('chrome/') ? Math.round : av;
    function e0(a) {
      ((a.min = e_(a.min)), (a.max = e_(a.max)));
    }
    function e1(a, b, c) {
      return (
        'position' === a ||
        ('preserve-aspect' === a && !(0.2 >= Math.abs(eA(b) - eA(c))))
      );
    }
    function e2(a) {
    ...
    let e3 = eI({
        attachResizeListener: (a, b) => dI(a, 'resize', b),
        measureScroll: () => ({
          x:
    ...
    function e8(a) {
      return !('touch' === a.pointerType || dJ.x || dJ.y);
    }
    function e9(a, b, c) {
      let { props: d } = a;
      a.animationState &&
      ...
      let e = d['onHover' + c];
      e && az.postRender(() => e(b, dR(b)));
    }
    function fa(a) {
      return ed(a) && 'offsetHeight' in a;
    }
    (a.s(['resolveElements', () => e6], 12547),
      a.s(['isHTMLElement', () => fa], 88412));
    let fb = (a, b) => !!b && (a === b || fb(a, b.parentElement)),
      fc = new WeakSet();
    function fd(a) {
      return (b) => {
        'Enter' === b.key && a(b);
      ...
      fm = (function (a, b) {
        ...
        return new Proxy((a, b) => d(a, b), {
          get: (e, f) =>
            'create' === f
              ? d
              : (c.has(f) || c.set(f, b9(f, void 0, a, b)), c.get(f)),
        });
      })(
        {
          animation: {
            Feature: class extends ca {
                            ...
                            b.map(({ animation: b, options: c }) =>
                              (function (a, b, c = {}) {
                                ...
                                if (
                                  ...
                                  d = Promise.all(b.map((b) => dx(a, b, c)));
                                else if ('string' == typeof b) d = dx(a, b, c);
                                else {
                                  let e =
                                    'function' == typeof b
                                      ? cb(a, b, c.custom)
                                      : b;
                                  d = Promise.all(dv(a, e, c));
                                }
                                return d.then(() => {
                              ...
                              ...x.map((b) => {
                                ...
                                if (
                                  ...
                                  if (d.enteringChildren && e) {
                                    let { delayChildren: b } =
                                      e.transition || {};
                                    c.delay = dw(d.enteringChildren, a, b);
                                  }
                                }
              ...
              updateAnimationControlsSubscription() {
                ...
                a0(a) && (this.unmountControls = a.subscribe(this.node));
              }
              mount() {
              ...
              startObserver() {
                ...
                let { viewport: c = {} } = this.node.getProps(),
                  ...
                  h = {
                    ...
                    rootMargin: e,
                    threshold: 'number' == typeof f ? f : fl[f],
                  },
                  i = (a) => {
                ...
                return (
                  ...
                  (b = (function ({ root: a, ...b }) {
                    ...
                    return (
                      d[e] ||
                        (d[e] = new IntersectionObserver(fk, {
                          root: a,
                          ...b,
                        })),
                      d[e]
              ...
              mount() {
                ...
                a &&
                  (this.unmount = (function (a, b, c = {}) {
                    ...
                    a,
                    (a, b) => (
                      fg(this.node, b, 'Start'),
                      (a, { success: b }) =>
                        fg(this.node, a, b ? 'End' : 'Cancel')
                    ),
              ...
              mount() {
                ...
                a &&
                  (this.unmount = (function (a, b, c = {}) {
                    ...
                    a,
                    (a, b) => (
                      e9(this.node, b, 'Start'),
                      (a) => e9(this.node, a, 'End')
                    )
                  ));
              }
              unmount() {}
          ...
          pan: {
            Feature: class extends ca {
              constructor() {
                (super(...arguments), (this.removePointerDownListener = av));
              }
              onPointerDown(a) {
                this.session = new dW(a, this.createPanHandlers(), {
                  transformPagePoint: this.node.getTransformPagePoint(),
                  contextWindow: dT(this.node),
                });
              }
              createPanHandlers() {
                let {
                ...
                return {
                  ...
                  onMove: c,
                  onEnd: (a, b) => {
                    (delete this.session, d && az.postRender(() => d(a, b)));
                  },
                };
              }
              mount() {
                this.removePointerDownListener = dS(
                  this.node.current,
                  'pointerdown',
          ...
          drag: {
            Feature: class extends ca {
              constructor(a) {
                (super(a),
                  (this.removeGroupControls = av),
                  (this.removeListeners = av),
                  (this.controls = new d4(a)));
              }
              mount() {
                let { dragControls: a } = this.node.getProps();
                (a && (this.removeGroupControls = a.subscribe(this.controls)),
                  (this.removeListeners = this.controls.addListeners() || av));
              }
              update() {
                let { dragControls: a } = this.node.getProps(),
          ...
          layout: { ProjectionNode: e5, MeasureLayout: ec },
        },
        (a, b) =>
          (b.isSVG ?? bM(a))
            ? new bv(b)
            : new bI(b, { allowProjection: a !== bK.Fragment })
      );
    a.s(['motion', () => fm], 29474);
  },
];

//# sourceMappingURL=3f92f_framer-motion_dist_es_render_components_motion_proxy_mjs_ee80ce72._.js.map
