module.exports = [
  ...
  (a) => {
        ...
        let d = (0, c.useRef)(null),
          { galleryRef: e } = ((a, b = !0) => {
            ...
            return (
              (0, c.useEffect)(() => {
                if (!b) return;
                g.current || (g.current = document.querySelector('.gallery'));
                let c = a.current,
                  h = g.current;
                if (!c || !h) return;
                let i = () => {
                    h.style.height = `${c.clientHeight}px`;
                  },
                  j = () => {
                    let a, b;
                    ((a = d.current),
                      (b = e.current),
                      (d.current = 0.95 * a + 0.05 * b),
                      (c.style.transform = `translateY(-${d.current}px)`),
                      Math.abs(d.current - e.current) > 0.5
                        ? (f.current = requestAnimationFrame(j))
                        : (f.current = null));
                  },
                  k = () => {
                    ((e.current = window.scrollY),
              ...
              children: (0, b.jsx)('div', {
                ...
                children: i.map((c, d) =>
                  (0, b.jsx)(
                    ...
                    {
                      className: 'w-full',
                      children: (0, b.jsx)(h.ProjectCard, {
                        project: c,
                        index: d,
                        onClick: a,
                        priority: d < 3,
    ...
    var k = a.i(13088),
      ...
      o = a.i(47318),
      p = a.i(92392);
    let q = ({ isOpen: a, onClose: d, project: e }) =>
      ((0, n.useBodyLock)(a),
      (0, c.useEffect)(() => {
        let a = (a) => {
          'Escape' === a.key && d();
                    ...
                    (0, b.jsxs)(f.motion.div, {
                      ...
                      children: [
                        ...
                        (0, b.jsx)(f.motion.div, {
                          ...
                          children:
                            'A' === e.type
                              ? (0, b.jsx)(o.default, { project: e })
                              : (0, b.jsx)(p.default, { project: e }),
                        }),
                      ],
                    }),
                  ],
      ...
      return (0, b.jsxs)('main', {
        ...
        children: [
          ...
          (0, b.jsxs)('div', {
            ...
            children: [(0, b.jsx)(r.default, {}), (0, b.jsx)(s.default, {})],
          }),
          (0, b.jsx)(q, {
            isOpen: e,
            onClose: () => {
              (f(!1), setTimeout(() => d(null), 300));
            },
            project: a,
          }),
        ],
...
//# sourceMappingURL=_28cf382b._.js.map
