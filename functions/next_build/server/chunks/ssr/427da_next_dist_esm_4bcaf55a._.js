module.exports = [
  ...
  (a) => {
    ...
    let L = (a, b) => {
      ...
      Q =
        ...
        () => c);
    a.s(['SpanKind', () => I, 'getTracer', () => Q], 78470);
  },
  98748,
  (a) => {
    'use strict';
  ...
  (a) => {
    'use strict';
    (a.i(78470), a.i(51752), a.i(98748), a.i(23898));
    let b = {
      OPENING: {
    ...
    function c() {}
    (a.s(['ENCODED_TAGS', 0, b], 24300), a.i(52646));
  ...
  (a) => {
    ...
    (a.i(36185),
      ...
      a.s(['detectDomainLocale', () => e], 16884),
      a.s(['removeTrailingSlash', () => f], 99719));
  },
  571,
  (a) => {
    'use strict';
  ...
  (a) => {
    ...
    (a.s(['addPathPrefix', () => c], 76145),
      a.s(['addPathSuffix', () => d], 65581));
  },
  58101,
  (a) => {
    'use strict';
  ...
  (a) => {
    ...
    (a.s(['formatNextPathnameInfo', () => f], 64046),
      a.s(['getHostname', () => g], 63065));
    let h = new WeakMap();
    function i(a, b) {
      let c;
    ...
    a.s(['normalizeLocalePath', () => i], 33943);
  },
  57123,
  (a) => {
    'use strict';
  ...
  (a) => {
    ...
    a.s(['isAbortError', () => t, 'pipeToNodeResponse', () => u], 5378);
  },
  70508,
  (a) => {
    'use strict';
  ...
  (a) => {
    'use strict';
    (a.i(69657), a.i(49648), a.i(98332), a.i(23898), a.i(32927));
    var b = a.i(94879),
      c = a.i(5378),
      d = a.i(3305);
    class e {
...
//# sourceMappingURL=427da_next_dist_esm_4bcaf55a._.js.map
