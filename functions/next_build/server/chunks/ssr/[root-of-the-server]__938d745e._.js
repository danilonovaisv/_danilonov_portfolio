      ...
      let { type: f, content: g } = a,
        ...
        j = (a, c, d = '') => {
          ...
          let e = [
            ...
            f = c?.color && c.color.startsWith('#') ? c.color : null,
            g = f ? `md-text-${f.replace(/[^a-zA-Z0-9]/g, '')}` : '';
            ...
            children: [
              f &&
                (0, b.jsx)(h.default, {
                  id: '5dabeed32825af40',
                  dynamic: [g, f, g, f],
                  children: `.${g}{color:${f}}.${g} a{color:${f}}`,
                }),
              (0, b.jsx)('div', {
                className: `prose prose-invert max-w-none ${d} ${g}`,
                children: (0, b.jsx)(cA, {
                  components: {
                    p: ({ children: a }) =>
                      (0, b.jsx)('p', { className: e, children: a }),
                    h1: ({ children: a }) =>
                      (0, b.jsx)('h1', {
                    ...
                    ul: ({ children: a }) =>
                      (0, b.jsx)('ul', {
                        className: `${e} list-disc pl-6 mb-4 space-y-2 text-left`,
                        children: a,
                      }),
                    ol: ({ children: a }) =>
                      (0, b.jsx)('ol', {
                        className: `${e} list-decimal pl-6 mb-4 space-y-2 text-left`,
                        children: a,
                      }),
                    strong: ({ children: a }) =>
                      (0, b.jsx)('strong', {
    ...
    function cE({ project: a }) {
      let h =
          a.cover && !a.cover.startsWith('http')
            ...
            : a.cover,
        i = (0, f.useSearchParams)().get('from');
      return (0, b.jsxs)('div', {
        className:
...
//# sourceMappingURL=%5Broot-of-the-server%5D__938d745e._.js.map
