module.exports = [
  ...
  (a) => {
    ...
    let L = (a, b) => {
      ...
      Q =
        ...
        () => c);
    a.s(['SpanKind', () => I, 'getTracer', () => Q], 53442);
  },
  11847,
  (a) => {
    'use strict';
  ...
  (a) => {
    'use strict';
    (a.i(53442), a.i(54826), a.i(11847), a.i(29483));
    let b = {
      OPENING: {
    ...
    function c() {}
    (a.s(['ENCODED_TAGS', 0, b], 71564), a.i(28515));
  ...
  (a) => {
    ...
    (a.i(50989),
      ...
      a.s(['detectDomainLocale', () => e], 93670),
      a.s(['removeTrailingSlash', () => f], 52414));
  },
  31797,
  (a) => {
    'use strict';
  ...
  (a) => {
    ...
    (a.s(['addPathPrefix', () => c], 51451),
      a.s(['addPathSuffix', () => d], 73006));
  },
  97420,
  (a) => {
    'use strict';
  ...
  (a) => {
    ...
    (a.s(['formatNextPathnameInfo', () => f], 87031),
      a.s(['getHostname', () => g], 54784));
    let h = new WeakMap();
    function i(a, b) {
      let c;
    ...
    a.s(['normalizeLocalePath', () => i], 24806);
  },
  41221,
  (a) => {
    'use strict';
  ...
  (a) => {
    ...
    a.s(['isAbortError', () => t, 'pipeToNodeResponse', () => u], 73663);
  },
  46102,
  (a) => {
    'use strict';
  ...
  (a) => {
    ...
    (a.s(['default', () => e], 33460), a.i(5648), a.i(50989), a.s([], 55838));
  },
];

//# sourceMappingURL=11cf4_next_dist_esm_99c758ea._.js.map
