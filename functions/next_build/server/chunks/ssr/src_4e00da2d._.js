module.exports = [
  ...
  (a) => {
    ...
    var b = a.i(33845),
      ...
      i = a.i(89433);
    let j = g.z.object({
      title: g.z.string().min(3),
      slug: g.z.string().min(3),
      client_name: g.z.string().min(2),
      brand_name: g.z.string().optional(),
      year: g.z.coerce.number().int().optional(),
      project_type: g.z.string().min(2),
      short_label: g.z.string().optional(),
      description: g.z.string().optional(),
      featured_on_home: g.z.boolean().optional(),
      featured_on_portfolio: g.z.boolean().optional(),
      featured_home_order: g.z.coerce.number().int().optional().nullable(),
      featured_portfolio_order: g.z.coerce.number().int().optional().nullable(),
      is_published: g.z.boolean().optional(),
      landing_page_id: g.z.string().optional().nullable(),
    ...
    function k({
      ...
      let [m, n] = (0, c.useState)(null),
        [o, p] = (0, c.useState)(null),
        [q, r] = (0, c.useState)([]),
        [s, t] = (0, c.useState)(null),
        [u, v] = (0, c.useTransition)(),
        w = (0, d.useRouter)(),
        x = (0, f.useForm)({
          resolver: (0, e.zodResolver)(j),
          defaultValues: {
            title: a?.title ?? '',
            slug: a?.slug ?? '',
            ...
            year: a?.year ?? void 0,
            project_type: a?.project_type ?? 'Branding & Identity',
            short_label: a?.short_label ?? '',
            description: a?.description ?? '',
            featured_on_home: a?.featured_on_home ?? !1,
            featured_on_portfolio: a?.featured_on_portfolio ?? !1,
            featured_home_order: a?.featured_home_order ?? void 0,
            featured_portfolio_order: a?.featured_portfolio_order ?? void 0,
      ...
      return (0, b.jsxs)('form', {
        className: 'space-y-6',
        onSubmit: x.handleSubmit((b) => {
          (t(null),
            v(async () => {
              try {
                let c = (0, h.createClientComponentClient)(),
                  d = a?.thumbnail_path ?? null,
                  e = a?.hero_image_path ?? null,
                  f = Array.isArray(a?.gallery)
                    ? a?.gallery?.map((a) => ({ path: a.path }))
                    : [];
                if (
                  (m &&
                    (d = await (0, i.uploadToBucket)(
                      'portfolio-media',
                      `projects/${b.slug}`,
                      'thumb',
                      m
                  ...
                  for (let a of q) {
                    let c = await (0, i.uploadToBucket)(
                      'portfolio-media',
                      `projects/${b.slug}/gallery`,
                      a.name.replace(/\W+/g, '-'),
                      a
                    );
                    c && f.push({ path: c });
                ...
                let { tags: g = [], ...j } = b;
                '' === j.landing_page_id && (j.landing_page_id = null);
                let { data: k, error: l } = await c
                ...
                if (k?.id) {
                  await c
                    ...
                    .delete()
                    .eq('project_id', k.id);
                  let a = g.length > 0 ? g : y;
                  a.length > 0 &&
                    (await c
                      .from('portfolio_project_tags')
                      .insert(a.map((a) => ({ project_id: k.id, tag_id: a }))));
                }
                (w.push('/admin/trabalhos'), w.refresh());
              } catch (a) {
                t(
                  a instanceof Error
                    ? a.message
        ...
        children: [
              ...
              (0, b.jsxs)('label', {
                ...
                children: [
                  ...
                  (0, b.jsxs)('select', {
                    className:
                      'rounded-md bg-slate-900/60 border border-white/10 px-3 py-2 text-sm',
                    ...x.register('project_type'),
                    children: [
                      (0, b.jsx)('option', { children: 'Branding & Identity' }),
                      (0, b.jsx)('option', {
                        children: 'Campanhas & Advertising',
                      }),
                      (0, b.jsx)('option', { children: 'Web & Digital' }),
                      (0, b.jsx)('option', { children: 'Motion & Video' }),
                      (0, b.jsx)('option', {
            ...
            children: [
              ...
              (0, b.jsxs)('label', {
                ...
                children: [
                  (0, b.jsx)('input', {
                    type: 'checkbox',
                    ...x.register('featured_on_portfolio'),
                  }),
                  'Destaque Portfólio',
                ],
              }),
              ...
              (0, b.jsxs)('label', {
                ...
                children: [
                  ...
                  (0, b.jsx)('input', {
                    ...
                    className:
                      'rounded-md bg-slate-900/60 border border-white/10 px-3 py-2 text-sm',
                    ...x.register('featured_home_order'),
                  }),
                ],
              }),
              (0, b.jsxs)('label', {
                ...
                children: [
                  ...
                  (0, b.jsx)('input', {
                    ...
                    className:
                      'rounded-md bg-slate-900/60 border border-white/10 px-3 py-2 text-sm',
                    ...x.register('featured_portfolio_order'),
                  }),
                ],
              }),
            ],
              ...
              (0, b.jsxs)('label', {
                ...
                children: [
                  ...
                  (0, b.jsx)('input', {
                    type: 'file',
                    accept: 'image/*,video/*',
                    onChange: (a) => n(a.target.files?.[0] ?? null),
                  }),
                  a?.thumbnail_path &&
                    (0, b.jsx)('span', {
                      className: 'text-xs text-slate-400 break-all',
                      children: a.thumbnail_path,
                    }),
                ],
              }),
              (0, b.jsxs)('label', {
                ...
                children: [
                  ...
                  (0, b.jsx)('input', {
                    type: 'file',
                    accept: 'image/*',
                    onChange: (a) => p(a.target.files?.[0] ?? null),
                  }),
                  a?.hero_image_path &&
                    (0, b.jsx)('span', {
                      className: 'text-xs text-slate-400 break-all',
                      children: a.hero_image_path,
                    }),
                ],
              }),
              (0, b.jsxs)('label', {
                ...
                children: [
                  ...
                  (0, b.jsx)('input', {
                    ...
                    accept: 'image/*,video/*',
                    multiple: !0,
                    onChange: (a) => r(Array.from(a.target.files ?? [])),
                  }),
                  Array.isArray(a?.gallery) &&
                    a.gallery.length > 0 &&
                    (0, b.jsxs)('span', {
                      className: 'text-xs text-slate-400',
                      children: [a.gallery.length, ' itens já cadastrados'],
                    }),
                ],
              }),
            ],
                    ...
                    'label',
                    {
                      ...
                      children: [
                        (0, b.jsx)('input', {
                          type: 'checkbox',
                          value: a.id,
                          checked: y.includes(a.id),
                          onChange: (a) => {
                            let { checked: b, value: c } = a.target;
                            b
                              ? x.setValue('tags', [...y, c])
                              : x.setValue(
                                  'tags',
          ...
          (0, b.jsx)('button', {
            ...
            disabled: u,
            children: u ? 'Salvando...' : 'Salvar projeto',
          }),
        ],
      });
    }
