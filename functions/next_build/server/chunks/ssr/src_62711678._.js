  ...
  (a) => {
    ...
    function i({ children: a }) {
      ...
      (g(
        ...
        g('--logo-light-url', d.BRAND.assets.logos.logoLight),
        g('--logo-dark-url', d.BRAND.assets.logos.logoDark),
        g('--favicon-light-url', d.BRAND.assets.logos.favicon),
        g('--favicon-dark-url', d.BRAND.assets.logos.favicon));
      let h = d.BRAND.assets.logos.logoLight;
      return (0, b.jsxs)('html', {
        lang: 'pt-BR',
        'data-scroll-behavior': 'smooth',
        suppressHydrationWarning: !0,
        children: [
          (0, b.jsx)('head', { children: (0, b.jsx)(e, { logoUrl: h }) }),
          (0, b.jsxs)('body', {
            className:
            ...
            children: [
              ...
              (0, b.jsx)(f.default, { children: a }),
            ],
          }),
        ],
      });
    }
    a.s(['default', () => i, 'metadata', 0, g, 'viewport', 0, h], 27572);
  },
];

//# sourceMappingURL=src_62711678._.js.map
