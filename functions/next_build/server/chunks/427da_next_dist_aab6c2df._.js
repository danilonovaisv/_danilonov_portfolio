module.exports = [
  ...
  (e, t, a) => {
    'use strict';
    t.exports = e.r(5547).vendored['react-rsc'].ReactServerDOMTurbopackServer;
  },
  13658,
  (e, t, a) => {
    'use strict';
  ...
  (e) => {
    ...
    let y = (e) => (0, w.buildSupabaseStorageUrl)('site-assets', e),
      ...
      x = (e) => (0, w.buildSupabaseStorageUrl)('project-videos', e),
      C = {
        hero: {
          tag: '[BRAND AWARENESS]',
    ...
    (y('about/hero/about.hero.desktop_video.mp4'),
      ...
      x('video-heroPort.mp4'),
      x('video-heroPort-mobile.mp4'));
    var _ = e.i(23856),
      E = e.i(18954),
      S = e.i(13658);
    e.i(72432);
    ...
    (0, S.registerServerReference)(
      M,
      '40ad3f16a742876fb1293ccebc078fb87889a1ae37',
      null
    );
    let N = 'force-static';
    async function I() {
      let e = `https://${_.BRAND.domain}`,
        t = [];
      try {
        let a = (function () {
    ...
    e.s(['default', () => I, 'dynamic', 0, N], 63034);
    var D = e.i(49267);
    async function O() {
      let e = await I(),
        t = (0, D.resolveRouteData)(e, 'sitemap');
    ...
    let j = new t.AppRouteRouteModule({
      ...
      { workAsyncStorage: U, workUnitAsyncStorage: z, serverHooks: H } = j;
    function $() {
    ...
    async function F(e, t, i) {
      ...
      let {
        ...
        I = !!(E.dynamicRoutes[N] || E.routes[P]),
        D = async () => (
      ...
      if (I && !_) {
        let e = !!E.routes[P],
          t = E.dynamicRoutes[N];
        if (t && !1 === t.fallback && !e) {
          if (x.experimental.adapterPath) return await D();
          throw new b.NoFallbackError();
        }
      }
      let O = null;
      !I || j.isDev || _ || (O = '/index' === (O = P) ? '/' : O);
      let q = !0 === j.isDev || !I,
        U = I && !q;
      M &&
        T &&
      ...
      try {
            ...
            j.handle(W, F).finally(() => {
              ...
              if (i) {
                ...
                (e.setAttributes({
                  ...
                  e.updateName(t));
              } else e.updateName(`${z} ${v}`);
            }),
          s = !!(0, r.getRequestMeta)(e, 'minimalMode'),
          l = async (r) => {
            var o, l;
            let c = async ({ previousCacheEntry: a }) => {
                try {
                  if (!s && A && k && !a)
                    return (
                      (t.statusCode = 404),
                    ...
                    );
                  {
                    ...
                    (c && (t[h.NEXT_CACHE_TAGS_HEADER] = c),
                      !t['content-type'] &&
                        e.type &&
            ...
            let b = (0, m.fromNodeOutgoingHttpHeaders)(d.value.headers);
            return (
              (s && I) || b.delete(h.NEXT_CACHE_TAGS_HEADER),
              !d.cacheControl ||
                t.getHeader('Cache-Control') ||
                b.get('Cache-Control') ||
                b.set(
                  'Cache-Control',
                  (0, g.getCacheControlHeader)(d.cacheControl)
                ),
              await (0, p.sendResponse)(
                B,
                V,
        ...
        if (
          ...
          throw t;
        return (
          await (0, p.sendResponse)(B, V, new Response(null, { status: 500 })),
          null
        );
      }
    }
...
//# sourceMappingURL=427da_next_dist_aab6c2df._.js.map
