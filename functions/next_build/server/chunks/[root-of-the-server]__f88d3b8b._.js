module.exports = [
  ...
  (e) => {
    ...
    function t(e, t) {
      ...
      return (
        ...
        r && a.startsWith(`${r}/`) && (a = a.slice(r.length + 1)),
        a
      );
    }
    function r(e, r) {
      if (!r) return null;
      let a = r.startsWith('http://') || r.startsWith('https://'),
        n = r.includes('/storage/v1/');
      if (a && !n)
        try {
          let e = new URL(r);
          if ('https:' !== e.protocol)
      ...
      let s = e.replace(/^\/+|\/+$/g, ''),
        i = t(r, s);
      if (!i) return r.startsWith('http') ? r : null;
      if (a && n)
        try {
          let e = new URL(r),
            t = `${e.protocol}//${e.host}`;
          return `${t}/storage/v1/object/public/${s}/${i}`;
        } catch {}
      let l = (function () {
      ...
      return l
        ? `${l}/storage/v1/object/public/${s}/${i}`
        : r.startsWith('http')
          ? r
          : null;
    }
  ...
  (e) => {
    ...
    async function E() {
      ...
      let r = (0, R.createClient)(e, t, { auth: { persistSession: !1 } }),
      ...
      if (n)
        return (
          console.error('Supabase error:', n),
          m.NextResponse.json({ error: n.message }, { status: 500 })
        );
      let s = (function (e, t = {}) {
        let { onlyActive: r = !1, dropInvalid: a = !0 } = t,
          ...
          l = (e) => {
            ...
            let n = Math.min(3, Math.floor(a.length / 2));
            for (let e = 1; e <= n; e++)
              if (
          ...
          let e = (function (e) {
              let t = (e.bucket || 'site-assets')
                ...
                r = e.key
                  ...
                  .replace(/,+$/g, '')
                  .trim(),
                a = (0, y.normalizeStoragePath)(e.file_path, t),
                n = a
                  ...
                  : a,
                s =
                  'site-assets' === t && n?.startsWith('projects/')
                    ? 'portfolio-media'
                    : t,
                i = (e) => {
                  if (!e) return;
                ...
                l = i(e.page) || i(n) || i(r) || 'global',
                o =
                  (0, y.buildSupabaseStorageUrl)(s, n) ||
              ...
              if (e.href) {
                let t = (0, y.validateExternalUrl)(e.href);
                t && (u = { ...u, href: t });
              }
              return u;
            })({
            ...
            u = e.key?.trim();
          if (!u || (a && (i(u) || i(e.file_path))) || (r && !e.is_active))
            continue;
          let p = !!(e.publicUrl || 'font' === e.asset_type || e.href);
          if (a && !p) continue;
          let c = (e, t) => {
              if (!e) return t;
              let r = o(e),
        ...
        let u = new Map();
        for (let e of n.values()) u.set(e.id, e);
        for (let e of s.values()) u.set(e.id, e);
        return Array.from(u.values()).sort((e, t) => {
          let r = e.page ?? '',
            a = t.page ?? '';
          if (r === a) {
      ...
      return m.NextResponse.json(s, { status: 200 });
    }
    e.s(
      ['GET', () => E, 'dynamic', 0, 'force-static', 'revalidate', 0, 3600],
      18022
    );
    var w = e.i(18022);
    let b = new t.AppRouteRouteModule({
        definition: {
          ...
          page: '/api/site-assets/route',
          pathname: '/api/site-assets',
          filename: 'route',
          bundlePath: '',
        },
        distDir: '.next',
        relativeProjectDir: '',
        resolvedPagePath: '[project]/src/app/api/site-assets/route.ts',
        nextConfigOutput: '',
        userland: w,
      }),
      { workAsyncStorage: _, workUnitAsyncStorage: k, serverHooks: C } = b;
    function A() {
    ...
    async function $(e, t, a) {
      ...
      let R = '/api/site-assets/route';
      R = R.replace(/\/index$/, '') || '/';
      let m = await b.prepare(e, t, { srcPage: R, multiZoneDraftMode: !1 });
      if (!m)
        return (
          (t.statusCode = 400),
          t.end('Bad Request'),
      ...
      let {
        ...
        P = (0, l.normalizeAppPath)(R),
        T = !!(C.dynamicRoutes[P] || C.routes[N]),
        O = async () => (
          (null == A ? void 0 : A.render404)
            ? await A.render404(e, t, _, !1)
      ...
      if (T && !k) {
        let e = !!C.routes[N],
          t = C.dynamicRoutes[P];
        if (t && !1 === t.fallback && !e) {
          if (w.experimental.adapterPath) return await O();
          throw new v.NoFallbackError();
        }
      }
      let M = null;
      !T || b.isDev || k || (M = '/index' === (M = N) ? '/' : M);
      let q = !0 === b.isDev || !T,
        I = T && !q;
      j &&
        U &&
        ...
        D = {
          ...
          renderOpts: {
            ...
            onInstrumentationRequestError: (t, r, a, n) =>
              b.onRequestError(e, t, a, n, A),
          },
          sharedContext: { buildId: y },
        },
        F = new o.NodeNextRequest(e),
        K = new o.NodeNextResponse(t),
        B = u.NextRequestAdapter.fromNodeNextRequest(
          F,
          (0, u.signalFromNodeResponse)(t)
        );
      try {
        let i = async (e) =>
            b.handle(B, D).finally(() => {
              if (!e) return;
              e.setAttributes({
          ...
          o = async (n) => {
            ...
            let u = async ({ previousCacheEntry: r }) => {
                try {
                  ...
                  let o = D.renderOpts.pendingWaitUntil;
                  o && a.waitUntil && (a.waitUntil(o), (o = void 0));
                  let u = D.renderOpts.collectedTags;
                  if (!T)
                    return (
                      await (0, d.sendResponse)(
                        F,
                        K,
                        s,
                    ...
                    );
                  {
                    ...
                    let r =
                        void 0 !== D.renderOpts.collectedRevalidate &&
                        !(
                          D.renderOpts.collectedRevalidate >= g.INFINITE_CACHE
                        ) &&
                        D.renderOpts.collectedRevalidate,
                      a =
                        void 0 === D.renderOpts.collectedExpire ||
                        D.renderOpts.collectedExpire >= g.INFINITE_CACHE
                          ? void 0
            ...
            if (!T) return null;
            if (
              (null == p || null == (s = p.value) ? void 0 : s.kind) !==
              x.CachedRouteKind.APP_ROUTE
            )
              throw Object.defineProperty(
                Error(
                  `Invariant: app-route received invalid cache entry ${null == p || null == (o = p.value) ? void 0 : o.kind}`
                ),
                '__NEXT_ERROR_CODE',
            ...
            let v = (0, h.fromNodeOutgoingHttpHeaders)(p.value.headers);
            return (
              (l && T) || v.delete(g.NEXT_CACHE_TAGS_HEADER),
              !p.cacheControl ||
                t.getHeader('Cache-Control') ||
                v.get('Cache-Control') ||
                v.set(
                  'Cache-Control',
                  (0, f.getCacheControlHeader)(p.cacheControl)
                ),
              await (0, d.sendResponse)(
                F,
                K,
                new Response(p.value.body, {
                  headers: v,
                  status: p.value.status || 200,
                })
              ),
              null
            );
        ...
        if (
          ...
          throw t;
        return (
          await (0, d.sendResponse)(F, K, new Response(null, { status: 500 })),
          null
        );
      }
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f88d3b8b._.js.map
