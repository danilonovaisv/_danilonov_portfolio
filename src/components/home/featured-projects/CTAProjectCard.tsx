...
export default function CTAProjectCard() {
  ...
  return (
    <div className="group flex flex-col items-center justify-center h-full min-h-[300px] md:min-h-[400px] rounded-xl bg-[#06071f] border border-white/5 p-8 md:p-12 relative overflow-hidden">
