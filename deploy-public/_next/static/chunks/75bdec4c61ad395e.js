(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    let tt = () => {},
      te = () => {};
    (Q.default, t.s(['invariant', () => te, 'warning', () => tt], 22870));
    ...
    t.s(['velocityPerSecond', () => tK], 94605);
    ...
    t.s(['collectMotionValues', () => tG, 'motionValue', () => t_], 78005);
    let tZ = [..._, A, j],
      tJ = { current: null },
      tQ = { current: !1 };
    t.s(
    ...
    t.s(['initPrefersReducedMotion', () => t1], 33774);
    let t5 = new WeakMap();
    function t2(t) {
    ...
    class en {
      ...
      constructor(
        ...
        ((this.latestValues = a),
          ...
          (this.isControllingVariants = t8(e)),
          (this.isVariantNode = t7(e)),
    ...
    t.s(['LayoutGroupContext', () => eW], 11805);
    ...
    t.s(['MotionConfigContext', () => ez], 84149);
    ...
    (t.s(['PresenceContext', () => e0], 4054),
      t.s(['useConstant', () => e1], 82109));
    let e5 = (t) => (e, i) => {
    ...
    t.s(['useIsomorphicLayoutEffect', () => is], 98960);
    class io {
      constructor(t) {
    ...
    function i8(t, e, { clamp: i = !0, ease: n, mixer: s } = {}) {
      let o = t.length;
      if (
        (te(
          o === e.length,
    ...
    function i6({
      ...
      let r = Array.isArray(n) && 'number' != typeof n[0] ? n.map(i9) : i9(n),
        o = { done: !1, value: e[0] },
        a = i8(
          ((s = i && i.length === e.length ? i : i7(e)), s.map((e) => e * t)),
          e,
          {
    ...
    (t.s(['progress', () => i4], 53268),
      t.s(['interpolate', () => i8], 59323),
      t.s(['defaultOffset', () => i7], 82577));
    let nt = (t) => null !== t;
    ...
    let ni = { decay: iW, inertia: iW, tween: i6, keyframes: i6, spring: i$ };
    function nn(t) {
    ...
    t.s(['JSAnimation', () => no], 83437);
    let nl = na(() => void 0 !== window.ScrollTimeline);
    t.s(['supportsScrollTimeline', () => nl], 94301);
    let nh = {},
      nu =
        ((i = na(() => {
          try {
        ...
        (iu(t, e),
          n.start(
            nM(
              ...
              n,
              s,
              t.shouldReduceMotion && G.has(e) ? { type: !1 } : o,
              t,
              d
            )
          ));
      ...
      resolveConstraints() {
        ...
        (t && ii(t)
          ...
          (this.elastic = (function (t = 0.35) {
            return (
              !1 === t ? (t = 0) : !0 === t && (t = 0.35),
              { x: n8(t, 'left', 'right'), y: n8(t, 'top', 'bottom') }
            );
          })(e)),
          n !== this.constraints &&
            i &&
    ...
    function su(t, e, [i, n, s], r, o) {
      !(function (t, e = 0, i = 1, n = 0.5, s, r = t, o = t) {
        ...
        (t === r && (a -= e),
          (t.min = sh(t.min, e, i, a, s)),
          (t.max = sh(t.max, e, i, a, s)));
      })(t, e[i], e[n], e[s], e.scale, r, o);
    }
    let sd = ['x', 'scaleX', 'originX'],
      sc = ['y', 'scaleY', 'originY'];
    function sp(t, e, i, n) {
      (su(t.x, e, sd, i ? i.x : void 0, n ? n.x : void 0),
        su(t.y, e, sc, i ? i.y : void 0, n ? n.y : void 0));
    }
    function sm(t, e) {
    ...
    t.s(['isSVGElement', () => sL], 92880);
    let sj = (t, e) => t.depth - e.depth;
    class sF {
      constructor() {
      ...
      forEach(t) {
        (this.isDirty && this.children.sort(sj),
          (this.isDirty = !1),
    ...
    function sN({
      ...
      return class {
              ...
              this.addEventListener(
                ...
                ({
                  ...
                  let r =
                    ...
                    l = !this.targetLayout || !sT(this.targetLayout, n),
                    h = !e && i;
                  if (
        ...
        measurePageBox() {
          ...
          if (!(this.scroll?.wasRoot || this.path.some(s7))) {
        ...
        removeElementScroll(t) {
          let e = H();
          if ((sf(e, t), this.scroll?.wasRoot)) return e;
          for (let i = 0; i < this.path.length; i++) {
            ...
            n !== this.root &&
              s &&
              r.layoutScroll &&
              (s.wasRoot && sf(e, t), eL(e.x, s.offset.x), eL(e.y, s.offset.y));
          }
          return e;
        }
        ...
        removeTransform(t) {
          ...
          return (eV(this.latestValues) && sp(e, this.latestValues), e);
        }
        setTargetDelta(t) {
          ((this.targetDelta = t),
            ...
            (this.mixTargetDelta = (e) => {
              ...
              (l &&
                ...
                (function (t, e, i, n, s, r) {
                  s
                    ? ((t.opacity = ex(0, i.opacity ?? 1, sC(n))),
                      (t.opacityExit = ex(e.opacity ?? 1, 0, sk(n))))
        ...
        applyTransformsToTarget() {
          ...
          if (e && i && n) {
            if (
              ...
              this.layout &&
              n &&
              s8(this.options.animationType, this.layout.layoutBox, n.layoutBox)
            ) {
              i = this.target || H();
    ...
    function s8(t, e, i) {
      return (
        'position' === t ||
        ('preserve-aspect' === t && !(0.2 >= Math.abs(sP(e) - sP(i))))
      );
    }
    function s7(t) {
    ...
    (t.s(['resolveElements', () => ri], 54232),
      t.s(['isHTMLElement', () => ro], 877));
