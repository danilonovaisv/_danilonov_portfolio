  ...
  (e) => {
    ...
    function c() {
      ...
      return (0, t.jsx)('footer', {
        className:
          'w-full bg-[#0057FF] text-white lg:fixed lg:bottom-0 lg:left-0 lg:z-10 relative z-0 pb-[env(safe-area-inset-bottom,0)]',
    ...
    function z(
      ...
      return (
        ...
        () => {
          ...
          let i = D.get(a);
          (i && ((0, s.cancelFrame)(i), D.delete(a)), R.delete(a));
        }
      );
    }
    let V = new Map();
