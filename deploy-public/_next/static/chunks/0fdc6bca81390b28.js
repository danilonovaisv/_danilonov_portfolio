(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let i = (e) => (0, t.buildSupabaseStorageUrl)('site-assets', e),
      ...
      s = {
        hero: {
          video: {
            desktop: r('video-heroPort.mp4'),
            mobile: r('video-heroPort-mobile.mp4'),
          },
        },
      };
    e.s([
      ...
      let e = [
        {
          ...
          icon: (0, t.jsx)(o.Instagram, { className: 'w-5 h-5 lg:w-4 lg:h-4' }),
        },
        {
          label: 'LinkedIn',
          href: l.SOCIALS.linkedin,
          icon: (0, t.jsx)(n.Linkedin, { className: 'w-5 h-5 lg:w-4 lg:h-4' }),
        },
        {
          label: 'Twitter',
          href: l.SOCIALS.twitter,
          icon: (0, t.jsx)(s.Twitter, { className: 'w-5 h-5 lg:w-4 lg:h-4' }),
        },
      ];
          ...
          children: [
            (0, t.jsx)('div', {
              ...
              children: (0, t.jsx)('p', {
                ...
                children: l.NAVIGATION.footer.copyright,
              }),
            }),
            (0, t.jsx)('nav', {
              className:
              ...
              children: l.NAVIGATION.footer.links.map((e) =>
                (0, t.jsxs)(
                  r.default,
                  {
                    href: e.href,
  ...
  (e) => {
    ...
    var t = e.i(79606),
      i = e.i(52155),
      a = e.i(62897);
    let r = (0, e.i(3645).default)('arrow-up-right', [
      ['path', { d: 'M7 7h10v10', key: '1tivn9' }],
      ['path', { d: 'M7 17 17 7', key: '1vkiza' }],
    ]);
    (e.s(['ArrowUpRight', () => r], 91424),
      e.s(
        [
          'default',
          0,
          ({
            ...
            onClick: n,
            className:
              s = 'fixed bottom-20 right-4 sm:bottom-12 sm:right-8 lg:bottom-12 lg:right-12 z-100 md:z-50',
          }) => {
      ...
      `,
              ...
              children: [
                ...
                (0, t.jsx)(a.motion.div, {
                  className:
                    ' relative z-10  flex items-center justify-center  h-12 sm:h-14 lg:h-[68px] pl-5 pr-4 sm:pl-8 sm:pr-6 lg:pl-10 lg:pr-8 min-w-cta-mobile sm:min-w-cta-tablet lg:min-w-cta-desktop text-white  shadow-lg rounded-full select-none transition-colors duration-200 active:scale-[0.98] ',
    ...
    function z(
      ...
      return (
        ...
        () => {
          ...
          (M.delete(a),
            t &&
              (W(a).removeEventListener('scroll', t),
              q.get(a)?.(),
              window.removeEventListener('resize', t)));
          let i = R.get(a);
          (i && ((0, s.cancelFrame)(i), R.delete(a)), D.delete(a));
        }
      );
    }
    let V = new Map();
          ...
          function e(a, r, o, c) {
            ...
            if (void 0 !== o && !Array.isArray(o) && 'function' != typeof r) {
              ...
              let t = (0, i.useConstant)(() => Object.keys(u)),
                n = (0, i.useConstant)(() => ({}));
              for (let i of t) n[i] = e(d, m, u[i], g);
              return n;
            }
            let h = 'function' == typeof r ? r : (0, t.transform)(r, o, c);
            return Array.isArray(a) ? l(a, h) : l([a], ([e]) => h(e));
          },
      ],
      28046
    );
