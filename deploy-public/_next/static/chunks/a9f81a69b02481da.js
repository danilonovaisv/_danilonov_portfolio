(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function m({ children: e, isPresent: r, anchorX: s, anchorY: l, root: n }) {
      let a = (0, o.useId)(),
        m = (0, o.useRef)(null),
        f = (0, o.useRef)({
          width: 0,
      ...
      return (
        (0, o.useInsertionEffect)(() => {
          ...
          let u = 'left' === s ? `left: ${o}` : `right: ${c}`,
            h = 'bottom' === l ? `bottom: ${d}` : `top: ${i}`;
          m.current.dataset.motionPopId = a;
          let x = document.createElement('style');
          p && (x.nonce = p);
          let g = n ?? document.head;
          return (
            g.appendChild(x),
            x.sheet &&
              x.sheet.insertRule(`
    ...
    let f = ({
      ...
      return (
        ...
        (0, t.jsx)(n.PresenceContext.Provider, { value: b, children: e })
      );
    };
    function p() {
      return new Map();
    ...
    let v = ({
      ...
      if (y !== A) {
        ...
        for (let t = 0; t < T.length; t++) {
          let i = T[t],
            r = x(i);
          w.includes(r) || (e.splice(t, 0, i), $.push(i));
        }
        return ('wait' === d && $.length && (e = $), P(g(e)), E(y), null);
      }
      let { forceRender: O } = (0, i.useContext)(r.LayoutGroupContext);
          ...
          return (0, t.jsx)(
            f,
            {
              ...
              onExitComplete: r
                ? void 0
                : () => {
                    if (k.current.has(i) || (k.current.add(i), !C.has(i)))
                      return;
                    C.set(i, !0);
                    let e = !0;
                    (C.forEach((t) => {
  ...
  (e) => {
      ...
      let s = (0, r.useReducedMotion)(),
        c = () =>
          (0, t.jsxs)(t.Fragment, {
            children: [
              (0, t.jsxs)('div', {
                className: `card-shell relative overflow-hidden rounded-md w-full bg-white/5 transition-all duration-500 ${s ? '' : 'md:group-hover:shadow-[0_22px_54px_-12px_rgba(0,72,255,0.15)] md:group-hover:-translate-y-1 active:scale-[0.98]'}`,
                children: [
                  (0, t.jsx)('div', {
                    className:
                  ...
                  (0, o.isVideo)(e.image)
                    ...
                    : (0, t.jsx)(l.default, {
                        ...
                        className: `object-cover transition-transform duration-700 opacity-90 md:group-hover:opacity-100 ${s ? '' : 'md:group-hover:scale-103'}`,
                        loading: 'lazy',
              ...
              (0, t.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, t.jsx)('div', {
                    className: `w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center text-white shrink-0 border border-white/10 transition-all duration-700 bg-[#0048ff] ${s ? '' : 'md:group-hover:translate-x-5 md:group-hover:bg-[#8705f2] md:group-hover:shadow-[0_0_20px_rgba(135,5,242,0.4)]'}`,
                    children: (0, t.jsx)(n, {
                      className:
    ...
    function u() {
      return (0, t.jsxs)('div', {
        ...
        children: [
          ...
          (0, t.jsxs)('h3', {
            className:
              'relative z-10 text-3xl md:text-5xl lg:text-6xl font-normal text-center mb-6 md:mb-12 tracking-tight leading-[1.1] text-white transition-colors duration-300 md:group-hover:text-bluePrimary',
    ...
    var m = e.i(89764);
    let { duration: f, offset: p } = s.MOTION_TOKENS,
      h = [
    ...
    function x({ projects: e, onProjectOpen: l }) {
      let n = (0, r.useReducedMotion)(),
        a = e.filter((e) => e.isFeatured),
        o = {
          hidden: n ? {} : { opacity: 0, y: p.dramatic, filter: 'blur(4px)' },
          visible: n
            ? { opacity: 1 }
            : {
                opacity: 1,
                y: 0,
                filter: 'blur(0px)',
                transition: (0, s.ghostTransition)(0, f.normal),
              },
        };
      return (0, t.jsx)('section', {
        ...
        children: (0, t.jsx)(m.Container, {
          children: (0, t.jsxs)(i.motion.div, {
            ...
            variants: (0, s.staggerContainer)(0.12),
            className:
              'grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-4 md:gap-6',
            children: [
              a.slice(0, 4).map((e, r) => {
                if (!e) return null;
                let s = h[r] || 'md:col-span-4 lg:col-span-4';
                return (0, t.jsx)(
                  i.motion.div,
                  {
                    variants: o,
                    className: `w-full col-span-4 ${s}`,
  ...
  (e, t, i) => {
    ...
    function o({ moduleIds: e }) {
      ...
      return (0, r.jsx)(r.Fragment, {
        children: i.map((e) => {
          let i = `${t.assetPrefix}/_next/${(0, n.encodeURIPath)(e)}${o}`;
      ...
      c = function (e) {
        ...
        function d(e) {
          let a = c
              ...
              : null,
            o = !t.ssr || !!t.loading,
            d = o ? s.Suspense : s.Fragment,
            u = t.ssr
              ? (0, r.jsxs)(r.Fragment, {
                  children: [
                    'u' < typeof window
                      ? (0, r.jsx)(n.PreloadChunks, { moduleIds: t.modules })
                      : null,
                    (0, r.jsx)(i, { ...e }),
                  ],
                })
  ...
  (e) => {
    e.v({
      baseText: 'HeroCopy-module__777Cdq__baseText',
      ctaSpacer: 'HeroCopy-module__777Cdq__ctaSpacer',
      ghostAura: 'HeroCopy-module__777Cdq__ghostAura',
      heroSubtitle: 'HeroCopy-module__777Cdq__heroSubtitle',
      heroTitle: 'HeroCopy-module__777Cdq__heroTitle',
      isLoaded: 'HeroCopy-module__777Cdq__isLoaded',
      maskLayer: 'HeroCopy-module__777Cdq__maskLayer',
      maskText: 'HeroCopy-module__777Cdq__maskText',
      root: 'HeroCopy-module__777Cdq__root',
      subText: 'HeroCopy-module__777Cdq__subText',
      tag: 'HeroCopy-module__777Cdq__tag',
    });
  },
  82890,
  (e) => {
    ...
    let a = (e, t = 1) => {
      ...
      o = a(n.BRAND.colors.bluePrimary, 0.45),
      c = a(n.BRAND.colors.blueAccent, 0.6);
    function d({
      ready: e,
      onComplete: r,
      durationMs: a = 2e3,
    ...
    let j = {
      ...
      y = {
        ...
        animate: {
          opacity: 1,
          y: 0,
          transition: { duration: 0.8, ease: x.GHOST_EASE },
        },
      };
    function w({ ghostRef: e, isLoaded: r = !0 }) {
      var s;
      let n = (0, i.useRef)(null),
        a = (0, g.useReducedMotion)();
      ((s = r && !a),
        (0, i.useEffect)(() => {
          let t;
          if (!s || !e?.current || !n.current) return;
          let i = () => {
            ...
            let r = e.current.position,
              ...
              l = ((r.x + 10) / 20) * 100,
              a = 100 - ((r.y + 7) / 14) * 100;
            ((s.style.transform = `translate(calc(${l}vw - 50%), calc(${a}vh - 50%))`),
      ...
      let o = (e) =>
        (0, t.jsx)(v.Container, {
          className: e ? b.default.maskText : b.default.baseText,
          children: (0, t.jsxs)('div', {
            className: 'flex flex-col items-center',
            children: [
              (0, t.jsx)('span', {
                className: `block mb-3 lg:mb-4 tracking-[0.25em] uppercase font-bold text-accent text-micro ${e ? '' : b.default.tag}`,
                children: f.HOME_CONTENT.hero.tag,
              }),
              (0, t.jsxs)('h1', {
                className: `hidden lg:block mb-20 font-display ${b.default.heroTitle}`,
                children: [
                  f.HOME_CONTENT.hero.title[0].split(' ').slice(0, 2).join(' '),
                  ' ',
                  (0, t.jsx)('br', {}),
                  f.HOME_CONTENT.hero.title[0].split(' ').slice(2).join(' '),
                ],
              }),
              (0, t.jsxs)('h1', {
                className: `lg:hidden mb-12 font-display ${b.default.heroTitle}`,
                children: [
                  f.HOME_CONTENT.hero.title[0].split(' ').slice(0, 2).join(' '),
                  ' ',
                  (0, t.jsx)('br', {}),
                  f.HOME_CONTENT.hero.title[0].split(' ').slice(2, 4).join(' '),
                  ' ',
                  (0, t.jsx)('br', {}),
                  f.HOME_CONTENT.hero.title[0].split(' ').slice(4).join(' '),
                ],
              }),
              (0, t.jsx)('h2', {
                className: `font-h2 type-h2 mt-6 lg:mt-9 text-textSecondary ${e ? '' : 'opacity-80'} ${b.default.heroSubtitle}`,
                children: f.HOME_CONTENT.hero.subtitle,
              }),
            ],
          }),
        });
      return (0, t.jsxs)(l.motion.div, {
        ...(a ? {} : { initial: 'initial', animate: 'animate', variants: j }),
        className: `relative flex flex-col items-center justify-center text-center w-full pointer-events-auto ${b.default.root}`,
        children: [
          (0, t.jsxs)(l.motion.div, {
            ...
            children: [
              o(!1),
              (0, t.jsx)('div', { className: b.default.ctaSpacer }),
            ],
          }),
          !a &&
            (0, t.jsx)('div', {
              className: b.default.maskLayer,
              'aria-hidden': 'true',
          ...
          (0, t.jsx)('div', {
            ref: n,
            className: `${b.default.ghostAura} ${r ? b.default.isLoaded : ''}`,
          }),
        ],
      });
    }
    var N = e.i(54768);
    let _ = (0, r.default)(() => e.A(25891), {
      loadableGenerated: { modules: [99202] },
      ssr: !1,
      loading: () =>
    ...
    function C() {
      let e = (0, i.useRef)(null),
        [r, l] = (0, i.useState)(!1),
        n = (0, N.useMediaQuery)('(min-width: 1024px)');
      (0, i.useEffect)(() => {
        let e = setTimeout(() => l(!0), 2e3);
        return () => clearTimeout(e);
      }, []);
      let a = (0, i.useCallback)(() => l(!0), []);
      return (0, t.jsx)(t.Fragment, {
        children: (0, t.jsxs)('section', {
          ...
          children: [
            !n &&
              (0, t.jsx)('div', {
                className:
                  'absolute inset-0 z-0 bg-[radial-gradient(circle_at_50%_50%,#0a0029_0%,#040013_70%)] animate-pulse opacity-60',
              }),
            (0, t.jsx)(s.AnimatePresence, {
              children:
                !r &&
  ...
  (e) => {
    ...
    function g({
      ...
      return (0, t.jsx)(r.motion.div, {
        ...
        transition: { duration: 0.8, ease: p, delay: 0.12 * s },
            ...
            (0, t.jsxs)('div', {
              ...
              children: [
                ...
                (0, t.jsx)(r.motion.div, {
                  ...
                  transition: { duration: 0.7, ease: p },
                  children: (0, t.jsx)('div', {
                ...
                (0, t.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, t.jsx)(r.motion.div, {
                      ...
                      transition: { duration: 0.5, ease: p },
        ...
        children: (0, t.jsxs)(n.Container, {
          children: [
            ...
            (0, t.jsx)(r.motion.div, {
              ...
              whileInView: { opacity: 1, y: 0 },
              viewport: { once: !0 },
              transition: { duration: 0.6, ease: p, delay: 0.4 },
  ...
  (e) => {
    ...
    e.s(['VideoManifesto', () => s]);
  },
  25891,
  (e) => {
    e.v((t) =>
      Promise.all(
        ['static/chunks/c2f0fd629e36c623.js'].map((t) => e.l(t))
      ).then(() => t(99202))
    );
  },
]);
