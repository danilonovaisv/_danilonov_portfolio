(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function h({ children: e, isPresent: a, anchorX: s, anchorY: l, root: r }) {
      let o = (0, n.useId)(),
        ...
        { nonce: u } = (0, n.useContext)(c.MotionConfigContext),
        g = (function (...e) {
      ...
      return (
        (0, n.useInsertionEffect)(() => {
          ...
          let p = 'left' === s ? `left: ${n}` : `right: ${c}`,
            g = 'bottom' === l ? `bottom: ${d}` : `top: ${i}`;
    ...
    let y = ({
      ...
      let [b, v] = (0, g.usePresence)(p),
        j = (0, i.useMemo)(() => f(e), [e]),
        w = p && !b ? [] : j.map(x),
        N = (0, i.useRef)(!0),
        A = (0, i.useRef)(j),
        k = (0, s.useConstant)(() => new Map()),
        C = (0, i.useRef)(new Set()),
        [P, M] = (0, i.useState)(j),
        [R, S] = (0, i.useState)(j);
      (0, l.useIsomorphicLayoutEffect)(() => {
        ((N.current = !1), (A.current = j));
        for (let e = 0; e < R.length; e++) {
          let t = x(R[e]);
          w.includes(t)
            ? (k.delete(t), C.current.delete(t))
            : !0 !== k.get(t) && k.set(t, !1);
        }
      }, [R, w.length, w.join('-')]);
      let U = [];
      if (j !== P) {
        ...
        for (let t = 0; t < R.length; t++) {
          let i = R[t],
            a = x(i);
          w.includes(a) || (e.splice(t, 0, i), U.push(i));
        }
        return ('wait' === d && U.length && (e = U), S(f(e)), M(j), null);
      }
      let { forceRender: E } = (0, i.useContext)(a.LayoutGroupContext);
      return (0, t.jsx)(t.Fragment, {
        children: R.map((e) => {
          let i = x(e),
            a = (!p || !!b) && (j === R || w.includes(i));
          return (0, t.jsx)(
            m,
            {
              isPresent: a,
              ...
              onExitComplete: a
                ? void 0
                : () => {
                    if (C.current.has(i) || (C.current.add(i), !k.has(i)))
                      return;
                    k.set(i, !0);
                    let e = !0;
                    (k.forEach((t) => {
  ...
  (e) => {
    ...
    (e.s(['galleryProjects', 0, m, 'showcaseProjects', 0, h], 94808),
      e.s(
        [
          'ProjectsGallery',
          0,
  ...
  (e) => {
    ...
    var o = e.i(64529),
      ...
      h = e.i(19230),
      m = e.i(20631);
    let u = ({ isOpen: e, onClose: a, project: s }) =>
      ((0, p.useBodyLock)(e),
      (0, i.useEffect)(() => {
        let e = (e) => {
          'Escape' === e.key && a();
                    ...
                    (0, t.jsxs)(l.motion.div, {
                      ...
                      children: [
                        ...
                        (0, t.jsx)(l.motion.div, {
                          ...
                          children:
                            'A' === s.type
                              ? (0, t.jsx)(h.default, { project: s })
                              : (0, t.jsx)(m.default, { project: s }),
                        }),
                      ],
                    }),
                  ],
    ...
    function y() {
      ...
      return (0, t.jsxs)('main', {
        ...
        children: [
          (0, t.jsx)(r, {}),
          (0, t.jsx)(o.ProjectsGallery, {
            projects: f.showcaseProjects,
            onProjectSelect: (e) => {
              (a(e), l(!0));
            },
          }),
          (0, t.jsxs)('div', {
            ...
            children: [(0, t.jsx)(g.default, {}), (0, t.jsx)(x.default, {})],
          }),
          (0, t.jsx)(u, {
            isOpen: s,
            onClose: () => {
              (l(!1), setTimeout(() => a(null), 300));
            },
            project: e,
          }),
        ],
