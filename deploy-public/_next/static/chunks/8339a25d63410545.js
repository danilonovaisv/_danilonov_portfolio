(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let l = new s.OrthographicCamera(-1, 1, 1, -1, 0, 1);
    class u extends s.BufferGeometry {
      constructor() {
        (super(),
          this.setAttribute(
            'position',
            new s.Float32BufferAttribute([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)
          ),
          this.setAttribute(
            'uv',
            new s.Float32BufferAttribute([0, 2, 0, 0, 2, 0], 2)
          ));
      }
    }
    let h = new u();
    ...
    class m {
      constructor(e, t) {
        if (
          ...
          const i = e.getSize(new r.Vector2());
          ((this._width = i.width),
        ...
        ((this.renderTarget1 = t),
          ...
          (this.passes = []),
          (this.copyPass = new f(o)),
          (this.copyPass.material.blending = r.NoBlending),
      ...
      render(e) {
        ...
        for (let t = 0, r = this.passes.length; t < r; t++) {
          ...
          if (!1 !== r.enabled) {
            ...
            void 0 !== c &&
              (r instanceof c ? (i = !0) : r instanceof p && (i = !1));
          }
        }
      ...
      reset(e) {
        if (void 0 === e) {
          let t = this.renderer.getSize(new r.Vector2());
    ...
    class g extends n {
      constructor(e, t, i = null, a = null, o = null) {
        (super(),
          (this.scene = e),
          (this.camera = t),
    ...
    let v = {
      ...
      uniforms: {
        ...
        smoothWidth: { value: 1 },
        defaultColor: { value: new r.Color(0) },
    ...
    class w extends n {
      constructor(e, t = 1, i, a) {
        (super(),
          (this.strength = t),
          (this.radius = i),
          (this.threshold = a),
          (this.resolution =
            void 0 !== e ? new r.Vector2(e.x, e.y) : new r.Vector2(256, 256)),
          (this.clearColor = new r.Color(0, 0, 0)),
          (this.needsSwap = !1),
        ...
        ((this.highPassUniforms = r.UniformsUtils.clone(v.uniforms)),
          (this.highPassUniforms.luminosityThreshold.value = a),
          (this.highPassUniforms.smoothWidth.value = 0.01),
          (this.materialHighPassFilter = new r.ShaderMaterial({
        ...
        for (let e = 0; e < this.nMips; e++)
          (this.separableBlurMaterials.push(
            this._getSeparableBlurMaterial(l[e])
          ),
            (this.separableBlurMaterials[e].uniforms.invSize.value =
              new r.Vector2(1 / s, 1 / n)),
            (s = Math.round(s / 2)),
            (n = Math.round(n / 2)));
        ((this.compositeMaterial = this._getCompositeMaterial(this.nMips)),
          ...
          (this.compositeMaterial.uniforms.bloomTintColors.value =
            this.bloomTintColors),
          (this.copyUniforms = r.UniformsUtils.clone(o.uniforms)),
          (this.blendMaterial = new r.ShaderMaterial({
          ...
          (this._basic = new r.MeshBasicMaterial()),
          (this._fsQuad = new d(null)));
      }
      dispose() {
      ...
      setSize(e, t) {
        ...
        for (let e = 0; e < this.nMips; e++)
          (this.renderTargetsHorizontal[e].setSize(i, a),
            this.renderTargetsVertical[e].setSize(i, a),
            (this.separableBlurMaterials[e].uniforms.invSize.value =
              new r.Vector2(1 / i, 1 / a)),
            (i = Math.round(i / 2)),
            (a = Math.round(a / 2)));
      }
      render(e, t, i, r, a) {
      ...
      _getSeparableBlurMaterial(e) {
        let t = [],
          i = e / 3;
        for (let r = 0; r < e; r++)
          t.push((0.39894 * Math.exp((-0.5 * r * r) / (i * i))) / i);
        return new r.ShaderMaterial({
          defines: { KERNEL_RADIUS: e },
          uniforms: {
            colorTexture: { value: null },
            invSize: { value: new r.Vector2(0.5, 0.5) },
            direction: { value: new r.Vector2(0.5, 0.5) },
    ...
    ((w.BlurDirectionX = new r.Vector2(1, 0)),
      (w.BlurDirectionY = new r.Vector2(0, 1)));
    let M = {
      name: 'OutputShader',
      uniforms: {
        tDiffuse: { value: null },
    ...
    class y extends n {
      constructor() {
        (super(),
          (this.isOutputPass = !0),
          (this.uniforms = r.UniformsUtils.clone(M.uniforms)),
      ...
      render(e, t, i) {
        ((this.uniforms.tDiffuse.value = i.texture),
          ...
          (this._outputColorSpace !== e.outputColorSpace ||
            ...
            r.ColorManagement.getTransfer(this._outputColorSpace) ===
              r.SRGBTransfer && (this.material.defines.SRGB_TRANSFER = ''),
            this._toneMapping === r.LinearToneMapping
              ? (this.material.defines.LINEAR_TONE_MAPPING = '')
              : this._toneMapping === r.ReinhardToneMapping
                ? (this.material.defines.REINHARD_TONE_MAPPING = '')
                : this._toneMapping === r.CineonToneMapping
                  ? (this.material.defines.CINEON_TONE_MAPPING = '')
                  : this._toneMapping === r.ACESFilmicToneMapping
                    ? (this.material.defines.ACES_FILMIC_TONE_MAPPING = '')
                    : this._toneMapping === r.AgXToneMapping
                      ? (this.material.defines.AGX_TONE_MAPPING = '')
                      : this._toneMapping === r.NeutralToneMapping
                        ? (this.material.defines.NEUTRAL_TONE_MAPPING = '')
                        : this._toneMapping === r.CustomToneMapping &&
    ...
    function b() {
      ...
      return (
        (0, i.useEffect)(() => {
          ...
          let R = {
              ...
              updateProgress: (e) => {
                let t = Math.min(e, 5);
                s.current && (s.current.style.width = `${(t / 5) * 100}%`);
              },
              complete: (e) => {
                R.isComplete ||
                  ((R.isComplete = !0),
                  R.updateProgress(5),
                  setTimeout(() => {
                    (o.current && o.current.classList.add('fade-out'),
            ...
            E = new r.Scene(),
            D = new r.PerspectiveCamera(
              75,
              window.innerWidth / window.innerHeight,
              0.1,
              1e3
            );
          ((D.position.z = 20), R.updateProgress(1));
          ...
          (U.setSize(window.innerWidth, window.innerHeight),
            (U.toneMapping = r.ACESFilmicToneMapping),
            (U.toneMappingExposure = 0.9),
            U.setClearColor(0, 0),
            (U.domElement.style.position = 'absolute'),
            (U.domElement.style.top = '0'),
            (U.domElement.style.left = '0'),
            (U.domElement.style.zIndex = '0'),
            (U.domElement.style.pointerEvents = 'none'),
            (U.domElement.style.background = 'transparent'),
          ...
          B.addPass(F);
          let G = new w(
            new r.Vector2(window.innerWidth, window.innerHeight),
            0.3,
            1.25,
            0
          );
          (B.addPass(G), R.updateProgress(3));
          let N = new f({
            uniforms: {
              tDiffuse: { value: null },
              uTime: { value: 0 },
      ...
      `,
          ...
          let I = {
            ...
            O = new r.PlaneGeometry(300, 300),
            z = new r.ShaderMaterial({
              uniforms: {
                ghostPosition: { value: new r.Vector3(0, 0, 0) },
                revealRadius: { value: I.revealRadius },
                fadeStrength: { value: I.fadeStrength },
                baseOpacity: { value: I.baseOpacity },
                revealOpacity: { value: I.revealOpacity },
                time: { value: 0 },
              },
              vertexShader: `
        varying vec2 vUv;
      ...
      `,
            ...
            j = new r.Mesh(O, z);
          ((j.position.z = -50), (j.renderOrder = -100), E.add(j));
          let H = new r.AmbientLight(657966, 0.08);
          E.add(H);
          let W = new r.Group();
          E.add(W);
          let k = new r.SphereGeometry(2, 40, 40),
            Q = k.getAttribute('position').array;
          for (let e = 0; e < Q.length; e += 3)
            if (Q[e + 1] < -0.2) {
              let t = Q[e],
                i = Q[e + 2],
                r = 0.35 * Math.sin(5 * t),
                a = 0.25 * Math.cos(4 * i),
                o = 0.15 * Math.sin((t + i) * 3);
              Q[e + 1] = -2 + r + a + o;
            }
          k.computeVertexNormals();
          let q = new r.MeshStandardMaterial({
              color: I.bodyColor,
              transparent: !0,
              opacity: I.ghostOpacity,
              emissive: L[I.glowColor],
            ...
            K = new r.Mesh(k, q);
          W.add(K);
          let X = new r.DirectionalLight(4886754, I.rimLightIntensity);
          (X.position.set(-8, 6, -4), E.add(X));
          let J = new r.DirectionalLight(5301186, 0.7 * I.rimLightIntensity);
          (J.position.set(8, -4, -6), E.add(J), R.updateProgress(4));
          let Y =
              ((l = new r.Group()),
              W.add(l),
              (u = new r.SphereGeometry(0.45, 16, 16)),
              (h = new r.MeshBasicMaterial({ color: 0 })),
              (d = new r.Mesh(u, h)).position.set(-0.7, 0.6, 1.9),
              d.scale.set(1.1, 1, 0.6),
              l.add(d),
              (c = new r.Mesh(u, h)).position.set(0.7, 0.6, 1.9),
              c.scale.set(1.1, 1, 0.6),
              l.add(c),
              (p = new r.SphereGeometry(0.3, 12, 12)),
              (v = new r.MeshBasicMaterial({
                color: L[I.eyeGlowColor],
                transparent: !0,
                opacity: 0,
              })),
              (M = new r.Mesh(p, v)).position.set(-0.7, 0.6, 2),
              l.add(M),
              ...
              (x = new r.Mesh(p, b)).position.set(0.7, 0.6, 2),
              l.add(x),
              (T = new r.SphereGeometry(0.525, 12, 12)),
              ...
              (S = new r.Mesh(T, C)).position.set(-0.7, 0.6, 1.95),
              l.add(S),
              ...
              (P = new r.Mesh(T, _)).position.set(0.7, 0.6, 1.95),
              l.add(P),
              {
                leftEyeMaterial: v,
                rightEyeMaterial: b,
                leftOuterGlowMaterial: C,
                rightOuterGlowMaterial: _,
              }),
            $ = [],
            Z = new r.Group();
          E.add(Z);
          let ee = n.fireflyCount;
          for (let e = 0; e < ee; e++) {
            let e = new r.SphereGeometry(0.02, 2, 2),
            ...
            let a = new r.SphereGeometry(0.08, 8, 8),
              ...
              s = new r.Mesh(a, o);
            i.add(s);
            let n = new r.PointLight(0xffff44, 0.8, 3, 2);
            (i.add(n),
              (i.userData = {
                velocity: new r.Vector3(
                  (Math.random() - 0.5) * I.fireflySpeed,
                  (Math.random() - 0.5) * I.fireflySpeed,
                  (Math.random() - 0.5) * I.fireflySpeed
                ),
          ...
          let er = [],
            ea = [
              new r.SphereGeometry(0.05, 6, 6),
              new r.TetrahedronGeometry(0.04, 0),
              new r.OctahedronGeometry(0.045, 0),
            ],
            eo = new r.MeshBasicMaterial({
              color: L[I.particleColor],
              transparent: !0,
              opacity: 0,
              alphaTest: 0.1,
            });
          for (let e = 0; e < 100; e++) {
            let e = ea[Math.floor(Math.random() * ea.length)],
              t = new r.Mesh(e, eo.clone());
            ((t.visible = !1), ei.add(t), er.push(t));
          }
          function es() {
            let e;
            if (er.length > 0) (e = er.pop()) && (e.visible = !0);
            else {
              if (!(et.length < I.particleCount)) return null;
              let t = ea[Math.floor(Math.random() * ea.length)];
              ((e = new r.Mesh(t, eo.clone())), ei.add(e));
            }
            if (!e) return null;
            let t = new r.Color(L[I.particleColor]);
            ...
            (e.scale.set(a, a, a),
              ...
              (e.userData.life = 1),
              (e.userData.decay = 0.003 * Math.random() + I.particleDecayRate),
          ...
          let en = 'ontouchstart' in window || navigator.maxTouchPoints > 0,
          ...
          window.addEventListener('scroll', ed, { passive: !0 });
          let ef = new r.Vector2(),
            ec = !1,
            ep = (e, i) => {
              ((ec = !0),
                (ef.x = (e / window.innerWidth) * 2 - 1),
                (ef.y = -(2 * (i / window.innerHeight)) + 1),
                clearTimeout(t),
                (t = setTimeout(() => {
                  ec = !1;
                }, 3e3)));
            ...
            em = (e) => {
              ep(e.clientX, e.clientY);
            },
            eg = (e) => {
              e.touches.length > 0 &&
                ep(e.touches[0].clientX, e.touches[0].clientY);
            };
          (window.addEventListener('mousemove', em),
            window.addEventListener('touchstart', eg, { passive: !0 }),
            window.addEventListener('touchmove', eg, { passive: !0 }));
          let ev = () => {
            ((D.aspect = window.innerWidth / window.innerHeight),
              ...
              N.uniforms.uResolution.value.set(
                window.innerWidth,
                window.innerHeight
              ));
          };
          ...
          (R.updateProgress(5),
            setTimeout(() => {
              for (let e = 0; e < 3; e++) B.render();
              for (let e = 0; e < 10; e++) es();
              (B.render(), (eb = !0), R.complete(U.domElement));
            }, 100));
          let eT = (e) => {
            let t, r;
            if (((i = requestAnimationFrame(eT)), !eb)) return;
            let a = e - eM;
            if (((eM = e), a > 100)) return;
            ((ew += (a / 16.67) * 0.01),
              (z.uniforms.time.value = ew),
              (N.uniforms.uTime.value = ew),
              (N.uniforms.uLimboMode.value = +!!I.limboMode));
            let o = 9 * Math.sin(0.85 * ew) + 2 * Math.cos(0.85 * ew * 0.5),
              s =
                6 * Math.sin(0.85 * ew * 0.7 + Math.PI / 2) +
                1.5 * Math.sin(0.85 * ew * 1.3);
            ec
              ? ((t = 12 * ef.x + 0.1 * o),
                (r = 8 * ef.y + 0.1 * s + -((eh / window.innerHeight) * 15)))
              : ((t = o), (r = s + -((eh / window.innerHeight) * 15)));
            let l = W.position.clone();
            ((W.position.x += (t - W.position.x) * I.followSpeed),
              (W.position.y += (r - W.position.y) * I.followSpeed),
              z.uniforms.ghostPosition.value.copy(W.position));
            let u = l.distanceTo(W.position);
            ((ey = ey * I.eyeGlowDecay + u * (1 - I.eyeGlowDecay)),
              (W.position.y += 0.03 * Math.sin(ew * I.floatSpeed * 1.5)));
            let h = Math.sin(ew * I.pulseSpeed) * I.pulseIntensity;
            q.emissiveIntensity = I.emissiveIntensity + h;
            let d = ey > I.movementThreshold,
              f = d ? 2 * I.eyeGlowResponse : I.eyeGlowResponse,
              c =
                Y.leftEyeMaterial.opacity +
                (!!d - Y.leftEyeMaterial.opacity) * f;
            ((Y.leftEyeMaterial.opacity = c),
              (Y.rightEyeMaterial.opacity = c),
              (Y.leftOuterGlowMaterial.opacity = 0.3 * c),
              (Y.rightOuterGlowMaterial.opacity = 0.3 * c),
              (eu
                ? ey > 0.003
                : I.createParticlesOnlyWhenMoving
                  ? ey > 0.005 && ec
                  : ey > 0.005) &&
                e - ex > 100 &&
                (Array.from({
                  length: Math.min(
                    I.particleCreationRate,
                    Math.max(1, Math.floor(100 * u))
                  ),
                }).forEach(() => es()),
                (ex = e)),
              et.forEach((e) => {
                ...
                ((t.opacity = 0.85 * e.userData.life),
                  e.userData.velocity &&
                    ...
                    (e.position.x += 8e-4 * Math.cos(1.8 * ew + e.position.y))),
                  e.userData.rotationSpeed &&
                    ((e.rotation.x += e.userData.rotationSpeed.x),
                    (e.rotation.y += e.userData.rotationSpeed.y),
                    (e.rotation.z += e.userData.rotationSpeed.z)),
                  e.userData.life <= 0 &&
                    ((e.visible = !1), (t.opacity = 0), er.push(e)));
              }));
            for (let e = et.length - 1; e >= 0; e--)
              et[e].visible || et.splice(e, 1);
            n.enablePostProcessing ? B.render() : U.render(E, D);
          };
          return (
            eT(0),
            () => {
              (window.removeEventListener('scroll', ed),
                window.removeEventListener('mousemove', em),
                window.removeEventListener('touchstart', eg),
                window.removeEventListener('touchmove', eg),
                ...
                k.dispose(),
                q.dispose(),
                Y.leftEyeMaterial.dispose(),
                Y.rightEyeMaterial.dispose(),
                Y.leftOuterGlowMaterial.dispose(),
                Y.rightOuterGlowMaterial.dispose(),
                $.forEach((e) => {
                  (e.geometry.dispose(),
                    e.material.dispose(),
                ...
                G.dispose && G.dispose(),
                F.dispose && F.dispose(),
                A && U.domElement && A.removeChild(U.domElement));
            }
          );
        }, []),
        (0, t.jsxs)(t.Fragment, {
