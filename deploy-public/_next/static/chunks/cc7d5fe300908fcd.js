(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var c = e.i(62897),
      ...
      b = e.i(19230),
      y = e.i(20631);
    let { offset: v } = u.MOTION_TOKENS;
    function j({ project: e, isOpen: s, onClose: a }) {
      ...
      if (!l) return null;
      let j = (0, t.jsx)(p.AnimatePresence, {
        mode: 'wait',
        children:
          s &&
          e &&
            ...
            children: [
              ...
              (0, t.jsx)(
                c.motion.div,
                {
                  ...
                  initial: m ? { opacity: 0 } : { opacity: 0, y: v.large },
                  animate: { opacity: 1, y: 0 },
                  exit: m ? { opacity: 0 } : { opacity: 0, y: v.standard },
                  transition: (0, u.ghostTransition)(
                    0.12 * !m,
                    m ? 0.15 : 0.26
                  ),
      ...
      return (0, h.createPortal)(j, document.body);
    }
    var w = e.i(74177);
    let N = function ({ projects: e, onProjectSelect: s }) {
    ...
    function k({ projects: e }) {
      ...
      return (0, t.jsxs)('div', {
        ...
        children: [
          (0, t.jsx)(o, {}),
          (0, t.jsx)(N, { projects: e, onProjectSelect: n }),
          (0, t.jsx)(j, { project: s, isOpen: l, onClose: c }),
          (0, t.jsx)(w.SiteClosure, {}),
        ],
      });
    }
    e.s(['default', () => k], 88048);
