(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    'use strict';
    let t = (0, e.i(16424).default)('arrow-up-right', [
      ['path', { d: 'M7 7h10v10', key: '1tivn9' }],
      ['path', { d: 'M7 17 17 7', key: '1vkiza' }],
    ]);
    e.s(['ArrowUpRight', () => t], 45439);
  },
  68164,
  (e) => {
    'use strict';
    ...
    e.s([
      ...
      ({
        ...
        onClick: n,
        className:
          s = 'fixed bottom-8 right-8 lg:bottom-12 lg:right-12 z-100 md:z-50',
      }) => {
      ...
      `,
          ...
          children: [
            ...
            (0, t.jsx)(a.motion.div, {
              ...
              animate: l ? 'hover' : 'initial',
              transition: m,
              children: (0, t.jsx)(r.ArrowUpRight, {
                size: 28,
                strokeWidth: 2.5,
                strokeLinecap: 'round',
  ...
  (e) => {
      ...
      p = (e, t, i) => (a, r) =>
        r && r[0]
          ...
          : (0, d.isSVGElement)(a) && 'getBBox' in a
            ? a.getBBox()[t]
            : a[i],
      g = p('inline', 'width', 'offsetWidth'),
      h = p('block', 'height', 'offsetHeight');
    function f({ target: e, borderBoxSize: t }) {
      u.get(e)?.forEach((i) => {
        i(e, {
          get width() {
            return g(e, t);
    ...
    function N(e, t, i, a) {
      let r = i[t],
        ...
        s = r.current,
        l = i.time;
      ((r.current = e[`scroll${n}`]),
        (r.scrollLength = e[`scroll${o}`] - e[`client${o}`]),
        (r.offset.length = 0),
        (r.offset[0] = 0),
        (r.offset[1] = r.scrollLength),
        (r.progress = (0, v.progress)(0, r.scrollLength, r.current)));
      let c = a - l;
      r.velocity = c > 50 ? 0 : (0, w.velocityPerSecond)(r.current - s, c);
    }
    e.i(74920);
    var C = e.i(59323),
      S = e.i(82577),
    ...
    function W(
      ...
      if (!a) return n.noop;
      let l = R.get(a);
      l || ((l = new Set()), R.set(a, l));
      let c = (function (e, t, i, a = {}) {
        return {
          measure: (t) => {
            (!(function (e, t = e, i) {
              ...
              (a.offset || a.target) &&
                (function (e, t, i) {
                  ...
                  for (let e = 0; e < m; e++) {
                    ...
                    (d || i === t[o].interpolatorOffsets[e] || (d = !0),
                      (t[o].offset[e] = i));
                  }
                  (d &&
                    ((t[o].interpolate = (0, C.interpolate)(
                      t[o].offset,
                      (0, S.defaultOffset)(a),
                      { clamp: !1 }
                    )),
                    (t[o].interpolatorOffsets = [...t[o].offset])),
                    (t[o].progress = (0, O.clamp)(
                      0,
                      1,
      ...
      })(a, e, { time: 0, x: y(), y: y() }, o);
      if ((l.add(c), !T.has(a))) {
        let e,
          r = () => {
            for (let e of l) e.measure(s.frameData.timestamp);
            s.frame.preUpdate(o);
          },
          o = () => {
            ...
            q.set(
              ...
              'function' == typeof a
                ...
                : (!t &&
                  ...
                  (e = (0, m.resolveElements)(a)).forEach((e) => {
                    let i = u.get(e);
                    (i || ((i = new Set()), u.set(e, i)),
                      i.add(n),
                      t?.observe(e));
                  }),
                  () => {
                    e.forEach((e) => {
                      let i = u.get(e);
                      (i?.delete(n), i?.size || t?.unobserve(e));
                    });
                  })
            ),
      ...
      if (r && !D.has(a)) {
        let e = T.get(a),
          t = { width: a.scrollWidth, height: a.scrollHeight };
        F.set(a, t);
        let i = s.frame.read(() => {
          let i = a.scrollWidth,
            r = a.scrollHeight;
          (t.width !== i || t.height !== r) &&
            (e(), (t.width = i), (t.height = r));
        }, !0);
        D.set(a, i);
      }
      let d = T.get(a);
      return (
        ...
        () => {
          ...
          (T.delete(a),
            t &&
              (z(a).removeEventListener('scroll', t),
              q.get(a)?.(),
              window.removeEventListener('resize', t)));
          let i = D.get(a);
          (i && ((0, s.cancelFrame)(i), D.delete(a)), F.delete(a));
        }
      );
    }
    let V = new Map();
    function _({ source: e, container: t, ...i }) {
      var a;
      let r,
        o,
        { axis: n } = i;
      e && (t = e);
      let s = V.get(t) ?? new Map();
      V.set(t, s);
      let l = i.target ?? 'self',
        d = s.get(l) ?? {},
        m = n + (i.offset ?? []).join(',');
          ...
          (d[m] =
            !i.target && (0, c.supportsScrollTimeline)()
              ...
              : ((a = { container: t, ...i }),
                (r = { value: 0 }),
                (o = W((e) => {
                  r.value = 100 * e[a.axis].progress;
                }, a)),
                { currentTime: r, cancel: o })),
        d[m]
      );
    }
    var B = e.i(82109),
    ...
    let P = () => ({
      ...
      $ = (e) => !!e && !e.current;
    function U({ container: e, target: t, ...i } = {}) {
      let a = (0, B.useConstant)(P),
        s = (0, o.useRef)(null),
        c = (0, o.useRef)(!1),
        d = (0, o.useCallback)(
          () => (
  ...
  (e) => {
    ...
    var t = e.i(78005),
      ...
      r = e.i(82109);
    function o(e) {
      let o = (0, r.useConstant)(() => (0, t.motionValue)(e)),
        { isStatic: n } = (0, i.useContext)(a.MotionConfigContext);
      if (n) {
        let [, t] = (0, i.useState)(e);
        (0, i.useEffect)(() => o.on('change', t), []);
      }
      return o;
    }
  ...
  (e) => {
    ...
    function n(e, t) {
      ...
      return (
        ...
        (0, r.useIsomorphicLayoutEffect)(() => {
          ...
          return () => {
            (i.forEach((e) => e()), (0, a.cancelFrame)(n));
          };
        }),
        i
      );
    ...
    var s = e.i(78005);
    function l(e, t) {
      let a = (0, i.useConstant)(() => []);
      return n(e, () => {
        a.length = 0;
        let i = e.length;
        for (let t = 0; t < i; t++) a[t] = e[t].get();
        return t(a);
      });
    }
    e.s(
          ...
          function e(a, r, o, c) {
            if ('function' == typeof a) {
              ...
              return (
                ...
                a(),
                (e = n(s.collectMotionValues.current, a)),
            ...
            if (void 0 !== o && !Array.isArray(o) && 'function' != typeof r) {
              var d = a,
                ...
                u = o,
                p = c;
              let t = (0, i.useConstant)(() => Object.keys(u)),
                n = (0, i.useConstant)(() => ({}));
              for (let i of t) n[i] = e(d, m, u[i], p);
              return n;
            }
            let g = 'function' == typeof r ? r : (0, t.transform)(r, o, c);
            return Array.isArray(a) ? l(a, g) : l([a], ([e]) => g(e));
          },
      ],
      35315
    );
  ...
  (e) => {
    ...
    function c(e, d = {}) {
      return (function (e, c = {}) {
        let { isStatic: d } = (0, o.useContext)(n.MotionConfigContext),
          m = () => ((0, i.isMotionValue)(e) ? e.get() : e);
        if (d) return (0, l.useTransform)(m);
        let u = (0, s.useMotionValue)(m());
        return (
            ...
            () =>
              (function (e, o, n = {}) {
                let s,
                  ...
                  c = null,
                  d = l,
                  m = 'string' == typeof l ? l.replace(/[\d.-]/g, '') : void 0,
                  u = () => {
                    c && (c.stop(), (c = null));
                  };
                if (
  ...
  (e) => {
    ...
    let t = [0.22, 1, 0.36, 1],
      ...
      a = {
        ...
        visible: {
          opacity: 1,
          filter: 'blur(0px)',
          transition: { duration: i.duration.normal, ease: t },
        },
      },
      r = {
        hidden: { opacity: 0, y: i.offset.standard, filter: 'blur(6px)' },
        visible: {
          opacity: 1,
          y: 0,
          filter: 'blur(0px)',
    ...
    (i.duration.slow,
      ...
      e.s([
        ...
        'ghostTransition',
        0,
        (e = 0, a = i.duration.normal) => ({ duration: a, delay: e, ease: t }),
        'riseSoft',
        0,
        r,
        'staggerContainer',
  ...
  (e) => {
    ...
    var t = e.i(54962),
      ...
      a = e.i(84833);
    function r() {
      t.hasReducedMotionListener.current || (0, i.initPrefersReducedMotion)();
      let [e] = (0, a.useState)(t.prefersReducedMotion.current);
      return e;
    }
  ...
  (e) => {
    'use strict';
    var t = e.i(62596);
    let i = (e) => (0, t.buildSupabaseStorageUrl)('site-assets', e),
      a = (e) => (0, t.buildSupabaseStorageUrl)('portfolio-media', e),
      r = {
        hero: {
          tag: '[BRAND AWARENESS]',
          ...
          categories: [
            {
              ...
              titleMobile: 'Brand &\nCampaigns',
              align: 'end',
              thumb: i('home/showcase/Branding-Project.webp'),
            },
            {
              id: 'videos-motions',
              label: 'Videos & Motion',
              ...
              titleMobile: 'Videos &\nMotion',
              align: 'center',
              thumb: i('home/showcase/Key-Visual.webp'),
            },
            {
              ...
              align: 'start',
              thumb: i('home/showcase/webdesigner-2.gif'),
            },
          ],
        },
        featuredProjects: [
          {
            ...
            img: a('projects/creative-direction/hero.webp'),
            layout: {
          ...
          },
          {
            ...
            img: a('projects/campaign/hero.webp'),
            layout: {
              h: 'min-h-[400px] md:h-[500px] aspect-[4/5] md:aspect-auto',
              cols: 'md:col-span-7',
          ...
          },
          {
            ...
            year: 2021,
            tags: ['Art Direction'],
            img: a('projects/key-vision/gallery/converted-5-webp.webp'),
            layout: {
          ...
          },
          {
            ...
            img: a('projects/key_vision/hero.webp'),
            layout: {
        ...
        clients: {
          ...
          logos: Array.from({ length: 12 }, (e, t) => ({
            id: t + 1,
            src: i(`clients/clients.strip.${t + 1}.svg`),
      ...
      o = {
        hero: {
          ...
          videos: {
            desktop: i('about/hero/about.hero.desktop_video.mp4'),
            mobile: i('about/hero/about.hero.mobile_video.mp4'),
          },
        },
        beliefsIntro: [
          { text: 'Acredito no ' },
          ...
          blocks: [
            {
              ...
              description: '',
              src: i('about/origin/about.origin_image.1.webp'),
            ...
            },
            {
              ...
              description: '',
              src: i('about/origin/about.origin_image.2.webp'),
            ...
            },
            {
              ...
              description: '',
              src: i('about/origin/about.origin_image.3.webp'),
            ...
            },
            {
              ...
              description: '',
              src: i('about/origin/about.origin_image.4.webp'),
        ...
        method: {
          ...
          videos: {
            desktop: i('about/method/about.method.desktop_video.mp4'),
            mobile: i('about/method/about.method.mobile_video.mp4'),
          },
          intro: [
      ...
      n = {
        hero: {
          video: {
            desktop: i('portfolio/portfolio.hero_desktop_video.mp4'),
            mobile: i('portfolio/portfolio.hero_mobile_video.mp4'),
          },
        },
      };
    e.s([
  ...
  (e) => {
    ...
    var t = e.i(96148),
      i = e.i(18853);
    function a({ children: e, className: a, as: r = 'div', ...o }) {
      return (0, t.jsx)(r, {
        className: (0, i.cn)(
  ...
  (e) => {
    ...
    function n() {
      let e = (0, a.useReducedMotion)(),
        n = o.HOME_CONTENT.clients.logos.slice(0, 12);
      return (0, t.jsx)('section', {
        id: 'clients',
        className:
          'bg-[#0048ff] py-4 md:py-20 lg:py-24 relative z-10 overflow-hidden',
        ...
        children: (0, t.jsxs)('div', {
          ...
          children: [
            ...
            (0, t.jsx)(i.motion.div, {
              ...
              className:
                'grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8 md:gap-12 items-center justify-items-center w-full',
              children: n.map((e) => {
                let a = e.src?.toLowerCase().endsWith('.svg');
                return (0, t.jsx)(
                  i.motion.div,
                  {
                    variants: {
                    ...
                    children: (0, t.jsx)('div', {
                      className:
                        'group relative w-32 h-16 md:w-40 md:h-20 flex items-center justify-center',
                      'aria-label': e.alt,
                      children: (0, t.jsx)(r.default, {
                        ...
                        sizes:
                          '(max-width: 768px) 128px, (max-width: 1200px) 160px, 160px',
                        loading: 'lazy',
                        unoptimized: a,
                      }),
                    }),
    ...
    var h = e.i(32648),
      f = e.i(68085),
      x = e.i(84833);
    let b = ({ label: e, error: i, id: a, className: r = '', ...o }) =>
        (0, t.jsxs)('div', {
          children: [
            (0, t.jsx)('label', {
              htmlFor: a,
            ...
            (0, t.jsx)('input', {
              id: a,
              'aria-invalid': !!i,
              'aria-describedby': i ? `${a}-error` : void 0,
              className: `w-full min-h-[48px] rounded-lg border border-[#111111]/10 bg-[#f8fafc] px-4 py-4 text-[#111111] placeholder:text-[#111111]/30 transition-all outline-none focus:border-[#0057FF] focus:ring-2 focus:ring-[#0057FF]/20 ${i ? 'border-red-500' : ''} ${r}`,
              ...o,
            }),
            i &&
              (0, t.jsx)('p', {
      ...
      v = ({ label: e, error: i, id: a, className: r = '', ...o }) =>
        (0, t.jsxs)('div', {
          children: [
            (0, t.jsx)('label', {
              htmlFor: a,
            ...
            (0, t.jsx)('textarea', {
              ...
              'aria-invalid': !!i,
              'aria-describedby': i ? `${a}-error` : void 0,
              className: `w-full resize-none rounded-lg border border-[#111111]/10 bg-[#f8fafc] px-4 py-4 text-[#111111] placeholder:text-[#111111]/30 transition-all outline-none focus:border-[#0057FF] focus:ring-2 focus:ring-[#0057FF]/20 min-h-[120px] ${i ? 'border-red-500' : ''} ${r}`,
              ...o,
            }),
            i &&
              (0, t.jsx)('p', {
          ...
          children: (0, t.jsxs)('div', {
            ...
            children: [
              (0, t.jsxs)(i.motion.div, {
                ...
                className:
                  'lg:col-span-5 flex flex-col space-y-10 order-1 md:order-1',
                children: [
                  (0, t.jsxs)('div', {
              ...
              (0, t.jsx)('div', {
                className:
                  'lg:hidden flex flex-wrap justify-center gap-4 py-8 border-t border-[#0e0e0e]/20 w-full',
                children: n.map((e) =>
                  (0, t.jsx)(
                    'a',
                    {
      ...
      let e = [
        {
          label: 'Instagram',
          href: f.SOCIALS.instagram,
          icon: (0, t.jsx)(d.Instagram, { className: 'w-5 h-5 lg:w-4 lg:h-4' }),
        },
        {
          label: 'LinkedIn',
          href: f.SOCIALS.linkedin,
        ...
        },
        {
          label: 'Twitter',
          href: f.SOCIALS.twitter,
          icon: (0, t.jsx)(u, { className: 'w-5 h-5 lg:w-4 lg:h-4' }),
        },
      ];
    ...
    function S() {
      return (0, t.jsxs)(t.Fragment, {
        children: [(0, t.jsx)(n, {}), (0, t.jsx)(j, {}), (0, t.jsx)(C, {})],
      });
    }
    e.s(['SiteClosure', () => S], 22621);
  },
]);
