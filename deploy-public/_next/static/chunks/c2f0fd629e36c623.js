(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function _(...e) {
      console.warn('THREE.' + e.shift(), ...e);
    }
    function v(...e) {
      console.error('THREE.' + e.shift(), ...e);
    }
    function x(...e) {
      let t = e.join(' ');
      t in m || ((m[t] = !0), _(...e));
    ...
    class M {
      ...
      hasEventListener(e, t) {
        let i = this._listeners;
        return void 0 !== i && void 0 !== i[e] && -1 !== i[e].indexOf(t);
      }
    ...
    class R {
      ...
      clamp(e, t) {
        return (
          (this.x = b(this.x, e.x, t.x)),
          (this.y = b(this.y, e.y, t.y)),
          this
        );
      }
      clampScalar(e, t) {
      ...
      clampLength(e, t) {
        let i = this.length();
        return this.divideScalar(i || 1).multiplyScalar(b(i, e, t));
      }
      floor() {
        return (
      ...
      angleTo(e) {
        ...
        return 0 === t ? Math.PI / 2 : Math.acos(b(this.dot(e) / t, -1, 1));
      }
      distanceTo(e) {
    ...
    class C {
      ...
      static slerpFlat(e, t, i, n, r, a, s) {
        ...
        if (c !== f || o !== u || l !== d || h !== p) {
          let e = o * u + l * d + h * p + c * f;
          e < 0 && ((u = -u), (d = -d), (p = -p), (f = -f), (e = -e));
          let t = 1 - s;
          if (e < 0.9995) {
            let i = Math.acos(e),
              n = Math.sin(i);
            ((o =
              o * (t = Math.sin(t * i) / n) + u * (s = Math.sin(s * i) / n)),
              (l = l * t + d * s),
              (h = h * t + p * s),
              (c = c * t + f * s));
          } else {
      ...
      slerp(e, t) {
        ...
        if (s < 0.9995) {
          ...
          ((o = Math.sin(o * e) / l),
            (t = Math.sin(t * e) / l),
            (this._x = this._x * o + i * t),
            (this._y = this._y * o + n * t),
    ...
    class P {
      ...
      applyEuler(e) {
        return this.applyQuaternion(U.setFromEuler(e));
      }
      applyAxisAngle(e, t) {
      ...
      F =
        ...
        (i = {
          ...
          getTransfer: function (e) {
            return '' === e ? c : this.spaces[e].transfer;
          },
          getToneMappingMode: function (e) {
            return (
              this.spaces[e].outputColorSpaceConfig.toneMappingMode ||
              'standard'
            );
          },
          ...
          [h]: {
            ...
            workingColorSpaceConfig: { unpackColorSpace: l },
            outputColorSpaceConfig: { drawingBufferColorSpace: l },
          },
          [l]: {
            primaries: n,
            whitePoint: a,
    ...
    class V {
      static getDataURL(e, i = 'image/png') {
        let n;
        if (/^data:/i.test(e.src) || 'u' < typeof HTMLCanvasElement)
          return e.src;
        ...
        return n.toDataURL(i);
      }
      static sRGBToLinear(e) {
        if (
          ('u' > typeof HTMLImageElement && e instanceof HTMLImageElement) ||
          ('u' > typeof HTMLCanvasElement && e instanceof HTMLCanvasElement) ||
          ...
          let n = i.getImageData(0, 0, e.width, e.height),
            r = n.data;
          for (let e = 0; e < r.length; e++) r[e] = 255 * B(r[e] / 255);
    ...
    class H {
      ...
      getSize(e) {
        let t = this.data;
        return (
          'u' > typeof HTMLVideoElement && t instanceof HTMLVideoElement
            ? e.set(t.videoWidth, t.videoHeight, 0)
            : 'u' > typeof VideoFrame && t instanceof VideoFrame
        ...
        if (null !== n) {
          ...
          if (Array.isArray(n)) {
            ...
            for (let t = 0, i = n.length; t < i; t++)
              n[t].isDataTexture ? e.push(k(n[t].image)) : e.push(k(n[t]));
          } else e = k(n);
          i.url = e;
        }
    ...
    class j extends M {
      ...
      setValues(e) {
        for (let t in e) {
          ...
          (n && i && n.isVector2 && i.isVector2) ||
          (n && i && n.isVector3 && i.isVector3) ||
          (n && i && n.isMatrix3 && i.isMatrix3)
            ? n.copy(i)
            : (this[t] = i);
        }
      }
    ...
    class Y extends M {
      constructor(e = 1, t = 1, i = {}) {
        ...
        const n = new j({ width: e, height: t, depth: i.depth });
        this.textures = [];
        const r = i.count;
        for (let e = 0; e < r; e++)
        ...
        if (this.width !== e || this.height !== t || this.depth !== i) {
          ...
          for (let n = 0, r = this.textures.length; n < r; n++)
            ((this.textures[n].image.width = e),
              ...
              !0 !== this.textures[n].isData3DTexture &&
      ...
      copy(e) {
        ...
        for (let t = 0, i = e.textures.length; t < i; t++) {
          ...
          let i = Object.assign({}, e.textures[t].image);
          this.textures[t].source = new H(i);
        }
        return (
    ...
    class Z {
      constructor(
        e = new P(Infinity, Infinity, Infinity),
        t = new P(-1 / 0, -1 / 0, -1 / 0)
      ) {
      ...
      setFromArray(e) {
        ...
        for (let t = 0, i = e.length; t < i; t += 3)
          this.expandByPoint($.fromArray(e, t));
        return this;
      }
      setFromBufferAttribute(e) {
        this.makeEmpty();
        for (let t = 0, i = e.count; t < i; t++)
          this.expandByPoint($.fromBufferAttribute(e, t));
        return this;
      }
      setFromPoints(e) {
        this.makeEmpty();
      ...
      setFromCenterAndSize(e, t) {
        let i = $.copy(t).multiplyScalar(0.5);
      ...
      intersectsSphere(e) {
        return (
          ...
          $.distanceToSquared(e.center) <= e.radius * e.radius
        );
      }
      intersectsPlane(e) {
        let t, i;
      ...
      intersectsTriangle(e) {
        ...
        (this.getCenter(eo),
          el.subVectors(this.max, eo),
          et.subVectors(e.a, eo),
          ei.subVectors(e.b, eo),
          en.subVectors(e.c, eo),
          er.subVectors(ei, et),
          ea.subVectors(en, ei),
          es.subVectors(et, en));
        let t = [
        ...
        return (
          !!eu(t, et, ei, en, el) &&
          !!eu((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), et, ei, en, el) &&
          (eh.crossVectors(er, ea),
          eu((t = [eh.x, eh.y, eh.z]), et, ei, en, el))
        );
      }
      clampPoint(e, t) {
        ...
        return (
          this.isEmpty()
            ...
            : (this.getCenter(e.center),
              (e.radius = 0.5 * this.getSize($).length())),
          e
        );
      }
      intersect(e) {
      ...
      applyMatrix4(e) {
        return (
          this.isEmpty() ||
            (Q[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(e),
    ...
    function eu(e, t, i, n, r) {
      for (let a = 0, s = e.length - 3; a <= s; a += 3) {
        ec.fromArray(e, a);
        let s =
            r.x * Math.abs(ec.x) + r.y * Math.abs(ec.y) + r.z * Math.abs(ec.z),
          o = t.dot(ec),
          l = i.dot(ec),
          h = n.dot(ec);
    ...
    class em {
      ...
      setFromPoints(e, t) {
        let i = this.center;
        void 0 !== t ? i.copy(t) : ed.setFromPoints(e).getCenter(i);
        let n = 0;
      ...
      expandByPoint(e) {
        ...
        ep.subVectors(e, this.center);
        let t = ep.lengthSq();
        if (t > this.radius * this.radius) {
          let e = Math.sqrt(t),
            i = (e - this.radius) * 0.5;
          (this.center.addScaledVector(ep, i / e), (this.radius += i));
        }
        return this;
      }
      union(e) {
          ...
          e.isEmpty() ||
            (this.isEmpty()
              ...
              : !0 === this.center.equals(e.center)
                ...
                : (ef.subVectors(e.center, this.center).setLength(e.radius),
                  this.expandByPoint(ep.copy(e.center).add(ef)),
                  this.expandByPoint(ep.copy(e.center).sub(ef)))),
          this
        );
      }
      equals(e) {
    ...
    class eT {
      constructor(e, t, i, n, r, a, s, o, l, h, c, u, d, p, f, m) {
        ((eT.prototype.isMatrix4 = !0),
          ...
          void 0 !== e &&
            this.set(e, t, i, n, r, a, s, o, l, h, c, u, d, p, f, m));
      }
      ...
      extractBasis(e, t, i) {
        return (
          0 === this.determinant()
            ? (e.set(1, 0, 0), t.set(0, 1, 0), i.set(0, 0, 1))
      ...
      multiplyMatrices(e, t) {
        ...
        return (
          ...
          (r[4] = a * y + s * w + o * P + l * N),
          (r[8] = a * T + s * A + o * L + l * I),
          (r[12] = a * E + s * R + o * U + l * O),
          (r[1] = h * S + c * b + u * C + d * D),
          (r[5] = h * y + c * w + u * P + d * N),
          (r[9] = h * T + c * A + u * L + d * I),
          (r[13] = h * E + c * R + u * U + d * O),
          (r[2] = p * S + f * b + m * C + g * D),
          (r[6] = p * y + f * w + m * P + g * N),
          (r[10] = p * T + f * A + m * L + g * I),
          (r[14] = p * E + f * R + m * U + g * O),
          (r[3] = _ * S + v * b + x * C + M * D),
          (r[7] = _ * y + v * w + x * P + M * N),
          (r[11] = _ * T + v * A + x * L + M * I),
          (r[15] = _ * E + v * R + x * U + M * O),
          this
        );
      }
      multiplyScalar(e) {
      ...
      decompose(e, t, i) {
        ...
        let r = eE.set(n[0], n[1], n[2]).length(),
          a = eE.set(n[4], n[5], n[6]).length(),
          s = eE.set(n[8], n[9], n[10]).length();
        (0 > this.determinant() && (r = -r), eb.copy(this));
        let o = 1 / r,
          l = 1 / a,
          h = 1 / s;
        return (
      ...
      makePerspective(e, t, i, n, r, a, s = 2e3, o = !1) {
        let l,
          h,
          c = this.elements;
        if (o) ((l = r / (a - r)), (h = (a * r) / (a - r)));
        else if (2e3 === s)
          ((l = -(a + r) / (a - r)), (h = (-2 * a * r) / (a - r)));
        else if (2001 === s) ((l = -a / (a - r)), (h = (-a * r) / (a - r)));
        else
          throw Error(
      ...
      makeOrthographic(e, t, i, n, r, a, s = 2e3, o = !1) {
        let l,
          h,
          c = this.elements;
        if (o) ((l = 1 / (a - r)), (h = a / (a - r)));
        else if (2e3 === s) ((l = -2 / (a - r)), (h = -(a + r) / (a - r)));
        else if (2001 === s) ((l = -1 / (a - r)), (h = -r / (a - r)));
        else
          throw Error(
    ...
    let eE = new P(),
      ...
      eU = new C();
    class eD {
      constructor(e = 0, t = 0, i = 0, n = eD.DEFAULT_ORDER) {
        ((this.isEuler = !0),
          (this._x = e),
          (this._y = t),
          (this._z = i),
      ...
      setFromQuaternion(e, t, i) {
        return (
          eL.makeRotationFromQuaternion(e),
          this.setFromRotationMatrix(eL, t, i)
        );
      }
      ...
      reorder(e) {
        return (eU.setFromEuler(this), this.setFromQuaternion(eU, e));
      }
      equals(e) {
        return (
          e._x === this._x &&
    ...
    class eJ extends M {
      constructor() {
        ...
        (t._onChange(function () {
          ...
          (this.matrixAutoUpdate = eJ.DEFAULT_MATRIX_AUTO_UPDATE),
          (this.matrixWorldAutoUpdate = eJ.DEFAULT_MATRIX_WORLD_AUTO_UPDATE),
      ...
      rotateOnWorldAxis(e, t) {
        return (
          eF.setFromAxisAngle(e, t),
          this.quaternion.premultiply(eF),
          this
        );
      }
      rotateX(e) {
      ...
      lookAt(e, t, i) {
        ...
        let n = this.parent;
        (this.updateWorldMatrix(!0, !1),
          eV.setFromMatrixPosition(this.matrixWorld),
          this.isCamera || this.isLight
            ? eB.lookAt(eV, ez, this.up)
            : eB.lookAt(ez, eV, this.up),
      ...
      add(e) {
        ...
        return (
          e === this
            ? v("Object3D.add: object can't be added as a child of itself.", e)
            : e && e.isObject3D
              ? (e.removeFromParent(),
                (e.parent = this),
                ...
                (eY.child = null))
              : v('Object3D.add: object not an instance of THREE.Object3D.', e),
          this
        );
      }
      remove(e) {
      ...
      attach(e) {
        return (
          ...
          null !== e.parent &&
            ...
            eB.multiply(e.parent.matrixWorld)),
          e.applyMatrix4(eB),
          e.removeFromParent(),
          (e.parent = this),
          this.children.push(e),
      ...
      getWorldQuaternion(e) {
        return (
          this.updateWorldMatrix(!0, !1),
          this.matrixWorld.decompose(eV, e, eG),
          e
        );
      }
      getWorldScale(e) {
        return (
          this.updateWorldMatrix(!0, !1),
          this.matrixWorld.decompose(eV, eH, e),
          e
        );
      }
      getWorldDirection(e) {
      ...
      toJSON(e) {
        ...
        if (
          ...
          this.isBatchedMesh &&
            ...
            (n.geometryInfo = this._geometryInfo.map((e) => ({
              ...e,
            ...
            (n.instanceInfo = this._instanceInfo.map((e) => ({ ...e }))),
    ...
    ((eJ.DEFAULT_UP = new P(0, 1, 0)),
      (eJ.DEFAULT_MATRIX_AUTO_UPDATE = !0),
      (eJ.DEFAULT_MATRIX_WORLD_AUTO_UPDATE = !0));
    let eZ = new P(),
      eQ = new P(),
      e$ = new P(),
      e0 = new P(),
      ...
      e7 = new q();
    class te {
      constructor(e = new P(), t = new P(), i = new P()) {
      ...
      getArea() {
        return (
          eZ.subVectors(this.c, this.b),
          eQ.subVectors(this.a, this.b),
          0.5 * eZ.cross(eQ).length()
        );
      }
      getMidpoint(e) {
        return e
      ...
      closestPointToPoint(e, t) {
        ...
        let f = d * l - o * p;
        if (f <= 0 && l >= 0 && p <= 0)
          return ((n = l / (l - p)), t.copy(r).addScaledVector(e3, n));
        let m = h * p - d * c;
        if (m <= 0 && c - h >= 0 && d - p >= 0)
          return (
            e2.subVectors(s, a),
            (n = (c - h) / (c - h + (d - p))),
            t.copy(a).addScaledVector(e2, n)
          );
        let g = 1 / (m + f + u);
        return (
          (i = f * g),
          (n = u * g),
          t.copy(r).addScaledVector(e1, i).addScaledVector(e3, n)
        );
      }
      equals(e) {
    ...
    class ta {
      ...
      setHex(e, t = l) {
        return (
          ...
          (this.g = ((e >> 8) & 255) / 255),
          (this.b = (255 & e) / 255),
          F.colorSpaceToWorking(this, t),
          this
        );
      }
      setRGB(e, t, i, n = F.workingColorSpace) {
        return (
          (this.r = e),
          (this.g = t),
          (this.b = i),
          F.colorSpaceToWorking(this, n),
          this
        );
      }
      setHSL(e, t, i, n = F.workingColorSpace) {
        if (
          ((e = ((e % 1) + 1) % 1), (t = b(t, 0, 1)), (i = b(i, 0, 1)), 0 === t)
        )
        ...
        return (F.colorSpaceToWorking(this, n), this);
      }
      setStyle(e, t = l) {
        let i;
        function n(t) {
          void 0 !== t &&
            1 > parseFloat(t) &&
            _('Color: Alpha component of ' + e + ' will be ignored.');
        }
        if ((i = /^(\w+)\(([^\)]*)\)/.exec(e))) {
          let r,
            a = i[1],
      ...
      setColorName(e, t = l) {
        ...
        return (
          void 0 !== i ? this.setHex(i, t) : _('Color: Unknown color ' + e),
          this
        );
      }
      clone() {
      ...
      getHex(e = l) {
        return (
          F.workingToColorSpace(ts.copy(this), e),
          65536 * Math.round(b(255 * ts.r, 0, 255)) +
            256 * Math.round(b(255 * ts.g, 0, 255)) +
            Math.round(b(255 * ts.b, 0, 255))
        );
      }
      getHexString(e = l) {
      ...
      getHSL(e, t = F.workingColorSpace) {
        let i, n;
        F.workingToColorSpace(ts.copy(this), t);
        let r = ts.r,
          a = ts.g,
          s = ts.b,
          o = Math.max(r, a, s),
      ...
      getStyle(e = l) {
        ...
        return e !== l
          ...
          : `rgb(${Math.round(255 * t)},${Math.round(255 * i)},${Math.round(255 * n)})`;
      }
      offsetHSL(e, t, i) {
      ...
      lerpHSL(e, t) {
        ...
        let a = ((i = ti.h), (1 - t) * i + t * tn.h),
          s = ((n = ti.s), (1 - t) * n + t * tn.s),
          o = ((r = ti.l), (1 - t) * r + t * tn.l);
    ...
    class tp {
      ...
      setComponent(e, t, i) {
        return (
          this.normalized && (i = A(i, this.array)),
      ...
      setX(e, t) {
        return (
          this.normalized && (t = A(t, this.array)),
      ...
      setXY(e, t, i) {
        return (
          (e *= this.itemSize),
          this.normalized && ((t = A(t, this.array)), (i = A(i, this.array))),
          (this.array[e + 0] = t),
          (this.array[e + 1] = i),
          this
        );
    ...
    class tE extends M {
      ...
      center() {
        return (
          ...
          this.boundingBox.getCenter(tM).negate(),
          this.translate(tM.x, tM.y, tM.z),
          this
        );
      }
      setFromPoints(e) {
        ...
        if (void 0 === t) {
          ...
          this.setAttribute('position', new tg(t, 3));
        } else {
          let i = Math.min(e.length, t.count);
          for (let n = 0; n < i; n++) {
            let i = e[n];
        ...
        if (void 0 !== e) {
          if ((this.boundingBox.setFromBufferAttribute(e), t))
            for (let e = 0, i = t.length; e < i; e++) {
              let i = t[e];
              (tS.setFromBufferAttribute(i),
                this.morphTargetsRelative
                  ? (tT.addVectors(this.boundingBox.min, tS.min),
                    this.boundingBox.expandByPoint(tT),
                    tT.addVectors(this.boundingBox.max, tS.max),
                    this.boundingBox.expandByPoint(tT))
      ...
      computeBoundingSphere() {
        null === this.boundingSphere && (this.boundingSphere = new em());
        let e = this.attributes.position,
          t = this.morphAttributes.position;
        if (e && e.isGLBufferAttribute) {
          (v(
          ...
          if ((tS.setFromBufferAttribute(e), t))
            for (let e = 0, i = t.length; e < i; e++) {
              ...
              (ty.setFromBufferAttribute(i),
                this.morphTargetsRelative
                  ? (tT.addVectors(tS.min, ty.min),
                    tS.expandByPoint(tT),
                    tT.addVectors(tS.max, ty.max),
                    tS.expandByPoint(tT))
                  : (tS.expandByPoint(ty.min), tS.expandByPoint(ty.max)));
            }
          tS.getCenter(i);
          let n = 0;
            ...
            for (let r = 0, a = t.length; r < a; r++) {
              ...
              for (let t = 0, r = a.count; t < r; t++)
                (tT.fromBufferAttribute(a, t),
                  s && (tM.fromBufferAttribute(e, t), tT.add(tM)),
                  (n = Math.max(n, i.distanceToSquared(tT))));
            }
      ...
      computeTangents() {
        ...
        !1 === this.hasAttribute('tangent') &&
          this.setAttribute(
            'tangent',
            new tp(new Float32Array(4 * i.count), 4)
          );
        let a = this.getAttribute('tangent'),
          s = [],
          o = [];
        for (let e = 0; e < i.count; e++) ((s[e] = new P()), (o[e] = new P()));
        let l = new P(),
          h = new P(),
          c = new P(),
          u = new R(),
        ...
        let _ = new P(),
          ...
          S = new P();
        function y(e) {
          (M.fromBufferAttribute(n, e), S.copy(M));
          let t = s[e];
          (_.copy(t),
        ...
        for (let t = 0, i = g.length; t < i; ++t) {
          ...
          for (let t = n, i = n + r; t < i; t += 3)
            (y(e.getX(t + 0)), y(e.getX(t + 1)), y(e.getX(t + 2)));
        }
      }
      computeVertexNormals() {
        ...
        if (void 0 !== t) {
          ...
          if (void 0 === i)
            ((i = new tp(new Float32Array(3 * t.count), 3)),
    ...
    let tb = new eT(),
      tw = new (class {
        ...
        recast(e) {
          return (this.origin.copy(this.at(e, eg)), this);
        }
        closestPointToPoint(e, t) {
        ...
        distanceSqToPoint(e) {
          let t = eg.subVectors(e, this.origin).dot(this.direction);
          return t < 0
            ? this.origin.distanceToSquared(e)
            : (eg.copy(this.origin).addScaledVector(this.direction, t),
              eg.distanceToSquared(e));
        }
        distanceSqToSegment(e, t, i, n) {
          let r, a, s, o;
          (e_.copy(e).add(t).multiplyScalar(0.5),
            ev.copy(t).sub(e).normalize(),
            ex.copy(this.origin).sub(e_));
          let l = 0.5 * e.distanceTo(t),
            h = -this.direction.dot(ev),
            c = ex.dot(this.direction),
            u = -ex.dot(ev),
            d = ex.lengthSq(),
            p = Math.abs(1 - h * h);
          if (p > 0)
          ...
          return (
            ...
            n && n.copy(e_).addScaledVector(ev, a),
            s
          );
        }
        intersectSphere(e, t) {
          eg.subVectors(e.center, this.origin);
          let i = eg.dot(this.direction),
            n = eg.dot(eg) - i * i,
            r = e.radius * e.radius;
          if (n > r) return null;
          let a = Math.sqrt(r - n),
        ...
        intersectsBox(e) {
          return null !== this.intersectBox(e, eg);
        }
        intersectTriangle(e, t, i, n, r) {
          let a;
          (eM.subVectors(t, e), eS.subVectors(i, e), ey.crossVectors(eM, eS));
          let s = this.direction.dot(ey);
          if (s > 0) {
            if (n) return null;
            a = 1;
          } else {
          ...
          ex.subVectors(this.origin, e);
          let o = a * this.direction.dot(eS.crossVectors(ex, eS));
          if (o < 0) return null;
          let l = a * this.direction.dot(eM.cross(ex));
    ...
    class tO extends eJ {
        ...
        if (r && s) {
          ...
          for (let i = 0, n = r.length; i < n; i++) {
            ...
            0 !== n &&
              ...
              a ? tD.addScaledVector(tU, n) : tD.addScaledVector(tU.sub(t), n));
          }
          t.add(tD);
        }
        return t;
      ...
      raycast(e, t) {
        ...
        void 0 === n ||
          ...
          tA.applyMatrix4(r),
          tw.copy(e.ray).recast(e.near),
          (!1 === tA.containsPoint(tw.origin) &&
            (null === tw.intersectSphere(tA, tR) ||
              tw.origin.distanceToSquared(tR) > (e.far - e.near) ** 2)) ||
            (tb.copy(r).invert(),
            tw.copy(e.ray).applyMatrix4(tb),
            (null === i.boundingBox ||
              !1 !== tw.intersectsBox(i.boundingBox)) &&
              this._computeIntersections(e, t, tw)));
      }
        ...
        if (null !== s)
          ...
          if (Array.isArray(a))
            for (let r = 0, s = u.length; r < s; r++) {
              ...
              for (let r = f; r < m; r += 3)
                (n = tF(this, p, e, i, l, h, c, r, r + 1, r + 2)) &&
                  ((n.faceIndex = Math.floor(r / 3)),
            ...
            for (let o = r; o < s; o += 3)
              (n = tF(this, a, e, i, l, h, c, o, o + 1, o + 2)) &&
                ((n.faceIndex = Math.floor(o / 3)), t.push(n));
          }
      }
    }
    function tF(e, t, i, n, r, a, s, o, l, h) {
      (e.getVertexPosition(o, tC),
        e.getVertexPosition(l, tP),
        e.getVertexPosition(h, tL));
      let c = (function (e, t, i, n, r, a, s, o) {
        ...
        let l = i.ray.origin.distanceTo(tI);
        return l < i.near || l > i.far
          ? null
          : { distance: l, point: tI.clone(), object: e };
      })(e, t, i, n, tC, tP, tL, tN);
      if (c) {
        let e = new P();
        (te.getBarycoord(tN, tC, tP, tL, e),
          r && (c.uv = te.getInterpolatedAttribute(r, o, l, h, e, new R())),
          a && (c.uv1 = te.getInterpolatedAttribute(a, o, l, h, e, new R())),
          s &&
            ((c.normal = te.getInterpolatedAttribute(s, o, l, h, e, new P())),
            c.normal.dot(n.direction) > 0 && c.normal.multiplyScalar(-1)));
        let t = { a: o, b: l, c: h, normal: new P(), materialIndex: 0 };
        (te.getNormal(tC, tP, tL, t.normal), (c.face = t), (c.barycoord = e));
      }
      return c;
    }
    class tB extends tE {
      constructor(e = 1, t = 1, i = 1, n = 1, r = 1, a = 1) {
        ...
        (p('z', 'y', 'x', -1, -1, i, t, e, (a = Math.floor(a)), r, 0),
          ...
          this.setIndex(o),
          this.setAttribute('position', new tg(l, 3)),
          this.setAttribute('normal', new tg(h, 3)),
          this.setAttribute('uv', new tg(c, 2)));
      }
      copy(e) {
        return (
          super.copy(e),
    ...
    class tq extends tk {
      ...
      getFocalLength() {
        let e = Math.tan(0.5 * y * this.fov);
        return (0.5 * this.getFilmHeight()) / e;
      }
      getEffectiveFOV() {
        return 2 * T * Math.atan(Math.tan(0.5 * y * this.fov) / this.zoom);
      }
      getFilmWidth() {
      ...
      updateProjectionMatrix() {
        let e = this.near,
          t = (e * Math.tan(0.5 * y * this.fov)) / this.zoom,
          i = 2 * t,
          n = this.aspect * i,
          r = -0.5 * n,
          a = this.view;
    ...
    class tY extends eJ {
      constructor(e, t, i) {
        ...
        const n = new tq(-90, 1, e, t);
        ((n.layers = this.layers), this.add(n));
        const r = new tq(-90, 1, e, t);
        ((r.layers = this.layers), this.add(r));
        const a = new tq(-90, 1, e, t);
        ((a.layers = this.layers), this.add(a));
        const s = new tq(-90, 1, e, t);
        ((s.layers = this.layers), this.add(s));
        const o = new tq(-90, 1, e, t);
        ((o.layers = this.layers), this.add(o));
        const l = new tq(-90, 1, e, t);
    ...
    class tK extends j {
      constructor(e = [], t = 301, i, n, r, a, s, o, l, h) {
        (super(e, t, i, n, r, a, s, o, l, h),
    ...
    class tJ extends K {
      constructor(e = 1, t = {}) {
        ...
        ((this.texture = new tK([i, i, i, i, i, i])),
    ...
    class t$ {
      ...
      update(e, t, i) {
        ...
        if (e && 'visible-blurred' !== t.session.visibilityState) {
          ...
          null !== s &&
            (null === (n = t.getPose(e.targetRaySpace, i)) &&
              null !== r &&
              (n = r),
            null !== n &&
    ...
    class t0 extends eJ {
      constructor() {
        (super(),
          ...
          (this.backgroundRotation = new eD()),
          (this.environmentIntensity = 1),
          (this.environmentRotation = new eD()),
    ...
    class t5 {
      ...
      setFromCoplanarPoints(e, t, i) {
        let n = t3.subVectors(i, t).cross(t2.subVectors(e, t)).normalize();
      ...
      applyMatrix4(e, t) {
        let i = t || t4.getNormalMatrix(e),
          n = this.coplanarPoint(t3).applyMatrix4(e),
    ...
    class t7 {
      ...
      setFromProjectionMatrix(e, t = 2e3, i = !1) {
        let n = this.planes,
          ...
          M = r[15];
        if (
          (n[0].setComponents(l - a, d - h, g - p, M - _).normalize(),
          n[1].setComponents(l + a, d + h, g + p, M + _).normalize(),
          n[2].setComponents(l + s, d + c, g + f, M + v).normalize(),
          n[3].setComponents(l - s, d - c, g - f, M - v).normalize(),
          i)
        )
          (n[4].setComponents(o, u, m, x).normalize(),
            n[5].setComponents(l - o, d - u, g - m, M - x).normalize());
        else if (
          (n[4].setComponents(l - o, d - u, g - m, M - x).normalize(),
          2e3 === t)
        )
          n[5].setComponents(l + o, d + u, g + m, M + x).normalize();
        else if (2001 === t) n[5].setComponents(o, u, m, x).normalize();
        else
          throw Error(
      ...
      intersectsObject(e) {
        if (void 0 !== e.boundingSphere)
          (null === e.boundingSphere && e.computeBoundingSphere(),
            t6.copy(e.boundingSphere).applyMatrix4(e.matrixWorld));
        else {
          let t = e.geometry;
          (null === t.boundingSphere && t.computeBoundingSphere(),
            t6.copy(t.boundingSphere).applyMatrix4(e.matrixWorld));
        }
        return this.intersectsSphere(t6);
      }
      intersectsSprite(e) {
        return (
          t6.center.set(0, 0, 0),
          (t6.radius = 0.7071067811865476 + t8.distanceTo(e.center)),
          t6.applyMatrix4(e.matrixWorld),
          this.intersectsSphere(t6)
        );
      }
      intersectsSphere(e) {
        let t = this.planes,
      ...
      intersectsBox(e) {
        ...
        for (let i = 0; i < 6; i++) {
          let n = t[i];
          if (
            ((t9.x = n.normal.x > 0 ? e.max.x : e.min.x),
            (t9.y = n.normal.y > 0 ? e.max.y : e.min.y),
            (t9.z = n.normal.z > 0 ? e.max.z : e.min.z),
            0 > n.distanceToPoint(t9))
          )
            return !1;
        }
        return !0;
    ...
    class ie extends j {
      constructor(
        ...
        (super({ width: e, height: t, depth: c }, n, r, a, s, o, h, i, l),
      ...
      copy(e) {
        return (
          super.copy(e),
          (this.source = new H(Object.assign({}, e.image))),
    ...
    class it extends ie {
      constructor(e, t = 1014, i = 301, n, r, a = 1003, s = 1003, o, l = 1026) {
        const h = { width: e, height: e, depth: 1 };
        (super(e, e, t, i, n, r, a, s, o, l),
          (this.image = [h, h, h, h, h, h]),
    ...
    class ir extends tE {
      constructor(e = [], t = [], i = 1, n = 0) {
        ...
        ((function (e) {
          ...
          (function () {
            ...
            for (let i = 0; i < r.length; i += 3) {
              ...
              let n = h(e) / 2 / Math.PI + 0.5,
                s =
                  Math.atan2(-(t = e).y, Math.sqrt(t.x * t.x + t.z * t.z)) /
                    Math.PI +
                  0.5;
              a.push(n, 1 - s);
            }
          ...
          this.setAttribute('position', new tg(r, 3)),
          this.setAttribute('normal', new tg(r.slice(), 3)),
          this.setAttribute('uv', new tg(a, 2)),
      ...
      static fromJSON(e) {
        return new ir(e.vertices, e.indices, e.radius, e.detail);
      }
    }
    class ia {
      constructor() {
      ...
      computeFrenetFrames(e, t = !1) {
        ...
        for (let t = 1; t <= e; t++) {
          if (
            ...
            s.normalize();
            let e = Math.acos(b(n[t - 1].dot(n[t]), -1, 1));
            r[t].applyMatrix4(o.makeRotationAxis(s, e));
          }
          a[t].crossVectors(n[t], r[t]);
        }
        if (!0 === t) {
          let t = Math.acos(b(r[0].dot(r[e]), -1, 1));
    ...
    class ig extends ia {
      ...
      getPoint(e, t = new R()) {
        let i = this.v0,
          ...
          r = this.v2,
          a = this.v3;
        return (t.set(im(e, i.x, n.x, r.x, a.x), im(e, i.y, n.y, r.y, a.y)), t);
      }
      copy(e) {
        return (
          super.copy(e),
    ...
    class iv extends ia {
      ...
      getPoint(e, t = new R()) {
        let i = this.v0,
          n = this.v1,
          r = this.v2;
        return (t.set(ip(e, i.x, n.x, r.x), ip(e, i.y, n.y, r.y)), t);
      }
      copy(e) {
        return (
          super.copy(e),
    ...
    class iM extends ia {
      ...
      getPoint(e, t = new R()) {
        ...
        return (t.set(id(a, s.x, o.x, l.x, h.x), id(a, s.y, o.y, l.y, h.y)), t);
      }
      copy(e) {
    ...
    class iy extends tE {
      constructor(e = 1, t = 1, i = 1, n = 1) {
        ...
        (this.setIndex(d),
          this.setAttribute('position', new tg(p, 3)),
          this.setAttribute('normal', new tg(f, 3)),
          this.setAttribute('uv', new tg(m, 2)));
      }
      copy(e) {
        return (
          super.copy(e),
      ...
      static fromJSON(e) {
        return new iy(e.width, e.height, e.widthSegments, e.heightSegments);
      }
    }
    class iT extends tE {
      constructor(
    ...
    class iE extends ir {
      ...
      static fromJSON(e) {
        return new iE(e.radius, e.detail);
      }
    }
    class ib extends tH {
      constructor(e) {
    ...
    class iN {
      constructor(e, t, i, n) {
        ...
        ((this.name = e),
          (this.times = iC(t, this.TimeBufferType)),
          (this.values = iC(i, this.ValueBufferType)),
      ...
      static toJSON(e) {
        ...
        if (i.toJSON !== this.toJSON) t = i.toJSON(e);
          ...
          t = {
            name: e.name,
            times: iC(e.times, Array),
            values: iC(e.values, Array),
          };
      ...
      validate() {
        ...
        let t = !0,
          i = this.getValueSize();
        i - Math.floor(i) != 0 &&
          (v('KeyframeTrack: Invalid value size in track.', this), (t = !1));
        let n = this.times,
          r = this.values,
          a = n.length;
        ...
        for (let e = 0; e !== a; e++) {
          ...
          if ('number' == typeof i && isNaN(i)) {
            (v('KeyframeTrack: Time is not a valid number.', this, e, i),
              (t = !1));
            break;
          }
          if (null !== s && s > i) {
            (v('KeyframeTrack: Out of order keys.', this, e, i, s), (t = !1));
            break;
          }
          s = i;
        }
        if (
          ...
          for (let e = 0, i = r.length; e !== i; ++e) {
            let i = r[e];
            if (isNaN(i)) {
              (v('KeyframeTrack: Value is not a valid number.', this, e, i),
                (t = !1));
              break;
            }
          }
    ...
    ((iN.prototype.ValueTypeName = ''),
      ...
      (iN.prototype.DefaultInterpolation = 2301));
    class iI extends iN {
      constructor(e, t, i) {
        super(e, t, i);
      }
    ...
    ((iF.prototype.ValueTypeName = 'quaternion'),
      (iF.prototype.InterpolantFactoryMethodSmooth = void 0));
    class iB extends iN {
      constructor(e, t, i) {
        super(e, t, i);
      }
    }
    ((iB.prototype.ValueTypeName = 'string'),
      (iB.prototype.ValueBufferType = Array),
      (iB.prototype.DefaultInterpolation = 2300),
      (iB.prototype.InterpolantFactoryMethodLinear = void 0),
      (iB.prototype.InterpolantFactoryMethodSmooth = void 0),
      (class extends iN {
        constructor(e, t, i, n) {
          super(e, t, i, n);
        }
    ...
    class ik {
      constructor(e) {
        ((this.camera = e),
          ...
          (this.autoUpdate = !0),
          (this.needsUpdate = !1),
          (this._frustum = new t7()),
          (this._frameExtents = new R(1, 1)),
      ...
      updateMatrices(e) {
        let t = this.camera,
          i = this.matrix;
        (iG.setFromMatrixPosition(e.matrixWorld),
          t.position.copy(iG),
          iH.setFromMatrixPosition(e.target.matrixWorld),
          t.lookAt(iH),
          t.updateMatrixWorld(),
          iV.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
    ...
    class iW extends ik {
      constructor() {
        (super(new tq(90, 1, 0.5, 500)), (this.isPointLightShadow = !0));
      }
    }
    class iX extends iz {
    ...
    class iY extends iz {
      constructor(e, t) {
        (super(e, t),
          ...
          this.position.copy(eJ.DEFAULT_UP),
          this.updateMatrix(),
          (this.target = new eJ()),
          (this.shadow = new iq()));
      }
    ...
    let iQ = '\\[\\]\\.:\\/',
      ...
      i3 = RegExp(
        '^' +
          /((?:WC+[\/:])*)/.source.replace('WC', i0) +
          /(WCOD+)?/.source.replace('WCOD', i1) +
          /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace('WC', i0) +
          /\.(WC+)(?:\[(.+)\])?/.source.replace('WC', i0) +
          '$'
      ),
      i2 = ['material', 'materials', 'bones', 'map'];
    class i4 {
      constructor(e, t, i) {
        ((this.path = t),
          (this.parsedPath = i || i4.parseTrackName(t)),
          (this.node = i4.findNode(e, this.parsedPath.nodeName)),
          (this.rootNode = e),
      ...
      static create(e, t, i) {
        return e && e.isAnimationObjectGroup
          ? new i4.Composite(e, t, i)
          : new i4(e, t, i);
      }
      static sanitizeNodeName(e) {
        return e.replace(/\s/g, '_').replace(i$, '');
      }
      ...
      bind() {
        let e = this.node,
          ...
          r = t.propertyIndex;
        if (
          (e || ((e = i4.findNode(this.rootNode, t.nodeName)), (this.node = e)),
    ...
    function i6() {
      ...
      return {
        start: function () {
          !0 === t ||
            (null !== i && ((n = e.requestAnimationFrame(r)), (t = !0)));
        },
        stop: function () {
        ...
        update: function (i, n) {
          ...
          if (void 0 === r)
            t.set(
              ...
              (function (t, i) {
                ...
                if (
                  ...
                  n = e.FLOAT;
                else if ('u' > typeof Float16Array && r instanceof Float16Array)
                  n = e.HALF_FLOAT;
                else if (r instanceof Uint16Array)
                  n = t.isFloat16BufferAttribute
                    ? e.HALF_FLOAT
                    : e.UNSIGNED_SHORT;
            ...
            (!(function (t, i, n) {
              let r = i.array,
                a = i.updateRanges;
              if ((e.bindBuffer(n, t), 0 === a.length))
                e.bufferSubData(n, 0, r);
              else {
    ...
    ((i4.Composite = class {
      ...
      (i4.prototype.BindingType = {
        Direct: 0,
        EntireArray: 1,
        ArrayElement: 2,
        HasFromToArray: 3,
      }),
      (i4.prototype.Versioning = {
        None: 0,
        NeedsUpdate: 1,
        MatrixWorldNeedsUpdate: 2,
      }),
      (i4.prototype.GetterByBindingType = [
        i4.prototype._getValue_direct,
        i4.prototype._getValue_array,
        i4.prototype._getValue_arrayElement,
        i4.prototype._getValue_toArray,
      ]),
      (i4.prototype.SetterByBindingTypeAndVersioning = [
        [
          i4.prototype._setValue_direct,
          i4.prototype._setValue_direct_setNeedsUpdate,
          i4.prototype._setValue_direct_setMatrixWorldNeedsUpdate,
        ],
        [
          i4.prototype._setValue_array,
          i4.prototype._setValue_array_setNeedsUpdate,
          i4.prototype._setValue_array_setMatrixWorldNeedsUpdate,
        ],
        [
          i4.prototype._setValue_arrayElement,
          i4.prototype._setValue_arrayElement_setNeedsUpdate,
          i4.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate,
        ],
        [
          i4.prototype._setValue_fromArray,
          i4.prototype._setValue_fromArray_setNeedsUpdate,
          i4.prototype._setValue_fromArray_setMatrixWorldNeedsUpdate,
        ],
      ]),
      new Float32Array(1),
      'u' > typeof __THREE_DEVTOOLS__ &&
      ...
      'u' > typeof window &&
        (window.__THREE__
          ? _('WARNING: Multiple instances of Three.js being imported.')
    ...
    let i9 = {
      ...
      i7 = {
        common: {
          diffuse: { value: new ta(0xffffff) },
          opacity: { value: 1 },
          map: { value: null },
          mapTransform: { value: new D() },
          alphaMap: { value: null },
          alphaMapTransform: { value: new D() },
          alphaTest: { value: 0 },
        },
        specularmap: {
          specularMap: { value: null },
          specularMapTransform: { value: new D() },
        },
        envmap: {
          envMap: { value: null },
          envMapRotation: { value: new D() },
          flipEnvMap: { value: -1 },
        ...
        aomap: {
          ...
          aoMapTransform: { value: new D() },
        },
        lightmap: {
          lightMap: { value: null },
          lightMapIntensity: { value: 1 },
          lightMapTransform: { value: new D() },
        },
        bumpmap: {
          bumpMap: { value: null },
          bumpMapTransform: { value: new D() },
          bumpScale: { value: 1 },
        },
        normalmap: {
          normalMap: { value: null },
          normalMapTransform: { value: new D() },
          normalScale: { value: new R(1, 1) },
        },
        displacementmap: {
          displacementMap: { value: null },
          displacementMapTransform: { value: new D() },
          displacementScale: { value: 1 },
          displacementBias: { value: 0 },
        },
        emissivemap: {
          emissiveMap: { value: null },
          emissiveMapTransform: { value: new D() },
        },
        metalnessmap: {
          metalnessMap: { value: null },
          metalnessMapTransform: { value: new D() },
        },
        roughnessmap: {
          roughnessMap: { value: null },
          roughnessMapTransform: { value: new D() },
        },
        ...
        fog: {
          ...
          fogNear: { value: 1 },
          fogFar: { value: 2e3 },
          fogColor: { value: new ta(0xffffff) },
        },
        lights: {
      ...
      ne = {
        basic: {
          ...
          vertexShader: i9.meshbasic_vert,
          fragmentShader: i9.meshbasic_frag,
        },
        lambert: {
          uniforms: tV([
            i7.common,
            ...
            i7.fog,
            i7.lights,
            { emissive: { value: new ta(0) } },
          ]),
          vertexShader: i9.meshlambert_vert,
          fragmentShader: i9.meshlambert_frag,
        },
        phong: {
          uniforms: tV([
            i7.common,
            ...
            {
              emissive: { value: new ta(0) },
              specular: { value: new ta(1118481) },
              shininess: { value: 30 },
            },
          ]),
          vertexShader: i9.meshphong_vert,
          fragmentShader: i9.meshphong_frag,
        },
        standard: {
          uniforms: tV([
            i7.common,
          ...
          vertexShader: i9.meshphysical_vert,
          fragmentShader: i9.meshphysical_frag,
        },
        toon: {
          uniforms: tV([
            i7.common,
          ...
          vertexShader: i9.meshtoon_vert,
          fragmentShader: i9.meshtoon_frag,
        },
        matcap: {
          uniforms: tV([
            i7.common,
          ...
          vertexShader: i9.meshmatcap_vert,
          fragmentShader: i9.meshmatcap_frag,
        },
        points: {
          uniforms: tV([i7.points, i7.fog]),
          vertexShader: i9.points_vert,
          fragmentShader: i9.points_frag,
        },
        dashed: {
          uniforms: tV([
            i7.common,
          ...
          vertexShader: i9.linedashed_vert,
          fragmentShader: i9.linedashed_frag,
        },
        depth: {
          uniforms: tV([i7.common, i7.displacementmap]),
          vertexShader: i9.depth_vert,
          fragmentShader: i9.depth_frag,
        },
        normal: {
          uniforms: tV([
            i7.common,
          ...
          vertexShader: i9.meshnormal_vert,
          fragmentShader: i9.meshnormal_frag,
        },
        sprite: {
          uniforms: tV([i7.sprite, i7.fog]),
          vertexShader: i9.sprite_vert,
          fragmentShader: i9.sprite_frag,
        },
        background: {
          uniforms: {
            uvTransform: { value: new D() },
          ...
          vertexShader: i9.background_vert,
          fragmentShader: i9.background_frag,
        },
        backgroundCube: {
          uniforms: {
            envMap: { value: null },
            ...
            backgroundIntensity: { value: 1 },
            backgroundRotation: { value: new D() },
          },
          vertexShader: i9.backgroundCube_vert,
          fragmentShader: i9.backgroundCube_frag,
        },
        cube: {
          uniforms: {
            tCube: { value: null },
          ...
          vertexShader: i9.cube_vert,
          fragmentShader: i9.cube_frag,
        },
        equirect: {
          uniforms: { tEquirect: { value: null } },
          vertexShader: i9.equirect_vert,
          fragmentShader: i9.equirect_frag,
        },
        distance: {
          uniforms: tV([
            i7.common,
          ...
          vertexShader: i9.distance_vert,
          fragmentShader: i9.distance_frag,
        },
        shadow: {
          uniforms: tV([
            i7.lights,
            i7.fog,
            { color: { value: new ta(0) }, opacity: { value: 1 } },
          ]),
          vertexShader: i9.shadow_vert,
          fragmentShader: i9.shadow_frag,
        },
      };
    ne.physical = {
      uniforms: tV([
        ne.standard.uniforms,
        {
          ...
          clearcoatMapTransform: { value: new D() },
          clearcoatNormalMap: { value: null },
          clearcoatNormalMapTransform: { value: new D() },
          clearcoatNormalScale: { value: new R(1, 1) },
          clearcoatRoughness: { value: 0 },
          clearcoatRoughnessMap: { value: null },
          clearcoatRoughnessMapTransform: { value: new D() },
          dispersion: { value: 0 },
          iridescence: { value: 0 },
          iridescenceMap: { value: null },
          iridescenceMapTransform: { value: new D() },
          iridescenceIOR: { value: 1.3 },
          iridescenceThicknessMinimum: { value: 100 },
          iridescenceThicknessMaximum: { value: 400 },
          iridescenceThicknessMap: { value: null },
          iridescenceThicknessMapTransform: { value: new D() },
          sheen: { value: 0 },
          sheenColor: { value: new ta(0) },
          sheenColorMap: { value: null },
          sheenColorMapTransform: { value: new D() },
          sheenRoughness: { value: 1 },
          sheenRoughnessMap: { value: null },
          sheenRoughnessMapTransform: { value: new D() },
          transmission: { value: 0 },
          transmissionMap: { value: null },
          transmissionMapTransform: { value: new D() },
          transmissionSamplerSize: { value: new R() },
          transmissionSamplerMap: { value: null },
          thickness: { value: 0 },
          thicknessMap: { value: null },
          thicknessMapTransform: { value: new D() },
          attenuationDistance: { value: 0 },
          attenuationColor: { value: new ta(0) },
          specularColor: { value: new ta(1, 1, 1) },
          specularColorMap: { value: null },
          specularColorMapTransform: { value: new D() },
          specularIntensity: { value: 1 },
          specularIntensityMap: { value: null },
          specularIntensityMapTransform: { value: new D() },
          anisotropyVector: { value: new R() },
          anisotropyMap: { value: null },
          anisotropyMapTransform: { value: new D() },
        },
      ]),
      vertexShader: i9.meshphysical_vert,
      fragmentShader: i9.meshphysical_frag,
    ...
    function nr(e, t, i, n, r, a, s) {
      ...
      function m(e) {
        ...
        return (
          n && n.isTexture && (n = (e.backgroundBlurriness > 0 ? i : t).get(n)),
          n
        );
      }
      function g(t, i) {
        (t.getRGB(nt, tG(e)), n.buffers.color.setClear(nt.r, nt.g, nt.b, i, s));
      }
      return {
        ...
        render: function (t) {
          let i = !1,
            r = m(t);
          null === r ? g(h, c) : r && r.isColor && (g(r, 1), (i = !0));
          ...
          n && (n.isCubeTexture || 306 === n.mapping)
            ? (void 0 === l &&
                ((l = new tO(
                  ...
                  new tH({
                    ...
                    uniforms: tz(ne.backgroundCube.uniforms),
              ...
              l.material.uniforms.backgroundRotation.value.setFromMatrix4(
                nn.makeRotationFromEuler(ni)
              ),
              (l.material.toneMapped = F.getTransfer(n.colorSpace) !== u),
            ...
            : n &&
              ...
              (void 0 === o &&
                ((o = new tO(
                  ...
                  new tH({
                    ...
                    uniforms: tz(ne.background.uniforms),
              ...
              (o.material.uniforms.backgroundIntensity.value =
                i.backgroundIntensity),
              (o.material.toneMapped = F.getTransfer(n.colorSpace) !== u),
        ...
        dispose: function () {
          (void 0 !== l &&
            ...
            void 0 !== o &&
              (o.geometry.dispose(), o.material.dispose(), (o = void 0)));
        },
      };
    }
    function na(e, t) {
        ...
        setup: function (i, r, l, m, g) {
          ...
          let x,
            ...
            E =
              ...
              (v = l),
              (x = !0 === r.wireframe),
              void 0 === (M = n[_.id]) && ((M = {}), (n[_.id] = M)),
              void 0 === (S = M[v.id]) && ((S = {}), (M[v.id] = S)),
              void 0 === (y = S[x]) &&
                ((y = h(e.createVertexArray())), (S[x] = y)),
              y);
          (a !== E && o((a = E).object),
            (T = (function (e, t, i, n) {
              let r = a.attributes,
    ...
    function no(e, t, i, n) {
      ...
      return (
        o !== s &&
          (_('WebGLRenderer:', s, 'not supported, using', o, 'instead.'),
          (s = o)),
        {
          isWebGL2: !0,
          ...
          precision: s,
          logarithmicDepthBuffer: !0 === i.logarithmicDepthBuffer,
          reversedDepthBuffer:
            !0 === i.reversedDepthBuffer && t.has('EXT_clip_control'),
    ...
    function nh(e) {
      ...
      function i(e, t) {
        return (
          303 === t ? (e.mapping = 301) : 304 === t && (e.mapping = 302),
          e
        );
      }
      function n(e) {
    ...
    let nc = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582],
      nu = new ij(),
      nd = new ta(),
      np = null,
      nf = 0,
    ...
    class nv {
      ...
      fromScene(e, t = 0, i = 0.1, n = 100, r = {}) {
        let { size: a = 256, position: s = n_ } = r;
        ((np = this._renderer.getRenderTarget()),
          (nf = this._renderer.getActiveCubeFace()),
          (nm = this._renderer.getActiveMipmapLevel()),
      ...
      _cleanup(e) {
        (this._renderer.setRenderTarget(np, nf, nm),
      ...
      _allocateTargets() {
        ...
        if (
          ...
          (null !== this._pingPongRenderTarget && this._dispose(),
            (this._pingPongRenderTarget = nx(e, t, i)));
          let { _lodMax: n } = this;
          (({
            ...
            for (let s = 0; s < a; s++) {
              ...
              let m = new tE();
              (m.setAttribute('position', new tp(d, 3)),
                m.setAttribute('uv', new tp(p, 2)),
                m.setAttribute('faceIndex', new tp(f, 1)),
                n.push(new tO(m, null)),
                r > 4 && r--);
            }
            return { lodMeshes: n, sizeLods: t, sigmas: i };
          })(n)),
            (this._blurMaterial =
              ((r = n),
              new tH({
      ...
      _compileMaterial(e) {
        let t = new tO(new tE(), e);
        this._renderer.compile(t, nu);
      }
      _sceneToCubeUV(e, t, i, n, r) {
        let a = new tq(90, 1, t, i),
          s = [1, -1, 1, 1, 1, 1],
          o = [1, 1, 1, -1, -1, -1],
          l = this._renderer,
          h = l.autoClear,
        ...
        for (let t = 0; t < 6; t++) {
          ...
          0 === i
            ? (a.up.set(0, s[t], 0),
              ...
              a.lookAt(r.x + o[t], r.y, r.z))
            : 1 === i
              ? (a.up.set(0, 0, s[t]),
                a.position.set(r.x, r.y, r.z),
                a.lookAt(r.x, r.y + o[t], r.z))
              : (a.up.set(0, s[t], 0),
                a.position.set(r.x, r.y, r.z),
                a.lookAt(r.x, r.y, r.z + o[t]));
          let h = this._cubeSize;
          (nM(n, i * h, t > 2 ? h : 0, h, h),
            l.setRenderTarget(n),
            p && l.render(u, a),
            l.render(e, a));
        }
        ((l.toneMapping = c), (l.autoClear = h), (e.background = f));
      }
      _textureToCubeUV(e, t) {
        ...
        n
          ...
          : null === this._equirectMaterial && (this._equirectMaterial = nS());
        let r = n ? this._cubemapMaterial : this._equirectMaterial,
          a = this._lodMeshes[0];
        ((a.material = r), (r.uniforms.envMap.value = e));
        let s = this._cubeSize;
        (nM(t, 0, 0, 3 * s, 2 * s), i.setRenderTarget(t), i.render(a, nu));
      }
      _applyPMREM(e) {
        let t = this._renderer,
          i = t.autoClear;
        t.autoClear = !1;
        let n = this._lodMeshes.length;
        for (let t = 1; t < n; t++) this._applyGGXFilter(e, t - 1, t);
        t.autoClear = i;
      }
      ...
      _halfBlur(e, t, i, n, r, a, s) {
        ...
        'latitudinal' !== a &&
          'longitudinal' !== a &&
          v('blur direction must be either latitudinal or longitudinal!');
        let h = this._lodMeshes[n];
        h.material = l;
        let c = l.uniforms,
        ...
        let { _lodMax: x } = this;
        ((c.dTheta.value = d), (c.mipInt.value = x - i));
        let M = this._sizeLods[n],
          S = 4 * (this._cubeSize - M);
        (nM(t, 3 * M * (n > x - 4 ? n - x + 4 : 0), S, 3 * M, 2 * M),
          o.setRenderTarget(t),
          o.render(h, nu));
      }
    }
              ...
              if (r.isRenderTargetTexture && r.pmremVersion !== l)
                return (
                  ...
                  ((a = s
                    ...
                    : i.fromCubemap(r, a)).texture.pmremVersion =
                    r.pmremVersion),
                  t.set(r, a),
                  a.texture
                );
                ...
                return (s && l && l.height > 0) ||
                  ...
                  ? (null === i && (i = new nv(e)),
                    ((a = s
                      ...
                      : i.fromCubemap(r)).texture.pmremVersion =
                      r.pmremVersion),
                    t.set(r, a),
                    r.addEventListener('dispose', n),
                    a.texture)
    ...
    function nb(e) {
      ...
      return {
        ...
        get: function (e) {
          ...
          return (
            null === t &&
              x('WebGLRenderer: ' + e + ' extension not supported.'),
            t
          );
        },
      };
    ...
    function nA(e, t, i) {
      ...
      function s(t, s, o) {
        0 !== o &&
          (e.drawElementsInstanced(n, s, r, t * a, o), i.update(s, n, o));
      }
      ((this.setMode = function (e) {
        n = e;
      }),
        ...
        update: function (i, n, r) {
          switch ((t.calls++, n)) {
            ...
            case e.POINTS:
              ...
              break;
            default:
              v('WebGLInfo: Unknown draw mode:', n);
          }
        },
      };
    }
      ...
      return {
        update: function (a, s, o) {
          ...
          if (void 0 === u || u.count !== c) {
            ...
            ((u = { count: c, texture: g, size: new R(p, f) }),
              n.set(s, u),
    ...
    function nU(e, t, i, n, r) {
      let a,
        s = new K(t, i, { type: e, depthBuffer: n, stencilBuffer: r }),
        o = new K(t, i, { type: 1016, depthBuffer: !1, stencilBuffer: !1 }),
        l = new tE();
      (l.setAttribute('position', new tg([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)),
        l.setAttribute('uv', new tg([0, 2, 0, 0, 2, 0], 2)));
      let h = new ib({
      ...
      ((this.setSize = function (e, t) {
        ...
        (this.begin = function (e, t) {
          ...
          if (((g = t), null !== t)) {
            let e = t.width,
              i = t.height;
            (s.width !== e || s.height !== i) && this.setSize(e, i);
          }
          return (
            !1 === v && e.setRenderTarget(s),
            (a = e.toneMapping),
            (e.toneMapping = 0),
            !0
          );
        ...
        (this.end = function (e, t) {
          ...
          for (let r = 0; r < _.length; r++) {
            ...
            if (
              !1 !== a.enabled &&
              (a.render(e, n, i, t), !1 !== a.needsSwap)
            ) {
              let e = i;
              ((i = n), (n = e));
            }
          ...
          if (p !== e.outputColorSpace || f !== e.toneMapping) {
            ((p = e.outputColorSpace),
              (f = e.toneMapping),
              (h.defines = {}),
              F.getTransfer(p) === u && (h.defines.SRGB_TRANSFER = ''));
            let t = nL[f];
            (t && (h.defines[t] = ''), (h.needsUpdate = !0));
          }
          ((h.uniforms.tDiffuse.value = i.texture),
            e.setRenderTarget(g),
            e.render(c, d),
            (g = null),
            (m = !1));
        ...
        (this.dispose = function () {
          (s.dispose(), o.dispose(), l.dispose(), h.dispose());
        }));
    }
    let nD = new j(),
      nN = new ie(1, 1),
      nI = new J(),
      nO = new (class extends j {
        constructor(e = null, t = 1, i = 1, n = 1) {
          (super(null),
      ...
      nB = [],
      nz = [],
      nV = new Float32Array(16),
      nG = new Float32Array(9),
    ...
    function nk(e, t, i) {
      ...
      let r = t * i,
        a = nB[r];
      if ((void 0 === a && ((a = new Float32Array(r)), (nB[r] = a)), 0 !== t)) {
        n.toArray(a, 0);
    ...
    function nj(e, t) {
      let i = nz[t];
      void 0 === i && ((i = new Int32Array(t)), (nz[t] = i));
    ...
    function nY(e, t) {
      ...
      if (void 0 !== t.x)
        ...
        if (nW(i, t)) return;
        (e.uniform2fv(this.addr, t), nX(i, t));
      }
    }
    function nK(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        ...
        if (nW(i, t)) return;
        (e.uniform3fv(this.addr, t), nX(i, t));
      }
    }
    function nJ(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        ...
        if (nW(i, t)) return;
        (e.uniform4fv(this.addr, t), nX(i, t));
      }
    }
    function nZ(e, t) {
      let i = this.cache,
      ...
      if (void 0 === n) {
        if (nW(i, t)) return;
        (e.uniformMatrix2fv(this.addr, !1, t), nX(i, t));
      } else {
        if (nW(i, n)) return;
        (nH.set(n), e.uniformMatrix2fv(this.addr, !1, nH), nX(i, n));
      }
    }
    function nQ(e, t) {
      let i = this.cache,
      ...
      if (void 0 === n) {
        if (nW(i, t)) return;
        (e.uniformMatrix3fv(this.addr, !1, t), nX(i, t));
      } else {
        if (nW(i, n)) return;
        (nG.set(n), e.uniformMatrix3fv(this.addr, !1, nG), nX(i, n));
      }
    }
    function n$(e, t) {
      let i = this.cache,
      ...
      if (void 0 === n) {
        if (nW(i, t)) return;
        (e.uniformMatrix4fv(this.addr, !1, t), nX(i, t));
      } else {
        if (nW(i, n)) return;
        (nV.set(n), e.uniformMatrix4fv(this.addr, !1, nV), nX(i, n));
      }
    }
    function n0(e, t) {
      let i = this.cache;
    ...
    function n1(e, t) {
      ...
      if (void 0 !== t.x)
        ...
        if (nW(i, t)) return;
        (e.uniform2iv(this.addr, t), nX(i, t));
      }
    }
    function n3(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        ...
        if (nW(i, t)) return;
        (e.uniform3iv(this.addr, t), nX(i, t));
      }
    }
    function n2(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        ...
        if (nW(i, t)) return;
        (e.uniform4iv(this.addr, t), nX(i, t));
      }
    }
    function n4(e, t) {
      let i = this.cache;
    ...
    function n5(e, t) {
      ...
      if (void 0 !== t.x)
        ...
        if (nW(i, t)) return;
        (e.uniform2uiv(this.addr, t), nX(i, t));
      }
    }
    function n6(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        ...
        if (nW(i, t)) return;
        (e.uniform3uiv(this.addr, t), nX(i, t));
      }
    }
    function n8(e, t) {
      let i = this.cache;
      if (void 0 !== t.x)
        ...
        if (nW(i, t)) return;
        (e.uniform4uiv(this.addr, t), nX(i, t));
      }
    }
    function n9(e, t, i) {
      let n,
      ...
      (r[0] !== a && (e.uniform1i(this.addr, a), (r[0] = a)),
        this.type === e.SAMPLER_2D_SHADOW
          ? ((nN.compareFunction = i.isReversedDepthBuffer() ? 518 : 515),
            (n = nN))
          : (n = nD),
    ...
    function n7(e, t, i) {
      ...
      (n[0] !== r && (e.uniform1i(this.addr, r), (n[0] = r)),
        i.setTexture3D(t || nO, r));
    }
    function re(e, t, i) {
      let n = this.cache,
        r = i.allocateTextureUnit();
      (n[0] !== r && (e.uniform1i(this.addr, r), (n[0] = r)),
        i.setTextureCube(t || nF, r));
    }
    function rt(e, t, i) {
      let n = this.cache,
        r = i.allocateTextureUnit();
      (n[0] !== r && (e.uniform1i(this.addr, r), (n[0] = r)),
        i.setTexture2DArray(t || nI, r));
    }
    function ri(e, t) {
      e.uniform1fv(this.addr, t);
    }
    function rn(e, t) {
      let i = nk(t, this.size, 2);
      e.uniform2fv(this.addr, i);
    }
    function rr(e, t) {
      let i = nk(t, this.size, 3);
      e.uniform3fv(this.addr, i);
    }
    function ra(e, t) {
      let i = nk(t, this.size, 4);
    ...
    function ro(e, t) {
      let i = nk(t, this.size, 9);
      e.uniformMatrix3fv(this.addr, !1, i);
    }
    function rl(e, t) {
      let i = nk(t, this.size, 16);
    ...
    function r_(e, t, i) {
      let n,
        ...
        a = t.length,
        s = nj(i, a);
      (nW(r, s) || (e.uniform1iv(this.addr, s), nX(r, s)),
        (n = this.type === e.SAMPLER_2D_SHADOW ? nN : nD));
      for (let e = 0; e !== a; ++e) i.setTexture2D(t[e] || n, s[e]);
    }
    function rv(e, t, i) {
      let n = this.cache,
        r = t.length,
        a = nj(i, r);
      nW(n, a) || (e.uniform1iv(this.addr, a), nX(n, a));
      for (let e = 0; e !== r; ++e) i.setTexture3D(t[e] || nO, a[e]);
    }
    function rx(e, t, i) {
      let n = this.cache,
        r = t.length,
        a = nj(i, r);
      nW(n, a) || (e.uniform1iv(this.addr, a), nX(n, a));
      for (let e = 0; e !== r; ++e) i.setTextureCube(t[e] || nF, a[e]);
    }
    function rM(e, t, i) {
      let n = this.cache,
        r = t.length,
        a = nj(i, r);
      nW(n, a) || (e.uniform1iv(this.addr, a), nX(n, a));
      for (let e = 0; e !== r; ++e) i.setTexture2DArray(t[e] || nI, a[e]);
    }
    class rS {
      constructor(e, t, i) {
        ((this.id = e),
          ...
          !(function (e, t, i) {
            ...
            for (rE.lastIndex = 0; ; ) {
              ...
              if ((l && (o |= 0), void 0 === h || ('[' === h && s + 2 === r))) {
                rb(i, void 0 === h ? new rS(o, e, t) : new ry(o, e, t));
                break;
              }
              {
                let e = i.map[o];
                (void 0 === e && rb(i, (e = new rT(o))), (i = e));
              }
            }
          })(i, r, this);
        }
    ...
    let rW = { 1: 'SHADOWMAP_TYPE_PCF', 3: 'SHADOWMAP_TYPE_VSM' },
      rX = {
        301: 'ENVMAP_TYPE_CUBE',
        302: 'ENVMAP_TYPE_CUBE',
        306: 'ENVMAP_TYPE_CUBE_UV',
      },
      rj = { 302: 'ENVMAP_MODE_REFRACTION' },
      rq = {
    ...
    function rY(e, t, i, n) {
      ...
      let s,
        ...
        m = i.vertexShader,
        g = i.fragmentShader,
        x = rW[i.shadowMapType] || 'SHADOWMAP_TYPE_BASIC',
        M =
          !1 === i.envMap
            ? 'ENVMAP_TYPE_CUBE'
            : rX[i.envMapMode] || 'ENVMAP_TYPE_CUBE',
        S =
          !1 === i.envMap
            ? 'ENVMAP_MODE_REFLECTION'
            : rj[i.envMapMode] || 'ENVMAP_MODE_REFLECTION',
        y =
          !1 === i.envMap
            ? 'ENVMAP_BLENDING_NONE'
            : rq[i.combine] || 'ENVMAP_BLENDING_NONE',
        T = (function (e) {
        ...
        w = p.createProgram(),
        A = i.glslVersion ? '#version ' + i.glslVersion + '\n' : '';
      if (i.isRawShaderMaterial)
        ...
        ((s = [
          ...
          (o = [
            ...
            i.transmissionMap ? '#define USE_TRANSMISSIONMAP' : '',
            i.thicknessMap ? '#define USE_THICKNESSMAP' : '',
            i.vertexTangents && !1 === i.flatShading
              ? '#define USE_TANGENT'
              : '',
            ...
            0 !== i.toneMapping ? i9.tonemapping_pars_fragment : '',
            0 !== i.toneMapping
              ? ((r = 'toneMapping'),
                void 0 === (e = rL[(a = i.toneMapping)])
                  ? (_('WebGLProgram: Unsupported toneMapping:', a),
                    'vec3 ' +
                      r +
            ...
            i9.colorspace_pars_fragment,
            ((t = (function (e) {
              F._getMatrix(rC, F.workingColorSpace, e);
              let t = `mat3( ${rC.elements.map((e) => e.toFixed(4))} )`;
              switch (F.getTransfer(e)) {
                case c:
                ...
                default:
                  return (
                    _('WebGLProgram: Unsupported color space: ', e),
	...
	return dot( weights, rgb );
      ...
      ((m = rI((m = rN((m = rF(m)), i)), i)),
        (g = rI((g = rN((g = rF(g)), i)), i)),
        (m = rG(m)),
        (g = rG(g)),
        !0 !== i.isRawShaderMaterial &&
          ...
          (o =
            [
              ...
              i.glslVersion === d ? '' : '#define gl_FragColor pc_fragColor',
      ...
      let R = A + s + m,
        C = A + o + g,
        P = rA(p, p.VERTEX_SHADER, R),
        L = rA(p, p.FRAGMENT_SHADER, C);
      function U(t) {
        if (e.debug.checkShaderErrors) {
          let i = p.getProgramInfoLog(w) || '',
            n = p.getShaderInfoLog(P) || '',
            r = p.getShaderInfoLog(L) || '',
            a = i.trim(),
            l = n.trim(),
            h = r.trim(),
            c = !0,
            u = !0;
          if (!1 === p.getProgramParameter(w, p.LINK_STATUS))
            if (((c = !1), 'function' == typeof e.debug.onShaderError))
              e.debug.onShaderError(p, w, P, L);
            else {
              let e = rP(p, P, 'vertex'),
                i = rP(p, L, 'fragment');
              v(
                'THREE.WebGLProgram: Shader Error ' +
                  p.getError() +
                  ' - VALIDATE_STATUS ' +
                  p.getProgramParameter(w, p.VALIDATE_STATUS) +
                  '\n\nMaterial Name: ' +
                  t.name +
                  '\nMaterial Type: ' +
                  t.type +
            ...
            '' !== a
              ? _('WebGLProgram: Program Info Log:', a)
              : ('' === l || '' === h) && (u = !1);
          u &&
            (t.diagnostics = {
              runnable: c,
              programLog: a,
              vertexShader: { log: l, prefix: s },
              fragmentShader: { log: h, prefix: o },
            });
        }
        (p.deleteShader(P),
          p.deleteShader(L),
      ...
      (p.attachShader(w, P),
        ...
        void 0 !== i.index0AttributeName
          ? p.bindAttribLocation(w, 0, i.index0AttributeName)
          : !0 === i.morphTargets && p.bindAttribLocation(w, 0, 'position'),
        p.linkProgram(w),
        (this.getUniforms = function () {
          return (void 0 === l && U(this), l);
        }),
        (this.getAttributes = function () {
          return (void 0 === h && U(this), h);
        }));
      let D = !1 === i.rendererExtensionParallelShaderCompile;
      return (
        (this.isReady = function () {
          return (!1 === D && (D = p.getProgramParameter(w, 37297)), D);
        }),
    ...
    class rJ {
      ...
      _getShaderStage(e) {
        let t = this.shaderCache,
          i = t.get(e);
        return (void 0 === i && ((i = new rZ(e)), t.set(e, i)), i);
      }
    }
    class rZ {
      constructor(e) {
    ...
    function rQ(e, t, i, n, r, a, s) {
      ...
      return {
        getParameters: function (a, o, d, p, x) {
          let M,
            S,
            y,
            T,
            ...
            A = (a.isMeshStandardMaterial ? i : t).get(a.envMap || w),
            R = A && 306 === A.mapping ? A.image.height : null,
            C = g[a.type];
          null !== a.precision &&
          ...
          let P =
            ...
            U = 0;
          if (
            (void 0 !== b.morphAttributes.position && (U = 1),
          ...
          let D = e.getRenderTarget(),
            ...
            ei = J && !!a.clearcoatMap,
            en = J && !!a.clearcoatNormalMap,
            er = J && !!a.clearcoatRoughnessMap,
          ...
          let eM = {
            ...
            precision: m,
            batching: O,
            batchingColor: O && null !== x._colorsTexture,
            instancing: I,
            ...
            alphaHash: e_,
            combine: a.combine,
            mapUv: B && v(a.map.channel),
            aoMapUv: G && v(a.aoMap.channel),
            lightMapUv: H && v(a.lightMap.channel),
            bumpMapUv: k && v(a.bumpMap.channel),
            normalMapUv: W && v(a.normalMap.channel),
            displacementMapUv: X && v(a.displacementMap.channel),
            emissiveMapUv: j && v(a.emissiveMap.channel),
            metalnessMapUv: q && v(a.metalnessMap.channel),
            roughnessMapUv: Y && v(a.roughnessMap.channel),
            anisotropyMapUv: et && v(a.anisotropyMap.channel),
            clearcoatMapUv: ei && v(a.clearcoatMap.channel),
            clearcoatNormalMapUv: en && v(a.clearcoatNormalMap.channel),
            clearcoatRoughnessMapUv: er && v(a.clearcoatRoughnessMap.channel),
            iridescenceMapUv: ea && v(a.iridescenceMap.channel),
            iridescenceThicknessMapUv:
              es && v(a.iridescenceThicknessMap.channel),
            sheenColorMapUv: eo && v(a.sheenColorMap.channel),
            sheenRoughnessMapUv: el && v(a.sheenRoughnessMap.channel),
            specularMapUv: eh && v(a.specularMap.channel),
            specularColorMapUv: ec && v(a.specularColorMap.channel),
            specularIntensityMapUv: eu && v(a.specularIntensityMap.channel),
            transmissionMapUv: ed && v(a.transmissionMap.channel),
            thicknessMapUv: ep && v(a.thicknessMap.channel),
            alphaMapUv: em && v(a.alphaMap.channel),
            ...
            decodeVideoTexture:
              ...
              F.getTransfer(a.map.colorSpace) === u,
            decodeVideoTextureEmissive:
              j &&
              !0 === a.emissiveMap.isVideoTexture &&
              F.getTransfer(a.emissiveMap.colorSpace) === u,
          ...
          return (
            (eM.vertexUv1s = c.has(1)),
            (eM.vertexUv2s = c.has(2)),
            (eM.vertexUv3s = c.has(3)),
            c.clear(),
            eM
          );
        },
        getProgramCacheKey: function (t) {
          ...
          if (
            (t.shaderID
              ? s.push(t.shaderID)
              : (s.push(t.customVertexShaderID),
                s.push(t.customFragmentShaderID)),
            void 0 !== t.defines)
          )
          ...
          return (
            !1 === t.isRawShaderMaterial &&
              ...
              (a = t),
              o.disableAll(),
              a.instancing && o.enable(0),
              a.instancingColor && o.enable(1),
              a.instancingMorph && o.enable(2),
              a.matcap && o.enable(3),
              a.envMap && o.enable(4),
              a.normalMapObjectSpace && o.enable(5),
              a.normalMapTangentSpace && o.enable(6),
              a.clearcoat && o.enable(7),
              a.iridescence && o.enable(8),
              a.alphaTest && o.enable(9),
              a.vertexColors && o.enable(10),
              a.vertexAlphas && o.enable(11),
              a.vertexUv1s && o.enable(12),
              a.vertexUv2s && o.enable(13),
              a.vertexUv3s && o.enable(14),
              a.vertexTangents && o.enable(15),
              a.anisotropy && o.enable(16),
              a.alphaHash && o.enable(17),
              a.batching && o.enable(18),
              a.dispersion && o.enable(19),
              a.batchingColor && o.enable(20),
              a.gradientMap && o.enable(21),
              r.push(o.mask),
              o.disableAll(),
              a.fog && o.enable(0),
              a.useFog && o.enable(1),
              ...
              a.reversedDepthBuffer && o.enable(4),
              a.skinning && o.enable(5),
              a.morphTargets && o.enable(6),
              a.morphNormals && o.enable(7),
              a.morphColors && o.enable(8),
              a.premultipliedAlpha && o.enable(9),
              a.shadowMapEnabled && o.enable(10),
              ...
              a.decodeVideoTexture && o.enable(19),
              a.decodeVideoTextureEmissive && o.enable(20),
              a.alphaToCoverage && o.enable(21),
              r.push(o.mask),
              s.push(e.outputColorSpace)),
        ...
        getUniforms: function (e) {
          let t,
            i = g[e.type];
          return (t = i ? tz(ne[i].uniforms) : e.uniforms);
        },
        acquireProgram: function (t, i) {
          ...
          return (
            void 0 !== n
              ? ++n.usedTimes
              : ((n = new rY(e, i, t, a)), d.push(n), p.set(i, n)),
            n
          );
        },
    ...
    function r3() {
      ...
      return {
        ...
        sort: function (e, t) {
          (i.length > 1 && i.sort(e || r0),
            n.length > 1 && n.sort(t || r1),
            r.length > 1 && r.sort(t || r1));
        },
      };
    }
    function r2() {
        ...
        get: function (t) {
          ...
          switch (t.type) {
            case 'DirectionalLight':
              i = { direction: new P(), color: new ta() };
              break;
            case 'SpotLight':
              i = {
                position: new P(),
              ...
              break;
            case 'PointLight':
              i = { position: new P(), color: new ta(), distance: 0, decay: 0 };
              break;
        ...
        setup: function (t) {
          ...
          for (let e = 0, x = t.length; e < x; e++) {
            ...
            if (
              ...
              (e.position.setFromMatrixPosition(x.matrixWorld),
                e.color.copy(M).multiplyScalar(S),
                (e.distance = y),
              ...
              if (
                ...
                ((t.shadowIntensity = e.intensity),
                  ...
                  (r.pointShadowMatrix[h] = x.shadow.matrix),
                  f++);
              }
              ((r.point[h] = e), h++);
          ...
          (u > 0 &&
            (!0 === e.has('OES_texture_float_linear')
              ? ((r.rectAreaLTC1 = i7.LTC_FLOAT_1),
                (r.rectAreaLTC2 = i7.LTC_FLOAT_2))
              : ((r.rectAreaLTC1 = i7.LTC_HALF_1),
                (r.rectAreaLTC2 = i7.LTC_HALF_2))),
            (r.ambient[0] = a),
            (r.ambient[1] = s),
            (r.ambient[2] = o));
          let x = r.hash;
          (x.directionalLength !== l ||
            ...
            (r.spotLightMatrix.length = m + g - _),
    ...
    function aa(e, t, i) {
      ...
      f.setAttribute(
        'position',
        new tp(new Float32Array([-1, -1, 0.5, 3, -1, 0.5, -1, 3, 0.5]), 3)
      );
      let m = new tO(f, d),
        g = this;
      ((this.enabled = !1),
      ...
      function x(t, i, n, r) {
        ...
        if (void 0 !== s) a = s;
          ...
          let r = n[t];
          (void 0 === r &&
            ((r = a.clone()), (n[t] = r), i.addEventListener('dispose', M)),
            (a = r));
        }
        return (
          (a.visible = i.visible),
          ...
          (a.alphaTest = !0 === i.alphaToCoverage ? 0.5 : i.alphaTest),
          (a.map = i.map),
      ...
      function M(e) {
        for (let t in (e.target.removeEventListener('dispose', M), h)) {
          let i = h[t],
            n = e.target.uuid;
      ...
      this.render = function (i, o, l) {
        ...
        for (let h = 0, u = i.length; h < u; h++) {
          let u = i[h],
            f = u.shadow;
          if (void 0 === f) {
            _('WebGLShadowMap:', u, 'has no shadow.');
            continue;
          }
          ...
          if (
            ...
            if (
              ...
              ((f.map = new K(r.x, r.y, {
                ...
                (f.map.depthTexture = new ie(r.x, r.y, 1015)),
                (f.map.depthTexture.name = u.name + '.shadowMapDepth'),
                (f.map.depthTexture.format = 1026),
                (f.map.depthTexture.compareFunction = null),
                (f.map.depthTexture.minFilter = 1003),
                (f.map.depthTexture.magFilter = 1003));
            } else {
              (u.isPointLight
                ? ((f.map = new tJ(r.x)),
                  (f.map.depthTexture = new it(r.x, 1014)))
                : ((f.map = new K(r.x, r.y)),
                  (f.map.depthTexture = new ie(r.x, r.y, 1014))),
                (f.map.depthTexture.name = u.name + '.shadowMap'),
                (f.map.depthTexture.format = 1026));
              let t = e.state.buffers.depth.getReversed();
              1 === this.type
                ? ((f.map.depthTexture.compareFunction = t ? 518 : 515),
                  (f.map.depthTexture.minFilter = 1006),
                  (f.map.depthTexture.magFilter = 1006))
                : ((f.map.depthTexture.compareFunction = null),
                  (f.map.depthTexture.minFilter = 1003),
                  (f.map.depthTexture.magFilter = 1003));
            }
          ...
          for (let i = 0; i < v; i++) {
            if (f.map.isWebGLCubeRenderTarget)
              (e.setRenderTarget(f.map, i), e.clear());
            else {
              0 === i && (e.setRenderTarget(f.map), e.clear());
              let t = f.getViewport(i);
            ...
            if (u.isPointLight) {
              let e = f.camera,
                t = f.matrix,
                n = u.distance || e.far;
              (n !== e.far && ((e.far = n), e.updateProjectionMatrix()),
                an.setFromMatrixPosition(u.matrixWorld),
                e.position.copy(an),
                ar.copy(e.position),
                ar.add(ae[i]),
                e.up.copy(at[i]),
                e.lookAt(ar),
                e.updateMatrixWorld(),
                t.makeTranslation(-an.x, -an.y, -an.z),
                ai.multiplyMatrices(e.projectionMatrix, e.matrixWorldInverse),
                f._frustum.setFromProjectionMatrix(
                  ai,
                  e.coordinateSystem,
                  e.reversedDepth
                ));
          ...
          (!0 !== f.isPointLightShadow &&
            ...
            (function (i, n) {
              ...
              (d.defines.VSM_SAMPLES !== i.blurSamples &&
                ...
                (p.needsUpdate = !0)),
                null === i.mapPass &&
                  (i.mapPass = new K(r.x, r.y, { format: 1030, type: 1016 })),
                (d.uniforms.shadow_pass.value = i.map.depthTexture),
    ...
    let as = { 0: 1, 2: 6, 4: 7, 3: 5, 1: 0, 6: 2, 7: 4, 5: 3 };
    function ao(e, t) {
      let i = new (function () {
          let t = !1,
            i = new q(),
        ...
        n = new (function () {
          ...
          return {
            setReversed: function (e) {
              if (n !== e) {
                let i = t.get('EXT_clip_control');
                (e
                  ? i.clipControlEXT(i.LOWER_LEFT_EXT, i.ZERO_TO_ONE_EXT)
                  : i.clipControlEXT(
                      i.LOWER_LEFT_EXT,
                      i.NEGATIVE_ONE_TO_ONE_EXT
                    ),
                  (n = e));
                let r = s;
        ...
        r = new (function () {
          ...
          return {
            setTest: function (i) {
              t || (i ? V(e.STENCIL_TEST) : G(e.STENCIL_TEST));
            },
            setMask: function (n) {
        ...
        A = null,
        R = null,
        C = e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),
        P = !1,
        L = e.getParameter(e.VERSION);
      -1 !== L.indexOf('WebGL')
        ? (P = parseFloat(/^WebGL (\d)/.exec(L)[1]) >= 1)
        : -1 !== L.indexOf('OpenGL ES') &&
          (P = parseFloat(/^OpenGL ES (\d)/.exec(L)[1]) >= 2);
      let U = null,
        D = {},
      ...
      function W(t, i, n, r, a, s, o, l, h, c) {
        ...
        ((a = a || i),
          ...
          (o = o || r),
          (i !== f || a !== _) &&
            (e.blendEquationSeparate(H[i], H[a]), (f = i), (_ = a)),
          (n !== m || r !== g || s !== x || o !== M) &&
            (e.blendFuncSeparate(k[n], k[r], k[s], k[o]),
            (m = n),
            (g = r),
            (x = s),
            (M = o)),
          (!1 === l.equals(S) || h !== y) &&
            (e.blendColor(l.r, l.g, l.b, h), S.copy(l), (y = h)),
          (p = t),
          (T = !1));
      }
      function X(t) {
      ...
      function Y(t, i, n) {
        t
          ? (V(e.POLYGON_OFFSET_FILL),
            (A !== i || R !== n) && (e.polygonOffset(i, n), (A = i), (R = n)))
      ...
      return {
        ...
        bindTexture: function (t, i, n) {
          void 0 === n && (n = null === U ? e.TEXTURE0 + C - 1 : U);
          let r = D[n];
          (void 0 === r &&
            ((r = { type: void 0, texture: void 0 }), (D[n] = r)),
            (r.type !== t || r.texture !== i) &&
              (U !== n && (e.activeTexture(n), (U = n)),
        ...
        updateUBOMapping: function (t, i) {
          ...
          let r = n.get(t);
          void 0 === r &&
            ((r = e.getUniformBlockIndex(i, t.name)), n.set(t, r));
        },
    ...
    function al(e, t, i, n, r, a, s) {
      ...
      function E(i, n, r, a, s = !1) {
        ...
        if (
          ...
          n === e.RGBA_INTEGER &&
            ...
            r === e.INT && (o = e.RGBA32I)),
          n === e.RGB &&
            (r === e.UNSIGNED_INT_5_9_9_9_REV && (o = e.RGB9_E5),
            r === e.UNSIGNED_INT_10F_11F_11F_REV && (o = e.R11F_G11F_B10F)),
          n === e.RGBA)
        ) {
          let t = s ? c : F.getTransfer(a);
          (r === e.FLOAT && (o = e.RGBA32F),
            r === e.HALF_FLOAT && (o = e.RGBA16F),
            r === e.UNSIGNED_BYTE && (o = t === u ? e.SRGB8_ALPHA8 : e.RGBA8),
      ...
      function U(t, r) {
        ...
        if (
          ...
          if (null === e)
            ...
            if (!1 !== e.complete) return void V(l, t, r);
            _(
          ...
          t.isExternalTexture &&
            (l.__webglTexture = t.sourceTexture ? t.sourceTexture : null);
        i.bindTexture(e.TEXTURE_2D, l.__webglTexture, e.TEXTURE0 + r);
      }
      let D = { 1e3: e.REPEAT, 1001: e.CLAMP_TO_EDGE, 1002: e.MIRRORED_REPEAT },
        N = {
          1003: e.NEAREST,
      ...
      function O(i, a) {
        if (
          ...
          e.texParameteri(i, e.TEXTURE_WRAP_S, D[a.wrapS]),
          e.texParameteri(i, e.TEXTURE_WRAP_T, D[a.wrapT]),
          (i === e.TEXTURE_3D || i === e.TEXTURE_2D_ARRAY) &&
            e.texParameteri(i, e.TEXTURE_WRAP_R, D[a.wrapR]),
          ...
          a.compareFunction &&
            ...
            e.texParameteri(i, e.TEXTURE_COMPARE_FUNC, I[a.compareFunction])),
      ...
      function B(t, i) {
        ...
        let l =
          ...
          n.push(i.minFilter),
          n.push(i.anisotropy),
          n.push(i.internalFormat),
          n.push(i.format),
          n.push(i.type),
          n.push(i.generateMipmaps),
          n.push(i.premultiplyAlpha),
          n.push(i.flipY),
          n.push(i.unpackAlignment),
          n.push(i.colorSpace),
          n.join());
        if (l !== t.__cacheKey) {
          (void 0 === o[l] &&
          ...
          (void 0 !== n &&
            (o[t.__cacheKey].usedTimes--, 0 === n.usedTimes && P(i)),
            (t.__cacheKey = l),
      ...
      function z(e, t, i) {
        return Math.floor(Math.floor(e / i) / t);
      }
      function V(t, s, o) {
        let l = e.TEXTURE_2D;
        ...
        if (c.version !== u.__version || !0 === h) {
          ...
          let n = F.getPrimaries(F.workingColorSpace),
            d = '' === s.colorSpace ? null : F.getPrimaries(s.colorSpace),
            p =
              '' === s.colorSpace || n === d ? e.NONE : e.BROWSER_DEFAULT_WEBGL;
          ...
          let f = S(s.image, !1, r.maxTextureSize);
          f = K(s, f);
          let m = a.convert(s.format, s.colorSpace),
            g = a.convert(s.type),
            v = E(s.internalFormat, m, g, s.colorSpace, s.isVideoTexture);
          O(l, s);
          let x = s.mipmaps,
            ...
            C = w(s, f);
          if (s.isDepthTexture)
            ((v = b(1027 === s.format, s.type)),
              A &&
                (M
                  ? i.texStorage2D(e.TEXTURE_2D, 1, v, f.width, f.height)
                  : i.texImage2D(
                      e.TEXTURE_2D,
                      0,
                      v,
            ...
            if (x.length > 0) {
              M &&
                A &&
                i.texStorage2D(e.TEXTURE_2D, C, v, x[0].width, x[0].height);
              for (let n = 0, r = x.length; n < r; n++)
                ((t = x[n]),
                  M
                    ? R &&
                      i.texSubImage2D(
              ...
              M
                ? (A && i.texStorage2D(e.TEXTURE_2D, C, v, f.width, f.height),
                  R &&
                    (function (t, n, r, a) {
                      ...
                      if (0 === s.length)
                        ...
                        for (let e = 1; e < s.length; e++) {
                          let t = s[o],
                            i = s[e],
                            r = t.start + t.count,
                            a = z(i.start, n.width, 4),
                            l = z(t.start, n.width, 4);
                          i.start <= r + 1 &&
                          a === l &&
                          z(i.start + i.count - 1, n.width, 4) === a
                            ? (t.count = Math.max(
                                t.count,
                        ...
                        s.length = o + 1;
                        let l = e.getParameter(e.UNPACK_ROW_LENGTH),
                          h = e.getParameter(e.UNPACK_SKIP_PIXELS),
                          c = e.getParameter(e.UNPACK_SKIP_ROWS);
                        e.pixelStorei(e.UNPACK_ROW_LENGTH, n.width);
                        for (let t = 0, o = s.length; t < o; t++) {
                          let o = s[t],
                            l = Math.floor(o.start / 4),
                            h = Math.ceil(o.count / 4),
                            c = l % n.width,
                        ...
                        (t.clearUpdateRanges(),
                          ...
                          e.pixelStorei(e.UNPACK_SKIP_ROWS, c));
                      }
                    })(s, f, m, g))
                : i.texImage2D(
                    e.TEXTURE_2D,
            ...
            if (s.isCompressedArrayTexture) {
              ...
              for (let n = 0, r = x.length; n < r; n++)
                if (((t = x[n]), 1023 !== s.format))
                  if (null !== m)
                    if (M) {
                      if (R)
                        if (s.layerUpdates.size > 0) {
                          let r = i5(t.width, t.height, s.format, s.type);
            ...
            if (M) {
              if (
                ...
                if (s.layerUpdates.size > 0) {
                  let t = i5(f.width, f.height, s.format, s.type);
            ...
            if (A)
              if (M) i.texStorage2D(e.TEXTURE_2D, C, v, f.width, f.height);
              else {
                let t = f.width,
                  n = f.height;
                for (let r = 0; r < C; r++)
                  (i.texImage2D(e.TEXTURE_2D, r, v, t, n, 0, m, g, null),
                    (t >>= 1),
                    (n >>= 1));
              }
          } else if (x.length > 0) {
            if (M && A) {
              let t = J(x[0]);
              i.texStorage2D(e.TEXTURE_2D, C, v, t.width, t.height);
            }
            for (let n = 0, r = x.length; n < r; n++)
              ((t = x[n]),
                M
                  ? R && i.texSubImage2D(e.TEXTURE_2D, n, 0, 0, m, g, t)
                  : i.texImage2D(e.TEXTURE_2D, n, v, m, g, t));
            s.generateMipmaps = !1;
          } else if (M) {
            if (A) {
              let t = J(f);
            ...
            R && i.texSubImage2D(e.TEXTURE_2D, 0, 0, 0, m, g, f);
          } else i.texImage2D(e.TEXTURE_2D, 0, v, m, g, f);
          (y(s) && T(l),
      ...
      function G(t, r, s, o, h, c) {
        let u = a.convert(s.format, s.colorSpace),
          d = a.convert(s.type),
          p = E(s.internalFormat, u, d, s.colorSpace),
          f = n.get(r),
          m = n.get(s);
        ...
        (i.bindFramebuffer(e.FRAMEBUFFER, t),
          Y(r)
            ...
            : (h === e.TEXTURE_2D ||
              ...
              e.framebufferTexture2D(e.FRAMEBUFFER, o, h, m.__webglTexture, c),
        ...
        if ((e.bindRenderbuffer(e.RENDERBUFFER, t), i.depthBuffer)) {
          ...
          for (let r = 0; r < t.length; r++) {
            let s = t[r],
              ...
              h = a.convert(s.type),
              c = E(s.internalFormat, o, h, s.colorSpace);
            Y(i)
              ? l.renderbufferStorageMultisampleEXT(
                  e.RENDERBUFFER,
                  q(i),
      ...
      function k(t, r, s) {
        ...
        if (
          ...
          if (
            (void 0 === h.__webglInit &&
              ((h.__webglInit = !0),
              r.depthTexture.addEventListener('dispose', A)),
            void 0 === h.__webglTexture)
          ) {
            let t;
            ((h.__webglTexture = e.createTexture()),
              i.bindTexture(e.TEXTURE_CUBE_MAP, h.__webglTexture),
              O(e.TEXTURE_CUBE_MAP, r.depthTexture));
            let n = a.convert(r.depthTexture.format),
              s = a.convert(r.depthTexture.type);
            1026 === r.depthTexture.format
              ? (t = e.DEPTH_COMPONENT24)
              : 1027 === r.depthTexture.format && (t = e.DEPTH24_STENCIL8);
            for (let i = 0; i < 6; i++)
              e.texImage2D(
        ...
        } else U(r.depthTexture, 0);
        let c = h.__webglTexture,
          u = q(r),
          d = o ? e.TEXTURE_CUBE_MAP_POSITIVE_X + s : e.TEXTURE_2D,
          p =
            1027 === r.depthTexture.format
              ? e.DEPTH_STENCIL_ATTACHMENT
              : e.DEPTH_ATTACHMENT;
        if (1026 === r.depthTexture.format)
          Y(r)
            ? l.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER, p, d, c, 0, u)
            : e.framebufferTexture2D(e.FRAMEBUFFER, p, d, c, 0);
      ...
      function W(t) {
        ...
        if (t.depthTexture && !r.__autoAllocateDepthBuffer)
          if (a) for (let e = 0; e < 6; e++) k(r.__webglFramebuffer[e], t, e);
          else {
            let e = t.texture.mipmaps;
            e && e.length > 0
              ? k(r.__webglFramebuffer[0], t, 0)
              : k(r.__webglFramebuffer, t, 0);
          }
        else if (a) {
          ...
          let n = t.texture.mipmaps;
          if (
            (n && n.length > 0
              ? i.bindFramebuffer(e.FRAMEBUFFER, r.__webglFramebuffer[0])
          ...
          !0 === e.isCompressedTexture ||
            ...
            (i !== h &&
              ...
              (F.getTransfer(i) === u
                ...
                : v('WebGLTextures: Unsupported texture color space:', i))),
          t
        );
      }
      function J(e) {
          ...
          o.__version !== t.version
            ? (function (t, s, o) {
                ...
                if (h.version !== c.__version || !0 === l) {
                  ...
                  let n = F.getPrimaries(F.workingColorSpace),
                    u =
                      '' === s.colorSpace ? null : F.getPrimaries(s.colorSpace),
                    d =
                      '' === s.colorSpace || n === u
                        ? e.NONE
                  ...
                  for (let e = 0; e < 6; e++)
                    (p || f
                      ...
                      : (m[e] = S(s.image[e], !0, r.maxCubemapSize)),
                      (m[e] = K(s, m[e])));
                  let g = m[0],
                    v = a.convert(s.format, s.colorSpace),
                    x = a.convert(s.type),
                    M = E(s.internalFormat, v, x, s.colorSpace),
                    b = !0 !== s.isVideoTexture,
                    A = void 0 === c.__version || !0 === l,
                    R = h.dataReady,
                    C = w(s, g);
                  if ((O(e.TEXTURE_CUBE_MAP, s), p)) {
                    b &&
                      A &&
                      i.texStorage2D(
                        e.TEXTURE_CUBE_MAP,
            ...
            if (t.samples > 0 && !1 === Y(t)) {
              ...
              (e.bindRenderbuffer(e.RENDERBUFFER, null),
                t.depthBuffer &&
                  ...
                  H(o.__webglDepthRenderbuffer, t, !0)),
                i.bindFramebuffer(e.FRAMEBUFFER, null));
            }
          }
          if (c) {
            (i.bindTexture(e.TEXTURE_CUBE_MAP, l.__webglTexture),
              O(e.TEXTURE_CUBE_MAP, r));
            for (let i = 0; i < 6; i++)
              if (r.mipmaps && r.mipmaps.length > 0)
            ...
            (y(r) && T(e.TEXTURE_CUBE_MAP), i.unbindTexture());
          } else if (u) {
            for (let r = 0, a = h.length; r < a; r++) {
              ...
              ((t.isWebGL3DRenderTarget || t.isWebGLArrayRenderTarget) &&
                (l = t.isWebGL3DRenderTarget
                  ? e.TEXTURE_3D
                  : e.TEXTURE_2D_ARRAY),
                i.bindTexture(l, s.__webglTexture),
                O(l, a),
                G(o.__webglFramebuffer, t, a, e.COLOR_ATTACHMENT0 + r, l, 0),
                y(a) && T(l));
            }
            i.unbindTexture();
          } else {
            ...
            if (
              ...
              for (let i = 0; i < r.mipmaps.length; i++)
                G(o.__webglFramebuffer[i], t, r, e.COLOR_ATTACHMENT0, n, i);
            else G(o.__webglFramebuffer, t, r, e.COLOR_ATTACHMENT0, n, 0);
            (y(r) && T(n), i.unbindTexture());
          }
          t.depthBuffer && W(t);
        }),
        (this.updateRenderTargetMipmap = function (t) {
          ...
          for (let a = 0, s = r.length; a < s; a++) {
            ...
            if (y(s)) {
              ...
              (i.bindTexture(r, a), T(r), i.unbindTexture());
            }
          }
        }),
        (this.updateMultisampleRenderTarget = function (t) {
          if (t.samples > 0) {
            if (!1 === Y(t)) {
              ...
              u && u.length > 0
                ? i.bindFramebuffer(e.DRAW_FRAMEBUFFER, h.__webglFramebuffer[0])
    ...
    function ah(e, t) {
      return {
        convert: function (i, n = '') {
          ...
          if (35899 === i) return e.UNSIGNED_INT_10F_11F_11F_REV;
          ...
          if (
            ...
            if (null === (r = t.get('WEBGL_compressed_texture_etc')))
              return null;
            if (36196 === i || 37492 === i)
              return a === u ? r.COMPRESSED_SRGB8_ETC2 : r.COMPRESSED_RGB8_ETC2;
            if (37496 === i)
              return a === u
                ? r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC
                : r.COMPRESSED_RGBA8_ETC2_EAC;
            if (37488 === i) return r.COMPRESSED_R11_EAC;
            if (37489 === i) return r.COMPRESSED_SIGNED_R11_EAC;
            if (37490 === i) return r.COMPRESSED_RG11_EAC;
            if (37491 === i) return r.COMPRESSED_SIGNED_RG11_EAC;
          }
          if (
            37808 === i ||
            37809 === i ||
          ...
          if (36283 === i || 36284 === i || 36285 === i || 36286 === i) {
            if (null === (r = t.get('EXT_texture_compression_rgtc')))
              return null;
            if (36283 === i) return r.COMPRESSED_RED_RGTC1_EXT;
...
void main() {
    ...
    class ad {
      ...
      getMesh(e) {
        if (null !== this.texture && null === this.mesh) {
          ...
          this.mesh = new tO(new iy(20, 20), i);
        }
        return this.mesh;
      }
      reset() {
    ...
    class ap extends M {
      constructor(e, t) {
        ...
        function I() {
          (n.removeEventListener('select', N),
            n.removeEventListener('selectstart', N),
            n.removeEventListener('selectend', N),
            n.removeEventListener('squeeze', N),
            n.removeEventListener('squeezestart', N),
            n.removeEventListener('squeezeend', N),
            n.removeEventListener('end', I),
            n.removeEventListener('inputsourceschange', O));
          for (let e = 0; e < S.length; e++) {
            let t = y[e];
            null !== t && ((y[e] = null), S[e].disconnect(t));
          }
          for (let e in ((U = null), (D = null), m.reset(), g)) delete g[e];
          (e.setRenderTarget(x),
            (d = null),
            (u = null),
            (c = null),
        ...
        ((this.cameraAutoUpdate = !0),
          ...
          (this.getBinding = function () {
            return (null === c && f && (c = new XRWebGLBinding(n, t)), c);
          }),
          ...
          (this.setSession = async function (h) {
            if (null !== (n = h)) {
              if (
                ...
                !0 !== v.xrCompatible && (await t.makeXRCompatible()),
                (b = e.getPixelRatio()),
                e.getSize(E),
                f && 'createProjectionLayer' in XRWebGLBinding.prototype)
              ) {
                let i = null,
                  a = null,
                  s = null;
                v.depth &&
                  ((s = v.stencil ? t.DEPTH24_STENCIL8 : t.DEPTH_COMPONENT24),
                  (i = v.stencil ? 1027 : 1026),
                  (a = v.stencil ? 1020 : 1014));
                let o = {
                  colorFormat: t.RGBA8,
                  depthFormat: s,
                  scaleFactor: r,
                };
                ((u = (c = this.getBinding()).createProjectionLayer(o)),
                  n.updateRenderState({ layers: [u] }),
                  e.setPixelRatio(1),
                  e.setSize(u.textureWidth, u.textureHeight, !1),
                  (M = new K(u.textureWidth, u.textureHeight, {
                    format: 1023,
                    type: 1009,
                    depthTexture: new ie(
                      u.textureWidth,
                ...
                ((d = new XRWebGLLayer(n, t, i)),
                  ...
                  (M = new K(d.framebufferWidth, d.framebufferHeight, {
                    format: 1023,
                    type: 1009,
                    colorSpace: e.outputColorSpace,
                    stencilBuffer: v.stencil,
        ...
        ((this.updateCamera = function (e) {
          ...
          let a = e.near,
            s = e.far;
          (null !== m.texture &&
            (m.depthNear > 0 && (a = m.depthNear),
            m.depthFar > 0 && (s = m.depthFar)),
            (L.near = A.near = w.near = a),
            (L.far = A.far = w.far = s),
            (U !== L.near || D !== L.far) &&
              (n.updateRenderState({ depthNear: L.near, depthFar: L.far }),
              (U = L.near),
              (D = L.far)),
            (L.layers.mask = 6 | e.layers.mask),
            (w.layers.mask = 3 & L.layers.mask),
            (A.layers.mask = 5 & L.layers.mask));
          let o = e.parent,
            l = L.cameras;
          z(L, o);
          ...
          (2 === l.length
            ...
            null === (r = o)
              ...
              : (t.matrix.copy(r.matrixWorld),
                t.matrix.invert(),
                t.matrix.multiply(i.matrixWorld)),
            t.matrix.decompose(t.position, t.quaternion, t.scale),
            t.updateMatrixWorld(!0),
            t.projectionMatrix.copy(i.projectionMatrix),
            t.projectionMatrixInverse.copy(i.projectionMatrixInverse),
            t.isPerspectiveCamera &&
              ((t.fov = 2 * T * Math.atan(1 / t.projectionMatrix.elements[5])),
              (t.zoom = 1)));
        }),
        ...
        (G.setAnimationLoop(function (t, r) {
          if (((h = r.getViewerPose(l || a)), (p = r), null !== h)) {
            ...
            null !== d &&
              ...
              e.setRenderTarget(M));
            let r = !1;
            t.length !== L.cameras.length && ((L.cameras.length = 0), (r = !0));
            for (let i = 0; i < t.length; i++) {
              let n = t[i],
                a = null;
              if (null !== d) a = d.getViewport(n);
              else {
                let t = c.getViewSubImage(u, n);
                ((a = t.viewport),
                  0 === i &&
              ...
              (void 0 === s &&
                ...
                0 === i &&
                  (L.matrix.copy(s.matrix),
                  L.matrix.decompose(L.position, L.quaternion, L.scale)),
                !0 === r && L.cameras.push(s));
            }
            let a = n.enabledFeatures;
            if (
              a &&
              a.includes('depth-sensing') &&
              'gpu-optimized' == n.depthUsage &&
              f
            ) {
              let e = (c = i.getBinding()).getDepthInformation(t[0]);
              e && e.isValid && e.texture && m.init(e, n.renderState);
            }
    ...
    function ag(e, t) {
      ...
      function n(e, n) {
        ...
        (a &&
          ...
          a.isCubeTexture &&
            ...
            ((af.y *= -1), (af.z *= -1)),
          e.envMapRotation.value.setFromMatrix4(am.makeRotationFromEuler(af)),
          (e.flipEnvMap.value =
      ...
      return {
        refreshFogUniforms: function (t, i) {
          (i.color.getRGB(t.fogColor.value, tG(e)),
            i.isFog
        ...
        refreshMaterialUniforms: function (e, r, a, s, o) {
          ...
          r.isMeshBasicMaterial || r.isMeshLambertMaterial
            ...
            : r.isMeshToonMaterial
              ? (n(e, r),
                (l = e),
                (h = r).gradientMap && (l.gradientMap.value = h.gradientMap))
              : r.isMeshPhongMaterial
                ? (n(e, r),
                  (c = e),
                  (u = r),
                  c.specular.value.copy(u.specular),
                  (c.shininess.value = Math.max(u.shininess, 1e-4)))
                : r.isMeshStandardMaterial
                  ? (n(e, r),
                    ...
                    p.metalnessMap &&
                      ...
                      i(p.metalnessMap, d.metalnessMapTransform)),
                    (d.roughness.value = p.roughness),
                    p.roughnessMap &&
                      ((d.roughnessMap.value = p.roughnessMap),
                      i(p.roughnessMap, d.roughnessMapTransform)),
                    ...
                    r.isMeshPhysicalMaterial &&
                      ...
                      m.sheen > 0 &&
                        ...
                        (f.sheenRoughness.value = m.sheenRoughness),
                        m.sheenColorMap &&
                          ((f.sheenColorMap.value = m.sheenColorMap),
                          i(m.sheenColorMap, f.sheenColorMapTransform)),
                        m.sheenRoughnessMap &&
                          ((f.sheenRoughnessMap.value = m.sheenRoughnessMap),
                          i(
                            m.sheenRoughnessMap,
                            f.sheenRoughnessMapTransform
                          ))),
                      m.clearcoat > 0 &&
                        ((f.clearcoat.value = m.clearcoat),
                        (f.clearcoatRoughness.value = m.clearcoatRoughness),
                        m.clearcoatMap &&
                          ((f.clearcoatMap.value = m.clearcoatMap),
                          i(m.clearcoatMap, f.clearcoatMapTransform)),
                        m.clearcoatRoughnessMap &&
                          ((f.clearcoatRoughnessMap.value =
                            m.clearcoatRoughnessMap),
                          i(
                            m.clearcoatRoughnessMap,
                        ...
                        m.clearcoatNormalMap &&
                          ...
                          f.clearcoatNormalScale.value.copy(
                            m.clearcoatNormalScale
                          ),
                          1 === m.side &&
                            f.clearcoatNormalScale.value.negate())),
                      m.dispersion > 0 && (f.dispersion.value = m.dispersion),
                      m.iridescence > 0 &&
                        ((f.iridescence.value = m.iridescence),
                        (f.iridescenceIOR.value = m.iridescenceIOR),
                        (f.iridescenceThicknessMinimum.value =
                          m.iridescenceThicknessRange[0]),
                        (f.iridescenceThicknessMaximum.value =
                          m.iridescenceThicknessRange[1]),
                        m.iridescenceMap &&
                          ((f.iridescenceMap.value = m.iridescenceMap),
                          i(m.iridescenceMap, f.iridescenceMapTransform)),
                        m.iridescenceThicknessMap &&
                          ((f.iridescenceThicknessMap.value =
                            m.iridescenceThicknessMap),
                          i(
                            m.iridescenceThicknessMap,
                            f.iridescenceThicknessMapTransform
                          ))),
                      m.transmission > 0 &&
                        ((f.transmission.value = m.transmission),
                        (f.transmissionSamplerMap.value = g.texture),
                        f.transmissionSamplerSize.value.set(g.width, g.height),
                        m.transmissionMap &&
                          ((f.transmissionMap.value = m.transmissionMap),
                          i(m.transmissionMap, f.transmissionMapTransform)),
                        (f.thickness.value = m.thickness),
                        m.thicknessMap &&
                          ((f.thicknessMap.value = m.thicknessMap),
                          i(m.thicknessMap, f.thicknessMapTransform)),
                        (f.attenuationDistance.value = m.attenuationDistance),
                        f.attenuationColor.value.copy(m.attenuationColor)),
                      m.anisotropy > 0 &&
                        ...
                        m.anisotropyMap &&
                          ((f.anisotropyMap.value = m.anisotropyMap),
                          i(m.anisotropyMap, f.anisotropyMapTransform))),
                      (f.specularIntensity.value = m.specularIntensity),
                      f.specularColor.value.copy(m.specularColor),
                      m.specularColorMap &&
                        ((f.specularColorMap.value = m.specularColorMap),
                        i(m.specularColorMap, f.specularColorMapTransform)),
                      m.specularIntensityMap &&
                        ((f.specularIntensityMap.value =
                          m.specularIntensityMap),
                        i(
                          m.specularIntensityMap,
                          f.specularIntensityMapTransform
                        ))))
                  : r.isMeshMatcapMaterial
                    ? (n(e, r),
                      (_ = e),
                      (v = r).matcap && (_.matcap.value = v.matcap))
                    : r.isMeshDepthMaterial
                      ...
                      : r.isMeshDistanceMaterial
                        ? (n(e, r),
                          ...
                          (M = r),
                          (L = t.get(M).light),
                          x.referencePosition.value.setFromMatrixPosition(
                            L.matrixWorld
                          ),
                          (x.nearDistance.value = L.shadow.camera.near),
                          (x.farDistance.value = L.shadow.camera.far))
                        : r.isMeshNormalMaterial
                          ...
                          : r.isLineBasicMaterial
                            ? ((S = e),
                              ...
                              (S.opacity.value = y.opacity),
                              y.map &&
                                ((S.map.value = y.map),
                                i(y.map, S.mapTransform)),
                            ...
                            : r.isPointsMaterial
                              ? ((b = e),
                                ...
                                (b.opacity.value = w.opacity),
                                (b.size.value = w.size * A),
                                (b.scale.value = 0.5 * R),
                                w.map &&
                                  ((b.map.value = w.map),
                                  i(w.map, b.uvTransform)),
                                w.alphaMap &&
                                  ((b.alphaMap.value = w.alphaMap),
                                  i(w.alphaMap, b.alphaMapTransform)),
                                w.alphaTest > 0 &&
                                  (b.alphaTest.value = w.alphaTest))
                              : r.isSpriteMaterial
                                ? ((C = e),
                                  (P = r),
                                  C.diffuse.value.copy(P.color),
                                  (C.opacity.value = P.opacity),
                                  (C.rotation.value = P.rotation),
                                  P.map &&
                                    ((C.map.value = P.map),
                                    i(P.map, C.mapTransform)),
                                  P.alphaMap &&
                                    ((C.alphaMap.value = P.alphaMap),
                                    i(P.alphaMap, C.alphaMapTransform)),
                                  P.alphaTest > 0 &&
                                    (C.alphaTest.value = P.alphaTest))
                                : r.isShadowMaterial
      ...
      return {
        ...
        update: function (i, c) {
          ...
          void 0 === g &&
            ...
            (f = u.__size),
            (m = u.usage),
            e.bindBuffer(e.UNIFORM_BUFFER, p),
            e.bufferData(e.UNIFORM_BUFFER, f, m),
            e.bindBuffer(e.UNIFORM_BUFFER, null),
            e.bindBufferBase(e.UNIFORM_BUFFER, d, p),
            (g = p),
            (r[i.id] = g),
    ...
    class aM {
      constructor(e = {}) {
        ...
        const Y = new Set([1033, 1031, 1029]),
          J = new Set([1009, 1014, 1012, 1020, 1017, 1018]),
          Z = new Uint32Array(4),
          Q = new Int32Array(4);
        let $ = null,
          ee = null;
        ...
        try {
          if (
            ('setAttribute' in N &&
              N.setAttribute('data-engine', 'three.js r182'),
            N.addEventListener('webglcontextlost', eB, !1),
            N.addEventListener('webglcontextrestored', ez, !1),
            N.addEventListener('webglcontextcreationerror', eV, !1),
            null === eN)
          ) {
            const e = 'webgl2';
            if (
        ...
        function eO() {
          ((i = new nb(eN)).init(),
            ...
            (n = new no(eN, i, e, L)),
            (r = new ao(eN, i)),
            n.reversedDepthBuffer && X && r.buffers.depth.setReversed(!0),
            (a = new nR(eN)),
            (s = new r$()),
            (o = new al(eN, i, r, s, n, L, a)),
            (c = new nh(er)),
            (u = new nE(er)),
            (d = new i8(eN)),
            (U = new na(eN, d)),
            ...
            (A = new nC(eN, n, o)),
            (E = new nl(s)),
            (M = new rQ(er, c, u, i, n, U, E)),
            (S = new ag(er, s)),
            (y = new r2()),
            (T = new r7(i)),
            (w = new nr(er, c, u, r, m, t, G)),
            (b = new aa(er, m, n)),
            (D = new a_(eN, a, n, r)),
            (R = new ns(eN, i, a)),
            (C = new nA(eN, i, a)),
        ...
        (eO(), 1009 !== j && (en = new nU(j, N.width, N.height, O, B)));
        const eF = new ap(er, eN);
        function eB(e) {
          (e.preventDefault(), g('WebGLRenderer: Context Lost.'), (ea = !0));
        }
        function ez() {
          (g('WebGLRenderer: Context Restored.'), (ea = !1));
          let e = a.autoReset,
            t = b.enabled,
            i = b.autoUpdate,
            n = b.needsUpdate,
        ...
        function eG(e) {
          ...
          let n,
            r = e.target;
          (r.removeEventListener('dispose', eG),
            (i = t = r),
            void 0 !== (n = s.get(i).programs) &&
              (n.forEach(function (e) {
                M.releaseProgram(e);
              }),
              i.isShaderMaterial && M.releaseShaderCache(i)),
            s.remove(t));
        }
        function eH(e, t, i) {
        ...
        ((this.xr = eF),
          ...
          (this.setSize = function (e, t, i = !0) {
            eF.isPresenting
              ...
              : ((eg = e),
                (e_ = t),
                (N.width = Math.floor(e * ev)),
                (N.height = Math.floor(t * ev)),
                !0 === i &&
                  ((N.style.width = e + 'px'), (N.style.height = t + 'px')),
                null !== en && en.setSize(N.width, N.height),
          ...
          (this.setViewport = function (e, t, i, n) {
            (e.isVector4 ? eS.set(e.x, e.y, e.z, e.w) : eS.set(e, t, i, n),
              r.viewport(eu.copy(eS).multiplyScalar(ev).round()));
          }),
          (this.getScissor = function (e) {
            return e.copy(ey);
          }),
          (this.setScissor = function (e, t, i, n) {
            (e.isVector4 ? ey.set(e.x, e.y, e.z, e.w) : ey.set(e, t, i, n),
              r.scissor(ed.copy(ey).multiplyScalar(ev).round()));
          }),
          ...
          (this.setClearColor = function () {
            w.setClearColor(...arguments);
          }),
          (this.getClearAlpha = function () {
            return w.getClearAlpha();
          }),
          (this.setClearAlpha = function () {
            w.setClearAlpha(...arguments);
          }),
              ...
              if (e) {
                ...
                t
                  ? ((Z[0] = r),
                    ...
                    (Z[2] = s),
                    (Z[3] = n),
                    eN.clearBufferuiv(eN.COLOR, 0, Z))
                  : ((Q[0] = r),
                    (Q[1] = a),
                    (Q[2] = s),
                    (Q[3] = n),
                    eN.clearBufferiv(eN.COLOR, 0, Q));
              } else n |= eN.COLOR_BUFFER_BIT;
            }
            (t && (n |= eN.DEPTH_BUFFER_BIT),
              i &&
                ((n |= eN.STENCIL_BUFFER_BIT),
          ...
          (this.dispose = function () {
            (N.removeEventListener('webglcontextlost', eB, !1),
              N.removeEventListener('webglcontextrestored', ez, !1),
              N.removeEventListener('webglcontextcreationerror', eV, !1),
              w.dispose(),
              y.dispose(),
              T.dispose(),
              s.dispose(),
              ...
              M.dispose(),
              eF.dispose(),
              eF.removeEventListener('sessionstart', eW),
              eF.removeEventListener('sessionend', eX),
              ej.stop());
          }),
          (this.renderBufferDirect = function (e, t, a, l, f, m) {
            let g;
            null === t && (t = eL);
            let _ = f.isMesh && 0 > f.matrixWorld.determinant(),
              v = (function (e, t, i, a, l) {
                var d, p;
                (!0 !== t.isScene && (t = eL), o.resetTextureUnits());
                let f = t.fog,
                  m = a.isMeshStandardMaterial ? t.environment : null,
                  g =
                    null === el
                      ? er.outputColorSpace
                      : !0 === el.isXRRenderTarget
                        ? el.texture.colorSpace
                        : h,
                  _ = (a.isMeshStandardMaterial ? u : c).get(a.envMap || m),
                  v =
                    !0 === a.vertexColors &&
                    !!i.attributes.color &&
                  ...
                  x =
                    ...
                    (!!a.normalMap || a.anisotropy > 0),
                  M = !!i.morphAttributes.position,
                  y = !!i.morphAttributes.normal,
                  T = !!i.morphAttributes.color,
                  b = 0;
                a.toneMapped &&
                  (null === el || !0 === el.isXRRenderTarget) &&
                  (b = er.toneMapping);
                let w =
                ...
                let L = !1;
                a.version === C.__version
                  ? (C.needsLights &&
                      C.lightsStateVersion !== P.state.version) ||
                    C.outputColorSpace !== g ||
                    (l.isBatchedMesh && !1 === C.batching)
                    ? (L = !0)
                    : l.isBatchedMesh || !0 !== C.batching
                      ? (l.isBatchedMesh &&
                          !0 === C.batchingColor &&
                          null === l.colorTexture) ||
                        (l.isBatchedMesh &&
                          !1 === C.batchingColor &&
                          null !== l.colorTexture) ||
                        (l.isInstancedMesh && !1 === C.instancing)
                        ? (L = !0)
                        : l.isInstancedMesh || !0 !== C.instancing
                          ? l.isSkinnedMesh && !1 === C.skinning
                            ? (L = !0)
                            : l.isSkinnedMesh || !0 !== C.skinning
                              ? (l.isInstancedMesh &&
                                  !0 === C.instancingColor &&
                                ...
                                (void 0 !== C.numClippingPlanes &&
                                  (C.numClippingPlanes !== E.numPlanes ||
                                    C.numIntersection !== E.numIntersection)) ||
                                C.vertexAlphas !== v ||
                                C.vertexTangents !== x ||
                                C.morphTargets !== M ||
                                C.morphNormals !== y ||
                ...
                let N = !1,
                  ...
                  B = C.uniforms;
                if (
                  (r.useProgram(U.program) && ((N = !0), (I = !0), (O = !0)),
                  a.id !== eh && ((eh = a.id), (I = !0)),
                  N || ec !== e)
                ) {
                  (r.buffers.depth.getReversed() &&
                    ...
                    F.setValue(eN, 'projectionMatrix', e.projectionMatrix),
                    F.setValue(eN, 'viewMatrix', e.matrixWorldInverse));
                  let t = F.map.cameraPosition;
                  (void 0 !== t &&
                    t.setValue(eN, eC.setFromMatrixPosition(e.matrixWorld)),
                ...
                if (
                  (C.needsLights &&
                    (P.state.directionalShadowMap.length > 0 &&
                      F.setValue(
                        eN,
                        'directionalShadowMap',
                        P.state.directionalShadowMap,
                        o
                      ),
                    P.state.spotShadowMap.length > 0 &&
                      F.setValue(eN, 'spotShadowMap', P.state.spotShadowMap, o),
                    P.state.pointShadowMap.length > 0 &&
                      F.setValue(
                        eN,
                        'pointShadowMap',
                        P.state.pointShadowMap,
                        o
                      )),
                  l.isSkinnedMesh)
                ) {
                  (F.setOptional(eN, l, 'bindMatrix'),
                    F.setOptional(eN, l, 'bindMatrixInverse'));
                  let e = l.skeleton;
                  e &&
                    (null === e.boneTexture && e.computeBoneTexture(),
                    F.setValue(eN, 'boneTexture', e.boneTexture, o));
                }
                l.isBatchedMesh &&
                  (F.setOptional(eN, l, 'batchingTexture'),
                  F.setValue(eN, 'batchingTexture', l._matricesTexture, o),
                  F.setOptional(eN, l, 'batchingIdTexture'),
                  F.setValue(eN, 'batchingIdTexture', l._indirectTexture, o),
                  F.setOptional(eN, l, 'batchingColorTexture'),
                  null !== l._colorsTexture &&
                    F.setValue(
                      eN,
                ...
                let z = i.morphAttributes;
                if (
                  ((void 0 !== z.position ||
                    void 0 !== z.normal ||
                    void 0 !== z.color) &&
                    A.update(l, i, U),
                  (I || C.receiveShadow !== l.receiveShadow) &&
                    ((C.receiveShadow = l.receiveShadow),
                    F.setValue(eN, 'receiveShadow', l.receiveShadow)),
                  ...
                  void 0 !== B.dfgLUT &&
                    (B.dfgLUT.value =
                      (null === ax &&
                        (((ax = new t1(av, 16, 16, 1030, 1016)).name =
                          'DFG_LUT'),
                        (ax.minFilter = 1006),
                        (ax.magFilter = 1006),
                        (ax.wrapS = 1001),
                        (ax.wrapT = 1001),
                        (ax.generateMipmaps = !1),
                        (ax.needsUpdate = !0)),
                      ax)),
                  I &&
                    (F.setValue(
                      eN,
                      'toneMappingExposure',
                      er.toneMappingExposure
                    ),
                    C.needsLights &&
                      ((d = B),
                      (p = O),
                      (d.ambientLightColor.needsUpdate = p),
                    ...
                    f && !0 === a.fog && S.refreshFogUniforms(B, f),
                    S.refreshMaterialUniforms(
                      B,
                      a,
                      ev,
                      e_,
                      ee.state.transmissionRenderTarget[e.id]
                    ),
                    rw.upload(eN, e$(C), B, o)),
                  a.isShaderMaterial &&
                    !0 === a.uniformsNeedUpdate &&
                    (rw.upload(eN, e$(C), B, o), (a.uniformsNeedUpdate = !1)),
                  a.isSpriteMaterial && F.setValue(eN, 'center', l.center),
                  F.setValue(eN, 'modelViewMatrix', l.modelViewMatrix),
                  F.setValue(eN, 'normalMatrix', l.normalMatrix),
                  F.setValue(eN, 'modelMatrix', l.matrixWorld),
                  a.isShaderMaterial || a.isRawShaderMaterial)
                ) {
                  let e = a.uniformsGroups;
                  for (let t = 0, i = e.length; t < i; t++) {
                    let i = e[t];
                    (D.update(i, U), D.bind(i, U));
                  }
                }
                return U;
              })(e, t, a, l, f);
            ...
            let T = a.drawRange,
              b = a.attributes.position,
              w = T.start * y,
              P = (T.start + T.count) * y;
            (null !== m &&
              ((w = Math.max(w, m.start * y)),
              (P = Math.min(P, (m.start + m.count) * y))),
              null !== M
                ? ((w = Math.max(w, 0)), (P = Math.min(P, M.count)))
                : null != b &&
                  ((w = Math.max(w, 0)), (P = Math.min(P, b.count))));
            let L = P - w;
            if (L < 0 || L === 1 / 0) return;
            U.setup(f, l, v, a, M);
            let N = R;
            if ((null !== M && ((g = d.get(M)), (N = C).setIndex(g)), f.isMesh))
              !0 === l.wireframe
                ? (r.setLineWidth(l.wireframeLinewidth * eD()),
                  N.setMode(eN.LINES))
                : N.setMode(eN.TRIANGLES);
            else if (f.isLine) {
              let e = l.linewidth;
              (void 0 === e && (e = 1),
                r.setLineWidth(e * eD()),
                f.isLineSegments
                  ? N.setMode(eN.LINES)
                  : f.isLineLoop
                    ? N.setMode(eN.LINE_LOOP)
                    : N.setMode(eN.LINE_STRIP));
            } else
              f.isPoints
                ? N.setMode(eN.POINTS)
                : f.isSprite && N.setMode(eN.TRIANGLES);
            if (f.isBatchedMesh)
              if (null !== f._multiDrawInstances)
                ...
                for (let a = 0; a < i; a++)
                  (r.setValue(eN, '_gl_DrawID', a), N.render(e[a] / n, t[a]));
              }
            else if (f.isInstancedMesh) N.renderInstances(w, L, f.count);
            else if (a.isInstancedBufferGeometry) {
              let e =
                  void 0 !== a._maxInstanceCount ? a._maxInstanceCount : 1 / 0,
                t = Math.min(a.instanceCount, e);
              N.renderInstances(w, L, t);
            } else N.render(w, L);
          }),
            ...
            (null === i && (i = e),
              ...
              i.traverseVisible(function (e) {
                e.isLight &&
                  ...
                  (ee.pushLight(e), e.castShadow && ee.pushShadow(e));
              }),
              e !== i &&
          ...
          if (e.layers.test(t.layers)) {
            if (e.isGroup) i = e.renderOrder;
              ...
              if (!e.frustumCulled || eb.intersectsSprite(e)) {
                n && eP.setFromMatrixPosition(e.matrixWorld).applyMatrix4(eR);
                let t = m.update(e),
                  r = e.material;
                r.visible && $.push(e, t, r, i, eP.z, null);
              }
            } else if (
              (e.isMesh || e.isLine || e.isPoints) &&
              (!e.frustumCulled || eb.intersectsObject(e))
            ) {
              let t = m.update(e),
                r = e.material;
              if (
                (n &&
                  (void 0 !== e.boundingSphere
                    ? (null === e.boundingSphere && e.computeBoundingSphere(),
                      eP.copy(e.boundingSphere.center))
                    : (null === t.boundingSphere && t.computeBoundingSphere(),
                      eP.copy(t.boundingSphere.center)),
                  eP.applyMatrix4(e.matrixWorld).applyMatrix4(eR)),
                Array.isArray(r))
              ) {
                let n = t.groups;
                for (let a = 0, s = n.length; a < s; a++) {
                  let s = n[a],
                    o = r[s.materialIndex];
                  o && o.visible && $.push(e, t, o, i, eP.z, s);
                }
              } else r.visible && $.push(e, t, r, i, eP.z, null);
            }
          }
          let r = e.children;
          for (let e = 0, a = r.length; e < a; e++) eq(r[e], t, i, n);
        }
        function eY(e, t, i, n) {
          let { opaque: a, transmissive: s, transparent: o } = e;
          (ee.setupLightsView(i),
            !0 === ew && E.setGlobalState(er.clippingPlanes, i),
            n && r.viewport(eu.copy(n)),
            a.length > 0 && eJ(a, t, i),
            s.length > 0 && eJ(s, t, i),
            o.length > 0 && eJ(o, t, i),
        ...
        function eK(e, t, r, a) {
          ...
          if (void 0 === ee.state.transmissionRenderTarget[a.id]) {
            let e =
              i.has('EXT_color_buffer_half_float') ||
              i.has('EXT_color_buffer_float');
            ee.state.transmissionRenderTarget[a.id] = new K(1, 1, {
              generateMipmaps: !0,
              type: e ? 1016 : 1009,
              minFilter: 1008,
              samples: n.samples,
              ...
              colorSpace: F.workingColorSpace,
            });
          }
          let s = ee.state.transmissionRenderTarget[a.id],
            l = a.viewport || eu;
          s.setSize(
            l.z * er.transmissionResolutionScale,
            l.w * er.transmissionResolutionScale
          );
          let h = er.getRenderTarget(),
            c = er.getActiveCubeFace(),
            u = er.getActiveMipmapLevel();
          (er.setRenderTarget(s),
            er.getClearColor(ef),
            (em = er.getClearAlpha()) < 1 && er.setClearColor(0xffffff, 0.5),
            er.clear(),
            eU && w.render(r));
          let d = er.toneMapping;
          er.toneMapping = 0;
          let p = a.viewport;
          if (
            (void 0 !== a.viewport && (a.viewport = void 0),
            ee.setupLightsView(a),
            !0 === ew && E.setGlobalState(er.clippingPlanes, a),
            eJ(e, r, a),
            ...
            for (let i = 0, n = t.length; i < n; i++) {
              let { object: n, geometry: s, material: o, group: l } = t[i];
              if (2 === o.side && n.layers.test(a.layers)) {
                let t = o.side;
                ((o.side = 1),
                  (o.needsUpdate = !0),
                  eZ(n, r, a, s, o, l),
          ...
          (er.setRenderTarget(h, c, u),
            er.setClearColor(ef, em),
            void 0 !== p && (a.viewport = p),
            (er.toneMapping = d));
        }
        function eJ(e, t, i) {
          ...
          for (let r = 0, a = e.length; r < a; r++) {
            let a = e[r],
              ...
              h = a.material;
            (!0 === h.allowOverride && null !== n && (h = n),
              s.layers.test(i.layers) && eZ(s, t, i, o, h, l));
          }
        }
        function eZ(e, t, i, n, r, a) {
          (e.onBeforeRender(er, t, i, n, r, a),
            e.modelViewMatrix.multiplyMatrices(
              i.matrixWorldInverse,
              e.matrixWorld
            ),
            e.normalMatrix.getNormalMatrix(e.modelViewMatrix),
            r.onBeforeRender(er, t, i, n, e, a),
            !0 === r.transparent && 2 === r.side && !1 === r.forceSinglePass
              ? ((r.side = 1),
                (r.needsUpdate = !0),
                er.renderBufferDirect(i, t, n, r, e, a),
                (r.side = 0),
                (r.needsUpdate = !0),
                er.renderBufferDirect(i, t, n, r, e, a),
                (r.side = 2))
              : er.renderBufferDirect(i, t, n, r, e, a),
            e.onAfterRender(er, t, i, n, r, a));
        }
        function eQ(e, t, i) {
          var n;
          !0 !== t.isScene && (t = eL);
          let r = s.get(e),
            a = ee.state.lights,
            o = ee.state.shadowsArray,
            l = a.state.version,
            h = M.getParameters(e, a.state, o, t, i),
            d = M.getProgramCacheKey(h),
            p = r.programs;
          ((r.environment = e.isMeshStandardMaterial ? t.environment : null),
            (r.fog = t.fog),
            (r.envMap = (e.isMeshStandardMaterial ? u : c).get(
            ...
            (r.envMapRotation =
              null !== r.environment && null === e.envMap
                ...
                : e.envMapRotation),
            void 0 === p &&
              (e.addEventListener('dispose', eG),
              (r.programs = p = new Map())));
          let f = p.get(d);
          if (void 0 !== f) {
            if (r.currentProgram === f && r.lightsStateVersion === l)
              return (e0(e, h), f);
          } else
            ((h.uniforms = M.getUniforms(e)),
              e.onBeforeCompile(h, er),
              (f = M.acquireProgram(h, d)),
              p.set(d, f),
              (r.uniforms = h.uniforms));
          let m = r.uniforms;
          return (
            ...
            e0(e, h),
            (r.needsLights =
              (n = e).isMeshLambertMaterial ||
              n.isMeshToonMaterial ||
              n.isMeshPhongMaterial ||
              n.isMeshStandardMaterial ||
              n.isShadowMaterial ||
              (n.isShaderMaterial && !0 === n.lights)),
            (r.lightsStateVersion = l),
            r.needsLights &&
              ((m.ambientLightColor.value = a.state.ambient),
              ...
              (m.spotLightMatrix.value = a.state.spotLightMatrix),
              (m.spotLightMap.value = a.state.spotLightMap),
        ...
        function e$(e) {
          if (null === e.uniformsList) {
            ...
            e.uniformsList = rw.seqWithValue(t.seq, e.uniforms);
          }
        ...
        (ej.setAnimationLoop(function (e) {
          ...
          'u' > typeof self && ej.setContext(self),
          (this.setAnimationLoop = function (e) {
            ((ek = e),
              eF.setAnimationLoop(e),
              null === e ? ej.stop() : ej.start());
          }),
          eF.addEventListener('sessionstart', eW),
          eF.addEventListener('sessionend', eX),
          (this.render = function (e, t) {
            ...
            if (!0 === ea) return;
            let i = !0 === eF.enabled && !0 === eF.isPresenting,
              n = null !== en && (null === el || i) && en.begin(er, el);
            if (
              ...
              !0 === eF.enabled &&
                !0 === eF.isPresenting &&
                (null === en || !1 === en.isCompositing()) &&
                (!0 === eF.cameraAutoUpdate && eF.updateCamera(t),
                (t = eF.getCamera())),
              !0 === e.isScene && e.onBeforeRender(er, e, t, el),
              (ee = T.get(e, ei.length)).init(t),
              ei.push(ee),
              eR.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
              eb.setFromProjectionMatrix(eR, 2e3, t.reversedDepth),
              (eA = this.localClippingEnabled),
              (ew = E.init(this.clippingPlanes, eA)),
              ($ = y.get(e, et.length)).init(),
              et.push($),
              !0 === eF.enabled && !0 === eF.isPresenting)
            ) {
              let e = er.xr.getDepthSensingMesh();
              null !== e && eq(e, t, -1 / 0, er.sortObjects);
            }
            (eq(e, t, 0, er.sortObjects),
              $.finish(),
              !0 === er.sortObjects && $.sort(ex, eM),
              (eU =
                !1 === eF.enabled ||
                !1 === eF.isPresenting ||
                !1 === eF.hasDepthSensing()) && w.addToRenderList($, e),
              this.info.render.frame++,
              !0 === ew && E.beginShadows());
            let r = ee.state.shadowsArray;
            if (
              (b.render(r, e, t),
              !0 === ew && E.endShadows(),
              !0 === this.info.autoReset && this.info.reset(),
              !1 === (n && en.hasRenderPass()))
            ) {
              let i = $.opaque,
                n = $.transmissive;
              if ((ee.setupLights(), t.isArrayCamera)) {
                let r = t.cameras;
                if (n.length > 0)
                  for (let t = 0, a = r.length; t < a; t++) eK(i, n, e, r[t]);
                eU && w.render(e);
                for (let t = 0, i = r.length; t < i; t++) {
                  let i = r[t];
                  eY($, e, i, i.viewport);
                ...
                (n.length > 0 && eK(i, n, e, t),
                  eU && w.render(e),
                  eY($, e, t));
            }
            (null !== el &&
              0 === eo &&
              (o.updateMultisampleRenderTarget(el),
              o.updateRenderTargetMipmap(el)),
              n && en.end(er),
              !0 === e.isScene && e.onAfterRender(er, e, t),
              U.resetDefaultState(),
              (eh = -1),
              (ec = null),
              ei.pop(),
              ei.length > 0
                ? ((ee = ei[ei.length - 1]),
                  !0 === ew &&
                    E.setGlobalState(er.clippingPlanes, ee.state.camera))
                : (ee = null),
              et.pop(),
              ($ = et.length > 0 ? et[et.length - 1] : null));
          }),
          ...
          (this.setRenderTargetTextures = function (e, t, i) {
            let n = s.get(e);
            ((n.__autoAllocateDepthBuffer = !1 === e.resolveDepthBuffer),
              !1 === n.__autoAllocateDepthBuffer &&
        ...
        ((this.setRenderTarget = function (e, t = 0, i = 0) {
          ...
          if (e) {
            let h = s.get(e);
            if (void 0 !== h.__useDefaultFramebuffer) {
              (r.bindFramebuffer(eN.FRAMEBUFFER, h.__webglFramebuffer),
                eu.copy(e.viewport),
                ed.copy(e.scissor),
                (ep = e.scissorTest),
                r.viewport(eu),
            ...
            if (void 0 === h.__webglFramebuffer) o.setupRenderTarget(e);
            else if (h.__hasExternalTextures)
              o.rebindTextures(
                e,
            ...
            (e.isWebGLCubeRenderTarget
              ? ((n = Array.isArray(u[t]) ? u[t][i] : u[t]), (a = !0))
              : (n =
                  e.samples > 0 && !1 === o.useMultisampledRTT(e)
                    ? s.get(e).__webglMultisampledFramebuffer
                    : Array.isArray(u)
                      ? u[i]
                      : u),
              eu.copy(e.viewport),
            ...
            (eu.copy(eS).multiplyScalar(ev).floor(),
              ed.copy(ey).multiplyScalar(ev).floor(),
              (ep = eE));
          if (
            (0 !== i && (n = e1),
            r.bindFramebuffer(eN.FRAMEBUFFER, n) && r.drawBuffers(e, n),
            r.viewport(eu),
            r.scissor(ed),
            r.setScissorTest(ep),
            a)
            ...
            eN.framebufferTexture2D(
              ...
              eN.TEXTURE_CUBE_MAP_POSITIVE_X + t,
              n.__webglTexture,
              i
            );
          } else if (l)
            for (let n = 0; n < e.textures.length; n++) {
              let r = s.get(e.textures[n]);
              eN.framebufferTextureLayer(
                eN.FRAMEBUFFER,
                eN.COLOR_ATTACHMENT0 + n,
                r.__webglTexture,
                i,
                t
              );
          ...
          (this.readRenderTargetPixels = function (e, t, i, a, o, l, h, c = 0) {
            ...
            if ((e.isWebGLCubeRenderTarget && void 0 !== h && (u = u[h]), u)) {
              r.bindFramebuffer(eN.FRAMEBUFFER, u);
              try {
                let r = e.textures[c],
                  s = r.format,
                  h = r.type;
                if (!n.textureFormatReadable(s))
                  return void v(
                ...
                t >= 0 &&
                  ...
                  i <= e.height - o &&
                  (e.textures.length > 1 &&
                    eN.readBuffer(eN.COLOR_ATTACHMENT0 + c),
                  eN.readPixels(t, i, a, o, L.convert(s), L.convert(h), l));
              } finally {
                let e = null !== el ? s.get(el).__webglFramebuffer : null;
                r.bindFramebuffer(eN.FRAMEBUFFER, e);
              }
            }
          }),
          (this.readRenderTargetPixelsAsync = async function (
            ...
            let u = s.get(e).__webglFramebuffer;
            if ((e.isWebGLCubeRenderTarget && void 0 !== h && (u = u[h]), u))
              if (t >= 0 && t <= e.width - a && i >= 0 && i <= e.height - o) {
                var d;
                r.bindFramebuffer(eN.FRAMEBUFFER, u);
                let h = e.textures[c],
                  p = h.format,
                  f = h.type;
                if (!n.textureFormatReadable(p))
                  throw Error(
                    'THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.'
                  );
                if (!n.textureTypeReadable(f))
                  throw Error(
                    'THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.'
                  );
                let m = eN.createBuffer();
                (eN.bindBuffer(eN.PIXEL_PACK_BUFFER, m),
                  eN.bufferData(
                  ...
                  e.textures.length > 1 &&
                    eN.readBuffer(eN.COLOR_ATTACHMENT0 + c),
                  eN.readPixels(t, i, a, o, L.convert(p), L.convert(f), 0));
                let g = null !== el ? s.get(el).__webglFramebuffer : null;
                r.bindFramebuffer(eN.FRAMEBUFFER, g);
                let _ = eN.fenceSync(eN.SYNC_GPU_COMMANDS_COMPLETE, 0);
                return (
                  eN.flush(),
                  await ((d = eN),
                  new Promise(function (e, t) {
                    setTimeout(function i() {
                      switch (
                        d.clientWaitSync(_, d.SYNC_FLUSH_COMMANDS_BIT, 0)
                      ) {
                        case d.WAIT_FAILED:
                          t();
                          break;
                  ...
                  eN.bindBuffer(eN.PIXEL_PACK_BUFFER, m),
                  eN.getBufferSubData(eN.PIXEL_PACK_BUFFER, 0, l),
                  eN.deleteBuffer(m),
                  eN.deleteSync(_),
                  l
                );
          ...
          (this.copyFramebufferToTexture = function (e, t = null, i = 0) {
            let n = Math.pow(2, -i),
              ...
              h = null !== t ? t.y : 0;
            (o.setTexture2D(e, 0),
              eN.copyTexSubImage2D(eN.TEXTURE_2D, i, 0, 0, l, h, a, s),
              r.unbindTexture());
          }));
        const e3 = eN.createFramebuffer(),
          e2 = eN.createFramebuffer();
        ((this.copyTextureToTexture = function (
          ...
          null === l &&
            (0 !== a
              ? (x(
                ...
                (a = 0))
              : (l = 0));
          let M = e.isCompressedTexture ? e.mipmaps[l] : e.image;
          if (null !== i)
            ((h = i.max.x - i.min.x),
              (c = i.max.y - i.min.y),
              (u = i.isBox3 ? i.max.z - i.min.z : 1),
              (d = i.min.x),
              (p = i.min.y),
              (f = i.isBox3 ? i.min.z : 0));
          else {
            let t = Math.pow(2, -a);
            ((h = Math.floor(M.width * t)),
              (c = Math.floor(M.height * t)),
              (u = e.isDataArrayTexture
                ? M.depth
                : e.isData3DTexture
                  ? Math.floor(M.depth * t)
                  : 1),
              (d = 0),
              (p = 0),
              (f = 0));
          ...
          null !== n
            ? ((m = n.x), (g = n.y), (_ = n.z))
            : ((m = 0), (g = 0), (_ = 0));
          let S = L.convert(t.format),
            y = L.convert(t.type);
          (t.isData3DTexture
            ? (o.setTexture3D(t, 0), (v = eN.TEXTURE_3D))
            : t.isDataArrayTexture || t.isCompressedArrayTexture
              ? (o.setTexture2DArray(t, 0), (v = eN.TEXTURE_2D_ARRAY))
              : (o.setTexture2D(t, 0), (v = eN.TEXTURE_2D)),
            eN.pixelStorei(eN.UNPACK_FLIP_Y_WEBGL, t.flipY),
            eN.pixelStorei(
              eN.UNPACK_PREMULTIPLY_ALPHA_WEBGL,
              t.premultiplyAlpha
            ),
            eN.pixelStorei(eN.UNPACK_ALIGNMENT, t.unpackAlignment));
          let T = eN.getParameter(eN.UNPACK_ROW_LENGTH),
            E = eN.getParameter(eN.UNPACK_IMAGE_HEIGHT),
            b = eN.getParameter(eN.UNPACK_SKIP_PIXELS),
            w = eN.getParameter(eN.UNPACK_SKIP_ROWS),
            A = eN.getParameter(eN.UNPACK_SKIP_IMAGES);
          (eN.pixelStorei(eN.UNPACK_ROW_LENGTH, M.width),
            eN.pixelStorei(eN.UNPACK_IMAGE_HEIGHT, M.height),
            eN.pixelStorei(eN.UNPACK_SKIP_PIXELS, d),
            eN.pixelStorei(eN.UNPACK_SKIP_ROWS, p),
            eN.pixelStorei(eN.UNPACK_SKIP_IMAGES, f));
          let R = e.isDataArrayTexture || e.isData3DTexture,
            C = t.isDataArrayTexture || t.isData3DTexture;
          if (e.isDepthTexture) {
            let i = s.get(e),
              n = s.get(t),
              o = s.get(i.__renderTarget),
              v = s.get(n.__renderTarget);
            (r.bindFramebuffer(eN.READ_FRAMEBUFFER, o.__webglFramebuffer),
              r.bindFramebuffer(eN.DRAW_FRAMEBUFFER, v.__webglFramebuffer));
            for (let i = 0; i < u; i++)
              (R &&
                (eN.framebufferTextureLayer(
                  eN.READ_FRAMEBUFFER,
            ...
            (r.bindFramebuffer(eN.READ_FRAMEBUFFER, null),
              r.bindFramebuffer(eN.DRAW_FRAMEBUFFER, null));
          } else if (0 !== a || e.isRenderTargetTexture || s.has(e)) {
            let i = s.get(e),
              n = s.get(t);
            (r.bindFramebuffer(eN.READ_FRAMEBUFFER, e3),
              r.bindFramebuffer(eN.DRAW_FRAMEBUFFER, e2));
            for (let e = 0; e < u; e++)
              (R
                ? eN.framebufferTextureLayer(
                    eN.READ_FRAMEBUFFER,
                ...
                0 !== a
                  ...
                  : C
                    ? eN.copyTexSubImage3D(v, l, m, g, _ + e, d, p, h, c)
                    : eN.copyTexSubImage2D(v, l, m, g, d, p, h, c));
            (r.bindFramebuffer(eN.READ_FRAMEBUFFER, null),
              r.bindFramebuffer(eN.DRAW_FRAMEBUFFER, null));
          } else
            C
              ? e.isDataTexture || e.isData3DTexture
                ? eN.texSubImage3D(v, l, m, g, _, h, c, u, S, y, M.data)
                : t.isCompressedArrayTexture
                  ...
                  : eN.texSubImage3D(v, l, m, g, _, h, c, u, S, y, M)
              : e.isDataTexture
                ? eN.texSubImage2D(eN.TEXTURE_2D, l, m, g, h, c, S, y, M.data)
                : e.isCompressedTexture
                  ...
                  : eN.texSubImage2D(eN.TEXTURE_2D, l, m, g, h, c, S, y, M);
          (eN.pixelStorei(eN.UNPACK_ROW_LENGTH, T),
            eN.pixelStorei(eN.UNPACK_IMAGE_HEIGHT, E),
            eN.pixelStorei(eN.UNPACK_SKIP_PIXELS, b),
            eN.pixelStorei(eN.UNPACK_SKIP_ROWS, w),
            eN.pixelStorei(eN.UNPACK_SKIP_IMAGES, A),
            0 === l && t.generateMipmaps && eN.generateMipmap(v),
            r.unbindTexture());
        }),
          ...
          (this.resetState = function () {
            ((es = 0), (eo = 0), (el = null), r.reset(), U.reset());
          }),
          'u' > typeof __THREE_DEVTOOLS__ &&
            __THREE_DEVTOOLS__.dispatchEvent(
              new CustomEvent('observe', { detail: this })
      ...
      set outputColorSpace(e) {
        ...
        ((t.drawingBufferColorSpace = F._getDrawingBufferColorSpace(e)),
          (t.unpackColorSpace = F._getUnpackColorSpace()));
      }
    }
    let aS = {
      name: 'CopyShader',
    ...
    let aT = new ij(-1, 1, 1, -1, 0, 1),
      aE = new (class extends tE {
        constructor() {
          (super(),
            this.setAttribute(
              'position',
              new tg([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)
            ),
            this.setAttribute('uv', new tg([0, 2, 0, 0, 2, 0], 2)));
        }
      })();
    class ab {
      constructor(e) {
        this._mesh = new tO(aE, e);
      }
      dispose() {
    ...
    class aw extends ay {
      constructor(e, t = 'tDiffuse') {
        (super(),
          ...
          (this._fsQuad = new ab(this.material)));
      }
      render(e, t, i) {
    ...
    class aA extends ay {
      ...
      render(e, t, i) {
        ...
        (s.buffers.color.setMask(!1),
          ...
          this.inverse ? ((n = 0), (r = 1)) : ((n = 1), (r = 0)),
          s.buffers.stencil.setTest(!0),
          s.buffers.stencil.setOp(a.REPLACE, a.REPLACE, a.REPLACE),
          s.buffers.stencil.setFunc(a.ALWAYS, n, 0xffffffff),
          s.buffers.stencil.setClear(r),
          ...
          s.buffers.stencil.setFunc(a.EQUAL, 1, 0xffffffff),
    ...
    class aC {
      ...
      render(e) {
        ...
        for (let t = 0, n = this.passes.length; t < n; t++) {
          ...
          if (!1 !== n.enabled) {
            ...
            void 0 !== aA &&
              (n instanceof aA ? (i = !0) : n instanceof aR && (i = !1));
          }
        }
      ...
      reset(e) {
        if (void 0 === e) {
          let t = this.renderer.getSize(new R());
    ...
    class aP extends ay {
      ...
      render(e, t, i) {
        ...
        ((e.autoClear = !1),
          ...
          null !== this.clearAlpha && e.setClearAlpha(n),
    ...
    class aU extends ay {
      constructor(e, t = 1, i, n) {
        (super(),
          ...
          (this.radius = i),
          (this.threshold = n),
          (this.resolution = void 0 !== e ? new R(e.x, e.y) : new R(256, 256)),
          (this.clearColor = new ta(0, 0, 0)),
          (this.needsSwap = !1),
        ...
        ((this.compositeMaterial = this._getCompositeMaterial(this.nMips)),
          ...
          (this.compositeMaterial.uniforms.bloomTintColors.value =
            this.bloomTintColors),
          (this.copyUniforms = tz(aS.uniforms)),
          (this.blendMaterial = new tH({
      ...
      setSize(e, t) {
        ...
        for (let e = 0; e < this.nMips; e++)
          (this.renderTargetsHorizontal[e].setSize(i, n),
            this.renderTargetsVertical[e].setSize(i, n),
            (this.separableBlurMaterials[e].uniforms.invSize.value = new R(
              1 / i,
              1 / n
            )),
      ...
      render(e, t, i, n, r) {
        ...
        for (let t = 0; t < this.nMips; t++)
          ((this._fsQuad.material = this.separableBlurMaterials[t]),
            ...
            e.clear(),
            this._fsQuad.render(e),
            (s = this.renderTargetsVertical[t]));
        ((this._fsQuad.material = this.compositeMaterial),
          ...
          this.renderToScreen ? e.setRenderTarget(null) : e.setRenderTarget(i),
          this._fsQuad.render(e),
      ...
      _getSeparableBlurMaterial(e) {
        let t = [],
          i = e / 3;
        for (let n = 0; n < e; n++)
          t.push((0.39894 * Math.exp((-0.5 * n * n) / (i * i))) / i);
        return new tH({
          defines: { KERNEL_RADIUS: e },
          uniforms: {
            colorTexture: { value: null },
            invSize: { value: new R(0.5, 0.5) },
            direction: { value: new R(0.5, 0.5) },
    ...
    ((aU.BlurDirectionX = new R(1, 0)), (aU.BlurDirectionY = new R(0, 1)));
    let aD = {
      name: 'OutputShader',
      uniforms: {
        tDiffuse: { value: null },
    ...
    class aN extends ay {
      constructor() {
        (super(),
          (this.isOutputPass = !0),
          (this.uniforms = tz(aD.uniforms)),
          (this.material = new ib({
            name: aD.name,
            uniforms: this.uniforms,
            vertexShader: aD.vertexShader,
            fragmentShader: aD.fragmentShader,
          })),
          (this._fsQuad = new ab(this.material)),
      ...
      render(e, t, i) {
        ((this.uniforms.tDiffuse.value = i.texture),
          ...
          (this._outputColorSpace !== e.outputColorSpace ||
            ...
            F.getTransfer(this._outputColorSpace) === u &&
    ...
    function aI() {
          ...
          return (
            (0, o.useEffect)(() => {
              let i,
                ...
                a = 'deviceMemory' in navigator && navigator.deviceMemory < 4;
              if (n || r || a) return void t('low');
      ...
      return (
        (0, o.useEffect)(() => {
          ...
          let y = {
              ...
              updateProgress: (e) => {
                let t = Math.min(e, 5);
                i.current && (i.current.style.width = `${(t / 5) * 100}%`);
              },
              complete: (e) => {
                y.isComplete ||
                  ((y.isComplete = !0),
                  y.updateProgress(5),
                  setTimeout(() => {
                    (t.current && t.current.classList.add('fade-out'),
            ...
            T = new t0(),
            E = new tq(75, window.innerWidth / window.innerHeight, 0.1, 1e3);
          ((E.position.z = 20), y.updateProgress(1));
          let b = new aM({
            antialias: !0,
          ...
          (b.setSize(window.innerWidth, window.innerHeight),
            (b.toneMapping = 4),
            (b.toneMappingExposure = 0.9),
            b.setClearColor(0, 0),
            (b.domElement.style.position = 'absolute'),
            (b.domElement.style.top = '0'),
            (b.domElement.style.left = '0'),
            (b.domElement.style.zIndex = '0'),
            (b.domElement.style.pointerEvents = 'none'),
            (b.domElement.style.background = 'transparent'),
            S.appendChild(b.domElement),
            y.updateProgress(2));
          let w = new aC(b),
            A = new aP(T, E);
          w.addPass(A);
          let C = new aU(
            new R(window.innerWidth, window.innerHeight),
            0.3,
            1.25,
            0
          );
          (w.addPass(C), y.updateProgress(3));
          let L = new aw({
            uniforms: {
              tDiffuse: { value: null },
              uTime: { value: 0 },
              uResolution: {
                value: new R(window.innerWidth, window.innerHeight),
              },
      ...
      `,
          ...
          let D = {
              ...
              particleCount: 5 * n.particleCount,
              particleDecayRate: 0.005,
              particleColor: 'violet',
              createParticlesOnlyWhenMoving: !0,
              particleCreationRate: 'low' === n.quality ? 2 : 5,
              revealRadius: 37,
              fadeStrength: 1.7,
              baseOpacity: 0.9,
              revealOpacity: 0.05,
            ...
            O = new tH({
              uniforms: {
                ghostPosition: { value: new P(0, 0, 0) },
                revealRadius: { value: D.revealRadius },
                fadeStrength: { value: D.fadeStrength },
                baseOpacity: { value: D.baseOpacity },
                revealOpacity: { value: D.revealOpacity },
                time: { value: 0 },
              },
              vertexShader: `
        varying vec2 vUv;
      ...
      `,
            ...
            F = new tO(I, O);
          ((F.position.z = -50), (F.renderOrder = -100), T.add(F));
          let B = new iK(657966, 0.08);
          T.add(B);
          let z = new tZ();
          T.add(z);
          let V = new iT(2, 40, 40),
            G = V.getAttribute('position').array;
          ...
          let H = new iw({
              color: D.bodyColor,
              transparent: !0,
              opacity: D.ghostOpacity,
              emissive: N[D.glowColor],
            ...
            k = new tO(V, H);
          z.add(k);
          let W = new iY(4886754, D.rimLightIntensity);
          (W.position.set(-8, 6, -4), T.add(W));
          let X = new iY(5301186, 0.7 * D.rimLightIntensity);
          (X.position.set(8, -4, -6), T.add(X), y.updateProgress(4));
          let j =
              ((s = new tZ()),
              z.add(s),
              (o = new iT(0.45, 16, 16)),
              (h = new tO(o, (l = new th({ color: 0 })))).position.set(
                -0.7,
                0.6,
                1.9
              ),
              h.scale.set(1.1, 1, 0.6),
              s.add(h),
              (c = new tO(o, l)).position.set(0.7, 0.6, 1.9),
              c.scale.set(1.1, 1, 0.6),
              s.add(c),
              (u = new iT(0.3, 12, 12)),
              (p = new tO(
                u,
                (d = new th({
                  color: N[D.eyeGlowColor],
                  transparent: !0,
                  opacity: 0,
                }))
              )).position.set(-0.7, 0.6, 2),
              s.add(p),
              (m = new tO(
                u,
                (f = new th({
              ...
              s.add(M),
              {
                leftEyeMaterial: d,
                rightEyeMaterial: f,
                leftOuterGlowMaterial: _,
                rightOuterGlowMaterial: x,
              }),
            q = [],
            Y = new tZ();
          T.add(Y);
          let K = n.fireflyCount;
          for (let e = 0; e < K; e++) {
            let e = new iT(0.02, 2, 2),
              t = new th({ color: 0xffff44, transparent: !0, opacity: 0.9 }),
              i = new tO(e, t);
            i.position.set(
              (Math.random() - 0.5) * 40,
              (Math.random() - 0.5) * 30,
            ...
            let n = new iT(0.08, 8, 8),
              ...
              a = new tO(n, r);
            i.add(a);
            let s = new iX(0xffff44, 0.8, 3, 2);
            (i.add(s),
              (i.userData = {
                velocity: new P(
                  (Math.random() - 0.5) * D.fireflySpeed,
                  (Math.random() - 0.5) * D.fireflySpeed,
                  (Math.random() - 0.5) * D.fireflySpeed
                ),
          ...
          T.add(Z);
          let Q = [],
            $ = [new iT(0.05, 6, 6), new iE(0.04, 0), new iS(0.045, 0)],
            ee = new th({
              color: N[D.particleColor],
              transparent: !0,
              opacity: 0,
              alphaTest: 0.1,
            });
          for (let e = 0; e < 100; e++) {
            let e = new tO($[Math.floor(Math.random() * $.length)], ee.clone());
            ((e.visible = !1), Z.add(e), Q.push(e));
          }
          function et() {
            let e;
            if (Q.length > 0) (e = Q.pop()) && (e.visible = !0);
            else {
              if (!(J.length < D.particleCount)) return null;
              ((e = new tO(
            ...
            if (!e) return null;
            let t = new ta(N[D.particleColor]);
            t.offsetHSL(0.1 * Math.random() - 0.05, 0, 0);
            let i = e.material;
            ((i.color = t),
              e.position.copy(z.position),
              (e.position.z -= 0.8 + 0.6 * Math.random()),
              (e.position.x += (Math.random() - 0.5) * 3.5),
              (e.position.y += (Math.random() - 0.5) * 3.5 - 0.8));
            let n = 0.6 + 0.7 * Math.random();
            (e.scale.set(n, n, n),
              e.rotation.set(
                6 * Math.random(),
                6 * Math.random(),
              ...
              (e.userData.life = 1),
              (e.userData.decay = 0.003 * Math.random() + D.particleDecayRate),
              (e.userData.rotationSpeed = {
              ...
              (i.opacity = 0.9 * Math.random()),
              J.push(e));
          }
          let ei = 'ontouchstart' in window || navigator.maxTouchPoints > 0,
            en = window.innerWidth <= 768,
            er = ei || en,
            ea = 0,
            es = () => {
              ea = window.scrollY;
            };
          window.addEventListener('scroll', es, { passive: !0 });
          let eo = new R(),
            el = !1,
            eh = (e, t) => {
              ((el = !0),
                (eo.x = (e / window.innerWidth) * 2 - 1),
                (eo.y = -(2 * (t / window.innerHeight)) + 1),
                clearTimeout(r),
                (r = setTimeout(() => {
                  el = !1;
                }, 3e3)));
            ...
            ec = (e) => {
              eh(e.clientX, e.clientY);
            },
            eu = (e) => {
              e.touches.length > 0 &&
                eh(e.touches[0].clientX, e.touches[0].clientY);
            };
          (window.addEventListener('mousemove', ec),
            window.addEventListener('touchstart', eu, { passive: !0 }),
            window.addEventListener('touchmove', eu, { passive: !0 }));
          let ed = () => {
            ((E.aspect = window.innerWidth / window.innerHeight),
              ...
              L.uniforms.uResolution.value.set(
                window.innerWidth,
                window.innerHeight
              ));
          };
          ...
          (y.updateProgress(5),
            setTimeout(() => {
              for (let e = 0; e < 3; e++) w.render();
              for (let e = 0; e < 10; e++) et();
              (w.render(), (eg = !0), y.complete(b.domElement));
            }, 100));
          let ev = (e) => {
            let t, i;
            if (((a = requestAnimationFrame(ev)), !eg)) return;
            let r = e - ef;
            if (((ef = e), r > 100)) return;
            ((ep += (r / 16.67) * 0.01),
              (O.uniforms.time.value = ep),
              (L.uniforms.uTime.value = ep),
              (L.uniforms.uLimboMode.value = +!!D.limboMode));
            let s = 9 * Math.sin(0.85 * ep) + 2 * Math.cos(0.85 * ep * 0.5),
              o =
                6 * Math.sin(0.85 * ep * 0.7 + Math.PI / 2) +
                1.5 * Math.sin(0.85 * ep * 1.3);
            el
              ? ((t = 12 * eo.x + 0.1 * s),
                (i = 8 * eo.y + 0.1 * o + -((ea / window.innerHeight) * 15)))
              : ((t = s), (i = o + -((ea / window.innerHeight) * 15)));
            let l = z.position.clone();
            ((z.position.x += (t - z.position.x) * D.followSpeed),
              (z.position.y += (i - z.position.y) * D.followSpeed),
              O.uniforms.ghostPosition.value.copy(z.position));
            let h = l.distanceTo(z.position);
            ((em = em * D.eyeGlowDecay + h * (1 - D.eyeGlowDecay)),
              (z.position.y += 0.03 * Math.sin(ep * D.floatSpeed * 1.5)));
            let c = Math.sin(ep * D.pulseSpeed) * D.pulseIntensity;
            H.emissiveIntensity = D.emissiveIntensity + c;
            let u = em > D.movementThreshold,
              d = u ? 2 * D.eyeGlowResponse : D.eyeGlowResponse,
              p =
                j.leftEyeMaterial.opacity +
                (!!u - j.leftEyeMaterial.opacity) * d;
            ((j.leftEyeMaterial.opacity = p),
              (j.rightEyeMaterial.opacity = p),
              (j.leftOuterGlowMaterial.opacity = 0.3 * p),
              (j.rightOuterGlowMaterial.opacity = 0.3 * p),
              (er
                ? em > 0.003
                : D.createParticlesOnlyWhenMoving
                  ? em > 0.005 && el
                  : em > 0.005) &&
                e - e_ > 100 &&
                (Array.from({
                  length: Math.min(
                    D.particleCreationRate,
                    Math.max(1, Math.floor(100 * h))
                  ),
                }).forEach(() => et()),
                (e_ = e)),
              J.forEach((e) => {
                if (!e.visible) return;
                e.userData.life -= e.userData.decay;
                let t = e.material;
                ((t.opacity = 0.85 * e.userData.life),
                  e.userData.velocity &&
                    (e.position.add(e.userData.velocity),
                    (e.position.x += 8e-4 * Math.cos(1.8 * ep + e.position.y))),
                  e.userData.rotationSpeed &&
                    ((e.rotation.x += e.userData.rotationSpeed.x),
                    (e.rotation.y += e.userData.rotationSpeed.y),
                    (e.rotation.z += e.userData.rotationSpeed.z)),
                  e.userData.life <= 0 &&
                    ((e.visible = !1), (t.opacity = 0), Q.push(e)));
              }));
            for (let e = J.length - 1; e >= 0; e--)
              J[e].visible || J.splice(e, 1);
            n.enablePostProcessing ? w.render() : b.render(T, E);
          };
          return (
            ev(0),
            () => {
              (window.removeEventListener('scroll', es),
                window.removeEventListener('mousemove', ec),
                window.removeEventListener('touchstart', eu),
                window.removeEventListener('touchmove', eu),
                window.removeEventListener('resize', ed),
                cancelAnimationFrame(a),
                I.dispose(),
                O.dispose(),
                V.dispose(),
                H.dispose(),
                j.leftEyeMaterial.dispose(),
                j.rightEyeMaterial.dispose(),
                j.leftOuterGlowMaterial.dispose(),
                j.rightOuterGlowMaterial.dispose(),
                q.forEach((e) => {
                  (e.geometry.dispose(),
                    e.material.dispose(),
                    e.userData.glowMat && e.userData.glowMat.dispose(),
                    e.userData.fireflyMat && e.userData.fireflyMat.dispose());
                }),
                $.forEach((e) => e.dispose()),
                ee.dispose(),
                Q.forEach((e) => {
                ...
                C.dispose && C.dispose(),
                A.dispose && A.dispose(),
                S && b.domElement && S.removeChild(b.domElement));
            }
          );
        }, []),
        (0, s.jsxs)(s.Fragment, {
