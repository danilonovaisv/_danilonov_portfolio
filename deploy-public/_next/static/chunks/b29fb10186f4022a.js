(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function p({ children: e, isPresent: s, anchorX: a, anchorY: l, root: r }) {
      let n = (0, o.useId)(),
        p = (0, o.useRef)(null),
        m = (0, o.useRef)({
          width: 0,
      ...
      return (
        (0, o.useInsertionEffect)(() => {
          ...
          if (s || !p.current || !e || !t) return;
          let u = 'left' === a ? `left: ${o}` : `right: ${c}`,
            x = 'bottom' === l ? `bottom: ${d}` : `top: ${i}`;
        ...
        (0, t.jsx)(u, {
          ...
          childRef: p,
          sizeRef: m,
          children: o.cloneElement(e, { ref: x }),
        })
      );
    }
    let m = ({
      ...
      return (
        ...
        (0, t.jsx)(r.PresenceContext.Provider, { value: v, children: e })
      );
    };
    function h() {
      return new Map();
    ...
    let y = ({
      ...
      let [v, b] = (0, x.usePresence)(u),
        j = (0, i.useMemo)(() => g(e), [e]),
        w = u && !v ? [] : j.map(f),
        N = (0, i.useRef)(!0),
        k = (0, i.useRef)(j),
        A = (0, a.useConstant)(() => new Map()),
      ...
      if (j !== E) {
        ...
        for (let t = 0; t < M.length; t++) {
          let i = M[t],
            s = f(i);
          w.includes(s) || (e.splice(t, 0, i), P.push(i));
        }
        return ('wait' === d && P.length && (e = P), R(g(e)), z(j), null);
      }
      let { forceRender: L } = (0, i.useContext)(s.LayoutGroupContext);
      return (0, t.jsx)(t.Fragment, {
        children: M.map((e) => {
          let i = f(e),
            s = (!u || !!v) && (j === M || w.includes(i));
          return (0, t.jsx)(
            m,
            {
              isPresent: s,
  ...
  (e) => {
    ...
    e.s(
      [
        ...
        ({
          ...
          let p = (0, n.useReducedMotion)(),
            m = (0, i.useRef)(null),
            { scrollYProgress: h } = (0, l.useScroll)({
              target: m,
              offset: ['start end', 'end start'],
            }),
            x = (0, r.useTransform)(h, [0, 1], [-40, 40]);
    ...
    function d(e) {
      ...
      (0, i.useEffect)(() => {
        let i = document.documentElement,
          a = document.body;
        if (e) {
          ((t.current = window.scrollY), (s.current = !0));
          let e = window.innerWidth - i.clientWidth;
          ((a.style.overflow = 'hidden'),
            (a.style.position = 'fixed'),
            (a.style.top = `-${t.current}px`),
            (a.style.left = '0'),
            (a.style.right = '0'),
            (a.style.paddingRight = `${e}px`),
    ...
    (e.s(['X', () => c], 60253), e.s(['useBodyLock', () => d], 49316));
    var u = e.i(91424);
    let p = (0, o.default)('calendar', [
              ...
              (0, t.jsxs)('div', {
                ...
                children: [
                  (0, t.jsxs)('div', {
                    ...
                    children: [
                      (0, t.jsx)(a.motion.h2, {
                        ...
                        animate: { opacity: 1, y: 0 },
                        transition: { delay: 0.76, duration: 0.2, ease: h },
                        className:
                  ...
                  (0, t.jsxs)(a.motion.div, {
                    ...
                    animate: { opacity: 1, y: 0 },
                    transition: { delay: 0.96, duration: 0.16, ease: h },
                    className: 'flex flex-col gap-6',
                    children: [
                      (0, t.jsxs)('div', {
    ...
    let v = {
      ...
      animate: { opacity: 1, y: 0 },
      exit: { opacity: 0, y: -8 },
      transition: { duration: 0.4, ease: h },
    };
    e.s(
      [
        'default',
          ...
          (0, t.jsxs)('div', {
            ...
            children: [
              (0, t.jsxs)(a.motion.div, {
                ...
                transition: { delay: 0.52, duration: 0.5, ease: h },
                className:
                ...
                children: [
                        ...
                        (0, t.jsxs)(t.Fragment, {
                          children: [
                            ...
                            (0, t.jsxs)('span', {
                              className: 'flex items-center gap-2',
                              children: [
                                (0, t.jsx)(g.Tag, { className: 'w-4 h-4' }),
                  ...
                  e.tags &&
                    (0, t.jsx)(a.motion.div, {
                      initial: { opacity: 0, y: 8 },
                      animate: { opacity: 1, y: 0 },
                      transition: { delay: 1.12, duration: 0.2, ease: h },
                      className: 'flex flex-wrap gap-2',
                      children: e.tags.map((e) =>
                        (0, t.jsx)(
                          'span',
  ...
  (e) => {
        ...
        children: [
          (0, t.jsx)('video', {
            ...
            children: (0, t.jsx)('source', {
              src: s.BRAND.video.manifesto,
              type: 'video/mp4',
            }),
          }),
          (0, t.jsx)('div', {
            className:
              'absolute inset-0 bg-linear-to-b from-black/60 via-black/40 to-black/60',
          }),
          (0, t.jsx)('div', {
            className:
              'std-grid relative z-10 flex h-full flex-col justify-end pb-12 sm:pb-16 md:pb-24',
            children: (0, t.jsxs)('div', {
              className:
                'col-span-full flex flex-col items-center justify-between gap-6 md:flex-row md:items-end',
              children: [
                (0, t.jsxs)(l.motion.h1, {
                  initial: { opacity: 0, y: 20 },
                  animate: { opacity: 1, y: 0 },
                  transition: { duration: 0.8, ease: [0.16, 1, 0.3, 1] },
                  className:
                    'font-h1 text-4xl font-bold uppercase tracking-tight text-white md:text-6xl lg:text-7xl',
                  children: [
                    (0, t.jsx)('span', {
    ...
    let o = [
        {
          ...
          year: 2024,
          image:
            'https://umkmwbkwvulxtdodzmzf.supabase.co/storage/v1/object/public/site-assets/portfolio/projects/cover/garoto.jpg',
          type: 'B',
          layout: {
            cols: 'col-span-1',
            height: 'h-[400px]',
        ...
        },
        {
          ...
          year: 2023,
          image:
            'https://umkmwbkwvulxtdodzmzf.supabase.co/storage/v1/object/public/site-assets/portfolio/projects/cover/nescafe.jpg',
          type: 'B',
          layout: {
            cols: 'col-span-1',
            height: 'h-[400px]',
        ...
        },
        {
          ...
          year: 2023,
          image:
            'https://umkmwbkwvulxtdodzmzf.supabase.co/storage/v1/object/public/site-assets/portfolio/projects/cover/mpdv.jpg',
          type: 'A',
          layout: {
            cols: 'col-span-2',
            height: 'h-[400px]',
        ...
        },
        {
          ...
          year: 2022,
          image:
            'https://umkmwbkwvulxtdodzmzf.supabase.co/storage/v1/object/public/site-assets/portfolio/projects/cover/swift.jpg',
          type: 'B',
          layout: {
            cols: 'col-span-1',
            height: 'h-[400px]',
        ...
        },
        {
          ...
          year: 2024,
          image:
            'https://umkmwbkwvulxtdodzmzf.supabase.co/storage/v1/object/public/site-assets/portfolio/projects/cover/ambev.jpg',
          type: 'A',
          layout: {
            cols: 'col-span-1',
            height: 'h-[400px]',
        ...
        },
        {
          ...
          year: 2023,
          image:
            'https://umkmwbkwvulxtdodzmzf.supabase.co/storage/v1/object/public/site-assets/portfolio/projects/cover/unilever.jpg',
          type: 'B',
          layout: {
            cols: 'col-span-1',
            height: 'h-[400px]',
        ...
        let s = (0, i.useRef)(null),
          { galleryRef: a } = ((e, t = !0) => {
            ...
            return (
              (0, i.useEffect)(() => {
                if (!t) return;
                r.current || (r.current = document.querySelector('.gallery'));
                let i = e.current,
                  n = r.current;
                if (!i || !n) return;
                let o = () => {
                  ...
                  c = () => {
                    ...
                    ((e = s.current),
                      (t = a.current),
                      (s.current = 0.95 * e + 0.05 * t),
                      (i.style.transform = `translateY(-${s.current}px)`),
                      Math.abs(s.current - a.current) > 0.5
                        ? (l.current = requestAnimationFrame(c))
                        : (l.current = null));
                  },
                  d = () => {
                    ((a.current = window.scrollY),
                      l.current || (l.current = requestAnimationFrame(c)));
                  },
        ...
        return (0, t.jsx)('div', {
          ...
          children: (0, t.jsx)('div', {
            ...
            children: (0, t.jsx)('div', {
              ...
              children: (0, t.jsx)('div', {
                className:
                  'col-span-full grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 md:gap-8',
                children: o.map((i, s) =>
                  (0, t.jsx)(
                    'div',
                    {
                      className: 'w-full',
                      children: (0, t.jsx)(n.ProjectCard, {
                        project: i,
                        index: s,
                        onClick: e,
                        priority: s < 3,
    ...
    var d = e.i(78191),
      ...
      h = e.i(19230),
      x = e.i(20631);
    let f = ({ isOpen: e, onClose: s, project: a }) =>
      ((0, m.useBodyLock)(e),
      (0, i.useEffect)(() => {
        let e = (e) => {
          'Escape' === e.key && s();
                ...
                (0, t.jsxs)(t.Fragment, {
                  children: [
                    (0, t.jsx)(l.motion.div, {
                      ...
                      onClick: s,
                      className:
                        'fixed inset-0 z-990 bg-black/90 backdrop-blur-md',
                    }),
                    (0, t.jsxs)(l.motion.div, {
                      ...
                      children: [
                        (0, t.jsx)('button', {
                          ...
                          className:
                            'fixed top-6 right-6 z-1000 flex h-12 w-12 items-center justify-center rounded-full bg-white/10 text-white backdrop-blur transition-colors hover:bg-white/20',
                          children: (0, t.jsx)(u.X, { size: 24 }),
                        }),
                        (0, t.jsx)(l.motion.div, {
                          initial: { opacity: 0, y: 20 },
                          animate: { opacity: 1, y: 0 },
                          ...
                          children:
                            'A' === a.type
                              ? (0, t.jsx)(h.default, { project: a })
                              : (0, t.jsx)(x.default, { project: a }),
                        }),
                      ],
                    }),
                  ],
    ...
    function v() {
      ...
      return (0, t.jsxs)('main', {
        className: 'bg-[#040013] min-h-screen',
        children: [
          (0, t.jsx)(r, {}),
          (0, t.jsx)(c, {
            onOpenProject: (e) => {
          ...
          (0, t.jsxs)('div', {
            className: 'relative z-10 bg-[#040013]',
            children: [(0, t.jsx)(g.default, {}), (0, t.jsx)(y.default, {})],
          }),
          (0, t.jsx)(f, {
            isOpen: a,
            onClose: () => {
              (l(!1), setTimeout(() => s(null), 300));
            },
            project: e,
          }),
        ],
