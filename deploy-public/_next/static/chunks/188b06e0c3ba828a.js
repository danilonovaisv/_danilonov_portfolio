(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
      ...
      getSnapshotBeforeUpdate(e) {
        ...
        if (t && e.isPresent && !this.props.isPresent) {
          let e = t.offsetParent,
            ...
            r = ((0, a.isHTMLElement)(e) && e.offsetHeight) || 0,
    ...
    function m({ children: e, isPresent: r, anchorX: l, anchorY: n, root: s }) {
      let a = (0, o.useId)(),
        m = (0, o.useRef)(null),
        f = (0, o.useRef)({
          width: 0,
        ...
        { nonce: p } = (0, o.useContext)(c.MotionConfigContext),
        h = (function (...e) {
      ...
      return (
        (0, o.useInsertionEffect)(() => {
          ...
          if (r || !m.current || !e || !t) return;
          let u = 'left' === l ? `left: ${o}` : `right: ${c}`,
            h = 'bottom' === n ? `bottom: ${d}` : `top: ${i}`;
          m.current.dataset.motionPopId = a;
          let x = document.createElement('style');
          p && (x.nonce = p);
          let g = s ?? document.head;
          return (
            g.appendChild(x),
            x.sheet &&
              x.sheet.insertRule(`
        ...
        (0, t.jsx)(u, {
          ...
          childRef: m,
          sizeRef: f,
          children: o.cloneElement(e, { ref: h }),
        })
      );
    }
    let f = ({
    ...
    let v = ({
      ...
      (0, n.useIsomorphicLayoutEffect)(() => {
        ((N.current = !1), (_.current = y));
        for (let e = 0; e < T.length; e++) {
          let t = x(T[e]);
          w.includes(t)
            ? (A.delete(t), k.current.delete(t))
            : !0 !== A.get(t) && A.set(t, !1);
        }
      }, [T, w.length, w.join('-')]);
      let O = [];
      if (y !== E) {
        ...
        for (let t = 0; t < T.length; t++) {
          let i = T[t],
            r = x(i);
          w.includes(r) || (e.splice(t, 0, i), O.push(i));
        }
        return ('wait' === d && O.length && (e = O), S(g(e)), C(y), null);
      }
      let { forceRender: P } = (0, i.useContext)(r.LayoutGroupContext);
      return (0, t.jsx)(t.Fragment, {
        children: T.map((e) => {
          let i = x(e),
            r = (!u || !!b) && (y === T || w.includes(i));
          return (0, t.jsx)(
            f,
            {
              isPresent: r,
              initial: (!N.current || !!a) && void 0,
              custom: s,
              presenceAffectsLayout: c,
              mode: d,
              root: v,
              onExitComplete: r
                ? void 0
                : () => {
                    if (k.current.has(i) || (k.current.add(i), !A.has(i)))
                      return;
                    A.set(i, !0);
                    let e = !0;
                    (A.forEach((t) => {
  ...
  (e) => {
    ...
    function r(e) {
      ...
      let l = r
        ...
        .replace(/^\/+/, '');
      return l ? `${t.SUPABASE_STORAGE_URL}/${l}` : i;
    }
    function l(e) {
  ...
  (e) => {
    ...
    function c(e, d = {}) {
      return (function (e, c = {}) {
        let { isStatic: d } = (0, n.useContext)(s.MotionConfigContext),
          u = () => ((0, i.isMotionValue)(e) ? e.get() : e);
        if (d) return (0, o.useTransform)(u);
        let m = (0, a.useMotionValue)(u());
        return (
  ...
  (e) => {
    ...
    function c({ project: e, onOpen: i }) {
      let l = (0, r.useReducedMotion)(),
        c = () =>
          (0, t.jsxs)(t.Fragment, {
            children: [
              (0, t.jsxs)('div', {
                className: `card-shell relative overflow-hidden rounded-md w-full bg-white/5 transition-all duration-500 ${l ? '' : 'md:group-hover:shadow-[0_22px_54px_-12px_rgba(0,72,255,0.15)] md:group-hover:-translate-y-1 active:scale-[0.98]'}`,
                children: [
                  (0, t.jsx)('div', {
                    className:
                  ...
                  (0, o.isVideo)(e.image)
                    ...
                    : (0, t.jsx)(n.default, {
                        ...
                        className: `object-cover transition-transform duration-700 opacity-90 md:group-hover:opacity-100 ${l ? '' : 'md:group-hover:scale-103'}`,
                        loading: 'lazy',
              ...
              (0, t.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, t.jsx)('div', {
                    className: `w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center text-white shrink-0 border border-white/10 transition-all duration-700 bg-[#0048ff] ${l ? '' : 'md:group-hover:translate-x-5 md:group-hover:bg-[#8705f2] md:group-hover:shadow-[0_0_20px_rgba(135,5,242,0.4)]'}`,
                    children: (0, t.jsx)(s, {
                      className:
    ...
    var m = e.i(87857);
    let { duration: f, offset: p } = l.MOTION_TOKENS,
      h = [
    ...
    function x({ projects: e, onProjectOpen: n }) {
      let s = (0, r.useReducedMotion)(),
        a = e.filter((e) => e.isFeatured),
        o = {
          hidden: s ? {} : { opacity: 0, y: p.dramatic, filter: 'blur(4px)' },
          visible: s
            ? { opacity: 1 }
            : {
                opacity: 1,
                y: 0,
                filter: 'blur(0px)',
                transition: (0, l.ghostTransition)(0, f.normal),
              },
        };
      return (0, t.jsx)('section', {
        ...
        children: (0, t.jsx)(m.Container, {
          children: (0, t.jsxs)(i.motion.div, {
            ...
            variants: (0, l.staggerContainer)(0.12),
            className:
              'grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-4 md:gap-6',
            children: [
              a.slice(0, 4).map((e, r) => {
                if (!e) return null;
                let l = h[r] || 'md:col-span-4 lg:col-span-4';
                return (0, t.jsx)(
                  i.motion.div,
                  {
                    variants: o,
                    className: `w-full col-span-4 ${l} h-full flex flex-col`,
                    children: (0, t.jsx)(c, { project: e, onOpen: n }),
                  },
                  e.id
                );
              }),
  ...
  (e, t, i) => {
    ...
    let r = e.r(81258)._(e.r(24850));
    function l(e, t) {
      let i = {};
      'function' == typeof e && (i.loader = e);
      let l = { ...i, ...t };
      return (0, r.default)({ ...l, modules: l.loadableGenerated?.modules });
    }
  ...
  (e) => {
    ...
    let s = (e, t = 1) => {
      ...
      a = s(n.BRAND.colors.bluePrimary, 0.45),
      o = s(n.BRAND.colors.blueAccent, 0.6);
    function c({
      ready: e,
      onComplete: s,
      durationMs: c = 2e3,
      ...
      return (
        ...
        (0, i.useEffect)(() => {
          if ('boolean' == typeof e) {
            if (!e) return;
            let t = setTimeout(() => p(!1), h ? 200 : 800);
        ...
        (0, t.jsx)(r.AnimatePresence, {
          children:
            ...
            (0, t.jsx)(l.motion.div, {
              ...
              transition: { duration: h ? 0.3 : 1, ease: [0.22, 1, 0.36, 1] },
              role: 'status',
              'aria-live': 'polite',
                ...
                children: [
                  ...
                  (0, t.jsx)('div', {
                    ...
                    children: (0, t.jsx)(l.motion.div, {
                      className: 'h-full',
                      style: {
                        background: `linear-gradient(90deg, ${n.BRAND.colors.bluePrimary} 0%, ${n.BRAND.colors.blueAccent} 100%)`,
    ...
    let u = (0, e.i(58691).default)(() => e.A(63316), {
    ...
    function N({ ghostRef: e, isLoaded: r = !0 }) {
      var n;
      let s = (0, i.useRef)(null),
        a = (0, v.useReducedMotion)();
      ((n = r && !a),
        (0, i.useEffect)(() => {
          let t;
          ...
          let i = () => {
            ...
            let r = e.current.position,
              ...
              n = ((r.x + 10) / 20) * 100,
              a = 100 - ((r.y + 7) / 14) * 100;
            ((l.style.transform = `translate(calc(${n}vw - 50%), calc(${a}vh - 50%))`),
              document.documentElement.style.setProperty('--ghost-x', `${n}vw`),
          ...
          children: (0, t.jsxs)('div', {
            ...
            children: [
              (0, t.jsx)('span', {
                ...
                children: p.HOME_CONTENT.hero.tag,
              }),
              (0, t.jsxs)('h1', {
                className: `hidden lg:block mb-20 font-display ${j.default.heroTitle}`,
                children: [
                  p.HOME_CONTENT.hero.title[0].split(' ').slice(0, 2).join(' '),
                  ' ',
                  (0, t.jsx)('br', {}),
                  p.HOME_CONTENT.hero.title[0].split(' ').slice(2).join(' '),
                ],
              }),
              (0, t.jsxs)('h1', {
                ...
                children: [
                  ...
                  ' ',
                  (0, t.jsx)('br', {}),
                  p.HOME_CONTENT.hero.title[0].split(' ').slice(2, 4).join(' '),
                  ' ',
                  (0, t.jsx)('br', {}),
                  p.HOME_CONTENT.hero.title[0].split(' ').slice(4).join(' '),
                ],
              }),
              (0, t.jsx)('h2', {
                className: `font-h2 type-h2 mt-6 lg:mt-9 text-textSecondary ${e ? '' : 'opacity-80'} ${j.default.heroSubtitle}`,
                children: p.HOME_CONTENT.hero.subtitle,
              }),
            ],
          }),
        });
      return (0, t.jsxs)(l.motion.div, {
        ...(a ? {} : { initial: 'initial', animate: 'animate', variants: y }),
        ...
        children: [
          ...
          (0, t.jsx)('div', {
            ref: s,
            className: `${j.default.ghostAura} ${r ? j.default.isLoaded : ''}`,
          }),
        ],
      });
    }
    ...
    function A() {
      let e = (0, i.useRef)(null),
        [l, n] = (0, i.useState)(!1),
        s = (0, _.useMediaQuery)('(min-width: 1024px)');
      (0, i.useEffect)(() => {
        let e = setTimeout(() => n(!0), 2e3);
        return () => clearTimeout(e);
      }, []);
      let a = (0, i.useCallback)(() => n(!0), []);
      return (0, t.jsx)(t.Fragment, {
  ...
  (e) => {
    ...
    function g({
      ...
      return (0, t.jsx)(r.motion.div, {
        ...
        transition: { duration: 0.8, ease: p.GHOST_EASE, delay: 0.12 * l },
            ...
            (0, t.jsxs)('div', {
              ...
              children: [
                ...
                (0, t.jsx)(r.motion.div, {
                  ...
                  initial: !1,
                  animate: { width: 288 * !!n, opacity: +!!n },
                  transition: { duration: 0.7, ease: p.GHOST_EASE },
                  children: (0, t.jsx)('div', {
                ...
                (0, t.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, t.jsx)(r.motion.div, {
                      ...
                      animate: {
                        rotate: n ? 0 : -45,
                        backgroundColor: n ? '#8705f2' : '#0048ff',
                      },
                      transition: { duration: 0.5, ease: p.GHOST_EASE },
        ...
        children: (0, t.jsxs)(s.Container, {
          children: [
            ...
            (0, t.jsx)(r.motion.div, {
              ...
              whileInView: { opacity: 1, y: 0 },
              viewport: { once: !0 },
              transition: { duration: 0.6, ease: p.GHOST_EASE, delay: 0.4 },
    ...
    function l({ src: e }) {
      ...
      ((0, i.useEffect)(() => {
        ...
        let e = new IntersectionObserver(
          ([t]) => {
            t.isIntersecting && (a(!0), e.disconnect());
          },
          { rootMargin: '200px' }
        );
  ...
  (e) => {
    e.v((t) =>
      Promise.all(
        [
          'static/chunks/a0291d34e7af01a3.js',
          'static/chunks/abf24408f194d284.js',
        ].map((t) => e.l(t))
      ).then(() => t(47908))
    );
  },
