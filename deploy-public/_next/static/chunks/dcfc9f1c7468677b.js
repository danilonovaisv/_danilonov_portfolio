(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var a = class {
        ...
        fromTo(
          e,
          t,
          { lerp: i, duration: r, easing: s, onStart: o, onUpdate: a }
        ) {
      ...
      u = class {
        constructor(e, t = { wheelMultiplier: 1, touchMultiplier: 1 }) {
          ((this.element = e),
            ...
            this.onWindowResize(),
            this.element.addEventListener('wheel', this.onWheel, d),
            this.element.addEventListener('touchstart', this.onTouchStart, d),
            this.element.addEventListener('touchmove', this.onTouchMove, d),
            this.element.addEventListener('touchend', this.onTouchEnd, d));
        }
        touchStart = { x: 0, y: 0 };
        lastDelta = { x: 0, y: 0 };
        ...
        destroy() {
          (this.emitter.destroy(),
            ...
            this.element.removeEventListener('wheel', this.onWheel, d),
            this.element.removeEventListener(
              'touchstart',
              this.onTouchStart,
              d
            ),
            this.element.removeEventListener('touchmove', this.onTouchMove, d),
            this.element.removeEventListener('touchend', this.onTouchEnd, d));
        }
        onTouchStart = (e) => {
        ...
        onWheel = (e) => {
          let { deltaX: t, deltaY: i, deltaMode: r } = e,
            s = 1 === r ? c : 2 === r ? this.window.width : 1,
            o = 1 === r ? c : 2 === r ? this.window.height : 1;
          ((t *= s),
            (i *= o),
      ...
      h = (e) => Math.min(1, 1.001 - Math.pow(2, -10 * e)),
      p = class {
        _isScrolling = !1;
        _isStopped = !1;
        _isLocked = !1;
        ...
        onVirtualScroll = (e) => {
          ...
          ('both' === this.options.gestureOrientation
            ...
            (!this.options.overscroll ||
              ...
              (r.lenisStopPropagation = !0),
            r.cancelable && r.preventDefault());
          let u = s && this.options.syncTouch,
            h = s && 'touchend' === r.type;
          (h &&
            (d =
        ...
        checkNestedScroll(e, { deltaX: t, deltaY: i }) {
          ...
          if (v - (b.time ?? 0) > 2e3) {
            ...
            if (
              ...
              (s = ['auto', 'overlay', 'scroll'].includes(u)),
              (b.hasOverflowX = r),
              (b.hasOverflowY = s),
              (!r && !s) ||
                ('vertical' === x && !s) ||
          ...
          if (
            ...
            return !1;
          if ('x' === u)
            ((h = e.scrollLeft), (p = n - c), (m = t), (f = r), (g = o));
          else {
            if ('y' !== u) return !1;
            ((h = e.scrollTop), (p = l - d), (m = i), (f = s), (g = a));
          }
    ...
    let m = (0, r.createContext)({ lenis: null });
    e.i(54101);
    var f = e.i(22708);
    let g = (e) => {
        let t = (0, f.createStore)(e),
          i = (e) =>
            (function (e, t = (e) => e) {
              let i = r.default.useSyncExternalStore(
                e.subscribe,
                r.default.useCallback(() => t(e.getState()), [e, t]),
                r.default.useCallback(() => t(e.getInitialState()), [e, t])
              );
              return (r.default.useDebugValue(i), i);
            })(t, e);
    ...
    function b({ children: e }) {
      let { flags: t } = v(),
        o = (0, s.usePathname)(),
        a = (0, r.useMemo)(() => o?.startsWith('/admin') ?? !1, [o]),
      ...
      return (
        ...
        (0, r.useEffect)(() => {
          if (t.reducedMotion || a) return void l(null);
          let e = new p({
            lerp: 0.08,
            wheelMultiplier: 1,
            touchMultiplier: 1.2,
        ...
        (0, i.jsx)(m.Provider, { value: { lenis: a ? null : n }, children: e })
      );
    }
    (e.s(['useAntigravityStore', 0, v], 94134),
      e.s(['default', () => b], 19017));
  },
  14072,
  (e) => {
  ...
  (e) => {
      ...
      return (function (e, t = {}) {
        let { onlyActive: i = !1, dropInvalid: r = !0 } = t,
          ...
          l = (e) => {
            ...
            let s = Math.min(3, Math.floor(r.length / 2));
            for (let e = 1; e <= s; e++)
              if (
          ...
          let e = (function (e) {
              let t = (e.bucket || 'site-assets')
                ...
                i = e.key
                  ...
                  .replace(/,+$/g, '')
                  .trim(),
                r = (0, o.normalizeStoragePath)(e.file_path, t),
                s = r
                  ...
                  : r,
                a =
                  'site-assets' === t && s?.startsWith('projects/')
                    ? 'portfolio-media'
                    : t,
                n = (e) => {
                  if (!e) return;
                ...
                l = n(e.page) || n(s) || n(i) || 'global',
                c =
                  (0, o.buildSupabaseStorageUrl)(a, s) ||
    ...
    var n = e.i(29935),
      ...
      p = e.i(85622),
      m = e.i(14072);
    let f = (0, e.i(16457).default)(() => e.A(60889), {
      loadableGenerated: { modules: [35454] },
      ssr: !1,
    });
    function g({
      navItems: e,
          ...
          children: (0, t.jsx)('div', {
            ...
            children: (0, t.jsxs)('div', {
              ...
              children: [
                (0, t.jsx)('div', {
                  className:
                    'absolute inset-0 rounded-4xl overflow-hidden opacity-60 pointer-events-none',
                  children: (0, t.jsx)(f, { accentColor: '#0048ff' }),
                }),
                (0, t.jsxs)('div', {
                  className:
    ...
    v.displayName = 'MobileMenuButton';
    var b = e.i(62897),
      x = e.i(77358),
      w = e.i(89361),
      y = e.i(5519),
                  ...
                  children: [
                    {
                      ...
                      icon: (0, t.jsx)(w.Linkedin, { className: 'w-5 h-5' }),
                    },
                    {
                      label: 'Instagram',
                      href: S.SOCIALS.instagram,
                      icon: (0, t.jsx)(x.Instagram, { className: 'w-5 h-5' }),
                    },
                    {
                      label: 'Email',
                      href: S.SOCIALS.emailPrimary,
                      icon: (0, t.jsx)(y.Mail, { className: 'w-5 h-5' }),
                    },
                  ].map((e) =>
                    (0, t.jsx)(
                      'a',
    ...
    E.displayName = 'MobileMenuPanel';
    let k = (0, i.forwardRef)((e, i) =>
      (0, t.jsx)('div', {
        ref: i,
        className:
    ...
    function j({ logoUrl: e, onLogoClick: i, children: r, isLight: s = !1 }) {
      let o = {
      ...
      return (0, t.jsx)(b.motion.header, {
        variants: {
        ...
        initial: 'hidden',
        animate: 'show',
        className: `fixed top-0 left-0 right-0 z-50 pointer-events-none ${s ? 'header--light' : ''}`,
        children: (0, t.jsx)('div', {
          className: `w-full h-[60px] pointer-events-auto transition-colors duration-300 ${s ? 'bg-background/40 border-b border-white/10 shadow-xl' : 'bg-background/40 backdrop-blur-md border-b border-white/5 shadow-lg shadow-black/20'}`,
          children: (0, t.jsxs)('div', {
            className:
              'flex items-center justify-between h-full w-full max-w-[1680px] mx-auto px-6 md:px-12 lg:px-16 xl:px-24',
            children: [
              (0, t.jsx)(b.motion.div, {
                variants: o,
              ...
              (0, t.jsx)(b.motion.div, { variants: o, children: r }),
            ],
          }),
        }),
      });
    }
    k.displayName = 'MobilePreLayers';
    var M = e.i(35259),
      N = e.i(90541),
      R = e.i(94134);
    function T({
      ...
      let {
        ...
        state: { open: y, textLines: S },
        actions: { toggleMenu: T, syncState: C },
      } = (function (e, t, r) {
        let s,
          o =
            ((s = (0, R.useAntigravityStore)((e) => e.flags)),
            !!(0, N.useReducedMotion)() || s.reducedMotion),
          a = (0, i.useRef)(null),
          n = (0, i.useRef)(null),
          l = (0, i.useRef)([]),
          c = (0, i.useRef)(null),
        ...
        (0, i.useLayoutEffect)(() => {
          ...
          let e = M.gsap.context(() => {
            ...
            (t && (c = Array.from(t.querySelectorAll('.sm-prelayer'))),
              ...
              M.gsap.set(i, { transformOrigin: '50% 50%', rotate: 0 }),
              M.gsap.set(r, { transformOrigin: '50% 50%', rotate: 90 }),
              M.gsap.set(s, { rotate: 0, transformOrigin: '50% 50%' }),
              M.gsap.set(o, { yPercent: 0 }));
          });
          return () => e.revert();
        }, [o]);
        let k = (0, i.useCallback)((e) => {
            ...
            t &&
              ...
              (x.current?.kill(),
              e
                ? (M.gsap.set(t, { rotate: 0, transformOrigin: '50% 50%' }),
                  (x.current = M.gsap
          ...
          j = (0, i.useCallback)((e) => {
            if (o) return void g([e ? 'Close' : 'Menu']);
            let t = m.current;
            if (!t) return;
            w.current?.kill();
            let i = e ? 'Menu' : 'Close',
            ...
            (r.push(e ? 'Close' : 'Menu'),
              g(r),
              M.gsap.set(t, { yPercent: 0 }));
            let a = r.length;
            w.current = M.gsap.to(t, {
              yPercent: -(((a - 1) / a) * 100),
              duration: 0.6,
              ease: 'expo.out',
            });
          ...
          T = (0, i.useCallback)(() => {
            ...
            let e = a.current,
              t = l.current;
            if (!e) return null;
            (v.current?.kill(), b.current?.kill());
            let i = e.querySelectorAll('.sm-panel-item'),
              r = c.current,
              s = r ? Array.from(r.querySelectorAll('.sm-social-link')) : [],
              n = r?.querySelector('.sm-social-title');
            (i.length &&
              M.gsap.set(i, { x: 40, opacity: 0, filter: 'blur(8px)' }),
              n && M.gsap.set(n, { opacity: 0, filter: 'blur(4px)' }),
              s.length && M.gsap.set(s, { x: 20, opacity: 0 }));
            let d = M.gsap.timeline({ paused: !0 });
            if (
              (t.length &&
                d.to(t, {
                  opacity: 0.9,
              ...
              let e = '-=0.4';
              (n &&
                d.to(n, { opacity: 1, filter: 'blur(0px)', duration: 0.6 }, e),
                s.length &&
                  d.to(
                    s,
                    {
          ...
          C = (0, i.useCallback)(() => {
            if (o) return;
            b.current && (b.current.kill(), (b.current = null));
            let e = T();
            e && e.play(0);
          }, [T]),
          O = (0, i.useCallback)(() => {
            if (o) return;
            (v.current?.kill(), (v.current = null));
            let e = a.current,
              t = l.current;
            if (!e) return;
            let i = [...t, e];
            (b.current?.kill(),
              (b.current = M.gsap.to(i, {
                opacity: 0,
                xPercent: 100,
                filter: 'blur(10px)',
                duration: 0.5,
                ...
                onComplete: () => {
                  ...
                  t.length &&
                    M.gsap.set(t, { x: 40, opacity: 0, filter: 'blur(8px)' });
                  let i = c.current;
                  if (i) {
                    let e = i.querySelector('.sm-social-title'),
                      t = Array.from(i.querySelectorAll('.sm-social-link'));
                    (e && M.gsap.set(e, { opacity: 0 }),
                      t.length && M.gsap.set(t, { x: 20, opacity: 0 }));
                  }
                },
              })));
          }, []),
          P = (0, i.useCallback)(() => {
            e !== E.current &&
              (e
                ? ((E.current = !0),
                  S(!0),
                  o ? (t(), g(['Close'])) : (C(), k(!0), j(!0)))
                : ((E.current = !1),
                  S(!1),
                  o ? (r(), g(['Menu'])) : (O(), k(!1), j(!1))));
          }, [e, C, O, k, j, o, r, t]);
        return {
          refs: {
            panelRef: a,
          ...
          state: { open: y, textLines: f },
          actions: {
            toggleMenu: (0, i.useCallback)(() => {
              let e = !E.current;
              if (e !== E.current) {
                if (((E.current = e), S(e), o)) {
                  (e ? t() : r(), g([e ? 'Close' : 'Menu']));
                  return;
                }
                (e ? (t(), C()) : (r(), O()), k(e), j(e));
              }
    ...
    function O({ navItems: e, gradient: s, accentColor: o }) {
      let a = (0, n.useRouter)(),
        [l, h] = (0, i.useState)(!1),
        [p, m] = (0, i.useState)(!1),
        [f, v] = (0, i.useState)(!1),
    ...
    function A({ children: e }) {
      let r = (0, n.usePathname)(),
        s = (0, i.useMemo)(() => r?.startsWith('/admin') ?? !1, [r]);
      return (!(function (e = !0) {
        let t = (0, R.useAntigravityStore)((e) => e.setFlags),
          r = (0, R.useAntigravityStore)((e) => e.setViewport);
        (0, i.useEffect)(() => {
          if (!e) return;
          let i = () => {
    ...
    function H({ children: e }) {
      ...
      n)
        ...
        : (0, t.jsx)(L, { children: (0, t.jsx)(A, { children: e }) });
    }
    e.s(['default', () => H], 66058);
  },
]);
