(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    e.v({
      'card-3d-wrapper': 'floating-cards-module__TOU2zq__card-3d-wrapper',
      'card-glass': 'floating-cards-module__TOU2zq__card-glass',
      'floating-cards-container':
        'floating-cards-module__TOU2zq__floating-cards-container',
      'purple-glow-text': 'floating-cards-module__TOU2zq__purple-glow-text',
    });
  },
  52931,
  (e) => {
    ...
    var t = e.i(79606),
      ...
      o = e.i(35259),
      i = e.i(35798);
    let s = 'u' > typeof document ? r.useLayoutEffect : r.useEffect,
      ...
      u = (e, t = c) => {
        ...
        (l(e)
          ? ((a = e),
            (e = null),
            (t = 'dependencies' in a ? a.dependencies : c))
          : l(t) && (t = 'dependencies' in (a = t) ? a.dependencies : c),
          e &&
            'function' != typeof e &&
            console.warn(
              'First parameter must be a function or config object'
            ));
        let { scope: o, revertOnUpdate: i } = a,
          u = (0, r.useRef)(!1),
          p = (0, r.useRef)(d.context(() => {}, o)),
          f = (0, r.useRef)((e) => p.current.add(null, e)),
          m = t && t.length && !i;
        return (
          m && s(() => ((u.current = !0), () => p.current.revert()), c),
          s(() => {
            if ((e && p.current.add(e, o), !m || !u.current))
    ...
    function m() {
      ...
      u(
        () => {
          let t = o.default.utils.toArray('.card-item');
          (t.forEach((e) => {
            o.default.to(e, {
              y: '-=20',
      ...
      return (0, t.jsx)('section', {
        ref: e,
        className: `${f.default['floating-cards-container']} relative min-h-screen w-full overflow-hidden bg-[#0f0f23] py-24 px-6 md:px-12`,
        children: (0, t.jsx)('div', {
          ...
          children: p.map((e) =>
            (0, t.jsx)(
              'div',
              {
                className: `card-item ${f.default['card-3d-wrapper']}`,
                onMouseEnter: l,
                onMouseLeave: c,
                tabIndex: 0,
                role: 'article',
                ...
                children: (0, t.jsxs)('div', {
                  className: `${f.default['card-glass']} relative flex h-[320px] w-full flex-col overflow-hidden rounded-[24px] p-6 transition-colors hover:bg-white/10 group`,
                  children: [
                    (0, t.jsx)('div', {
                      className:
                    ...
                    (0, t.jsx)('h3', {
                      className: `${f.default['purple-glow-text']} mb-2 text-xl font-bold text-white transition-colors group-hover:text-[#4fe6ff]`,
                      children: e.title,
                    }),
                    (0, t.jsx)('p', {
