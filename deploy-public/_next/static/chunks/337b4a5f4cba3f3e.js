(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function o({ assets: e, children: o }) {
      let l = (0, i.useMemo)(() => {
          let t = {};
          return (
            e.forEach((e) => {
              if (e.href) {
                let i = (0, s.validateExternalUrl)(e.href);
                t[e.key] = { ...e, href: i };
              } else t[e.key] = e;
            }),
            t
      ...
      return (0, t.jsx)(r.Provider, { value: n, children: o });
    }
    function l(e, t) {
      let s = (0, i.useContext)(r);
      return s?.getUrl(e) ?? t;
    }
    e.s(['SiteAssetsProvider', () => o, 'useSiteAssetUrl', () => l]);
  },
  72928,
  (e) => {
    'use strict';
    let t = {
      ...
      s = t.about.originImages.map((e, t) => ({
        key: e,
  ...
  (e) => {
    ...
    e.s(['BRAND', 0, s, 'SUPABASE_STORAGE_URL', 0, t]);
  },
  59747,
  98788,
  (e) => {
    ...
    e.s(['Instagram', () => i], 59747);
    let s = (0, t.default)('linkedin', [
      [
        'path',
        {
    ...
    e.s(['Linkedin', () => s], 98788);
  },
  1498,
  (e) => {
    'use strict';
    let t = (0, e.i(16424).default)('mail', [
    ...
    var i = class {
        ...
        advance(e) {
          ...
          if (this.duration && this.easing) {
            this.currentTime += e;
            let s = t(0, this.currentTime / this.duration, 1),
              r = (i = s >= 1) ? 1 : this.easing(s);
        ...
        fromTo(
          e,
          t,
          { lerp: i, duration: s, easing: r, onStart: o, onUpdate: l }
        ) {
      ...
      n = class {
        ...
        onWheel = (e) => {
          let { deltaX: t, deltaY: i, deltaMode: s } = e,
            r = 1 === s ? o : 2 === s ? this.window.width : 1,
            l = 1 === s ? o : 2 === s ? this.window.height : 1;
          ((t *= r),
            (i *= l),
      ...
      h = class {
        ...
        constructor({
          ...
          ((window.lenisVersion = '1.3.17'),
            ...
            'number' == typeof c && 'function' != typeof u
              ? (u = a)
              : 'function' == typeof u && 'number' != typeof c && (c = 1),
            (this.options = {
              wrapper: e,
              content: t,
              eventsTarget: i,
            ...
            (this.dimensions = new s(e, t, { autoResize: b })),
        ...
        scrollTo(
          e,
          {
            ...
            lock: r = !1,
            programmatic: o = !0,
            lerp: l = o ? this.options.lerp : void 0,
            duration: n = o ? this.options.duration : void 0,
            easing: h = o ? this.options.easing : void 0,
            onStart: c,
            onComplete: u,
            force: d = !1,
            userData: p,
          ...
          if ((!this.isStopped && !this.isLocked) || d) {
            ...
            if ('number' == typeof e) {
              ...
              (o || (this.targetScroll = e),
                'number' == typeof n && 'function' != typeof h
                  ? (h = a)
                  : 'function' == typeof h && 'number' != typeof n && (n = 1),
        ...
        checkNestedScroll(e, { deltaX: t, deltaY: i }) {
          ...
          if (v - (b.time ?? 0) > 2e3) {
            ...
            if (
              ...
              (r = ['auto', 'overlay', 'scroll'].includes(u)),
              (b.hasOverflowX = s),
              (b.hasOverflowY = r),
              (!s && !r) ||
                ('vertical' === w && !r) ||
          ...
          if (
            ...
            return !1;
          if ('x' === u)
            ((d = e.scrollLeft), (p = n - h), (f = t), (m = s), (g = o));
          else {
            if ('y' !== u) return !1;
            ((d = e.scrollTop), (p = a - c), (f = i), (m = r), (g = l));
          }
  ...
  (e) => {
    e.v({
      fallbackBackground:
        'DesktopFluidHeader-module__gTVa7a__fallbackBackground',
      headerContainer: 'DesktopFluidHeader-module__gTVa7a__headerContainer',
      headerDark: 'DesktopFluidHeader-module__gTVa7a__headerDark',
      headerLight: 'DesktopFluidHeader-module__gTVa7a__headerLight',
      subtleBorder: 'DesktopFluidHeader-module__gTVa7a__subtleBorder',
    });
  },
  25827,
  (e) => {
    ...
    async function n() {
      ...
      if (i) throw i;
      return (function (e, t = {}) {
        let { onlyActive: i = !1, dropInvalid: s = !0 } = t,
          r = new Map(),
          o = new Map(),
          n = (e) => {
            if (!e) return !0;
          ...
          a = (e) => {
            ...
            if (!t) return e;
            let i = t.includes('/') ? '/' : '.',
              s = t.split(i).filter(Boolean);
            if (s.length < 4) return e;
            let r = Math.min(3, Math.floor(s.length / 2));
            for (let e = 1; e <= r; e++)
              if (
                s.slice(0, e).join('|').toLowerCase() ===
                s
                  .slice(e, 2 * e)
                  .join('|')
                  .toLowerCase()
              )
                return [...s.slice(0, e), ...s.slice(2 * e)].join(i);
            return e;
          },
          h = (e) =>
            4 * !!e.is_active +
        ...
        for (let t of e) {
          let e = (function (e) {
              let t = (e.bucket || 'site-assets')
                ...
                i = e.key
                  ...
                  .replace(/,+$/g, '')
                  .trim(),
                s = (0, l.normalizeStoragePath)(e.file_path, t),
                r = s
                  ? /^clients\.clients\.strip\./.test(s)
                    ? s.replace(
                        /^clients\.clients\.strip\./,
                        'clients/clients.strip.'
                      )
                    : /^clients\.strip\./.test(s)
                      ? s.replace(/^clients\.strip\./, 'clients/clients.strip.')
                      : s
                  : s,
                o =
                ...
                a = n(e.page) || n(r) || n(i) || 'global',
                h =
                  (0, l.buildSupabaseStorageUrl)(o, r) ||
              ...
              if (e.href) {
                let t = (0, l.validateExternalUrl)(e.href);
                t && (c = { ...c, href: t });
              }
              return c;
            })({
              ...t,
              key: a(t.key) ?? t.key,
              file_path: a(t.file_path) ?? t.file_path,
            }),
            c = e.key?.trim();
          if (!c || (s && (n(c) || n(e.file_path))) || (i && !e.is_active))
            continue;
          ...
          let d = (e, t) => {
              ...
              let i = h(e),
                s = h(t);
              return s > i || (s === i && t.key.length < e.key.length) ? t : e;
            },
            p = d(r.get(c), e);
          r.set(c, p);
          let f = e.file_path || '';
        ...
        let c = new Map();
        for (let e of r.values()) c.set(e.id, e);
        for (let e of o.values()) c.set(e.id, e);
        return Array.from(c.values()).sort((e, t) => {
          let i = e.page ?? '',
            s = t.page ?? '';
          if (i === s) {
            let i = e.sort_order ?? Number.MAX_SAFE_INTEGER,
              s = t.sort_order ?? Number.MAX_SAFE_INTEGER;
            return i === s ? e.key.localeCompare(t.key) : i - s;
          }
    ...
    var a = e.i(63844),
      h = e.i(69527);
    let c = (0, s.createContext)({ lenis: null }),
      u = (e) => {
        let t,
          i = new Set(),
          s = (e, s) => {
            ...
            if (!Object.is(r, t)) {
              let e = t;
              ((t = (null != s ? s : 'object' != typeof r || null === r)
                ? r
                : Object.assign({}, t, r)),
                i.forEach((i) => i(t, e)));
            }
    ...
    function f({ children: e }) {
      ...
      return (
        ...
        (0, i.jsx)(c.Provider, { value: { lenis: r }, children: e })
      );
    }
    var m = e.i(32648),
      g = e.i(54768),
    ...
    function y({
      ...
      return (0, i.jsx)('header', {
        className: `hidden lg:block fixed top-6 left-0 right-0 z-40 w-full pointer-events-none transition-all duration-300 ease-in-out ${l ? 'header--light' : ''}`,
        children: (0, i.jsx)('div', {
          ...
          children: (0, i.jsx)('div', {
            ...
            children: (0, i.jsx)('div', {
              className: `${x.default.headerContainer} ${l ? x.default.headerLight : x.default.headerDark} h-16 w-[calc(100%+5rem)] -ml-10 rounded-4xl backdrop-blur-md border border-white/10 bg-black/20 transition-all duration-300`,
                  ...
                  (0, i.jsx)('nav', {
                    ...
                    children: h.map((e) => {
                      ...
                      let s =
                        ...
                        a = s
                          ? `${l ? 'text-blueAccent' : 'text-bluePrimary'} font-semibold`
                          : `${l ? 'text-white' : 'text-white/70'} ${l ? 'hover:text-blueAccent' : 'hover:text-white'} font-medium`,
                        h = c ? 'text-bluePrimary font-semibold' : '',
                        u = s
                      ...
                      /^https?:\/\//.test(t) ||
                        ...
                        ? (0, i.jsxs)(
                            'a',
                            {
                              ...
                              className: `group ${n} ${a} ${h} relative flex items-center`,
                              children: [
                                (0, i.jsx)('span', {
                                  className: 'tracking-tight',
                                  children: e.label,
                                }),
                                (0, i.jsx)('span', { className: u }),
                              ],
                            },
                            e.href
                          )
                ...
                children: t.map((e, s) =>
                  (0, i.jsx)(
                    'span',
                    {
                      ...
                      style: {
                        visibility: s === t.length - 1 ? 'visible' : 'hidden',
                      },
                      children: e,
                    },
                    `${e}-${s}`
                ...
                return (0, i.jsx)(
                  'li',
                  {
                    ...
                    children: (0, i.jsx)('button', {
                      onClick: () => o(e.href),
                      className: `sm-panel-item text-4xl font-light tracking-wide transition-colors text-left leading-none uppercase will-change-transform origin-bottom ${(a ? 'text-blueAccent font-semibold' : '') || (n === t ? 'text-blueAccent font-medium underline underline-offset-4' : 'text-white/80 hover:text-white')}`,
                      children: e.label,
                    }),
                  },
                  e.href
              ...
              children: [
                ...
                (0, i.jsx)('div', {
                  ...
                  children: [
                    {
                      label: 'LinkedIn',
                      href: L.SOCIALS.linkedin,
                      icon: (0, i.jsx)(_.Linkedin, { className: 'w-5 h-5' }),
                    },
                    {
                      label: 'Instagram',
                      href: L.SOCIALS.instagram,
                      icon: (0, i.jsx)(E.Instagram, { className: 'w-5 h-5' }),
                    },
                    {
                      label: 'Email',
                      href: L.SOCIALS.emailPrimary,
                      icon: (0, i.jsx)(N.Mail, { className: 'w-5 h-5' }),
                    },
                  ].map((e) =>
                    (0, i.jsx)(
                      'a',
    ...
    function T({ logoUrl: e, onLogoClick: t, children: s, isLight: r = !1 }) {
      let o = {
        ...
        children: (0, i.jsx)('div', {
          ...
          children: (0, i.jsxs)('div', {
            ...
            children: [
              ...
              (0, i.jsx)(k.motion.div, { variants: o, children: s }),
            ],
          }),
        }),
      });
    }
    M.displayName = 'MobilePreLayers';
    var C = e.i(38421);
    function R({
      navItems: e,
      logoUrl: t,
      isLight: r = !1,
      accentColor: o = '#0057FF',
      isOpen: l,
      onOpen: n,
      onClose: a,
      onNavigate: h,
      ...
      let {
        ...
        state: { open: x, textLines: y },
        actions: { toggleMenu: k, syncState: E },
      } = (function (e, t, i) {
        ...
        (0, s.useLayoutEffect)(() => {
          let e = C.gsap.context(() => {
            ...
            (t && (p = Array.from(t.querySelectorAll('.sm-prelayer'))),
              ...
              C.gsap.set(i, { transformOrigin: '50% 50%', rotate: 0 }),
              C.gsap.set(s, { transformOrigin: '50% 50%', rotate: 90 }),
              C.gsap.set(n, { rotate: 0, transformOrigin: '50% 50%' }),
              C.gsap.set(a, { yPercent: 0 }));
          });
          return () => e.revert();
        }, []);
        let S = (0, s.useCallback)((e) => {
            ...
            t &&
              ...
              (v.current?.kill(),
              e
                ? (C.gsap.set(t, { rotate: 0, transformOrigin: '50% 50%' }),
                  (v.current = C.gsap
                    .timeline({ defaults: { ease: 'expo.out' } })
                    .to(i, { rotate: 45, duration: 0.6 }, 0)
                    .to(s, { rotate: -45, duration: 0.6 }, 0)))
                : (v.current = C.gsap
                    .timeline({ defaults: { ease: 'expo.inOut' } })
                    .to(i, { rotate: 0, duration: 0.45 }, 0)
                    .to(s, { rotate: 90, duration: 0.45 }, 0)
          ...
          k = (0, s.useCallback)((e) => {
            ...
            (s.push(e ? 'Close' : 'Menu'),
              f(s),
              C.gsap.set(t, { yPercent: 0 }));
            let o = s.length;
            b.current = C.gsap.to(t, {
              yPercent: -(((o - 1) / o) * 100),
              duration: 0.6,
              ease: 'expo.out',
            });
          ...
          E = (0, s.useCallback)(() => {
            let e = r.current,
              t = l.current;
            if (!e) return null;
            (m.current?.kill(), g.current?.kill());
            let i = e.querySelectorAll('.sm-panel-item'),
              s = n.current,
              o = s ? Array.from(s.querySelectorAll('.sm-social-link')) : [],
              a = s?.querySelector('.sm-social-title');
            (i.length &&
              C.gsap.set(i, { x: 40, opacity: 0, filter: 'blur(8px)' }),
              a && C.gsap.set(a, { opacity: 0, filter: 'blur(4px)' }),
              o.length && C.gsap.set(o, { x: 20, opacity: 0 }));
            let h = C.gsap.timeline({ paused: !0 });
            if (
              (t.length &&
                h.to(t, {
                  opacity: 0.9,
              ...
              let e = '-=0.4';
              (a &&
                h.to(a, { opacity: 1, filter: 'blur(0px)', duration: 0.6 }, e),
                o.length &&
                  h.to(
                    o,
                    {
          ...
          N = (0, s.useCallback)(() => {
            (m.current?.kill(), (m.current = null));
            let e = r.current,
              t = l.current;
            if (!e) return;
            let i = [...t, e];
            (g.current?.kill(),
              (g.current = C.gsap.to(i, {
                opacity: 0,
                xPercent: 100,
                filter: 'blur(10px)',
                duration: 0.5,
                ...
                onComplete: () => {
                  ...
                  t.length &&
                    C.gsap.set(t, { x: 40, opacity: 0, filter: 'blur(8px)' });
                  let i = n.current;
                  if (i) {
                    let e = i.querySelector('.sm-social-title'),
                      t = Array.from(i.querySelectorAll('.sm-social-link'));
                    (e && C.gsap.set(e, { opacity: 0 }),
                      t.length && C.gsap.set(t, { x: 20, opacity: 0 }));
                  }
                },
              })));
          }, []),
          L = (0, s.useCallback)(() => {
            e !== y.current &&
              (e
                ? ((y.current = !0), x(!0), _(), S(!0), k(!0))
                : ((y.current = !1), x(!1), N(), S(!1), k(!1)));
          }, [e, _, N, S, k]);
        return {
          refs: {
            panelRef: r,
          ...
          state: { open: w, textLines: p },
          actions: {
            toggleMenu: (0, s.useCallback)(() => {
              let e = !y.current;
              e !== y.current &&
                ((y.current = e),
                x(e),
    ...
    function z({ navItems: e, gradient: t, accentColor: o }) {
      let l = (0, a.useRouter)(),
        [n, h] = (0, s.useState)(!1),
        [c, u] = (0, s.useState)(!1),
        [d, p] = (0, s.useState)(!1),
          ...
          (0, s.useMemo)(
            () =>
              e
                ...
                .map((e) => A(e.href).replace('#', '')),
            [e]
          )
        ),
        w = (0, a.usePathname)(),
        x = (0, s.useMemo)(() => ('/' === w ? b : (w ?? void 0)), [w, b]),
      ...
      let _ =
        (0, r.useSiteAssetUrl)(
          ...
          m.BRAND.assets.logos.logoLight
        ) ?? m.BRAND.assets.logos.logoLight;
      return d
        ? (0, i.jsx)(i.Fragment, {
            children: f
    ...
    function W() {
      return (0, i.jsx)(z, {
        navItems: L.NAVIGATION.header || [],
        gradient: ['rgba(0,87,255,0.55)', 'rgba(82,39,255,0.45)'],
        accentColor: m.BRAND.colors.bluePrimary,
      });
    }
    function O({ children: e }) {
      let t = (0, a.usePathname)(),
        r = (0, s.useMemo)(() => t?.startsWith('/admin') ?? !1, [t]);
      return (!(function (e = !0) {
    ...
    function D({ children: e }) {
      ...
      l)
        ? (0, i.jsx)(r.SiteAssetsProvider, {
            assets: t,
            children: (0, i.jsx)(O, { children: e }),
          })
        : (0, i.jsx)(O, { children: e });
    }
    e.s(['default', () => D], 25827);
  },
]);
