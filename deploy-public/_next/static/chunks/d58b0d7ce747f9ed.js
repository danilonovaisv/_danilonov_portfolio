(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var C = e.i(52154),
      ...
      E = e.i(79672),
      k = e.i(82075);
    let O = { start: 0, center: 0.5, end: 1 };
    function A(e, t, i = 0) {
      let a = 0;
      if ((e in O && (e = O[e]), 'string' == typeof e)) {
        let t = parseFloat(e);
        e.endsWith('px')
          ? (a = t)
          : e.endsWith('%')
    ...
    function z(
      ...
      return (
        ...
        () => {
          ...
          let i = D.get(a);
          (i && ((0, s.cancelFrame)(i), D.delete(a)), W.delete(a));
        }
      );
    }
    let B = new Map();
    function V({ source: e, container: t, ...i }) {
      var a;
      let r,
        o,
        { axis: n } = i;
      e && (t = e);
      let s = B.get(t) ?? new Map();
      B.set(t, s);
      let l = i.target ?? 'self',
        d = s.get(l) ?? {},
        m = n + (i.offset ?? []).join(',');
