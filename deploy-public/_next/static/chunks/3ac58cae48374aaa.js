(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function r({ assets: e, children: r }) {
      let l = (0, t.useMemo)(() => {
          let o = {};
          return (
            e.forEach((e) => {
        ...
        s = (0, t.useMemo)(() => {
          ...
          return {
            ...
            getAssetsByPrefix: (o) => e.filter((e) => e.key.startsWith(o)),
            getAssetWithValidation: (e) => {
              let o = l[e];
              if (o?.href) {
                let e = (0, i.validateExternalUrl)(o.href);
                return e ? { ...o, href: e } : o;
              }
              return o;
            },
      ...
      return (0, o.jsx)(a.Provider, { value: s, children: r });
    }
    function l(e, o) {
      let i = (0, t.useContext)(a);
      return i?.getUrl(e) ?? o;
    }
    e.s(['SiteAssetsProvider', () => r, 'useSiteAssetUrl', () => l]);
  },
  82970,
  (e) => {
    'use strict';
    let o = {
        ...
        clients: {
          strips: Array.from(
            { length: 12 },
            (e, o) => `clients.strip.${o + 1}`
          ),
        },
      },
      t = Object.entries(o.fonts).map(([e, o]) => ({
        key: o,
        label: `Fonte ${e}`,
        page: 'global',
        category: 'font',
      })),
      i = o.about.originImages.map((e, o) => ({
        key: e,
        label: `Origem imagem ${o + 1}`,
        page: 'about',
        category: 'image',
      })),
      a = o.clients.strips.map((e, o) => ({
        key: e,
        label: `Logo cliente ${o + 1}`,
        page: 'clients',
        category: 'client',
      }));
    ([
      o.logos.headerLight,
      o.logos.headerDark,
      o.logos.faviconLight,
      o.logos.faviconDark,
      ...t,
      o.heroVideos.homeManifesto,
      o.heroVideos.aboutDesktop,
      o.heroVideos.aboutMobile,
      o.heroVideos.method,
      ...i,
      o.portfolio.heroDesktop,
      o.portfolio.heroMobile,
      ...a,
    ],
      e.s(['SITE_ASSET_KEYS', 0, o]));
  },
  40022,
  (e) => {
    'use strict';
    let o = `${'https://umkmwbkwvulxtdodzmzf.supabase.co'.replace(/\/$/, '')}/storage/v1/object/public`,
      t = (e) => `${o}/${e.replace(/^\/+/, '')}`,
      i = {
        name: 'Danilo Novais',
        ...
        assets: {
          logos: {
            favicon: t('site-assets/global/logos/global.favicon_dark.svg'),
            faviconLight: t(
            ...
            logoDark: t('site-assets/global/logos/global.logo_header_dark.svg'),
          },
          video: { manifesto: t('site-assets/home/home.manifesto_video.mp4') },
          fonts: { primary: 'TT Norms Pro', mono: 'PPSupplyMono' },
        },
        video: { manifesto: t('site-assets/home/home.manifesto_video.mp4') },
        layout: { mobile: { stacking: 'vertical', alignment: 'center' } },
      };
    e.s(['BRAND', 0, i, 'SUPABASE_STORAGE_URL', 0, o]);
  },
  77358,
  89361,
  (e) => {
    ...
    e.s(['Instagram', () => t], 77358);
    let i = (0, o.default)('linkedin', [
      [
        'path',
        {
    ...
    e.s(['Linkedin', () => i], 89361);
  },
  5519,
  (e) => {
    'use strict';
    let o = (0, e.i(3645).default)('mail', [
  ...
  (e) => {
    ...
    var o = e.i(7382),
      ...
      i = e.i(46858);
    function a() {
      o.hasReducedMotionListener.current || (0, t.initPrefersReducedMotion)();
      let [e] = (0, i.useState)(o.prefersReducedMotion.current);
      return e;
    }
  ...
  (e) => {
    'use strict';
    let o = (0, e.i(46858).createContext)({ lenis: null });
    e.s(['ScrollContext', 0, o]);
  },
  34476,
  (e) => {
    'use strict';
    let o = (e) => {
        let o,
          ...
          i = (e, i) => {
            ...
            if (!Object.is(a, o)) {
              let e = o;
              ((o = (null != i ? i : 'object' != typeof a || null === a)
                ? a
                : Object.assign({}, o, a)),
                t.forEach((t) => t(o, e)));
            }
  ...
  (e) => {
    ...
    var t = e.i(46858),
      i = e.i(34476);
    let a = (e) => {
        let o = (0, i.createStore)(e),
          a = (e) =>
            (function (e, o = (e) => e) {
              let i = t.default.useSyncExternalStore(
                e.subscribe,
                t.default.useCallback(() => o(e.getState()), [e, o]),
                t.default.useCallback(() => o(e.getInitialState()), [e, o])
              );
      ...
      r = (o = (e) => ({
        ...
        narrativeState: 'IDLE',
        scrollProgress: 0,
        setFlag: (o, t) => e((e) => ({ flags: { ...e.flags, [o]: t } })),
        setFlags: (o) => e((e) => ({ flags: { ...e.flags, ...o } })),
        setViewport: (o, t) => e({ viewport: { width: o, height: t } }),
        setNarrativeState: (o) => e({ narrativeState: o }),
        setScrollProgress: (o) => e({ scrollProgress: o }),
      }))
        ? a(o)
        : a;
    e.s(['useAntigravityStore', 0, r], 94134);
  },
  94608,
  (e) => {
    'use strict';
    var o = e.i(90541),
      t = e.i(94134);
    function i() {
      let e = (0, t.useAntigravityStore)((e) => e.flags);
      return !!(0, o.useReducedMotion)() || e.reducedMotion;
    }
    e.s(['useMotionGate', () => i]);
  },
]);
