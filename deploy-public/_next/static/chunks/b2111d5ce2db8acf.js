(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
    ...
    e.r(41548);
    var i = e.r(52155),
      l = i && 'object' == typeof i && 'default' in i ? i : { default: i },
      ...
      s = (function () {
        function e(e) {
          ...
          (u(a(r), '`name` must be a string'),
            ...
            u('boolean' == typeof l, '`optimizeForSpeed` must be a boolean'),
    ...
    function p(e, t) {
      ...
      var n = e + t;
      return (
        f[n] || (f[n] = t.replace(/__jsx-style-dynamic-selector/g, e)),
        f[n]
      );
    }
    var h = (function () {
        function e(e) {
          var t = void 0 === e ? {} : e,
            ...
            l = void 0 !== i && i;
          ((this._sheet =
            r || new s({ name: 'styled-jsx', optimizeForSpeed: l })),
            this._sheet.inject(),
            r &&
              'boolean' == typeof l &&
    ...
    ((k.dynamic = function (e) {
      ...
      (n.StyleRegistry = function (e) {
        ...
        return l.default.createElement(m.Provider, { value: o }, n);
      }),
  ...
  (e, t, n) => {
    ...
    t.exports = function e() {
      var t,
        ...
        h = !1;
      for (
        'boolean' == typeof f && ((h = f), (f = arguments[1] || {}), (d = 2)),
              ...
              f !== (i = c(t, n)) &&
                (h && i && (s(i) || (l = a(i)))
                  ? (l
                      ? ((l = !1), (o = r && a(r) ? r : []))
                      : (o = r && s(r) ? r : {}),
                    u(f, { name: n, newValue: e(h, o, i) }))
                  : void 0 !== i && u(f, { name: n, newValue: i })));
      return f;
    };
  },
  76753,
  (e) => {
    ...
    function s() {}
    function u() {}
    let c = /^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
      f = /^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
      d = {};
    function p(e, t) {
      return ((t || d).jsx ? f : c).test(e);
    }
    let h = /[ \t\n\f\r]/g;
    function m(e) {
      return '' === e.replace(h, '');
    ...
    function O(e) {
      ...
      for (let [r, i] of Object.entries(e.properties)) {
        let l = new A(r, e.transform(e.attributes || {}, r), i, e.space);
        (e.mustUseProperty &&
    ...
    function et(e) {
      return ee(e && e.start) + '-' + ee(e && e.end);
    }
    function en(e) {
    ...
    let ei = {}.hasOwnProperty,
      ...
      es = new Set(['td', 'th']),
      eu = 'https://github.com/syntax-tree/hast-util-to-jsx-runtime';
    function ec(e, t, n) {
      var r, i, l, o, a, u, c, f, d;
      let p, h, y, v, x, k, b, w, S, C, E;
        ...
        ? ((r = e),
          ...
          (v = (function (e, t) {
            ...
            for (r in t.properties)
              if ('children' !== r && ei.call(t.properties, r)) {
                let l = (function (e, t, n) {
                  ...
                  if (
                    !(null == n || ('number' == typeof n && Number.isNaN(n)))
                  ) {
                    var i;
                    let t;
                    if (
                      ...
                      let t =
                        'object' == typeof n
                          ...
                          : (function (e, t) {
                              try {
                                return (0, X.default)(t, { reactCompat: !0 });
                              } catch (n) {
                                ...
                                throw (
                                  ...
                                  (t.url =
                                    eu + '#cannot-parse-style-attribute'),
                                  t
                                );
                              }
                            })(e, String(n));
          ...
          ea.has(i.tagName) &&
            (x = x.filter(function (e) {
              return (
                'string' != typeof e ||
                !('object' == typeof e ? 'text' === e.type && m(e.value) : m(e))
              );
            })),
          ef(r, v, y, i),
          ed(v, x),
        ...
        : 'mdxFlowExpression' === t.type || 'mdxTextExpression' === t.type
          ...
          : 'mdxJsxFlowElement' === t.type || 'mdxJsxTextElement' === t.type
            ? ((o = e),
              ...
              (u = n),
              (b = k = o.schema),
              'svg' === a.name && 'html' === k.space && (o.schema = Q),
              o.ancestors.push(a),
              (w = null === a.name ? o.Fragment : eh(o, a.name, !0)),
              (S = (function (e, t) {
                let n = {};
                for (let r of t.attributes)
                  if ('mdxJsxExpressionAttribute' === r.type)
                    if (r.data && r.data.estree && e.evaluater) {
                      ...
                      s('ExpressionStatement' === t.type);
                      let i = t.expression;
                      s('ObjectExpression' === i.type);
                      let l = i.properties[0];
                      (s('SpreadElement' === l.type),
                        Object.assign(
                          n,
    ...
    function eh(e, t, n) {
      ...
      if ('Literal' === r.type) {
        let t = r.value;
        return ei.call(e.components, t) ? e.components[t] : t;
      }
      if (e.evaluater) return e.evaluater.evaluateExpression(r);
      em(e);
    }
    function em(e, t) {
      let n = new er('Cannot handle MDX estrees without `createEvaluater`', {
        ancestors: e.ancestors,
        place: t,
        ruleId: 'mdx-estree',
        source: 'hast-util-to-jsx-runtime',
      ...
      throw (
        ...
        (n.url = eu + '#cannot-handle-mdx-estrees-without-createevaluater'),
        n
      );
    }
    function eg(e) {
    ...
    function ex(e, t, n) {
      ...
      if ((r = e) && 'object' == typeof r) {
        ...
        if ('children' in e) return ek(e.children, t, n);
      }
      return Array.isArray(e) ? ek(e, t, n) : '';
    }
    function ek(e, t, n) {
      let r = [],
        i = -1;
      for (; ++i < e.length; ) r[i] = ex(e[i], t, n);
      return r.join('');
    }
    function eb(e, t, n, r) {
      let i,
    ...
    function eF(e, t, n, r) {
      ...
      return function (r) {
        return eN(r)
          ? (e.enter(n),
            (function r(o) {
              return eN(o) && l++ < i ? (e.consume(o), r) : (e.exit(n), t(o));
            })(r))
          : t(r);
      };
    }
    let eO = {
        ...
        tokenize: function (e) {
          ...
          function s(e) {
            if ((o++, i.containerState._closeFlow)) {
              ...
              return (
                eb(i.events, l + 1, 0, i.events.slice(r)),
                (i.events.length = a),
                u(e)
              );
            }
          ...
          function u(n) {
            ...
            return ((i.containerState = {}), e.check(eB, c, f)(n));
          }
          function c(e) {
            return (t && y(), g(o), d(e));
          }
          ...
          function d(t) {
            return ((i.containerState = {}), e.attempt(eB, p, h)(t));
          }
          function p(e) {
          ...
          function m(e, l) {
            ...
            if (
              ...
              (eb(i.events, s + 1, 0, i.events.slice(a)),
                (i.events.length = l));
            }
          }
          function g(t) {
      ...
      eU = {
        ...
        tokenize: function (e, t, n) {
          return function (t) {
            return eN(t) ? eF(e, r, 'linePrefix')(t) : r(t);
          };
          function r(e) {
    ...
    class eH {
      ...
      pushMany(e) {
        (this.setCursor(1 / 0), eV(this.left, e));
      }
      unshift(e) {
      ...
      for (; ++u < c.length; ) {
        ...
        if ('enter' === t[0])
            ...
            (Object.assign(
              ...
              (function (e, t) {
                let n,
                  ...
                  s = i._tokenizer;
                !s &&
                  ((s = l.parser[i.contentType](i.start)),
          ...
          n &&
            ...
            (l = c.slice(n, u)).unshift(t),
            c.splice(n, u - n + 1, l));
        }
      }
      return (eb(e, 0, 1 / 0, c.slice(0)), !a);
    }
    let e$ = {
        resolve: function (e) {
          return (eq(e), e);
          ...
          let t = this,
            n = e.attempt(
              ...
              e.attempt(
                ...
                eF(
                  e,
                  e.attempt(this.parser.constructs.flow, r, e.attempt(e$, r)),
                  'linePrefix'
                )
              )
            );
    ...
    function eY(e) {
      return {
        resolveAll: eZ('text' === e ? eG : void 0),
        tokenize: function (t) {
          let n = this,
    ...
    function e0(e) {
      return null === e || ej(e) || eR(e) ? 1 : eL(e) ? 2 : void 0;
    }
    function e1(e, t, n) {
      let r = [],
        i = -1;
          ...
          return (
            ...
            (function o(a) {
              ...
              let s = e.exit('attentionSequence'),
                u = e0(a),
                c = !u || (2 === u && l) || r.includes(a),
                f = !l || (2 === l && u) || r.includes(i);
              return (
                (s._open = !!(42 === n ? c : c && (l || !f))),
    ...
    let e5 = {
      ...
      e3 = document.createElement('i');
    function e9(e) {
      let t = '&' + e + ';';
      e3.innerHTML = t;
      let n = e3.textContent;
      return (
    ...
    let e7 = {
          ...
          function a(t) {
            return 35 === t
              ? (e.enter('characterReferenceMarkerNumeric'),
                ...
                s)
              : (e.enter('characterReferenceValue'), (r = 31), (i = eE), u(t));
          }
          function s(t) {
            return 88 === t || 120 === t
              ? (e.enter('characterReferenceMarkerHexadecimal'),
                ...
                (i = eP),
                u)
              : (e.enter('characterReferenceValue'), (r = 7), (i = eA), u(t));
          }
          function u(a) {
            if (59 === a && o) {
              let r = e.exit('characterReferenceValue');
              return i !== eE || e9(l.sliceSerialize(r))
                ? (e.enter('characterReferenceMarker'),
                  e.consume(a),
                  e.exit('characterReferenceMarker'),
      ...
      te = {
        ...
        tokenize: function (e, t, n) {
          ...
          function s(l) {
            return null === l || eI(l)
              ? (e.exit('codeFencedFence'),
                i.interrupt ? t(l) : e.check(e8, c, h)(l))
          ...
          function d(t) {
            return o > 0 && eN(t) ? eF(e, p, 'linePrefix', o + 1)(t) : p(t);
          }
          function p(t) {
            return null === t || eI(t)
              ? e.check(e8, c, h)(t)
    ...
    function ti(e, t, n, r, i, l) {
      ...
      function c(t) {
        return null === t || 91 === t || 93 === t || eI(t) || s++ > 999
    ...
    let ts = {
        ...
        tokenize: function (e, t, n) {
          ...
          function i(t) {
            return eN(t) ? eF(e, l, 'whitespace')(t) : l(t);
          }
          function l(e) {
            return null === e || eI(e) ? t(e) : n(e);
          }
      ...
      tp = {
        ...
        resolveTo: function (e, t) {
          ...
          return (
            ...
            (l = ew(l, [['exit', c, t], e[i - 2], e[i - 1], ['exit', u, t]])),
            (l = ew(l, e.slice(i + 1))),
            (l = ew(l, [['exit', s, t]])),
            eb(e, r, e.length, l),
            e
            ...
            return r
              ? r._inactive
                ...
                : ((i = l.parser.defined.includes(
                    ta(l.sliceSerialize({ start: r.end, end: l.now() }))
                  )),
                  e.enter('labelEnd'),
                  e.enter('labelMarker'),
                  e.consume(t),
        ...
        tokenize: function (e, t, n) {
            ...
            if (
              ...
              if (
                ...
                return (
                  ...
                  42 === t || 45 === t ? e.check(tk, n, a)(t) : a(t)
                );
              if (!r.interrupt || 49 === t)
                return (
                  e.enter('listItemPrefix'),
          ...
          function a(t) {
            return (
              ...
              e.check(eU, r.interrupt ? n : s, e.attempt(tw, c, u))
            );
          }
          function s(e) {
        ...
        0,
        {
          91: {
            ...
            tokenize: function (e, t, n) {
              ...
              function s(t) {
                return e.attempt(ts, u, u)(t);
              }
              function u(t) {
                return eN(t) ? eF(e, c, 'whitespace')(t) : c(t);
              }
              function c(l) {
                return null === l || eI(l)
            ...
            tokenize: function (e, t, n) {
              ...
              function u(o) {
                return 33 === o
                  ...
                  : 47 === o
                    ? (e.consume(o), (i = !0), p)
                    : 63 === o
                      ? (e.consume(o), (r = 3), s.interrupt ? t : j)
                      : eC(o)
              ...
              function c(i) {
                return 45 === i
                  ? (e.consume(i), (r = 2), f)
                  : 91 === i
                    ? (e.consume(i), (r = 5), (o = 0), d)
                    : eC(i)
                      ? (e.consume(i), (r = 4), s.interrupt ? t : j)
                      : n(i);
              }
              function f(r) {
                return 45 === r ? (e.consume(r), s.interrupt ? t : j) : n(r);
              }
              function d(r) {
                let i = 'CDATA[';
              ...
              function h(o) {
                if (null === o || 47 === o || 62 === o || ej(o)) {
                  let a = 47 === o,
                    u = l.toLowerCase();
                  return !a && !i && tc.includes(u)
                    ? ((r = 1), s.interrupt ? t(o) : C(o))
                    : tu.includes(l.toLowerCase())
                      ? ((r = 6), a)
                        ? (e.consume(o), m)
                        : s.interrupt
                          ? t(o)
              ...
              function y(t) {
                return 45 === t || 46 === t || 58 === t || 95 === t || eE(t)
                  ? (e.consume(t), y)
                  : v(t);
              }
              function v(t) {
                    ...
                    : 62 === t && 4 === r
                      ...
                      : 63 === t && 3 === r
                        ...
                        : 93 === t && 5 === r
                          ? (e.consume(t), I)
                          : eI(t) && (6 === r || 7 === r)
                            ? (e.exit('htmlFlowData'), e.check(tf, L, E)(t))
                            : null === t || eI(t)
                              ? (e.exit('htmlFlowData'), E(t))
                              : (e.consume(t), C);
              }
              function E(t) {
                return e.check(td, _, L)(t);
              }
              function _(t) {
                return (
                  e.enter('lineEnding'),
              ...
              function A(t) {
                return 45 === t ? (e.consume(t), j) : C(t);
              }
              function P(t) {
                return 47 === t ? (e.consume(t), (l = ''), z) : C(t);
              }
              function z(t) {
                if (62 === t) {
                  let n = l.toLowerCase();
                  return tc.includes(n) ? (e.consume(t), N) : C(t);
                }
                return eC(t) && l.length < 8
                  ? (e.consume(t), (l += String.fromCharCode(t)), z)
                  : C(t);
              }
              function I(t) {
                return 93 === t ? (e.consume(t), j) : C(t);
              }
              function j(t) {
                return 62 === t
                  ? (e.consume(t), N)
          ...
          60: [
            {
              ...
              tokenize: function (e, t, n) {
                ...
                function i(t) {
                  return eC(t) ? (e.consume(t), l) : 64 === t ? n(t) : a(t);
                }
                function l(t) {
                  return 43 === t || 45 === t || 46 === t || eE(t)
                    ? ((r = 1),
                      (function t(n) {
                        return 58 === n
                          ? (e.consume(n), (r = 0), o)
    ...
    function tP(e, t, n) {
      ...
      if (35 === n.charCodeAt(0)) {
        let e = n.charCodeAt(1),
          t = 120 === e || 88 === e;
        return tT(n.slice(t ? 2 : 1), t ? 16 : 10);
      }
      return e9(n) || e;
    }
      ...
      if (e)
        throw Error(
          'Cannot close `' +
            e.type +
            '` (' +
            G({ start: e.start, end: e.end }) +
            '): a different token (`' +
            t.type +
            '`, ' +
            G({ start: t.start, end: t.end }) +
            ') is open'
        );
      throw Error(
          ...
          (function (e) {
            let t = {
              ...
              exit: {
                ...
                characterReference: function (e) {
                  this.stack.pop().position.end = tI(e.end);
                },
                ...
                definitionLabelString: function (e) {
                  ...
                  ((n.label = t),
                    (n.identifier = ta(this.sliceSerialize(e)).toLowerCase()));
                },
                ...
                labelText: function (e) {
                  ...
                  ((n.label = t.replace(tA, tP)),
                    (n.identifier = ta(t).toLowerCase()));
                },
                lineEnding: function (e) {
                  let n = this.stack[this.stack.length - 1];
                  if (this.data.atHardBreak) {
                    ((n.children[n.children.length - 1].position.end = tI(
                      e.end
                    )),
            ...
            function l(e, t, n) {
              (this.stack[this.stack.length - 1].children.push(e),
                ...
                (e.position = { start: tI(t.start), end: void 0 }));
            }
            function o(e) {
              return function (t) {
                ...
                .write(
                  ...
                  function (e, t, n) {
                    ...
                    for (
                      ...
                      if (10 === f && u === c && l) (d.push(-3), (l = void 0));
                      else
                        switch (
                          (l && (d.push(-5), (l = void 0)),
                          u < c && (d.push(e.slice(u, c)), (o += c - u)),
                          f)
                        ) {
                          case 0:
                            (d.push(65533), o++);
                    ...
                    return (
                      n && (l && d.push(-5), a && d.push(a), d.push(null)),
                      d
                    );
                  })(n, r, !0)
                )
    ...
    let tL = 'object' == typeof self ? self : globalThis,
      tR = (e) => {
        var t;
        let n, r;
        return ((t = new Map()),
            ...
            switch (t) {
              ...
              case 5: {
                let n = [],
                  i = o([t, n], e);
                for (let [t, i] of e)
                  (r || !(tM(tO(t)) || tM(tO(i)))) && n.push([a(t), a(i)]);
                return i;
              }
              case 6: {
                let n = [],
                  i = o([t, n], e);
                for (let t of e) (r || !tM(tO(t))) && n.push(a(t));
                return i;
              }
            }
            let { message: s } = e;
    ...
    function tH(e) {
      ...
      for (; ++n < e.length; ) {
        let l = e.charCodeAt(n),
          o = '';
        if (37 === l && eE(e.charCodeAt(n + 1)) && eE(e.charCodeAt(n + 2)))
          i = 2;
        else if (l < 128)
    ...
    let t$ = function (e) {
      var t, n;
      if (null == e) return tK;
      if ('function' == typeof e) return tW(e);
      if ('object' == typeof e) {
        ...
        (function e(t, n, r) {
          ...
          function s() {
            ...
            let s,
              ...
              p = tQ;
            if (
              (!i || f(t, n, r[r.length - 1] || void 0)) &&
              !1 ===
                (p = Array.isArray((a = l(t, r)))
                  ? a
                  : 'number' == typeof a
                    ? [!0, a]
                    : null == a
            ...
            if ('children' in t && t.children && t.children && 'skip' !== p[0])
              for (
                u = (o ? t.children.length : -1) + d, c = r.concat(t);
                u > -1 && u < t.children.length;
              ) {
                if (!1 === (s = e(t.children[u], u, c)())[0]) return s;
                u = 'number' == typeof s[1] ? s[1] : u + d;
              }
            return p;
          }
        })(e, void 0, [])());
    ...
    let tG = {
      ...
      listItem: function (e, t, n) {
        ...
        s &&
          ...
          o.push({ type: 'text', value: '\n' });
        let u = { type: 'element', tagName: 'li', properties: l, children: o };
        return (e.patch(t, u), e.applyData(t, u));
      },
      list: function (e, t) {
        let n = {},
      ...
      table: function (e, t) {
        ...
        if (n.length > 0) {
          let r = {
            ...
            l = Y(t.children[1]),
            o = J(t.children[t.children.length - 1]);
        ...
        let n = {
          ...
          value: (function (e) {
            let t = String(e),
              ...
              l = [];
            for (; r; )
              (l.push(tZ(t.slice(i, r.index), i > 0, !0), r[0]),
                (i = r.index + r[0].length),
                (r = n.exec(t)));
            return (l.push(tZ(t.slice(i), i > 0, !1)), l.join(''));
          })(String(t.value)),
        };
        return (e.patch(t, n), e.applyData(t, n));
      },
    ...
    function t5(e, t) {
      ...
      if (e && e.data) {
        ...
        ('string' == typeof t &&
          ...
          'element' === n.type && i && Object.assign(n.properties, tU(i)),
      ...
      let n,
        ...
        o =
          ...
          (l = {
            ...
            footnoteOrder: [],
            handlers: { ...tG, ...n.handlers },
            one: function (e, t) {
              let n = e.type,
                r = l.handlers[n];
              if (t1.call(l.handlers, n) && r) return r(l, e, t);
              ...
              return (
                ...
                function (e, t) {
                  let n = t.data || {},
                    r =
                      'value' in t &&
                      !(t1.call(n, 'hProperties') || t1.call(n, 'hChildren'))
        ...
        u = (function (e) {
          let t =
              'string' == typeof e.options.clobberPrefix
                ? e.options.clobberPrefix
                : 'user-content-',
            n = e.options.footnoteBackContent || tV,
              ...
              children: [
                {
                  type: 'element',
                  tagName: l,
                  properties: { ...tU(o), id: 'footnote-label' },
    ...
    let nn = function (e, t) {
      ...
      nl = function (...e) {
        ...
        let n,
          ...
          l = -1;
        for (; ++l < e.length; )
          (no(e[l]), e[l] && (i = void 0 === i ? e[l] : i + '/' + e[l]));
        return void 0 === i
          ? '.'
          : (no((t = i)),
    ...
    let ns = ['history', 'path', 'basename', 'stem', 'extname', 'dirname'];
    class nu {
      constructor(e) {
        let t, n;
        ((t = e
        ...
        for (n in t) ns.includes(n) || (this[n] = t[n]);
      }
      get basename() {
      ...
      set basename(e) {
        (nf(e, 'basename'),
          nc(e, 'basename'),
          (this.path = nl(this.dirname || '', e)));
      }
      get dirname() {
        return 'string' == typeof this.path ? nr(this.path) : void 0;
      }
      set dirname(e) {
        (nd(this.basename, 'dirname'),
          (this.path = nl(e || '', this.basename)));
      }
      get extname() {
        return 'string' == typeof this.path ? ni(this.path) : void 0;
      }
      set extname(e) {
        if ((nc(e, 'extname'), nd(this.dirname, 'extname'), e)) {
          if (46 !== e.codePointAt(0))
            throw Error('`extname` must start with `.`');
          if (e.includes('.', 1))
            throw Error('`extname` cannot contain multiple dots');
        }
        this.path = nl(this.dirname, this.stem + (e || ''));
      }
      get path() {
      ...
      get stem() {
        return 'string' == typeof this.path
          ? nn(this.path, this.extname)
          : void 0;
      }
      set stem(e) {
        (nf(e, 'stem'),
          nc(e, 'stem'),
          (this.path = nl(this.dirname || '', e + (this.extname || ''))));
      }
      fail(e, t, n) {
    ...
    class nm extends np {
      ...
      copy() {
        ...
        return (e.data((0, ne.default)(!0, {}, this.namespace)), e);
      }
      data(e, t) {
        return 'string' == typeof e
          ? 2 == arguments.length
            ? (nx('data', this.frozen), (this.namespace[e] = t), this)
            : (nh.call(this.namespace, e) && this.namespace[e]) || void 0
          : e
            ? (nx('data', this.frozen), (this.namespace = e), this)
            : this.namespace;
      }
      freeze() {
      ...
      parse(e) {
        ...
        return (ny('parse', n), n(String(t), t));
      }
      process(e, t) {
        let n = this;
        return (
          this.freeze(),
          ny('process', this.parser || this.Parser),
          nv('process', this.compiler || this.Compiler),
        ...
        function r(r, i) {
          ...
          function a(e, n) {
            e || !n
              ...
              : r
                ? r(n)
                : (s(t, '`done` is defined if `resolve` is not'), t(void 0, n));
          }
          n.run(o, l, function (e, t, r) {
            var i, l;
            if (e || !t || !r) return a(e);
      ...
      processSync(e) {
        ...
        return (
          this.freeze(),
          ny('processSync', this.parser || this.Parser),
          nv('processSync', this.compiler || this.Compiler),
          this.process(e, function (e, r) {
            ((n = !0), t8(e), (t = r));
          }),
          nb('processSync', 'process', n),
          s(t, 'we either bailed on an error or have a tree'),
          t
        );
      }
      run(e, t, n) {
        ...
        function i(i, l) {
          ...
          r.run(e, o, function (t, r, o) {
            ...
            t
              ...
              : i
                ? i(a)
                : (s(n, '`done` is defined if `resolve` is not'),
                  n(void 0, a, o));
          });
        }
      }
      runSync(e, t) {
        ...
        return (
          ...
          nb('runSync', 'run', r),
          s(n, 'we either bailed on an error or have a tree'),
          n
        );
      }
      stringify(e, t) {
        ...
        return (nv('stringify', r), nk(e), r(e, n));
      }
      use(e, ...t) {
        let n = this.attachers,
          r = this.namespace;
        if ((nx('use', this.frozen), null == e));
        ...
        function i(e) {
          ...
          (l(e.plugins),
            e.settings &&
              (r.settings = (0, ne.default)(!0, r.settings, e.settings)));
        }
        function l(e) {
          let t = -1;
          if (null == e);
        ...
        function o(e, t) {
          ...
          if (-1 === i) n.push([e, ...t]);
            ...
            let [r, ...l] = t,
              o = n[i][1];
            (nt(o) && nt(r) && (r = (0, ne.default)(!0, o, r)),
              (n[i] = [e, r, ...l]));
          }
        }
      }
    }
    let ng = new nm().freeze();
    function ny(e, t) {
    ...
    let nS = [],
      nC = { allowDangerousHtml: !0 },
      nE = /^(https?|ircs?|mailto|xmpp)$/i,
      n_ = [
    ...
    function nT(e) {
      ...
      let r,
        ...
        a,
        s =
          ((r = (n = e).rehypePlugins || nS),
          (i = n.remarkPlugins || nS),
          (l = n.remarkRehypeOptions
            ? { ...n.remarkRehypeOptions, ...nC }
            : nC),
          ng().use(tN).use(i).use(t7, l).use(r)),
        c =
          ((o = e.children || ''),
          (a = new nu()),
          'string' == typeof o
          ...
          a);
      return (function (e, n) {
        let r = n.allowedElements,
          i = n.allowElement,
          l = n.components,
          o = n.disallowedElements,
          a = n.skipHtml,
        ...
        return (
          ...
          tX(e, function (e, t, n) {
            ...
            if ('element' === e.type) {
              let l = r ? !r.includes(e.tagName) : !!o && o.includes(e.tagName);
              if (
                (!l && i && 'number' == typeof t && (l = !i(e, t, n)),
                l && n && 'number' == typeof t)
              )
                return (
                  s && e.children
    ...
    function nI({ block: e, index: i }) {
      let { type: l, content: o } = e,
        s = (e) =>
          e
            ? e.startsWith('http')
              ? e
              : `https://umkmwbkwvulxtdodzmzf.supabase.co/storage/v1/object/public/site-assets/${e}`
            : '',
        u = (e, n, r = '') => {
          if (!e) return null;
          let i = e
            ...
            l = [
              n?.fontSize || 'text-lg md:text-xl',
              n?.fontWeight || 'font-light',
              n?.textAlign || '',
              n?.color && !n.color.startsWith('#')
                ? (0, nP.sanitizeTailwindValue)(n.color)
                : '',
              'mb-4 leading-relaxed',
            ].join(' '),
            o = n?.color && n.color.startsWith('#') ? n.color : null,
            s = o
              ? `md-text-${(0, nP.sanitizeTailwindValue)(o.replace(/[^a-zA-Z0-9]/g, ''))}`
              : '';
            ...
            children: [
              o &&
                (0, t.jsx)(a.default, {
                  id: '5dabeed32825af40',
                  dynamic: [s, o, s, o],
                  children: `.${s}{color:${o}}.${s} a{color:${o}}`,
                }),
              (0, t.jsx)('div', {
                className: `prose prose-invert max-w-none ${r} ${s}`,
                children: (0, t.jsx)(nT, {
                  skipHtml: !0,
                  components: {
                    p: ({ children: e }) =>
                      (0, t.jsx)('p', { className: l, children: e }),
                    h1: ({ children: e }) =>
                      (0, t.jsx)('h1', {
                        className: `${n?.textAlign || ''} font-bold text-4xl md:text-6xl mb-8`,
                        children: e,
                      }),
                    h2: ({ children: e }) =>
                      (0, t.jsx)('h2', {
                        className: `${n?.textAlign || ''} font-bold text-3xl md:text-5xl mb-6`,
                        children: e,
                      }),
                    h3: ({ children: e }) =>
                      (0, t.jsx)('h3', {
                        className: `${n?.textAlign || ''} font-bold text-2xl md:text-4xl mb-4`,
                        children: e,
                      }),
                    ul: ({ children: e }) =>
                      (0, t.jsx)('ul', {
                        className: `${l} list-disc pl-6 mb-4 space-y-2 text-left`,
                        children: e,
                      }),
                    ol: ({ children: e }) =>
                      (0, t.jsx)('ol', {
                        className: `${l} list-decimal pl-6 mb-4 space-y-2 text-left`,
                        children: e,
                      }),
                    strong: ({ children: e }) =>
                      (0, t.jsx)('strong', {
                    ...
                    em: ({ children: e }) =>
                      (0, t.jsx)('em', { className: 'italic', children: e }),
                  },
                  children: i,
                }),
              }),
        ...
        c = (e, n, i = !0) => {
          ...
          let o =
            ...
            a = o
              ? 'youtube'
              : n || (e.match(/\.(mp4|webm|ogg)$/i) ? 'video' : 'image');
          if ('youtube' === a && o)
            return (0, t.jsx)('div', {
              className:
                'w-full relative rounded-2xl overflow-hidden bg-slate-900/50 border border-white/5 aspect-video',
              children: (0, t.jsx)('iframe', {
                src: `https://www.youtube.com/embed/${o}?autoplay=1&mute=0&loop=1&playlist=${o}&controls=1&modestbranding=1&rel=0`,
      ...
      return (0, t.jsx)(n.motion.section, {
        className: 'w-full',
        initial: 'hidden',
        whileInView: 'visible',
            ...
            case 'text':
              return (0, t.jsx)('div', {
                ...
                children: (0, t.jsx)('div', {
                  ...
                  children: u(o.text, o.textConfig),
                }),
              });
            case 'image':
              return (0, t.jsx)('div', {
                className: 'w-full max-w-screen-2xl mx-auto px-4 md:px-0',
                children: c(o.media, 'image'),
              });
            case 'video':
              return (0, t.jsx)('div', {
                className: 'w-full max-w-screen-2xl mx-auto px-4 md:px-0',
                children: c(o.media, 'video', !1),
              });
            case 'video-autoplay':
              return (0, t.jsx)('div', {
                className: 'w-full max-w-screen-2xl mx-auto px-4 md:px-0',
                children: c(o.media, 'video', !0),
              });
            case 'image-text':
              return (0, t.jsx)('div', {
                className: 'std-grid',
                children: (0, t.jsxs)('div', {
                  ...
                  children: [
                    (0, t.jsx)('div', { children: c(o.media, 'image') }),
                    (0, t.jsx)('div', { children: u(o.text, o.textConfig) }),
                  ],
                }),
              });
            case 'text-image':
            ...
            case 'image-image':
              return (0, t.jsx)('div', {
                ...
                children: (0, t.jsxs)('div', {
                  ...
                  children: [c(o.media, 'image'), c(o.media2, 'image')],
                }),
              });
            case 'image-video':
              return (0, t.jsx)('div', {
                ...
                children: (0, t.jsxs)('div', {
                  ...
                  children: [c(o.media, 'image'), c(o.media2, 'video', !0)],
                }),
              });
            case 'video-text':
              return (0, t.jsx)('div', {
                ...
                children: (0, t.jsxs)('div', {
                  className:
                    'grid grid-cols-1 md:grid-cols-2 gap-12 items-center',
                  children: [c(o.media, 'video', !0), u(o.text, o.textConfig)],
                }),
              });
            default:
              return null;
    ...
    function nj({ project: e }) {
      let a =
          'https://umkmwbkwvulxtdodzmzf.supabase.co'.replace(/\/$/, '') ?? '',
        s =
          e.cover && !e.cover.startsWith('http')
            ? a
              ? `${a}/storage/v1/object/public/site-assets/${e.cover}`
              : ''
            : e.cover || '',
        u = (0, l.useSearchParams)().get('from');
      return (0, t.jsxs)('div', {
        className:
          ...
          (0, t.jsx)('div', {
            ...
            children:
              e.content && Array.isArray(e.content)
                ? e.content.map((e, n) =>
                    (0, t.jsx)(nI, { block: e, index: n }, e.id ?? `block-${n}`)
                  )
                : (0, t.jsx)('div', {
