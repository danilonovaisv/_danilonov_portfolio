(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function o() {
      ...
      let [e] = (0, i.useState)(a.prefersReducedMotion.current);
      return e;
    }
  ...
  (e) => {
    ...
    let t = (e) => (0, a.buildSupabaseStorageUrl)('site-assets', e),
      ...
      s = {
        hero: {
          video: {
            desktop: t('portfolio/portfolio.hero_desktop_video.mp4'),
            mobile: t('portfolio/portfolio.hero_mobile_video.mp4'),
          },
        },
      };
    e.s([
      ...
      let e = [
        {
          label: 'Instagram',
          href: x.SOCIALS.instagram,
          icon: (0, a.jsx)(d.Instagram, { className: 'w-5 h-5 lg:w-4 lg:h-4' }),
        },
        {
          label: 'LinkedIn',
          href: x.SOCIALS.linkedin,
