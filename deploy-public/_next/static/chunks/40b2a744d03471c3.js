  ...
  (e) => {
    ...
    function O(e) {
      ...
      for (let [r, i] of Object.entries(e.properties)) {
        let l = new T(r, e.transform(e.attributes || {}, r), i, e.space);
        (e.mustUseProperty &&
          ...
          function s(t) {
            return 88 === t || 120 === t
              ? (e.enter('characterReferenceMarkerHexadecimal'),
                ...
                (i = eP),
                u)
              : (e.enter('characterReferenceValue'), (r = 7), (i = eT), u(t));
          }
          function u(a) {
            if (59 === a && o) {
    ...
    function ti(e, t, n, r, i, l) {
      ...
      function c(t) {
        return null === t || 91 === t || 93 === t || ez(t) || s++ > 999
        ...
        0,
        {
          ...
          60: {
            ...
            tokenize: function (e, t, n) {
              ...
              function P(t) {
                return 47 === t ? (e.consume(t), (l = ''), I) : C(t);
              }
              function I(t) {
                if (62 === t) {
                  let n = l.toLowerCase();
                ...
                return eC(t) && l.length < 8
                  ? (e.consume(t), (l += String.fromCharCode(t)), I)
                  : C(t);
              }
              function z(t) {
          ...
          (function (e) {
            let t = {
              ...
              exit: {
                ...
                characterReference: function (e) {
                  this.stack.pop().position.end = tz(e.end);
                },
                ...
                labelText: function (e) {
                  ...
                  ((n.label = t.replace(tT, tP)),
                    (n.identifier = ta(t).toLowerCase()));
                },
                lineEnding: function (e) {
                  let n = this.stack[this.stack.length - 1];
                  if (this.data.atHardBreak) {
                    ((n.children[n.children.length - 1].position.end = tz(
                      e.end
                    )),
            ...
            function l(e, t, n) {
              (this.stack[this.stack.length - 1].children.push(e),
                ...
                (e.position = { start: tz(t.start), end: void 0 }));
            }
            function o(e) {
              return function (t) {
      ...
      let { type: l, content: o } = e,
        ...
        u = (e, n, r = '') => {
          ...
          let i = e
            ...
            s = o ? `md-text-${o.replace(/[^a-zA-Z0-9]/g, '')}` : '';
