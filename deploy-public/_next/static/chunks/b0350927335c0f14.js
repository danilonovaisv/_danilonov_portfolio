  ...
  (e) => {
    ...
    function eF(e, t, n, r) {
      ...
      return function (r) {
        return ez(r)
          ? (e.enter(n),
            (function r(o) {
              return ez(o) && l++ < i ? (e.consume(o), r) : (e.exit(n), t(o));
            })(r))
          : t(r);
      };
    }
    let eR = {
      ...
      eU = {
        ...
        tokenize: function (e, t, n) {
          return function (t) {
            return ez(t) ? eF(e, r, 'linePrefix')(t) : r(t);
          };
          function r(e) {
            return null === e || eL(e) ? t(e) : n(e);
          }
        },
      };
    class eH {
    ...
    function e0(e) {
      return null === e || ej(e) || eO(e) ? 1 : eN(e) ? 2 : void 0;
    }
    function e1(e, t, n) {
      let r = [],
        i = -1;
    ...
    let e3 = {
      ...
      e5 = document.createElement('i');
    function e9(e) {
      let t = '&' + e + ';';
      e5.innerHTML = t;
      let n = e5.textContent;
      return (
    ...
    let e7 = {
      ...
      te = {
        ...
        tokenize: function (e, t, n) {
          ...
          function d(t) {
            return o > 0 && ez(t) ? eF(e, p, 'linePrefix', o + 1)(t) : p(t);
          }
          function p(t) {
            return null === t || eL(t)
              ? e.check(e8, c, h)(t)
    ...
    function ti(e, t, n, r, i, l) {
      ...
      function c(t) {
        return null === t || 91 === t || 93 === t || eL(t) || s++ > 999
          ? (e.exit('chunkString'), u(t))
          : (e.consume(t), o || (o = !ez(t)), 92 === t ? f : c);
      }
      function f(t) {
    ...
    let ts = {
        ...
        tokenize: function (e, t, n) {
          ...
          function i(t) {
            return ez(t) ? eF(e, l, 'whitespace')(t) : l(t);
          }
          function l(e) {
            return null === e || eL(e) ? t(e) : n(e);
          }
          ...
          tokenize: function (e, t, n) {
            ...
            return (
              ...
              e.check(
                ...
                function (n) {
                  return r.containerState.furtherBlankLines || !ez(n)
      ...
      tw = {
        ...
        tokenize: function (e, t, n) {
          ...
          return eF(
            ...
            function (e) {
              let i = r.events[r.events.length - 1];
              return !ez(e) && i && 'listItemPrefixWhitespace' === i[1].type
                ? t(e)
                : n(e);
            },
        ...
        0,
        {
          91: {
            ...
            tokenize: function (e, t, n) {
              ...
              function u(t) {
                return ez(t) ? eF(e, c, 'whitespace')(t) : c(t);
              }
              function c(l) {
                return null === l || eL(l)
        ...
        0,
        {
          ...
          60: {
            ...
            tokenize: function (e, t, n) {
                    ...
                    : 62 === t && 4 === r
                      ...
                      : 63 === t && 3 === r
                        ...
                        : 93 === t && 5 === r
                          ? (e.consume(t), L)
                          : eL(t) && (6 === r || 7 === r)
                            ? (e.exit('htmlFlowData'), e.check(tf, N, E)(t))
                            : null === t || eL(t)
                              ? (e.exit('htmlFlowData'), E(t))
                              : (e.consume(t), C);
              }
              function E(t) {
                return e.check(td, P, N)(t);
              }
              function P(t) {
                return (
                  e.enter('lineEnding'),
              ...
              function I(t) {
                return 47 === t ? (e.consume(t), (l = ''), D) : C(t);
              }
              function D(t) {
                if (62 === t) {
                  let n = l.toLowerCase();
                  return tc.includes(n) ? (e.consume(t), z) : C(t);
                }
          ...
          60: [
            ...
            },
            {
              ...
              tokenize: function (e, t, n) {
                ...
                function g(t) {
                  return 62 === t ? I(t) : 93 === t ? (e.consume(t), g) : h(t);
                }
                function y(t) {
                  return null === t || 62 === t
                    ? I(t)
          ...
          92: [
            {
              ...
              tokenize: function (e, t, n) {
                ...
                function r(r) {
                  return eL(r) ? (e.exit('hardBreakEscape'), t(r)) : n(r);
                }
              },
            },
            e6,
          ...
          (function (e) {
            ...
            function s() {
              ...
              return (
                ...
                ev(
                  e,
                  'boolean' != typeof ex.includeImageAlt || ex.includeImageAlt,
                  'boolean' != typeof ex.includeHtml || ex.includeHtml
                )
              );
            }
            function u(e) {
    ...
    let tN = 'object' == typeof self ? self : globalThis,
      tO = (e) => {
        var t;
        let n, r;
        return ((t = new Map()),
      ...
      t_ = ([e, t]) => 0 === e && ('function' === t || 'symbol' === t),
      tB = (e, { json: t, lossy: n } = {}) => {
        var r, i, l;
        let o,
          a,
            ...
            switch (t) {
              ...
              case 5: {
                let n = [],
                  i = o([t, n], e);
                for (let [t, i] of e)
                  (r || !(t_(tR(t)) || t_(tR(i)))) && n.push([a(t), a(i)]);
                return i;
              }
              case 6: {
                let n = [],
                  i = o([t, n], e);
                for (let t of e) (r || !t_(tR(t))) && n.push(a(t));
                return i;
              }
            }
            let { message: s } = e;
                ...
                for (; ++r < n.length; ) {
                  ...
                  if (i) {
                    if (
                      ...
                      let e = i.children[0];
                      e && 'text' === e.type && (e.value = t5(e.value));
                    }
    ...
    class nm extends np {
      ...
      data(e, t) {
        return 'string' == typeof e
          ? 2 == arguments.length
            ? (nv('data', this.frozen), (this.namespace[e] = t), this)
            : (nh.call(this.namespace, e) && this.namespace[e]) || void 0
          : e
            ? (nv('data', this.frozen), (this.namespace = e), this)
            : this.namespace;
      }
      freeze() {
      ...
      process(e, t) {
        ...
        return (
          ...
          nx('process', this.compiler || this.Compiler),
      ...
      processSync(e) {
        ...
        return (
          ...
          nx('processSync', this.compiler || this.Compiler),
      ...
      stringify(e, t) {
        ...
        return (nx('stringify', r), nk(e), r(e, n));
      }
      use(e, ...t) {
        let n = this.attachers,
          r = this.namespace;
        if ((nv('use', this.frozen), null == e));
      ...
      let r,
        ...
        s =
          ...
          (l = n.remarkRehypeOptions
            ...
            : nC),
          ng().use(tz).use(i).use(t7, l).use(r)),
        c =
          ((o = e.children || ''),
          (a = new nu()),
          'string' == typeof o
      ...
      let { type: l, content: o } = e,
        ...
        u = (e, n, r = '') => {
          ...
          let i = [
              ...
              n?.textAlign || '',
              n?.color && !n.color.startsWith('#') ? n.color : '',
              'mb-4 leading-relaxed',
            ].join(' '),
            l = n?.color && n.color.startsWith('#') ? n.color : null,
            o = l ? `md-text-${n.color.replace(/[^a-zA-Z0-9]/g, '')}` : '';
            ...
            children: [
              l &&
                (0, t.jsx)(a.default, {
                  id: '5dabeed32825af40',
                  dynamic: [o, l, o, l],
                  children: `.${o}{color:${l}}.${o} a{color:${l}}`,
                }),
              (0, t.jsx)('div', {
                className: `prose prose-invert max-w-none ${r} ${o}`,
                children: (0, t.jsx)(nT, {
                  components: {
                    p: ({ children: e }) =>
                      (0, t.jsx)('p', { className: i, children: e }),
                    h1: ({ children: e }) =>
                      (0, t.jsx)('h1', {
                    ...
                    ul: ({ children: e }) =>
                      (0, t.jsx)('ul', {
                        className: `${i} list-disc pl-6 mb-4 space-y-2 text-left`,
                        children: e,
                      }),
                    ol: ({ children: e }) =>
                      (0, t.jsx)('ol', {
                        className: `${i} list-decimal pl-6 mb-4 space-y-2 text-left`,
                        children: e,
                      }),
                    strong: ({ children: e }) =>
                      (0, t.jsx)('strong', {
          ...
          (0, t.jsx)('div', {
            ...
            children:
              e.content && Array.isArray(e.content)
                ? e.content.map((e, n) =>
                    (0, t.jsx)(nD, { block: e, index: n }, e.id || `block-${n}`)
                  )
                : (0, t.jsx)('div', {
