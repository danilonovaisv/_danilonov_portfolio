(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    let o = {
      ...
      m = { ...o, transform: (t) => Math.round(r(0, 255, t)) },
      f = {
        test: c('rgb', 'red'),
      ...
      A = {
        ...
        parse: (t) =>
          f.test(t) ? f.parse(t) : b.test(t) ? b.parse(t) : y.parse(t),
        transform: (t) =>
          'string' == typeof t
            ? t
      ...
      let e = t.toString(),
        ...
        o = e
          .replace(
            ...
            (t) => (
              A.test(t)
                ? (n.color.push(r), s.push(V), i.push(A.parse(t)))
                : t.startsWith('var(')
                  ? (n.var.push(r), s.push('var'), i.push(t))
                  : (n.number.push(r), s.push(E), i.push(parseFloat(t))),
              ++r,
              '${}'
            )
          )
    ...
    let L = (t) =>
        'number' == typeof t ? 0 : A.test(t) ? A.getAnimatableNone(t) : t,
      j = {
        test: function (t) {
          return (
            isNaN(t) &&
            'string' == typeof t &&
            (t.match(u)?.length || 0) + (t.match(M)?.length || 0) > 0
          );
        },
        parse: D,
        createTransformer: R,
    ...
    let G = new Set([
      ...
      q = (t) => (e) => e.test(t),
      _ = [o, w, x, v, P, T, { test: (t) => 'auto' === t, parse: (t) => t }],
      Z = (t) => _.find(q(t));
    var J,
      Q = t.i(39507);
    let tt = () => {},
      te = () => {};
    (Q.default, t.s(['invariant', () => te, 'warning', () => tt], 18699));
    ...
    function tF() {
      ...
      ((tL = !1), (tR = !1), tD.forEach((t) => t.complete(tj)), tD.clear());
    }
    function tB() {
      tD.forEach((t) => {
    ...
    class tI {
      ...
      scheduleResolve() {
        ((this.state = 'scheduled'),
          this.isAsync
            ? (tD.add(this),
              tR || ((tR = !0), tE.read(tB), tE.resolveKeyframes(tF)))
      ...
      cancel() {
        'scheduled' === this.state &&
          (tD.delete(this), (this.state = 'pending'));
      }
      resume() {
      ...
      resolveNoneKeyframes() {
        ...
        i.length &&
          (function (t, e, i) {
            ...
            if (n && i) for (let s of e) t[s] = tO(i, n);
          })(t, i, e);
      }
      measureInitialState() {
    ...
    class tY {
      ...
      add(t) {
        return (t$(this.subscriptions, t), () => tW(this.subscriptions, t));
      }
      notify(t, e, i) {
    ...
    let { schedule: tz } = tM(queueMicrotask, !1);
    function tX() {
      e = void 0;
    }
    let tH = {
      now: () => (
        void 0 === e &&
          tH.set(
            tC.isProcessing || tb.useManualTiming
              ? tC.timestamp
              : performance.now()
          ),
        e
      ...
      set: (t) => {
        ((e = t), queueMicrotask(tX));
      },
    };
    function tK(t, e) {
      return e ? (1e3 / e) * t : 0;
    }
    t.s(['velocityPerSecond', () => tK], 51741);
    let tG = { current: void 0 };
    class tq {
      constructor(t, e = {}) {
    ...
    t.s(['collectMotionValues', () => tG, 'motionValue', () => t_], 98864);
    let tZ = [..._, A, j],
      tJ = { current: null },
      tQ = { current: !1 };
    t.s(
      ['hasReducedMotionListener', () => tQ, 'prefersReducedMotion', () => tJ],
      7382
    );
    let t0 = 'u' > typeof window;
    function t1() {
      if (((tQ.current = !0), t0))
    ...
    t.s(['initPrefersReducedMotion', () => t1], 36348);
    let t5 = new WeakMap();
    function t3(t) {
    ...
    let t9 = [
      ...
      t4 = ['initial', ...t9];
    function t6(t) {
      return t3(t.animate) || t4.some((e) => t2(t[e]));
    }
    function t8(t) {
    ...
    class en {
      ...
      constructor(
        ...
        ((this.latestValues = a),
          ...
          (this.isControllingVariants = t6(e)),
          (this.isVariantNode = t8(e)),
        ...
        ((this.current = t),
          ...
          'never' === this.reducedMotionConfig
            ...
            : 'always' === this.reducedMotionConfig
              ...
              : (tQ.current || t1(), (this.shouldReduceMotion = tJ.current)),
      ...
      update(t, e) {
        ...
        ((this.prevMotionValues = (function (t, e, i) {
          for (let n in e) {
            ...
            else if (K(r)) t.addValue(n, t_(s, { owner: t }));
            else if (r !== s)
              if (t.hasValue(n)) {
                let e = t.getValue(n);
                ...
                t.addValue(n, t_(void 0 !== e ? e : s, { owner: t }));
              }
          }
      ...
      getValue(t, e) {
        ...
        return (
          void 0 === i &&
            void 0 !== e &&
            ((i = t_(null === e ? void 0 : e, { owner: this })),
            this.addValue(t, i)),
          i
        );
      }
      readValue(t, e) {
        ...
        if (null != i) {
          ...
          if (
            ...
            let n;
            ((n = i), !tZ.find(q(n)) && j.test(e) && (i = tO(t, e)));
          }
      ...
      getBaseTarget(t) {
        ...
        if ('string' == typeof i || 'object' == typeof i) {
          let n = et(this.props, i, this.presenceContext?.custom);
          n && (e = n[t]);
        }
    ...
    let eo = (t, e) => (e && 'number' == typeof t ? e.transform(t) : t),
      ea = {
        x: 'translateX',
        y: 'translateY',
        z: 'translateZ',
    ...
    function ey(t, { style: e, vars: i }, n, s) {
      let r,
        o = t.style;
      for (r in e) o[r] = e[r];
    ...
    class eb extends es {
      ...
      readValueFromInstance(t, e) {
        ...
        return ((e = em.has(e) ? e : er(e)), t.getAttribute(e));
      }
      scrapeMotionValuesFromProps(t, e, i) {
        return eS(t, e, i);
      }
      build(t, e, i) {
        ep(t, e, this.isSVGTag, i.transformTemplate, i.style);
      }
      renderInstance(t, e, i, n) {
        for (let i in (ey(t, e, void 0, n), e.attrs))
          t.setAttribute(em.has(i) ? i : er(i), e.attrs[i]);
      }
      mount(t) {
    ...
    function ek(t, e, i, n, s) {
      return (void 0 !== s && (t = n + s * (t - n)), n + i * (t - n) + e);
    }
    function eD(t, e = 0, i = 1, n, s) {
      ((t.min = ek(t.min, e, i, n, s)), (t.max = ek(t.max, e, i, n, s)));
    }
    function eR(t, { x: e, y: i }) {
    ...
    function eN(t) {
      ...
      else if (eU.indexOf(t) > -1 || /[A-Z]/u.test(t)) return !0;
      return !1;
    }
    var e$ = t.i(91047);
    let eW = (0, eO.createContext)({});
    t.s(['LayoutGroupContext', () => eW], 65418);
    let eY = (0, eO.createContext)({ strict: !1 }),
      ez = (0, eO.createContext)({
        transformPagePoint: (t) => t,
        isStatic: !1,
        reducedMotion: 'never',
      });
    t.s(['MotionConfigContext', () => ez], 50798);
    let eX = (0, eO.createContext)({});
    function eH(t) {
    ...
    function eG(t, e, i) {
      for (let n in e) K(e[n]) || eT(n, i) || (t[n] = e[n]);
    }
    let eq = () => ({ ...eK(), attrs: {} }),
      e_ = new Set([
        'animate',
    ...
    try {
      ((J = (() => {
        ...
        'function' == typeof J &&
          (eJ = (t) => (t.startsWith('on') ? !eZ(t) : J(t))));
    } catch {}
    function eQ(t) {
      return K(t) ? t.get() : t;
    }
    let e0 = (0, eO.createContext)(null);
    function e1(t) {
      let e = (0, eO.useRef)(null);
      return (null === e.current && (e.current = t()), e.current);
    }
    (t.s(['PresenceContext', () => e0], 69857),
      t.s(['useConstant', () => e1], 29550));
    let e5 = (t) => (e, i) => {
        let n = (0, eO.useContext)(eX),
          s = (0, eO.useContext)(e0),
          r = () =>
            (function (
      ...
      e3 = e5({ scrapeMotionValuesFromProps: eP, createRenderState: eK }),
      e2 = e5({ scrapeMotionValuesFromProps: eS, createRenderState: eq }),
      e9 = 'u' > typeof window,
      e4 = {
        animation: [
          'animate',
    ...
    function e8() {
      return (
        !(function () {
          ...
          let t = {};
          for (let e in e4)
            t[e] = { isEnabled: (t) => e4[e].some((e) => !!t[e]) };
          ((ei = t), (e6 = !0));
        })(),
        ei
      );
    ...
    let e7 = Symbol.for('motionComponentSymbol'),
      it = 'data-' + er('framerAppearId'),
      ie = (0, eO.createContext)({});
    function ii(t) {
      return (
        t &&
        'object' == typeof t &&
    ...
    let is = e9 ? eO.useLayoutEffect : eO.useEffect;
    function ir(t, { forwardMotionProps: e = !1, type: i } = {}, n, s) {
      n &&
        (function (t) {
          let e = e8();
      ...
      function a(i, n) {
        ...
        let l,
          ...
          m = o(i, c);
        if (!c && e9) {
          (0, eO.useContext)(eY).strict;
          let e = (function (t) {
            let { drag: e, layout: i } = e8();
            if (!e && !i) return {};
            let n = { ...e, ...i };
            return {
              MeasureLayout:
          ...
          ((l = e.MeasureLayout),
            (p.visualElement = (function (t, e, i, n, s, r) {
              let { visualElement: o } = (0, eO.useContext)(eX),
                a = (0, eO.useContext)(eY),
                l = (0, eO.useContext)(e0),
                h = (0, eO.useContext)(ez).reducedMotion,
                u = (0, eO.useRef)(null),
                d = (0, eO.useRef)(!1);
              ((n = n || a.renderer),
                !u.current &&
        ...
        return (0, e$.jsxs)(eX.Provider, {
          value: p,
          children: [
            l && p.visualElement
              ? (0, e$.jsx)(l, { visualElement: p.visualElement, ...d })
              : null,
            (function (t, e, i, { latestValues: n }, s, r = !1, o) {
              let a = (
                  (o ?? eN(t))
                    ? function (t, e, i, n) {
                        let s = (0, eO.useMemo)(() => {
                          let i = eq();
                          return (
                            ep(i, e, ef(n), t.transformTemplate, t.style),
                            { ...i.attrs, style: { ...i.style } }
                          );
                        }, [e]);
                        if (t.style) {
                          let e = {};
                          (eG(e, t.style, t), (s.style = { ...e, ...s.style }));
                        }
                        return s;
                      }
                    : function (t, e) {
                ...
                h = t !== eO.Fragment ? { ...l, ...a, ref: i } : {},
                { children: u } = e,
                d = (0, eO.useMemo)(() => (K(u) ? u.get() : u), [u]);
              return (0, eO.createElement)(t, { ...h, children: d });
            })(
              t,
              i,
              ((a = p.visualElement),
      ...
      let l = (0, eO.forwardRef)(a);
      return ((l[e7] = t), l);
    }
    t.s(['useIsomorphicLayoutEffect', () => is], 40023);
    class io {
      constructor(t) {
    ...
    function ia(t, e, i) {
      let n = t.getProps();
      return et(n, e, void 0 !== i ? i : n.custom, t);
    }
    function il(t, e) {
      return t?.[e] ?? t?.default ?? t;
    }
    let ih = (t) => Array.isArray(t);
    function iu(t, e) {
    ...
    function iM(t, e) {
      let i = { ...t, ...e },
        n = {};
      for (let s in i)
        void 0 !== t[s] && void 0 !== e[s] && (n[s] = ib(t[s])(t[s], e[s]));
      return (t) => {
    ...
    let iE = (t, e) => {
      ...
      if ((iP.has(t) && !s.values.length) || (iP.has(e) && !n.values.length))
    ...
    let iO = ['duration', 'bounce'],
      iU = ['stiffness', 'damping', 'mass'];
    function iN(t, e) {
      return e.some((e) => void 0 !== t[e]);
    }
    function i$(t = 0.3, e = 0.3) {
      let i,
        n =
          'object' != typeof t
            ? { visualDuration: t, keyframes: [0, 1], bounce: e }
            : t,
        { restSpeed: s, restDelta: o } = n,
        a = n.keyframes[0],
          ...
          if (!iN(t, iU) && iN(t, iO))
            if (t.visualDuration) {
              let i = (2 * Math.PI) / (1.2 * t.visualDuration),
                n = i * i,
                s = 2 * r(0.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(n);
                ...
                ((a = r(0.05, 1, a)),
                  ...
                  a < 1
                    ? ((s = (e) => {
                        let n = e * a,
                          s = n * t;
                        return 0.001 - ((n - i) / iI(e, a)) * Math.exp(-s);
                      }),
                      (o = (e) => {
                        let n = e * a * t,
        ...
        x = Math.sqrt(u / c) / 1e3,
        w = 5 > Math.abs(v);
      if ((s || (s = w ? iL : ij), o || (o = w ? iF : iB), g < 1)) {
        let t = iI(x, g);
        i = (e) =>
          l -
          Math.exp(-g * x * e) *
            (((y + g * x * v) / t) * Math.sin(t * e) + v * Math.cos(t * e));
      } else if (1 === g)
        ...
        i = (e) => {
          ...
          return (
            l -
            (i * ((y + g * x * v) * Math.sinh(n) + t * v * Math.cosh(n))) / t
          );
        };
      }
      let T = {
        ...
        next: (t) => {
          ...
          if (f) h.done = t >= p;
            ...
            let n = 0 === t ? y : 0;
            g < 1 && (n = 0 === t ? id(y) : iR(i, t, e));
            let r = Math.abs(l - e) <= o;
            h.done = Math.abs(n) <= s && r;
          }
          return ((h.value = h.done ? l : e), h);
        },
        toString: () => {
          let t = Math.min(iD(T), 2e4),
    ...
    t.s(['cubicBezier', () => iz], 33659);
    let iX = iz(0.42, 0, 1, 1),
      iH = iz(0, 0, 0.58, 1),
      iK = iz(0.42, 0, 0.58, 1),
      iG = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
      iq = (t) => (e) => 1 - t(1 - e),
      i_ = iz(0.33, 1.53, 0.69, 0.99),
      iZ = iq(i_),
      iJ = iG(iZ),
      iQ = (t) =>
        (t *= 2) < 1 ? 0.5 * iZ(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1))),
      i0 = (t) => 1 - Math.sin(Math.acos(t)),
      i1 = iq(i0),
      i5 = iG(i0),
      i3 = (t) => Array.isArray(t) && 'number' == typeof t[0],
      i2 = {
        linear: tS,
        easeIn: iX,
        easeInOut: iK,
    ...
    function i6(t, e, { clamp: i = !0, ease: n, mixer: s } = {}) {
      let o = t.length;
      if (
        (te(
          o === e.length,
      ...
      let l = (function (t, e, i) {
          ...
          for (let i = 0; i < r; i++) {
            let r = s(t[i], t[i + 1]);
            (e && (r = ip(Array.isArray(e) ? e[i] || tS : e, r)), n.push(r));
          }
          return n;
        })(e, n, s),
        h = l.length,
    ...
    function i7({
      ...
      var s;
      let r = Array.isArray(n) && 'number' != typeof n[0] ? n.map(i9) : i9(n),
        o = { done: !1, value: e[0] },
        a = i6(
          ((s = i && i.length === e.length ? i : i8(e)), s.map((e) => e * t)),
          e,
          {
            ease: Array.isArray(r)
              ? r
              : e.map(() => r || iK).splice(0, e.length - 1),
          }
        );
      return {
    ...
    (t.s(['progress', () => i4], 51458),
      t.s(['interpolate', () => i6], 52154),
      t.s(['defaultOffset', () => i8], 50044));
    let nt = (t) => null !== t;
    function ne(t, { repeat: e, repeatType: i = 'loop' }, n, s = 1) {
      let r = t.filter(nt),
        o = s < 0 || (e && 'loop' !== i && e % 2 == 1) ? 0 : r.length - 1;
      return o && void 0 !== n ? n : r[o];
    }
    let ni = { decay: iW, inertia: iW, tween: i7, keyframes: i7, spring: i$ };
    function nn(t) {
      'string' == typeof t.type && (t.type = ni[t.type]);
    }
    class ns {
      constructor() {
        this.updateFinished();
    ...
    class no extends ns {
      ...
      initAnimation() {
        ...
        a !== i7 &&
          'number' != typeof o[0] &&
          ((this.mixKeyframes = ip(nr, iV(o[0], o[1]))), (o = [0, 100]));
        ...
        ('mirror' === s &&
          ...
          null === l.calculatedDuration && (l.calculatedDuration = iD(l)));
      ...
      tick(t, e = !1) {
        ...
        let T = v ? { done: !1, value: u[0] } : w.next(x);
        s && (T.value = s(T.value));
        let { done: P } = T;
        v ||
          null === l ||
        ...
        return (
          S && m !== iW && (T.value = ne(u, this.options, y, this.speed)),
          f && f(T.value),
          S && this.finish(),
          T
        );
      ...
      play() {
        ...
        let { driver: t = iC, startTime: e } = this.options;
    ...
    t.s(['JSAnimation', () => no], 54395);
    let nl = na(() => void 0 !== window.ScrollTimeline);
    t.s(['supportsScrollTimeline', () => nl], 9701);
    let nh = {},
      nu =
        ((i = na(() => {
          try {
        ...
        () => nh.linearEasing ?? i()),
      nd = ([t, e, i, n]) => `cubic-bezier(${t}, ${e}, ${i}, ${n})`,
      nc = {
        linear: 'linear',
        ease: 'ease',
        easeIn: 'ease-in',
        ...
        circIn: nd([0, 0.65, 0.55, 1]),
        circOut: nd([0.55, 0, 1, 0.45]),
        backIn: nd([0.31, 0.01, 0.66, -0.59]),
        backOut: nd([0.33, 1.53, 0.69, 0.99]),
      };
    function np(t) {
    ...
    class nm extends ns {
        ...
        ((this.animation = (function (
          ...
          (this.animation.onfinish = () => {
            if (((this.finishedTime = this.time), !s)) {
              let t = ne(n, this.options, o, this.speed);
      ...
      set time(t) {
        ((this.manualStartTime = null),
          (this.finishedTime = null),
          (this.animation.currentTime = id(t)));
      }
      get speed() {
    ...
    let nf = { anticipate: iQ, backInOut: iJ, circInOut: i5 };
    class ny extends nm {
      constructor(t) {
        (!(function (t) {
      ...
      updateMotionValue(t) {
        ...
        let a = new no({ ...o, autoplay: !1 }),
          l = Math.max(10, tH.now() - this.startTime),
          h = r(0, 10, l - 10);
        (e.setWithVelocity(
          a.sample(Math.max(0, l - h)).value,
          a.sample(l).value,
          h
        ),
          a.stop());
    ...
    let nx = new Set(['opacity', 'clipPath', 'filter', 'transform']),
      nw = na(() => Object.hasOwnProperty.call(Element.prototype, 'animate'));
    class nT extends ns {
      constructor({
        autoplay: t = !0,
        delay: e = 0,
      ...
      onKeyframesResolved(t, e, i, n) {
        ...
        ((this.resolvedAt = tH.now()),
          !(function (t, e, i, n) {
            ...
            ((tb.instantAnimations || !a) && h?.(ne(t, i, e)),
            (t[0] = t[t.length - 1]),
            nv(i),
            (i.repeat = 0)));
        let u = {
          ...
          p = d ? new ny({ ...u, element: c }) : new no(u);
        (p.finished
          .then(() => {
            this.notifyFinished();
          })
      ...
      get animation() {
        return (
          this._animation ||
            (this.keyframeResolver?.resume(), (tj = !0), tB(), tF(), (tj = !1)),
          this._animation
        );
      }
      get duration() {
      ...
      nM =
        ...
        (a) => {
          ...
          (!(function ({
            ...
            d.duration && (d.duration = id(d.duration)),
            d.repeatDelay && (d.repeatDelay = id(d.repeatDelay)),
            void 0 !== d.from && (d.keyframes[0] = d.from));
          let c = !1;
          if (
            ((!1 !== d.type && (0 !== d.duration || d.repeatDelay)) ||
              (nv(d), 0 === d.delay && (c = !0)),
            (tb.instantAnimations || tb.skipAnimations) &&
              ((c = !0), nv(d), (d.delay = 0)),
            ...
            if (void 0 !== t)
              return void tE.update(() => {
                (d.onUpdate(t), d.onComplete());
              });
          }
          return l.isSync ? new no(d) : new nT(d);
        };
    function nE(t, e, { delay: i = 0, transitionOverride: n, type: s } = {}) {
      ...
      for (let e in a) {
        ...
        if (window.MotionHandoffAnimation) {
          let i = t.props[it];
          if (i) {
            let t = window.MotionHandoffAnimation(i, e, tE);
            null !== t && ((o.startTime = t), (c = !0));
          }
        }
        iu(t, e);
        let p = l ?? t.shouldReduceMotion;
        n.start(nM(e, n, s, p && G.has(e) ? { type: !1 } : o, t, c));
        let m = n.animation;
        m && h.push(m);
      }
      return (
            ...
            tE.update(() => {
              o &&
                (function (t, e) {
                  ...
                  for (let e in (s = { ...s, ...i })) {
                    var r;
                    let i = ih((r = s[e])) ? r[r.length - 1] || 0 : r;
    ...
    function nC(t, e, i = {}) {
      let n = ia(t, e, 'exit' === i.type ? t.presenceContext?.custom : void 0),
    ...
    function nU(t) {
      return nO.has(t.tagName) || !0 === t.isContentEditable;
    }
    ...
    function nz(t, e, i, n) {
      (nY(t.x, e.x, i.x, n ? n.originX : void 0),
        nY(t.y, e.y, i.y, n ? n.originY : void 0));
    }
    function nX(t, e, i) {
      ((t.min = i.min + e.min), (t.max = t.min + nW(e)));
    }
    function nH(t, e, i) {
      ((t.min = e.min - i.min), (t.max = t.min + nW(e)));
    }
    function nK(t, e, i) {
    ...
    function n_(t, e, i, n) {
      return nN(t, e, (t) => nG(t) && i(t, nq(t)), n);
    }
    let nZ = ({ current: t }) => (t ? t.ownerDocument.defaultView : null),
      nJ = (t, e) => Math.abs(t - e),
    ...
    class n0 {
      constructor(
        ...
        if (
          ...
          (this.updatePoint = () => {
            ...
            let i = n3(this.lastMoveEventInfo, this.history),
              ...
              s =
                ((t = i.offset),
                (e = { x: 0, y: 0 }),
                Math.sqrt(nJ(t.x, e.x) ** 2 + nJ(t.y, e.y) ** 2) >=
          ...
          (this.handlePointerMove = (t, e) => {
            ((this.lastMoveEvent = t),
              (this.lastMoveEventInfo = n1(e, this.transformPagePoint)),
        ...
        const a = n1(nq(t), this.transformPagePoint),
          { point: l } = a,
          { timestamp: h } = tC;
        this.history = [{ ...l, timestamp: h }];
        const { onSessionStart: u } = e;
        (u && u(t, n3(a, this.history)),
          (this.removeListeners = ip(
            n_(this.contextWindow, 'pointermove', this.handlePointerMove),
            n_(this.contextWindow, 'pointerup', this.handlePointerUp),
            n_(this.contextWindow, 'pointercancel', this.handlePointerUp)
          )),
    ...
    function n3({ point: t }, e) {
      return {
        ...
        velocity: (function (t, e) {
          ...
          for (
            ;
            i >= 0 && ((n = t[i]), !(s.timestamp - n.timestamp > id(0.1)));
          )
            i--;
          if (!n) return { x: 0, y: 0 };
    ...
    class st {
      ...
      start(t, { snapToCursor: e = !1, distanceThreshold: i } = {}) {
        ...
        let s = (t) => {
            e
              ? (this.stopAnimation(), this.snapToCursor(nq(t).point))
              : this.pauseAnimation();
          },
          r = (t, e) => {
            this.stopAnimation();
        ...
        this.panSession = new n0(
          ...
          },
          {
            ...
            dragSnapToOrigin: h,
            distanceThreshold: i,
            contextWindow: nZ(this.visualElement),
      ...
      resolveConstraints() {
        ...
        (t && ii(t)
          ...
          (this.elastic = (function (t = 0.35) {
            return (
              !1 === t ? (t = 0) : !0 === t && (t = 0.35),
              { x: n6(t, 'left', 'right'), y: n6(t, 'top', 'bottom') }
            );
          })(e)),
          n !== this.constraints &&
            i &&
      ...
      resolveRefConstraints() {
        ...
        let r = (function (t, e, i) {
          ...
          o = ((t = s.layout.layoutBox), { x: n4(t.x, r.x), y: n4(t.y, r.y) });
        if (i) {
          let t = i(
            (function ({ x: t, y: e }) {
      ...
      startAnimation(t) {
        ...
        return Promise.all(
          nI((o) => {
            if (!se(o, e, this.currentDirection)) return;
            let l = (a && a[o]) || {};
            r && (l = { min: 0, max: 0 });
            let h = {
              type: 'inertia',
        ...
        nI((t) => {
          ...
          if (e && !1 !== this.constraints) {
            ...
            n[t] =
              ...
              (a = nW(i)),
              (l = nW(s)) > a
                ? (o = i4(s.min, s.max - a, i.min))
                : a > l && (o = i4(i.min, i.max - l, s.min)),
              r(0, 1, o));
          }
        });
      ...
      addListeners() {
        if (!this.visualElement.current) return;
        n7.set(this.visualElement, this);
        let t = this.visualElement.current,
          e = n_(t, 'pointerdown', (e) => {
    ...
    let si = (t) => (e, i) => {
        t && tE.postRender(() => t(e, i));
      },
      sn = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 };
    var ss = eO;
    function sr(t = !0) {
      let e = (0, eO.useContext)(e0);
      ...
      let o = (0, eO.useCallback)(() => t && n && n(r), [r, n, t]);
      return !i && n ? [!1, o] : [!0];
    }
    t.s(['usePresence', () => sr], 4036);
    let so = !1;
    ...
    function su(t) {
      return sh(t) && 'ownerSVGElement' in t;
    }
    t.s(['isSVGElement', () => su], 2391);
    let sd = ['TopLeft', 'TopRight', 'BottomLeft', 'BottomRight'],
      sc = sd.length,
      sp = (t) => ('string' == typeof t ? parseFloat(t) : t),
      sm = (t) => 'number' == typeof t || w.test(t);
    function sf(t, e) {
    ...
    let sy = sv(0, 0.5, i1),
      sg = sv(0.5, 0.95, tS);
    function sv(t, e, i) {
      return (n) => (n < t ? 0 : n > e ? 1 : i(i4(t, e, n)));
    }
    function sx(t, e) {
      ((t.min = e.min), (t.max = e.max));
    }
    function sw(t, e) {
      (sx(t.x, e.x), sx(t.y, e.y));
    }
    function sT(t, e) {
    ...
    function sS(t, e, [i, n, s], r, o) {
      !(function (t, e = 0, i = 1, n = 0.5, s, r = t, o = t) {
        if (
          (x.test(e) &&
            ((e = parseFloat(e)), (e = ex(o.min, o.max, e / 100) - o.min)),
          'number' != typeof e)
        )
          return;
        let a = ex(r.min, r.max, n);
        (t === r && (a -= e),
          (t.min = sP(t.min, e, i, a, s)),
          (t.max = sP(t.max, e, i, a, s)));
      })(t, e[i], e[n], e[s], e.scale, r, o);
    }
    let sb = ['x', 'scaleX', 'originX'],
      sA = ['y', 'scaleY', 'originY'];
    function sM(t, e, i, n) {
      (sS(t.x, e, sb, i ? i.x : void 0, n ? n.x : void 0),
        sS(t.y, e, sA, i ? i.y : void 0, n ? n.y : void 0));
    }
    function sE(t) {
      return 0 === t.translate && 1 === t.scale;
    }
    function sV(t) {
      return sE(t.x) && sE(t.y);
    }
    function sC(t, e) {
    ...
    function sN({
      ...
      return class {
        ...
        addEventListener(t, e) {
          return (
            this.eventHandlers.has(t) || this.eventHandlers.set(t, new tY()),
        ...
        mount(e) {
          ...
          ((this.isSVG = su(e) && !(su(e) && 'svg' === e.tagName)),
            (this.instance = e));
            ...
            !1 !== this.options.animate &&
              ...
              this.addEventListener(
                ...
                ({
                  ...
                  let r =
                      this.options.transition || s.getDefaultTransition() || s3,
                    {
                      onLayoutAnimationStart: o,
                      onLayoutAnimationComplete: a,
                    } = s.getProps(),
                    l = !this.targetLayout || !sD(this.targetLayout, n),
                    h = !e && i;
                  if (
        ...
        startUpdate() {
          !this.isUpdateBlocked() &&
            ((this.isUpdating = !0),
            this.nodes && this.nodes.forEach(sJ),
            this.animationId++);
        }
        ...
        update() {
          ...
          if (this.animationId <= this.animationCommitId)
            return void this.nodes.forEach(sK);
        ...
        didUpdate() {
          this.updateScheduled ||
            ((this.updateScheduled = !0), tz.read(this.scheduleUpdate));
        }
        clearAllSnapshots() {
          (this.nodes.forEach(sX), this.sharedNodes.forEach(sQ));
        }
        ...
        resetTransform() {
          ...
          let t =
            ...
            e = this.projectionDelta && !sV(this.projectionDelta),
            i = this.getTransformTemplate(),
            n = i ? i(this.latestValues, '') : void 0,
            r = n !== this.prevTransformTemplateValue;
          t &&
            this.instance &&
            (e || eV(this.latestValues) || r) &&
            (s(this.instance, n),
            (this.shouldResetTransform = !1),
            this.scheduleRender());
        }
        ...
        measurePageBox() {
          ...
          if (!(this.scroll?.wasRoot || this.path.some(s8))) {
        ...
        removeElementScroll(t) {
          let e = H();
          if ((sw(e, t), this.scroll?.wasRoot)) return e;
          for (let i = 0; i < this.path.length; i++) {
            ...
            n !== this.root &&
              s &&
              r.layoutScroll &&
              (s.wasRoot && sw(e, t), eL(e.x, s.offset.x), eL(e.y, s.offset.y));
          }
          return e;
        }
        applyTransform(t, e = !1) {
          ...
          for (let t = 0; t < this.path.length; t++) {
            ...
            (!e &&
              ...
              n.scroll &&
              n !== n.root &&
              eF(i, { x: -n.scroll.offset.x, y: -n.scroll.offset.y }),
              eV(n.latestValues) && eF(i, n.latestValues));
          }
          return (eV(this.latestValues) && eF(i, this.latestValues), i);
        }
        removeTransform(t) {
          let e = H();
          sw(e, t);
          for (let t = 0; t < this.path.length; t++) {
            let i = this.path[t];
            if (!i.instance || !eV(i.latestValues)) continue;
            eE(i.latestValues) && i.updateSnapshot();
            let n = H();
            (sw(n, i.measurePageBox()),
              sM(
                e,
                i.latestValues,
          ...
          return (eV(this.latestValues) && sM(e, this.latestValues), e);
        }
        setTargetDelta(t) {
          ((this.targetDelta = t),
        ...
        resolveTargetDelta(t = !1) {
          ...
          if (
            ...
            if (
              (this.target ||
                ((this.target = H()), (this.targetWithTransforms = H())),
              this.relativeTarget &&
              ...
              this.targetDelta
                ? (this.resumingFrom
                    ...
                    : sw(this.target, this.layout.layoutBox),
                  eR(this.target, this.targetDelta))
                : sw(this.target, this.layout.layoutBox);
            this.attemptToResolveRelativeTarget &&
        ...
        createRelativeTarget(t, e, i) {
          ((this.relativeParent = t),
            ...
            nK(this.relativeTargetOrigin, e, i),
            sw(this.relativeTarget, this.relativeTargetOrigin));
        }
        ...
        calcProjection() {
          ...
          if (
            ...
            return;
          sw(this.layoutCorrected, this.layout.layoutBox);
              ...
              for (let a = 0; a < o; a++) {
                ...
                (!o ||
                  ...
                  (n &&
                    ...
                    s.scroll &&
                    s !== s.root &&
                    eF(t, { x: -s.scroll.offset.x, y: -s.scroll.offset.y }),
                  r && ((e.x *= r.x.scale), (e.y *= r.y.scale), eR(t, r)),
                  n && eV(s.latestValues) && eF(t, s.latestValues));
              }
          ...
          (this.projectionDelta && this.prevProjectionDelta
            ? (sT(this.prevProjectionDelta.x, this.projectionDelta.x),
              sT(this.prevProjectionDelta.y, this.projectionDelta.y))
            ...
            (this.treeScale.x === r &&
              this.treeScale.y === o &&
              sL(this.projectionDelta.x, this.prevProjectionDelta.x) &&
              sL(this.projectionDelta.y, this.prevProjectionDelta.y)) ||
              ((this.hasProjected = !0),
              this.scheduleRender(),
              ...
              if (
                ...
                (nK(
                  ...
                  i &&
                    ...
                    (c = i),
                    sC(h.x, c.x) && sC(h.y, c.y)) &&
                    (this.isProjectionDirty = !1),
                  i || (i = H()),
                  sw(i, this.relativeTarget));
              }
              (l &&
                ((this.animationValues = r),
                (function (t, e, i, n, s, r) {
                  s
                    ? ((t.opacity = ex(0, i.opacity ?? 1, sy(n))),
                      (t.opacityExit = ex(e.opacity ?? 1, 0, sg(n))))
                    : r && (t.opacity = ex(e.opacity ?? 1, i.opacity ?? 1, n));
                  for (let s = 0; s < sc; s++) {
                    let r = `border${sd[s]}Radius`,
                      o = sf(e, r),
                      a = sf(i, r);
                    (void 0 !== o || void 0 !== a) &&
                      (o || (o = 0),
                      a || (a = 0),
                      0 === o || 0 === a || sm(o) === sm(a)
                        ? ((t[r] = Math.max(ex(sp(o), sp(a), n), 0)),
                          (x.test(a) || x.test(o)) && (t[r] += '%'))
                        : (t[r] = a));
                  }
                  (e.rotate || i.rotate) &&
        ...
        applyTransformsToTarget() {
          ...
          if (e && i && n) {
            if (
              ...
              this.layout &&
              n &&
              s6(this.options.animationType, this.layout.layoutBox, n.layoutBox)
            ) {
              i = this.target || H();
              let e = nW(this.layout.layoutBox.x);
              ((i.x.min = t.target.x.min), (i.x.max = i.x.min + e));
              let n = nW(this.layout.layoutBox.y);
        ...
        registerSharedNode(t, e) {
          (this.sharedNodes.has(t) || this.sharedNodes.set(t, new sj()),
        ...
        resetSkewAndRotation() {
          ...
          if (
            ...
            return;
          let n = {};
          i.z && sU('z', t, n, this.animationValues);
          for (let e = 0; e < sI.length; e++)
            (sU(`rotate${sI[e]}`, t, n, this.animationValues),
              sU(`skew${sI[e]}`, t, n, this.animationValues));
        ...
        applyProjectionStyles(t, e) {
          ...
          if (this.needsReset) {
            ((this.needsReset = !1),
              (t.visibility = ''),
              (t.opacity = ''),
              (t.pointerEvents = eQ(e?.pointerEvents) || ''),
          ...
          this.options.layoutId &&
            (t.pointerEvents =
              n === this ? eQ(e?.pointerEvents) || '' : 'none');
        }
        clearSnapshot() {
    ...
    let s3 = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
      s2 = (t) =>
        'u' > typeof navigator &&
        navigator.userAgent &&
        navigator.userAgent.toLowerCase().includes(t),
      s9 = s2('applewebkit/') && !s2('chrome/') ? Math.round : tS;
    function s4(t) {
      ((t.min = s9(t.min)), (t.max = s9(t.max)));
    }
    function s6(t, e, i) {
      return (
        'position' === t ||
        ('preserve-aspect' === t && !(0.2 >= Math.abs(sR(e) - sR(i))))
      );
    }
    function s8(t) {
    ...
    function rr(t, e, i) {
      ...
      let s = n['onHover' + i];
      s && tE.postRender(() => s(e, nq(e)));
    }
    function ro(t) {
      return sh(t) && 'offsetHeight' in t;
    }
    (t.s(['resolveElements', () => ri], 51398),
      t.s(['isHTMLElement', () => ro], 82075));
      ...
      rv = (function (t, e) {
        ...
        return new Proxy((t, e) => n(t, e), {
          get: (s, r) =>
            'create' === r
              ? n
              : (i.has(r) || i.set(r, ir(r, void 0, t, e)), i.get(r)),
        });
      })(
        {
          animation: {
            Feature: class extends io {
                              ...
                              ...S.map((e) => {
                                ...
                                if (
                                  ...
                                  if (n.enteringChildren && s) {
                                    let { delayChildren: e } =
                                      s.transition || {};
                                    i.delay = nV(n.enteringChildren, t, e);
                                  }
                                }
              ...
              updateAnimationControlsSubscription() {
                ...
                t3(t) && (this.unmountControls = t.subscribe(this.node));
              }
              mount() {
              ...
              startObserver() {
                ...
                let { viewport: i = {} } = this.node.getProps(),
                  ...
                  a = {
                    ...
                    rootMargin: s,
                    threshold: 'number' == typeof r ? r : rg[r],
                  },
                  l = (t) => {
                ...
                return (
                  ...
                  (e = (function ({ root: t, ...e }) {
                    ...
                    return (
                      n[s] ||
                        (n[s] = new IntersectionObserver(ry, {
                          root: t,
                          ...e,
                        })),
                      n[s]
            ...
            Feature: class extends io {
              ...
              createPanHandlers() {
                ...
                return {
                  ...
                  onMove: i,
                  onEnd: (t, e) => {
                    (delete this.session, n && tE.postRender(() => n(t, e)));
                  },
                };
              }
              mount() {
                this.removePointerDownListener = n_(
                  this.node.current,
                  'pointerdown',
          ...
          layout: { ProjectionNode: re, MeasureLayout: sl },
        },
        (t, e) =>
          (e.isSVG ?? eN(t))
            ? new eb(e)
            : new eI(e, { allowProjection: t !== eO.Fragment })
      );
    t.s(['motion', () => rv], 62897);
  },
]);
