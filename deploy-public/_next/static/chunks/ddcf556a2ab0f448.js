  ...
  (e, t, r) => {
        ...
        return (
          ...
          (r.replaceRule = function (e, t) {
            if (this._optimizeForSpeed || 'u' < typeof window) {
              ...
              var n = this._tags[e];
              (h(n, 'old rule at index `' + e + '` not found'),
                (n.textContent = t));
            }
            return e;
          }),
          ...
          (r.makeStyleTag = function (e, t, r) {
            t &&
              h(u(t), 'makeStyleTag accepts only strings as second parameter');
    ...
    var p = (function () {
        function e(e) {
          var t = void 0 === e ? {} : e,
            ...
            s = void 0 !== i && i;
          ((this._sheet =
            n || new l({ name: 'styled-jsx', optimizeForSpeed: s })),
            this._sheet.inject(),
            n &&
              'boolean' == typeof s &&
    ...
    ((g.dynamic = function (e) {
      ...
      (r.StyleRegistry = function (e) {
        ...
        return s.default.createElement(_.Provider, { value: o }, r);
      }),
      (r.createStyleRegistry = m),
      (r.style = g),
      (r.useStyleRegistry = y));
  },
  55264,
  (e, t, r) => {
