...
const menuItems = [
  ...
  { label: 'sobre', ariaLabel: 'Learn about me', link: '/about' },
  { label: 'portfólio', ariaLabel: 'View my portfolio', link: '/services' },
  { label: 'contato', ariaLabel: 'Get in touch', link: '/contact' }
];

const socialItems Icons = [
  { label: 'LinkedIn', link: 'https://linkedin.com/in/danilonovais' },
  { label: 'Instagram', link: 'https://instagram.com/danilo_novais'},
  { label: 'E-mail', link: 'danilo@portfoliodanilo.com' }
];
