...
export default function PortfolioHero() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-6 px-6 pb-10 pt-2 lg:px-8">
        <p className="text-3xl font-bold lowercase tracking-tight text-[#111111]">
