      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 max-w-7xl">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-16 lg:gap-x-16 items-start">
            {projects[0] && (
              <motion.div variants={{ hidden: { opacity: 0, y: 24 }, visible: { opacity: 1, y: 0 } }} className="w-full">
                <ProjectCard project={projects[0]} index={0} className="md:aspect-4/3 aspect-[4/3.5]" />
              </motion.div>
            )}
            {projects[1] && (
              <motion.div variants={{ hidden: { opacity: 0, y: 24 }, visible: { opacity: 1, y: 0 } }} className="w-full md:pt-24">
                 <ProjectCard project={projects[1]} index={1} className="md:aspect-[3.5/4] aspect-4/3" />
              </motion.div>
            )}
          </div>
          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 24 }, visible: { opacity: 1, y: 0 } }} className="w-full">
            {projects[2] && (
              <ProjectCard project={projects[2]} index={2} className="aspect-video md:aspect-[2.4/1]" />
            )}
          </motion.div>
