...
import ManifestoOverlay from '../home/ManifestoOverlay';
      ...
      >
        <div className="relative z-10 container mx-auto px-6 md:px-10 lg:px-16 h-full flex flex-col justify-center">
          <div className="grid grid-cols-1 items-center gap-10 py-12 md:grid-cols-12 md:gap-4 md:py-0 w-full min-h-[600px]">
            ...
            <motion.div
              style={{ opacity: textOpacity, y: textY }}
              className="hidden md:flex flex-col items-center gap-6 md:col-span-3 md:items-end md:self-end z-20 mt-12 md:mt-0 md:pb-12"
            >
              ...
              <motion.div
                ...
                className="relative w-full max-w-[360px] cursor-pointer origin-center"
              ...
              >
                ...
                >
                  ...
                  {/* IMPORTANT: This div gets layoutId to morph into the overlay */}
                  <motion.div
