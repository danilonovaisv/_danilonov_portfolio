(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    let O = {
      ...
      _ = (t) => (e) => e.test(t),
      K = [O, z, $, N, Y, H, { test: (t) => 'auto' === t, parse: (t) => t }],
      G = (t) => K.find(_(t));
    t.i(47167);
    let q = () => {},
      Z = () => {};
    ...
    let tv = (t) => Math.round(1e5 * t) / 1e5,
      ...
      tb = (t, e) => (i) =>
        !!(
          ('string' == typeof i && tw.test(i) && i.startsWith(t)) ||
      ...
      tE = {
        test: (t) => tS.test(t) || tA.test(t) || tM.test(t),
        parse: (t) =>
          tS.test(t) ? tS.parse(t) : tM.test(t) ? tM.parse(t) : tA.parse(t),
        transform: (t) =>
          'string' == typeof t
            ? t
      ...
      let e = t.toString(),
        ...
        o = e
          .replace(
            ...
            (t) => (
              tE.test(t)
                ? (n.color.push(r), s.push(tk), i.push(tE.parse(t)))
                : t.startsWith('var(')
    ...
    let tF = (t) =>
        'number' == typeof t ? 0 : tE.test(t) ? tE.getAnimatableNone(t) : t,
      tB = {
        test: function (t) {
          return (
            isNaN(t) &&
    ...
    let tK = (t) => !!(t && t.getVelocity);
    function tG() {
      e = void 0;
    }
    t.s(['isMotionValue', () => tK], 83411);
    let tq = {
      now: () => (
        void 0 === e &&
          tq.set(
            tu.isProcessing || ts.useManualTiming
              ? tu.timestamp
              : performance.now()
          ),
        e
    ...
    (t.s(
      ['hasReducedMotionListener', () => es, 'prefersReducedMotion', () => en],
      96097
    ),
      ...
      update(t, e) {
        ...
        ((this.prevMotionValues = (function (t, e, i) {
          for (let n in e) {
            let s = e[n],
              r = i[n];
            if (tK(s)) t.addValue(n, s);
            else if (tK(r)) t.addValue(n, t5(s, { owner: t }));
            else if (r !== s)
              if (t.hasValue(n)) {
                let e = t.getValue(n);
      ...
      readValue(t, e) {
        ...
        if (null != i) {
          ...
          if (
            ...
            let n;
            ((n = i), !t3.find(_(n)) && tB.test(e) && (i = tY(t, e)));
          }
          this.setBaseTarget(t, tK(i) ? i.get() : i);
        }
        return tK(i) ? i.get() : i;
      }
      setBaseTarget(t, e) {
    ...
    class ey extends eg {
      constructor() {
        (super(...arguments), (this.KeyframeResolver = t_));
      }
    ...
    function eT(t, { style: e, vars: i }, n, s) {
      let r,
        o = t.style;
      for (r in e) o[r] = e[r];
    ...
    class eL extends ey {
      ...
      build(t, e, i) {
        ek(t, e, this.isSVGTag, i.transformTemplate, i.style);
      }
      renderInstance(t, e, i, n) {
        for (let i in (eT(t, e, void 0, n), e.attrs))
    ...
    var eO = t.i(43476);
    let eI = (0, s.createContext)({});
    t.s(['LayoutGroupContext', () => eI], 31178);
    let eU = (0, s.createContext)({ strict: !1 }),
      eW = (0, s.createContext)({
        transformPagePoint: (t) => t,
        isStatic: !1,
        reducedMotion: 'never',
      });
    t.s(['MotionConfigContext', () => eW], 37806);
    let eN = (0, s.createContext)({});
    function e$(t) {
    ...
    function eH(t, e, i) {
      for (let n in e) tK(e[n]) || eS(n, i) || (t[n] = e[n]);
    }
    let eY = () => ({ ...ez(), attrs: {} }),
      eX = new Set([
        'animate',
    ...
    try {
      ((n = (() => {
        ...
        'function' == typeof n &&
          (eK = (t) => (t.startsWith('on') ? !e_(t) : n(t))));
    } catch {}
    let eG = (0, s.createContext)(null);
    function eq(t) {
    ...
    let e5 = 'data-' + eE('framerAppearId'),
      e3 = (0, s.createContext)({}),
      e4 = ei ? s.useLayoutEffect : s.useEffect;
    function e6(t, { forwardMotionProps: e = !1 } = {}, i, n) {
      i &&
        (function (t) {
      ...
      function o(i, o) {
        ...
        if (!h && ei) {
          ...
          ((l = e.MeasureLayout),
            (c.visualElement = (function (t, e, i, n, r) {
              let { visualElement: o } = (0, s.useContext)(eN),
                a = (0, s.useContext)(eU),
                l = (0, s.useContext)(eG),
                u = (0, s.useContext)(eW).reducedMotion,
                h = (0, s.useRef)(null);
              ((n = n || a.renderer),
                !h.current &&
                  n &&
        ...
        return (0, eO.jsxs)(eN.Provider, {
          ...
          children: [
            l && c.visualElement
              ? (0, eO.jsx)(l, { visualElement: c.visualElement, ...u })
              : null,
                  ...
                  eB(t)
                    ? function (t, e, i, n) {
                        let r = (0, s.useMemo)(() => {
                          let i = eY();
                          return (
                            ek(i, e, eR(n), t.transformTemplate, t.style),
    ...
    function iv(t, e) {
      let i = { ...t, ...e },
        n = {};
      for (let s in i)
        void 0 !== t[s] && void 0 !== e[s] && (n[s] = ig(t[s])(t[s], e[s]));
      return (t) => {
    ...
    let ib = (t) => {
        ...
        return {
          ...
          stop: () => tl(e),
          now: () => (tu.isProcessing ? tu.timestamp : tq.now()),
        };
      },
      iT = (t, e, i = 10) => {
        let n = '',
    ...
    function iD(t = 0.3, e = 0.3) {
      let i,
                ...
                ((o = B(0.05, 1, o)),
                  ...
                  o < 1
                    ? ((s = (e) => {
                        let n = e * o,
                          s = n * t;
                        return 0.001 - ((n - i) / iV(e, o)) * Math.exp(-s);
                      }),
                      (r = (e) => {
                        let n = e * o * t,
        ...
        v = Math.sqrt(u / c) / 1e3,
        x = 5 > Math.abs(y);
      if ((s || (s = x ? iA : iM), r || (r = x ? iE : iC), g < 1)) {
        let t = iV(v, g);
        i = (e) =>
          a -
          Math.exp(-g * v * e) *
    ...
    function iQ(t, e, { clamp: i = !0, ease: n, mixer: s } = {}) {
      let r = t.length;
      if (
        (Z(
          r === e.length,
      ...
      let a = (function (t, e, i) {
          ...
          for (let i = 0; i < r; i++) {
            let r = s(t[i], t[i + 1]);
            (e && (r = is(Array.isArray(e) ? e[i] || tn : e, r)), n.push(r));
          }
          return n;
        })(e, n, s),
        l = a.length,
        u = (i) => {
          ...
          let s = iJ(t[n], t[n + 1], i);
          return a[n](s);
        };
      return i ? (e) => u(B(t[0], t[r - 1], e)) : u;
    }
    function i0(t) {
      let e = [0];
      return (
    ...
    function i1({
      ...
      let r = Array.isArray(n) && 'number' != typeof n[0] ? n.map(iZ) : iZ(n),
        o = { done: !1, value: e[0] },
        a = iQ(
          ((s = i && i.length === e.length ? i : i0(e)), s.map((e) => e * t)),
          e,
          {
    ...
    let i2 = (t) => null !== t;
    function i5(t, { repeat: e, repeatType: i = 'loop' }, n, s = 1) {
      let r = t.filter(i2),
    ...
    class i8 extends i6 {
      ...
      initAnimation() {
        ...
        a !== i1 &&
          'number' != typeof o[0] &&
          ((this.mixKeyframes = is(i7, iw(o[0], o[1]))), (o = [0, 100]));
      ...
      tick(t, e = !1) {
        ...
        return (
          T && p !== iL && (w.value = i5(u, this.options, f, this.speed)),
          m && m(w.value),
          T && this.finish(),
          w
        );
    ...
    let nt = i9(() => void 0 !== window.ScrollTimeline);
    ...
    let na = { anticipate: iY, backInOut: iH, circInOut: iK };
    class nl extends no {
      constructor(t) {
        (!(function (t) {
    ...
    let nu = (t, e) =>
      ...
      nc = i9(() => Object.hasOwnProperty.call(Element.prototype, 'animate'));
    class nd extends i6 {
      constructor({
        autoplay: t = !0,
        delay: e = 0,
      ...
      onKeyframesResolved(t, e, i, n) {
        ...
        ((this.resolvedAt = tq.now()),
          !(function (t, e, i, n) {
            ...
            ((ts.instantAnimations || !a) && u?.(i5(t, i, e)),
            (t[0] = t[t.length - 1]),
            ie(i),
            (i.repeat = 0)));
        let h = {
    ...
    let np = (t) => null !== t,
      nm = { type: 'spring', stiffness: 500, damping: 25, restSpeed: 10 },
      ...
      ny =
        ...
        (a) => {
          ...
          return l.isSync ? new i8(c) : new nd(c);
        };
            ...
            ta.update(() => {
              o &&
                (function (t, e) {
                  ...
                  for (let e in (s = { ...s, ...i })) {
                    var r;
                    let i = e9((r = s[e])) ? r[r.length - 1] || 0 : r;
    ...
    function nw(t, e, i = {}) {
      let n = e7(t, e, 'exit' === i.type ? t.presenceContext?.custom : void 0),
    ...
    function nD(t, e, i, n) {
      return nk(t, e, (t) => nj(t) && i(t, nR(t)), n);
    }
    function nL(t) {
      return t.max - t.min;
    }
    function nF(t, e, i, n = 0.5) {
      ((t.origin = n),
    ...
    function nB(t, e, i, n) {
      (nF(t.x, e.x, i.x, n ? n.originX : void 0),
        nF(t.y, e.y, i.y, n ? n.originY : void 0));
    }
    function nO(t, e, i) {
    ...
    let nN = ({ current: t }) => (t ? t.ownerDocument.defaultView : null),
      n$ = (t, e) => Math.abs(t - e);
    class nz {
      constructor(
        t,
        ...
        const o = nH(nR(t), this.transformPagePoint),
          { point: a } = o,
          { timestamp: l } = tu;
    ...
    function nX({ point: t }, e) {
      return {
        ...
        velocity: (function (t, e) {
          ...
          for (
            ;
            i >= 0 && ((n = t[i]), !(s.timestamp - n.timestamp > ir(0.1)));
          )
            i--;
          if (!n) return { x: 0, y: 0 };
    ...
    class nQ {
      ...
      resolveConstraints() {
        ...
        (t && e2(t)
          ...
          (this.elastic = (function (t = 0.35) {
            return (
              !1 === t ? (t = 0) : !0 === t && (t = 0.35),
              { x: nq(t, 'left', 'right'), y: nq(t, 'top', 'bottom') }
            );
          })(e)),
          n !== this.constraints &&
            i &&
      ...
      stopAnimation() {
        nW((t) => this.getAxisMotionValue(t).stop());
      }
      pauseAnimation() {
        nW((t) => this.getAxisMotionValue(t).animation?.pause());
      }
      getAnimationState(t) {
        ...
        nW((t) => {
          ...
          if (e && !1 !== this.constraints) {
            ...
            n[t] =
              ...
              (o = nL(i)),
              (a = nL(s)) > o
                ? (r = iJ(s.min, s.max - o, i.min))
                : o > a && (r = iJ(i.min, i.max - a, s.min)),
              B(0, 1, r));
          }
        });
    ...
    class n8 extends n2.Component {
      componentDidMount() {
        let {
          ...
          { projection: s } = t;
        for (let t in st) ((eP[t] = st[t]), v(t) && (eP[t].isCSSVariable = !0));
        (s &&
    ...
    function si(t) {
      return se(t) && 'ownerSVGElement' in t;
    }
    t.s(['isSVGElement', () => si], 89026);
    let sn = (t, e) => t.depth - e.depth;
    class ss {
      constructor() {
      ...
      forEach(t) {
        (this.isDirty && this.children.sort(sn),
          (this.isDirty = !1),
          this.children.forEach(t));
      }
    }
    let sr = ['TopLeft', 'TopRight', 'BottomLeft', 'BottomRight'],
      so = sr.length,
      sa = (t) => ('string' == typeof t ? parseFloat(t) : t),
      sl = (t) => 'number' == typeof t || z.test(t);
    function su(t, e) {
    ...
    function sy(t, e, [i, n, s], r, o) {
      !(function (t, e = 0, i = 1, n = 0.5, s, r = t, o = t) {
        ...
        (t === r && (a -= e),
          (t.min = sg(t.min, e, i, a, s)),
          (t.max = sg(t.max, e, i, a, s)));
      })(t, e[i], e[n], e[s], e.scale, r, o);
    }
    let sv = ['x', 'scaleX', 'originX'],
      sx = ['y', 'scaleY', 'originY'];
    function sw(t, e, i, n) {
      (sy(t.x, e, sv, i ? i.x : void 0, n ? n.x : void 0),
        sy(t.y, e, sx, i ? i.y : void 0, n ? n.y : void 0));
    }
    function sb(t) {
    ...
    function sR({
      ...
      return class {
        ...
        mount(e) {
          ...
          ((this.isSVG = si(e) && !(si(e) && 'svg' === e.tagName)),
            (this.instance = e));
            ...
            !1 !== this.options.animate &&
              ...
              this.addEventListener(
                ...
                ({
                  ...
                  let r =
                      this.options.transition || s.getDefaultTransition() || sG,
                    {
                      onLayoutAnimationStart: o,
                      onLayoutAnimationComplete: a,
                    } = s.getProps(),
                    l = !this.targetLayout || !sA(this.targetLayout, n),
                    u = !e && i;
                  if (
        ...
        startUpdate() {
          !this.isUpdateBlocked() &&
            ((this.isUpdating = !0),
            this.nodes && this.nodes.forEach(sH),
            this.animationId++);
        }
        ...
        update() {
          ...
          if (this.animationId <= this.animationCommitId)
            return void this.nodes.forEach(sU);
          ((this.animationCommitId = this.animationId),
            ...
            this.clearAllSnapshots());
          let t = tq.now();
          ((tu.delta = B(0, 1e3 / 60, t - tu.timestamp)),
            (tu.timestamp = t),
            (tu.isProcessing = !0),
        ...
        clearAllSnapshots() {
          (this.nodes.forEach(sO), this.sharedNodes.forEach(sY));
        }
        ...
        measurePageBox() {
          ...
          if (!(this.scroll?.wasRoot || this.path.some(s0))) {
        ...
        removeElementScroll(t) {
          let e = ee();
          if ((sm(e, t), this.scroll?.wasRoot)) return e;
          for (let i = 0; i < this.path.length; i++) {
            ...
            n !== this.root &&
              s &&
              r.layoutScroll &&
              (s.wasRoot && sm(e, t), j(e.x, s.offset.x), j(e.y, s.offset.y));
          }
          return e;
        }
        applyTransform(t, e = !1) {
          ...
          for (let t = 0; t < this.path.length; t++) {
            ...
            (!e &&
              ...
              M(n.latestValues) && D(i, n.latestValues));
          }
          return (M(this.latestValues) && D(i, this.latestValues), i);
        }
        removeTransform(t) {
          let e = ee();
          sm(e, t);
          ...
          return (M(this.latestValues) && sw(e, this.latestValues), e);
        }
        setTargetDelta(t) {
          ((this.targetDelta = t),
            ...
            if (
              ...
              this.targetDelta
                ? (this.resumingFrom
                    ...
                    : sm(this.target, this.layout.layoutBox),
        ...
        createRelativeTarget(t, e, i) {
          ((this.relativeParent = t),
            ...
            sm(this.relativeTarget, this.relativeTargetOrigin));
        }
        ...
        calcProjection() {
          ...
          if (
            ...
            return;
          sm(this.layoutCorrected, this.layout.layoutBox);
            ...
            if (o) {
              ...
              for (let a = 0; a < o; a++) {
                ...
                (!o ||
                  ...
                  r && ((e.x *= r.x.scale), (e.y *= r.y.scale), k(t, r)),
                  n && M(s.latestValues) && D(t, s.latestValues));
              }
              ...
              if (
                ...
                (nU(
                  ...
                  i &&
                    ...
                    (d = i),
                    sP(u.x, d.x) && sP(u.y, d.y)) &&
                    (this.isProjectionDirty = !1),
                  i || (i = ee()),
                  sm(i, this.relativeTarget));
              }
              (l &&
                ...
                (function (t, e, i, n, s, r) {
                  s
                    ? ((t.opacity = P(0, i.opacity ?? 1, sh(n))),
                      (t.opacityExit = P(e.opacity ?? 1, 0, sc(n))))
                    : r && (t.opacity = P(e.opacity ?? 1, i.opacity ?? 1, n));
                  for (let s = 0; s < so; s++) {
                    let r = `border${sr[s]}Radius`,
                      o = su(e, r),
                      a = su(i, r);
                    (void 0 !== o || void 0 !== a) &&
                      (o || (o = 0),
        ...
        registerSharedNode(t, e) {
          (this.sharedNodes.has(t) || this.sharedNodes.set(t, new sC()),
        ...
        resetSkewAndRotation() {
          ...
          for (let e = 0; e < sV.length; e++)
            (sj(`rotate${sV[e]}`, t, n, this.animationValues),
              sj(`skew${sV[e]}`, t, n, this.animationValues));
    ...
    let sG = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
      sq = (t) =>
        'undefined' != typeof navigator &&
        navigator.userAgent &&
        navigator.userAgent.toLowerCase().includes(t),
      sZ = sq('applewebkit/') && !sq('chrome/') ? Math.round : tn;
    function sJ(t) {
      ((t.min = sZ(t.min)), (t.max = sZ(t.max)));
    }
    function sQ(t, e, i) {
      return (
        'position' === t ||
        ('preserve-aspect' === t && !(0.2 >= Math.abs(sM(e) - sM(i))))
      );
    }
    function s0(t) {
    ...
    let s1 = sR({
        attachResizeListener: (t, e) => nk(t, 'resize', e),
        measureScroll: () => ({
    ...
    function s6(t) {
      return !('touch' === t.pointerType || nV.x || nV.y);
    }
    function s7(t, e, i) {
      let { props: n } = t;
      t.animationState &&
      ...
      let s = n['onHover' + i];
      s && ta.postRender(() => s(e, nR(e)));
    }
    function s8(t) {
      return se(t) && 'offsetHeight' in t;
    }
    (t.s(['resolveElements', () => s3], 49652),
      t.s(['isHTMLElement', () => s8], 72846));
    let s9 = (t, e) => !!e && (t === e || s9(t, e.parentElement)),
      ...
      })(
        {
                            ...
                            e.map(({ animation: e, options: i }) =>
                              (function (t, e, i = {}) {
                                ...
                                if (
                                  ...
                                  n = Promise.all(e.map((e) => nw(t, e, i)));
                                else if ('string' == typeof e) n = nw(t, e, i);
                                else {
                                  let s =
                                    'function' == typeof e
                                      ? e7(t, e, i.custom)
              ...
              startObserver() {
                ...
                return (
                  ...
                  (e = (function ({ root: t, ...e }) {
                    ...
                    return (
                      n[s] ||
                        (n[s] = new IntersectionObserver(ru, {
                          root: t,
                          ...e,
                        })),
                      n[s]
          ...
          focus: {
            Feature: class extends nE {
              ...
              mount() {
                this.unmount = is(
                  nk(this.node.current, 'focus', () => this.onFocus()),
                  nk(this.node.current, 'blur', () => this.onBlur())
                );
              }
              unmount() {}
            },
              ...
              mount() {
                ...
                t &&
                  (this.unmount = (function (t, e, i = {}) {
                    ...
                    t,
                    (t, e) => (
                      s7(this.node, e, 'Start'),
                      (t) => s7(this.node, t, 'End')
                    )
                  ));
              }
              unmount() {}
          ...
          layout: { ProjectionNode: s5, MeasureLayout: n9 },
        },
        (t, e) =>
          eB(t) ? new eL(e) : new eM(e, { allowProjection: t !== s.Fragment })
      );
    t.s(['motion', () => rc], 46932);
  },
  10542,
              ...
              (n.offset || n.target) &&
                (function (t, e, i) {
                  ...
                  for (let t = 0; t < c; t++) {
                    ...
                    (h || i === e[r].interpolatorOffsets[t] || (h = !0),
                      (e[r].offset[t] = i));
                  }
                  (h &&
  ...
  (t) => {
    ...
    var e = t.i(86427),
      ...
      s = t.i(47414);
    function r(t) {
      let r = (0, s.useConstant)(() => (0, e.motionValue)(t)),
        { isStatic: o } = (0, i.useContext)(n.MotionConfigContext);
      if (o) {
  ...
  (t) => {
    ...
    function o(t, e) {
      ...
      return (
        ...
        (0, s.useIsomorphicLayoutEffect)(() => {
          let e = () => n.frame.preRender(o, !1, !0),
            i = t.map((t) => t.on('change', e));
          return () => {
            (i.forEach((t) => t()), (0, n.cancelFrame)(o));
          };
        }),
        i
      );
    ...
    function l(t, i, n, s) {
      ...
      let r = 'function' == typeof i ? i : (0, e.transform)(i, n, s);
      return Array.isArray(t) ? u(t, r) : u([t], ([t]) => r(t));
    }
    function u(t, e) {
    ...
    let v = ({
      ...
      if (w !== A) {
        ...
        for (let e = 0; e < E.length; e++) {
          let i = E[e],
            n = g(i);
          b.includes(n) || (t.splice(e, 0, i), V.push(i));
        }
        return ('wait' === h && V.length && (t = V), C(y(t)), M(w), null);
      }
      let { forceRender: k } = (0, i.useContext)(n.LayoutGroupContext);
      return (0, e.jsx)(e.Fragment, {
        children: E.map((t) => {
          let i = g(t),
            n = (!c || !!v) && (w === E || b.includes(i));
          return (0, e.jsx)(
            p,
            {
              isPresent: n,
