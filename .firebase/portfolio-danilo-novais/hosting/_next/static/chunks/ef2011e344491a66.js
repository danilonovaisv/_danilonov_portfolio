(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function P(e, t, r) {
      for (var n = 0; n < t.length; n++) {
        var o = t[n];
        'function' == typeof o ? o(r) : H(e, o.handler, r);
      }
    }
    function j(e, t) {
        ...
        .then(function t(i) {
          ...
          for (
            ...
            if (-1 < b)
                  ...
                  case 73:
                    ...
                    if ((p = l(h))) {
                      if (_) {
                        var b = _;
                        b.status = 'blocked';
                      } else ((b = new R('blocked', null, null)), y.set(f, b));
                      p.then(
                        function () {
                          return N(c, b, h);
                        },
                      ...
                      _
                        ? N(c, _, h)
                        : ((_ = new R('resolved_module', h, null)),
                          y.set(f, _));
                    break;
                  case 72:
                    switch (
              ...
              })(e, u, i, p, _, (y = new Uint8Array(s.buffer, g, b - c))),
                (c = b),
                3 === f && c++,
                (y = i = p = f = 0),
                (_.length = 0));
    ...
    ((r.createFromFetch = function (e, t) {
      ...
      (r.createFromReadableStream = function (e, t) {
        return (es((t = ei(t)), e, ea.bind(null, t)), $(t, 0));
      }),
