(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
              ...
              if ('$' === u[0]) {
                ...
                switch (u[1]) {
                  case '$':
                    return u.slice(1);
                  case 'L':
                    return I((r = $(r, (n = parseInt(u.slice(2), 16)))));
                  case '@':
    ...
    function el(e, t, r) {
      ...
      a.read()
        .then(function t(i) {
          ...
          i = u._rowID;
          for (
            var p = u._rowTag, h = u._rowLength, _ = u._buffer, y = l.length;
            s < y;
          ) {
            var b = -1;
            switch (f) {
            ...
            if (-1 < b)
                  ...
                  case 73:
                    ...
                    if ((p = c(y))) {
                      if (_) {
                        var b = _;
                        b.status = 'blocked';
                      } else ((b = new R('blocked', null, null)), h.set(f, b));
                      p.then(
                        function () {
                          return N(s, b, y);
                        },
                      ...
                      _
                        ? N(s, _, y)
                        : ((_ = new R('resolved_module', y, null)),
                          h.set(f, _));
                    break;
                  case 72:
                    switch (
              ...
              })(e, u, i, p, _, (h = new Uint8Array(l.buffer, g, b - s))),
                (s = b),
                3 === f && s++,
                (h = i = p = f = 0),
                (_.length = 0));
          ...
          [
            (function e(t, r, n, o) {
              ...
              if ('string' == typeof l)
                ...
                ((u = [e, (0, a.getCacheKeyForDynamicParam)(s, r), t]),
                  (i = !0));
              }
              let s = i ? o + 1 : o,
                c = t[1],
  ...
  (e, t, r) => {
    ...
    function l(e, t, r = u.RedirectStatusCode.TemporaryRedirect) {
