      ...
      [
        ...
        () => {
          let { scrollY: e } = (0, l.useScroll)(),
            ...
            [g, v] = (0, r.useState)(!1),
            [y, j] = (0, r.useState)(''),
            k = (0, o.useTransform)(e, [0, 50], ['6.875rem', '5rem']),
            F = (0, o.useTransform)(
              e,
              [0, 50],
          ...
          return (0, t.jsxs)(t.Fragment, {
            children: [
              (0, t.jsxs)(a.motion.header, {
                ...
                className:
                  'fixed top-0 left-0 right-0 z-999 flex items-center justify-between px-6 lg:px-12 will-change-transform border-b border-transparent data-[scrolled=true]:border-neutral-100 backdrop-blur-md bg-white/70',
