(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function P(e, t, r) {
      for (var n = 0; n < t.length; n++) {
        var o = t[n];
        'function' == typeof o ? o(r) : F(e, o.handler, r);
      }
    }
    function j(e, t) {
    ...
    function w(e, t, r) {
      if ('pending' !== t.status && 'blocked' !== t.status) t.reason.error(r);
        ...
        var n = t.reason;
        ((t.status = 'rejected'), (t.reason = r), null !== n && P(e, n, r));
      }
    }
    function A(e, t, r) {
      return new R(
    ...
    function I(e) {
      return { $$typeof: _, _payload: e, _init: O };
    }
    function L(e, t) {
      var r = e._chunks,
        n = r.get(t);
      return (
        n ||
          ((n = e._closed
            ? new R('rejected', null, e._closedReason)
            : new R('pending', null, null)),
          r.set(t, n)),
        n
      );
    }
    function $(e, t, r) {
      for (
        ...
        for (; 'object' == typeof r && null !== r && r.$$typeof === _; )
      ...
      switch (u.status) {
        case 'fulfilled':
          ...
          for (var a = 1; a < t.length; a++) {
            for (; 'object' == typeof u && null !== u && u.$$typeof === _; ) {
        ...
        default:
          return (
            C
              ? ((C.errored = !0), (C.value = null), (C.reason = u.reason))
              : (C = {
                  parent: null,
                  chunk: null,
                  value: null,
              ...
              if ('$' === u[0]) {
                ...
                switch (u[1]) {
                  case '$':
                    return u.slice(1);
                  case 'L':
                    return I((r = L(r, (n = parseInt(u.slice(2), 16)))));
                  case '@':
              ...
              if (t[0] === p) {
                if (
                  ...
                  if (((C = (t = C).parent), t.errored))
                    e = I((e = new R('rejected', null, t.reason)));
                  else if (0 < t.deps) {
    ...
    function Q(e, t, r) {
      ...
      n && 'pending' !== n.status
        ...
        : ((r = new R('fulfilled', r, null)), e.set(t, r));
    }
    function Z(e, t, r, n) {
      var o = e._chunks,
        u = o.get(t);
      u
        ? 'pending' === u.status &&
          ...
          (u.value = r),
          (u.reason = n),
          null !== t && S(e, t, u.value))
        : ((e = new R('fulfilled', r, n)), o.set(t, e));
    }
    function ee(e, t, r) {
      var n = null;
      ...
      ((a[y] = function () {
        ...
        return (
          ((e = {
            next: (e = function (e) {
              ...
              if (t === n.length) {
                if (o)
                  return new R('fulfilled', { done: !0, value: void 0 }, null);
        ...
        Z(e, t, r ? a[y]() : a, {
          enqueueValue: function (t) {
            if (u === n.length)
              n[u] = new R('fulfilled', { done: !1, value: t }, null);
            else {
              var r = n[u],
                o = r.value,
                a = r.reason;
          ...
          error: function (t) {
            for (
              o = !0, u === n.length && (n[u] = new R('pending', null, null));
              u < n.length;
            )
              w(e, n[u++], t);
          },
                ...
                switch (((u = i += t.decode(a)), n)) {
                  case 73:
                    ...
                    if ((p = c(y))) {
                      if (h) {
                        var b = h;
                        b.status = 'blocked';
                      } else ((b = new R('blocked', null, null)), _.set(f, b));
                      p.then(
                        function () {
                          return N(l, b, y);
                        },
                      ...
                      h
                        ? N(l, h, y)
                        : ((h = new R('resolved_module', y, null)),
                          _.set(f, h));
                    break;
                  case 72:
                    switch (
                  ...
                  case 69:
                    ((a = (n = e._chunks).get(r)),
                      ...
                      a
                        ? w(e, a, t)
                        : ((e = new R('rejected', null, t)), n.set(r, e)));
                    break;
                  case 84:
                    (n = (e = e._chunks).get(r)) && 'pending' !== n.status
                      ? n.reason.enqueueValue(u)
                      : ((u = new R('fulfilled', u, null)), e.set(r, u));
                    break;
                  case 78:
                  case 68:
                  case 74:
                  ...
                  default:
                    (a = (n = e._chunks).get(r))
                      ? D(e, a, u)
                      : ((e = new R('resolved_model', u, e)), n.set(r, e));
                }
              })(e, u, i, p, h, (_ = new Uint8Array(s.buffer, g, b - l))),
                (l = b),
                3 === f && l++,
                (_ = i = p = f = 0),
                (h.length = 0));
    ...
    ((r.createFromFetch = function (e, t) {
      ...
      (r.createFromReadableStream = function (e, t) {
        return (es((t = ei(t)), e, ea.bind(null, t)), L(t, 0));
      }),
    ...
    async function v(e, t) {
      ...
      try {
        let t = o ? (o === c.PrefetchKind.TEMPORARY ? 'high' : 'low') : 'auto',
          ...
          l = !!r.headers.get('vary')?.includes(i.NEXT_URL),
          p = !!r.headers.get(i.NEXT_DID_POSTPONE_HEADER),
          h = r.headers.get(i.NEXT_ROUTER_STALE_TIME_HEADER),
          y = null !== h ? 1e3 * parseInt(h, 10) : -1;
        if (!s.startsWith(i.RSC_CONTENT_TYPE_HEADER) || !r.ok || !r.body)
          return (e.hash && (n.hash = e.hash), b(n.toString()));
        let g = r.flightResponse;
        if (null === g) {
          let e,
            t = p
              ? ((e = r.body.getReader()),
        ...
        let v = await g;
        if ((0, d.getAppBuildId)() !== v.b) return b(r.url);
        let R = (0, f.normalizeFlightData)(v.f);
        if ('string' == typeof R) return b(R);
        return {
          flightData: R,
          canonicalUrl: a,
