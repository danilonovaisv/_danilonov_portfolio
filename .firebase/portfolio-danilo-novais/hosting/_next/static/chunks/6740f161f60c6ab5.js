            ...
            (l =
              A === a.DEFAULT_SEGMENT_KEY
                ? void 0 !== f
                  ...
                  : h(t, f, c, F, s, void 0 !== C ? C : null, y, g, N, _)
                : R && 0 === Object.keys(c[1]).length
                  ? h(t, f, c, F, s, void 0 !== C ? C : null, y, g, N, _)
                  : void 0 !== f &&
                      void 0 !== L &&
                      (0, u.matchSegment)(A, L) &&
                      void 0 !== F &&
                      void 0 !== f
                    ? e(t, r, F, f, c, s, C, y, g, R, N, _)
                    : h(t, f, c, F, s, void 0 !== C ? C : null, y, g, N, _))
          ) {
    ...
    function S(e) {
      e.priority === s.PrefetchPriority.Intent &&
        ...
        (null !== R &&
          ...
          ((R.priority = s.PrefetchPriority.Default), K(h, R)),
        (R = e));
    }
    function T() {
      g || ((g = !0), f(C));
        ...
        switch (
          ...
          case 2:
            (1 === t.phase
              ? ((t.phase = 0), K(h, t))
              : n
                ? ((t.priority = s.PrefetchPriority.Background), K(h, t))
                : z(h),
              (t = V(h)));
            continue;
        }
  ...
  (e, t, r) => {
    ...
    async function $(e, t, r) {
      ...
      try {
        let r,
          h,
          _ = new URL(n + l, location.origin);
        if (
          ((r = await er(_, c)),
          (h = null !== r && r.redirected ? new URL(r.url) : _),
              ...
              O = (function e(t, r, n, l, a) {
                ...
                if (Array.isArray(f)) {
                  ...
                  ((i = (0, s.appendLayoutVaryPath)(n, e)),
                    (d = (0, s.finalizeLayoutVaryPath)(r, i)),
                    (o = f));
                } else
                  ((i = n),
                    r.endsWith(v.PAGE_SEGMENT_KEY)
                      ? ((c = !0),
                        ...
                        (d = (0, s.finalizePageVaryPath)(r, l, i)),
                        null === a.metadataVaryPath &&
                          (a.metadataVaryPath = (0, s.finalizeMetadataVaryPath)(
                            r,
                            l,
                            i
                          )))
